...
@section('content')
                                            ...
                                            <section class="mobile">
                                                ...
                                                <div id="carouselExample" class="carousel slide mobile-image-slider text-center" data-bs-ride="carousel">
                                                    <a style="background-color: #ffb300; font-size: 20px; padding: 20px 10px;" class="mb-3 text-center text-white rounded fw-bold">Registration for 5th Convocation</a>
            ...
            'content' => '',
                                            ...
                                            <section class="website">
                                                ...
                                                <div id="popup-web" class="popup-overlay">
                                                    <a href="https://docs.google.com/forms/d/e/1FAIpQLSfKAyNyc88p6x7K-rFpnG9C25dneSv79DvxkvHXlOi_CHGixA/viewform"
                                                        target="_blank"><img src="{{ asset('mobile-assets/notification/convo-5th.jpeg') }}"
                                                ...
                                                <div>
                                                    <div class="convocation-btn-wrapper">
                                                        <a href="https://forms.gle/t7dhtshNKYwcHumq7" class="convocation-btn">
                                                                ...
                                                                <div class="col-lg-7" style="display: flex; flex-direction: column;">
                                                                    <div id="slider" style="width: 620px; overflow: hidden; margin: auto; position: relative;">
                                                                        ...
                                                                        <div id="slides" style="display: flex; transition: transform 0.7s ease;">
                                                                            <img class="zoomable" src="mobile-assets/events/sep10-1.jpeg"
                                                                        ...
                                                                        <div class="p-0 rounded">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="row bg-light p-2 rounded">
                                                                                    <div class="col-lg-5 rounded">
                                                                                        <img class="rounded" style="height: 130px; width: 100%"
                                                                                            src="mobile-assets/media-corner/news45/2.jpg" alt="" />
                                                                                    </div>
                                                                                    <div class="col-lg-7">
                                                                                        <p style="color: #27467A; font-size: 19px; line-height: 1;"
                                                                                            class="pt-2 m-0 fw-bold">Industry Stalwarts Ravi Kant & Rajesh Srivastava address session at RGU

                                                                                        </p>
                                                                                        <p class="pt-1 pt-2 m-0"
                                                                                            style="font-size: 16px; color: black; line-height: 1.4;">September 9,
                                                                                            2025
                                                                                        </p>
                                                                                        <a
                                                                                            href="/industry-stalwarts-ravi-kant-rajesh-srivastava-address-session-at-rgu">
                                                                                ...
                                                                                <div class="row bg-light p-2 rounded mt-3">
                                                                                    <div class="col-lg-5">
                                                                                        <img class="rounded" style="height: 130px; width: 100%;"
                                                                                            src="mobile-assets/media-corner/news44/2.JPG" alt="" />
                                                                                    </div>
                                                                                    <div class="col-lg-7">
                                                                                        <p style="color: #27467A; font-style: 10px; line-height: 1;"
                                                                                            class="pt-2 m-0 fw-bold">Prof. Amarjyoti Choudhury Calls to Reignite Public Enthusiasm for Bhupen Hazarika for Another Century</p>
                                                                                        <p class="pt-1 p-0 m-0"
                                                                                            style="font-size: 16px; color: black; line-height: 1.4;">September 8,
                                                                                            2025
                                                                                        </p>
                                                                                        <a
                                                                                            href="/prof-amarjyoti-choudhury-calls-to-reignite-public-enthusiasm-for-bhupen-hazarika-for-another-century">
                                                                                            <p class="pt-2 fw-bold m-0"
                                                                                                style="font-size: 16px; color: black; line-height: 1.4; color: #FF9A1E;">
                                                                                                Read More ...</p>
                                                                                        </a>
                                                                                ...
                                                                                <div class="row p-2 bg-light rounded mt-3">
                                                                                    <div class="row bg-light p-2 rounded">
                                                                                        <div class="col-lg-5 ">
                                                                                            <img class="rounded" style="height: 130px; width: 100%;"
                                                                                                src="mobile-assets/media-corner/news43/1.jpg"
                                                                                                alt="" />
                                                                                        </div>
                                                                                        <div class="col-lg-7">
                                                                                            <p style="color: #27467A; font-style: 10px; line-height: 1;"
                                                                                                class="pt-2 m-0 fw-bold">Regenerate Public Enthusiasm for Bhupen Hazarika for Another Century: Prof Amarjyoti Choudhury</p>
                                                                                            <p class="pt-1 p-0 m-0"
                                                                                                style="font-size: 16px; color: black; line-height: 1.4;">September
                                                                                                6, 2025
                                                                                            </p>
                                                                                            <a
                                                                                                href="/regenerate-public-enthusiasm-for-bhupen-hazarika-for-another-century-prof-amarjyoti-choudhury">
                                                                                                <p class="pt-2 fw-bold m-0"
                                                                                                    style="font-size: 16px; color: black; line-height: 1.4; color: #FF9A1E;">
                                                                                                    Read More ...</p>
                                                                                            </a>
