    ...
    <section class="website">
        ...
        {{-- <div id="popup-web" class="popup-overlay"
            ...
            <div style="position: relative; display: inline-block;">
                ...
                <!-- Popup Image -->
                <a>
                    <img src="{{ asset('/mobile-assets/ads/phd.jpg') }}"
                                ...
                                <div id="slides" style="display: flex; transition: transform 0.7s ease;">
                                    <img class="zoomable" src="mobile-assets/events/techer.jpeg"
                                        style="width:400px; height: 530px; margin-right: 20px; border: 2px solid #e68900; border-radius: 10px;">
                                         ...
                                         <img class="zoomable" src="mobile-assets/events/feb-9.png"
                                        style="width:300px; height: 530px; margin-right: 20px; border: 2px solid #e68900; border-radius: 10px;">

                                    <img class="zoomable" src="mobile-assets/events/feb10.jpeg"
                                        style="width:400px; height: 530px; margin-right: 20px; border: 2px solid #e68900; border-radius: 10px;">
                                ...
                                <div class="p-0 rounded">
                                    <div class="row">
                                        ...
                                        <div class="row bg-light p-2 rounded">
                                            <div class="col-lg-5">
                                                <img class="rounded" style="height: 130px; width: 100%;"
                                                    src="mobile-assets/media-corner/news82/pro/1.jpeg" alt="" />
                                            </div>
                                            <div class="col-lg-7">
                                                <p style="color: #27467A; font-style: 10px; line-height: 1; font-size: 19px;"
                                                    class="pt-2 m-0 fw-bold">Chancellor’s Appreciation & Felicitation Ceremony Celebrates Excellence at RGU</p>
                                                <p class="pt-1 p-0 m-0"
                                                    style="font-size: 16px; color: black; line-height: 1.4;">February 4,
                                                    2026
                                                </p>
                                                <a
                                        ...
                                        <div class="row bg-light p-2 rounded">
                                            <div class="col-lg-5">
                                                <img class="rounded" style="height: 130px; width: 100%;"
                                                    src="mobile-assets/media-corner/news82/new/1.jpeg" alt="" />
                                            </div>
                                            <div class="col-lg-7">
                                                <p style="color: #27467A; font-style: 10px; line-height: 1; font-size: 19px;"
                                                    class="pt-2 m-0 fw-bold">
                                                ...
                                                <a
                                                    href="/38th-bci-national-all-india-inter-university-moot-court-competition-begins-at-rgu">
                                                    <p class="pt-2 fw-bold m-0"
                                                        style="font-size: 16px; color: black; line-height: 1.4; color: #FF9A1E;">
                                                        Read More ...</p>
                                                </a>
