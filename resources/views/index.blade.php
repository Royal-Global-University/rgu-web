                                                                                                        ...
                                                                                                        <div class="col-lg-7" style="display: flex; flex-direction: column;">
                                                                                                            <div id="slider" style="width: 620px; overflow: hidden; margin: auto; position: relative;">
                                                                                                                ...
                                                                                                                <div id="slides" style="display: flex; transition: transform 0.7s ease;">
                                                                                                                    <img class="zoomable" src="mobile-assets/events/foot.jpeg"
                                                                                                                            ...
                                                                                                                            <div class="row bg-light p-2 rounded">
                                                                                                                                <div class="col-lg-5 ">
                                                                                                                                    <img class="rounded" style="height: 130px; width: 100%;"
                                                                                                                                        src="mobile-assets/media-corner/news46/1.jpg"
                                                                                                                                        alt="" />
                                                                                                                                </div>
                                                                                                                                <div class="col-lg-7">
                                                                                                                                    <p style="color: #27467A; font-style: 10px; line-height: 1;"
                                                                                                                                        class=" m-0 fw-bold">Raise Children as Help Givers, Not Help Seekers: Prof. Alaka Sarma at RGU’s Leadership Conclave 2025</p>
                                                                                                                                    <p class="pt-1 p-0 m-0"
                                                                                                                                        style="font-size: 16px; color: black; line-height: 1.4;">September
                                                                                                                                        11, 2025
                                                                                                                                    </p>
                                                                                                                                    <a
                                                                                                                                        href="/raise-children-as-help-givers-not-help-seekers-prof-alaka-sarma-at-rgu’s-leadership-conclave-2025">
