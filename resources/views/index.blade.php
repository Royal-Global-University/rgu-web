                                                                                                                                                                ...
                                                                                                                                                                <div class="row p-2 bg-light rounded">
                                                                                                                                                                 ...
                                                                                                                                                                 <div class="row bg-light p-2 rounded mt-3">
                                                                                                                                                                    <div class="col-lg-5 rounded">
                                                                                                                                                                        <img class="rounded" style="height: 130px; width: 100%"
                                                                                                                                                                            src="mobile-assets/media-corner/news48/1.jpg" alt="" />
                                                                                                                                                                    </div>
                                                                                                                                                                    <div class="col-lg-7">
                                                                                                                                                                        <p style="color: #27467A; font-size: 19px; line-height: 1;"
                                                                                                                                                                            class="pt-2 m-0 fw-bold">RGU NCC Cadets Shine at YAMS CATC-85 Camp

                                                                                                                                                                        </p>
                                                                                                                                                                        <p class="pt-1 pt-2 m-0"
                                                                                                                                                                            style="font-size: 16px; color: black; line-height: 1.4;">September 18,
                                                                                                                                                                            2025
                                                                                                                                                                        </p>
                                                                                                                                                                        <a
                                                                                                                                                                            href="/rgu-ncc-cadets-shine-at-yams-catc-85-camp">
                                                                                                                                                                            <p class="pt-2 fw-bold m-0"
                                                                                                                                                                                style="font-size: 16px; color: black; line-height: 1.4; color: #FF9A1E;">
                                                                                                                                                                                Read More ...</p>
                                                                                                                                                                        </a>
