                                ...
                                <div class="notification-item text-dark para1">
                                    <a href="https://media.rgu.ac/notifications/Summer%20School%20program%202025%20with%20link.pdf" class="pt-3"
                                        ...
                                        target="_blank"><img style="width: 50px;" src="mobile-assets/icons/newicon.gif"
                                            alt="">
                                        Summer School Program cum Boot Camp 1.0-2025 </a>
                                    ...
                                    <a href="https://media.rgu.ac/Brochure/sports-policy.pdf"
                                        style="display: block; text-decoration: none; color: inherit; padding: 15px;"
                                        target="_blank"><img style="width: 50px;" src="mobile-assets/icons/newicon.gif"
                                            alt="">
                ...
                <div class="elementor-column elementor-col-100 elementor-element elementor-element-b58434b"
                    ...
                    <div class="elementor-widget-wrap elementor-element-populated">
                        <div class="elementor-element elementor-element-faf1a3a elementor-widget elementor-widget-go-team-carousel"
                            data-id="faf1a3a" data-element_type="widget" data-widget_type="go-team-carousel.default">
                            <div class="elementor-widget-container">
                                            ...
                                            <div class="col-lg-8">
                                                <div class="kd-team-4-right">
                                                    ...
                                                    <div class="kd-team-4-slide-prview pt-5">
                                                        <div class="swiper-container fix kd-team-4-slide-prview-active">
                                                            <div class="swiper-wrapper">
                                                                <div class="swiper-slide">
                ...
                <div class="row" style="background-color: #f2f2f2;">
                    ...
                    <div class="col-lg-8" style="padding-top: 80px;">
                        <marquee>
                            ...
                            <span class="text-dark p-3" style="font-size: 36px;"><svg xmlns="http://www.w3.org/2000/svg"
                                    width="20" height="20" fill="red" class="bi bi-star-fill" viewBox="0 0 16 16">
                                    <path
                                        d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z" />
