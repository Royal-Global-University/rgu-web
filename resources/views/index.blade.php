                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="row bg-light p-2 rounded mt-3">
                                                            <div class="col-lg-5 rounded">
                                                                <img class="rounded" style="height: 130px; width: 100%"
                                                                    src="mobile-assets/media-corner/news41/1.jpg" alt="" />
                                                            </div>
                                                            <div class="col-lg-7">
                                                                <p style="color: #27467A; font-size: 19px; line-height: 1;"
                                                                    class="pt-2 m-0 fw-bold">India’s Legendary Physiotherapist Prof. Ali
                                                                    Irani takes Session at RGU
                                                                </p>
                                                                <p class="pt-1 pt-2 m-0"
                                                                    style="font-size: 16px; color: black; line-height: 1.4;">September 5,
                                                                    2025
                                                                </p>
                                                                <a
                                                                    href="/india’s-legendary-physiotherapist-prof-ali-irani-takes-session-at-royal-global-university">
                                                                    <p class="pt-2 fw-bold m-0"
                                                                        style="font-size: 16px; color: black; line-height: 1.4; color: #FF9A1E;">
                                                                        Read More ...</p>
                                                                </a>
                                                        ...
                                                        <div class="row bg-light p-2 rounded mt-3">
                                                            ...
                                                            <div class="col-lg-7">
                                                                <p style="color: #27467A; font-style: 10px; line-height: 1;"
                                                                    class="pt-2 m-0 fw-bold">Former Tata Motors CEO to talk on “Leading from
                                                                    the Back to Achieve the Impossible” at RGU</p>
                                                                <p class="pt-1 p-0 m-0"
                                                                    style="font-size: 16px; color: black; line-height: 1.4;">September 4,
                                                                    2025
                                                                </p>
                                                                <a
                                                                    href="/former-tata-motors-ceo-to-talk-on-leading-from-the-back-to-achieve-the-impossible-at-rgu">
                                                                    <p class="pt-2 fw-bold m-0"
                                                                        style="font-size: 16px; color: black; line-height: 1.4; color: #FF9A1E;">
                                                                        Read More ...</p>
                                                                </a>
