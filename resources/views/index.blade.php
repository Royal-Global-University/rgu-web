                                                                                        ...
                                                                                        <div class="p-0 rounded">
                                                                                            <div class="row">
                                                                                                ...
                                                                                                <div class="row bg-light p-2 rounded">
                                                                                                    <div class="col-lg-5">
                                                                                                        <img class="rounded" style="height: 130px; width: 100%" src="mobile-assets/media-corner/news36/1.JPG" alt="" />
                                                                                                    </div>
                                                                                                    <div class="col-lg-7">
                                                                                                        <p style="color: #27467A; font-size: 19px; line-height: 1;" class="pt-2 m-0 fw-bold">500 Newly Admitted Students Awarded Scholarships by Royal Global University
                                                                                                        </p>
                                                                                                        <p class="pt-1 pt-2 m-0" style="font-size: 16px; color: black; line-height: 1.4;">August 12, 2025
                                                                                                        </p>
                                                                                                        <a href="/500-newly-admitted-students-awarded-scholarships-by-royal-global-university">
                                                                                                ...
                                                                                                <div class="row bg-light p-2 rounded  mt-3">
                                                                                                    ...
                                                                                                    <div class="col-lg-7">
                                                                                                        <p style="color: #27467A; font-style: 10px; line-height: 1;"
                                                                                                            class="pt-2 m-0 fw-bold">Royal Global University Celebrates 79th Independence-Day</p>
                                                                                                        <p class="pt-1 p-0 m-0"
                                                                                                            style="font-size: 16px; color: black; line-height: 1.4;">August 16, 2025
                                                                                                        </p>
                                                                                                        <a
                                                                                                            href="/royal-global-university-celebrates-79th-independence-day">
                                                                                                ...
                                                                                                <div class="row bg-light p-2 rounded mt-3">
                                                                                                    ...
                                                                                                    <div class="col-lg-7">
                                                                                                        <p style="color: #27467A; font-style: 10px; line-height: 1;"
                                                                                                            class="pt-2 m-0 fw-bold">Apply Critical Thinking and Creativity for a
                                                                                                            Successful Living: IITG Director Prof. Jalihal to students of RGU</p>
                                                                                                        <p class="pt-1 p-0 m-0"
