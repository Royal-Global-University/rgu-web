                                                                                                                            ...
                                                                                                                            <div class="p-0 rounded">
                                                                                                                                <div class="row">
                                                                                                                                    ...
                                                                                                                                    <div class="row bg-light p-2 rounded mt-3">
                                                                                                                                        <div class="col-lg-5">
                                                                                                                                            <img class="rounded" style="height: 130px; width: 100%;"
                                                                                                                                                src="mobile-assets/media-corner/news38/head.jpg" alt="" />
                                                                                                                                        </div>
                                                                                                                                        <div class="col-lg-7">
                                                                                                                                            <p style="color: #27467A; font-style: 10px; line-height: 1;"
                                                                                                                                                class="pt-2 m-0 fw-bold">Supreme Court Judge unveils one of India’s largest Gavels at Royal Global University</p>
                                                                                                                                            <p class="pt-1 p-0 m-0"
                                                                                                                                                style="font-size: 16px; color: black; line-height: 1.4;">August 30, 2025
                                                                                                                                            </p>
                                                                                                                                            <a href="/supreme-court-judge-unveils-one-of-india’s-largest-gavels-at-royal-global-university">
                                                                                                                                                <p class="pt-2 fw-bold m-0"
                                                                                                                                                    style="font-size: 16px; color: black; line-height: 1.4; color: #FF9A1E;">
                                                                                                                                                    Read More ...</p>
                                                                                                                                            </a>
