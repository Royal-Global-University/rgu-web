                                            ...
                                            <div class="row">
                                                ...
                                                <div class="row p-2 bg-light rounded mt-3">
                                                    <div class="row bg-light p-2 rounded">
                                                        <div class="col-lg-5 ">
                                                            <img class="rounded" style="height: 130px; width: 100%;"
                                                                src="mobile-assets/media-corner/news39/Leadership%20Conclave%202025.jpg"
                                                                alt="" />
                                                        </div>
                                                        <div class="col-lg-7">
                                                            <p style="color: #27467A; font-style: 10px; line-height: 1;"
                                                                class="pt-2 m-0 fw-bold">National Leadership Conclave 2025 from 11th
                                                                September at Royal Global University</p>
                                                            <p class="pt-1 p-0 m-0"
