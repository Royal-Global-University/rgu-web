                                                                                                                                    ...
                                                                                                                                    <div class="row bg-light p-2 rounded">
                                                                                                                                        ...
                                                                                                                                        <div class="col-lg-7">
                                                                                                                                            <p style="color: #27467A; font-style: 10px; line-height: 1;"
                                                                                                                                                class="pt-2 m-0 fw-bold">RGU holds AICTE-VAANI National Conference in Assamese Language</p>
                                                                                                                                            <p class="pt-1 p-0 m-0"
                                                                                                                                                style="font-size: 16px; color: black; line-height: 1.4;">September 16,
                                                                                                                                                2025
                                                                                                                                            </p>
                                                                                                                                            <a
                                                                                                                                                href="/rgu-holds-aicte-vaani-national-conference-in-assamese-language">
