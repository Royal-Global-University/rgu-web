                                                ...
                                                <div class="p-0 rounded">
                                                    <div class="row">
                                                        ...
                                                        <div class="row bg-light p-2 rounded">
                                                            <div class="col-lg-5">
                                                                <img class="rounded" style="height: 130px; width: 100%;" src="mobile-assets/media-corner/news37/3.JPG" alt="" />
                                                            </div>
                                                            <div class="col-lg-7">
                                                                <p style="color: #27467A; font-style: 10px; line-height: 1;" class="pt-2 m-0 fw-bold">Chinese Diplomats visit Royal Global University for Educational Collaboration</p>
                                                                <p class="pt-1 p-0 m-0" style="font-size: 16px; color: black; line-height: 1.4;">August 29, 2025
                                                                </p>
                                                                <a
