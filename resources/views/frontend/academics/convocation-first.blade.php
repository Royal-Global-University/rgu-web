...
@section('content')
    <div class="mobile">
        ...
        <div  style="background-image: url(mobile-assets/first-convo/Bg.png); background-size: cover; padding-top: 90px; position: relative;">
            <div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <p class="mobile-para1" style="color: #27467A;">
                            The first Convocation of Assam Royal Global University (RGU) took place on March 30, 2022, in
                            Betkuchi, Guwahati, with 1,723 students receiving their degrees. Three honorary degrees were
                            awarded: Professor C.N.R. Rao (D.Sc.), Professor Nagen Saikia (D.Litt.), and Shri Sajjan Bhajanka
                            (D.Litt.). </p>
                        </p>
    ...
    <div class="col-lg-6">
       ...
       <p class="para1" style="color: #27467A;">
           The first Convocation of Assam Royal Global University (RGU) took place on March 30, 2022, in Betkuchi, Guwahati, with 1,723 students receiving their degrees. Three honorary degrees were awarded: Professor C.N.R. Rao (D.Sc.), Professor Nagen Saikia (D.Litt.), and Shri Sajjan Bhajanka (D.Litt.).            </p>
    </div>
    ...
    <h2 class="headd2 mt-4 pb-2" style="color: #000000;">The honorary degrees were conferred on the following distinguised personalities</h2>
    <!-- Data Table 5 -->
    <div class="table-responsive mb-5">
    <div class="col-xl-12 col-md-12">
     <table class="table border table-responsive table-striped">
