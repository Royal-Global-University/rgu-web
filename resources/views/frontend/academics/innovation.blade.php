...
<div id="page" class="site site_wrapper">
    ...
    <div data-elementor-type="wp-page" data-elementor-id="704" class="elementor elementor-704">
        <section style="background-image: url(assets/img/iic-cell/4.svg); padding-top: 30px;"
                        ...
                        <div class="elementor-element elementor-element-4878838 elementor-widget elementor-widget-go-img--bx"
                            ...
                            <div class="elementor-widget-container">
                                <div class="kd-about-3-img-wrap txaa-slide-down-1">
                                    <div style="border: 3px solid #000;" class="kd-about-3-img img-cover fix kd-img-ani-1">
                                        <img decoding="async" src="assets/img/iic-cell/head1.png" alt="">
                                    </div>
                            ...
                            <div class="elementor-widget-container">
                                <div class="prthalign">
                                    <h1 class="headd2 text-dark fw-bold kd-title-ani kd-split-text">
                                        Institution's Innovation Council (IIC-RGU)</h1>
                                    <div class="para1 text-dark kd-para-1 disc" data-splitting style="text-align: justify;">

                                        <p>Ministry of Education (MoE), Govt. of India established Institution’s Innovation
                                            Council in the year 2018. Different educational institutions in the country are
                                            part of this initiative. The motive of this pro- gram is to systematically
                                            foster the culture of innovation amongst all Higher Education Institutions
                                            (HEIs). The Assam Royal Global University becomes a part of this initiative in
                                            the year 2019 and established the IIC- RGU. The IIC- RGU has achieved 3 Star
                                            rating out of 4 Stars in the year 2021 result published by MoE, AICTE. The
                                            primary mandate of IIC-RGU is to encourage, inspire and nurture young students
                                            by supporting them to work with new ideas and transform them. The Royal
                                            Innovation Incubator was established in the year 2021 under IIC-RGU. The
                                            Managing Director of NRL inaugurated the Royal Innovation Incubator. The focus
                                            of the incubator is to create an ecosystem of innovation and entrepreneurship
                                            development and create an awareness of IPR activity.
                                        </p>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="pt-5 text-center elementor-element elementor-element-e22f91b elementor-widget elementor-widget-go-s-heading"
            ...
            <div class="elementor-widget-container">
                <div class="prthalign">
                    ...
                    <h1 style="font-weight: 600;" class="headd1 text-dark kd-title-ani kd-split-text pb-4">
                        Glimpse of Innovations</h1>
                </div>
            </div>
            <section>
                    ...
                    <div class="row">
                            ...
                            <div class="kd-course-1-tabs-card fix shadow-lg">
                                <div class="main-img">
                                    <img fetchpriority="high" decoding="async" width="352" height="235"
                                        src="assets/img/iic-cell/innovation1.jpeg"
                                        class="attachment-kadu-400x235 size-kadu-400x235 wp-post-image" alt=""
                                        sizes="(max-width: 352px) 100vw, 352px" />
                                </div>
                                <div class="content">
                                    <h4 style="font-size: 20px;" class="title kd-heading-1 kd-font-900">
                                        <a aria-label="name">3-wheeler
                                            Electric operated Food-cart</a>
                                    </h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="kd-course-1-tabs-card fix shadow-lg">
                                <div class="main-img">
                                    <img fetchpriority="high" decoding="async" width="352" height="235"
                                        src="assets/img/iic-cell/innovation2.jpeg"
                                        class="attachment-kadu-400x235 size-kadu-400x235 wp-post-image" alt=""
                                        sizes="(max-width: 352px) 100vw, 352px" />
                                </div>
                                <div class="content">
                                    <h4 class="title kd-heading-1 kd-font-900">
                                        <a aria-label="name">Banana Leaf
                                            Cutter</a>
                                    </h4>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="kd-course-1-tabs-card fix shadow-lg">
                                <div class="main-img">
                                    <img fetchpriority="high" decoding="async" width="352" height="235"
                                        src="assets/img/iic-cell/innovation3.jpeg"
                                        class="attachment-kadu-400x235 size-kadu-400x235 wp-post-image" alt=""
                                        sizes="(max-width: 352px) 100vw, 352px" />
                                </div>
                                <div class="content">
                                    <h4 class="title kd-heading-1 kd-font-900">
                                        <a aria-label="name">Electric
                                            Car</a>
                                    </h4>
                                </div>
                            </div>
                    ...
                    <div class="row pt-4">
                        <div class="col-lg-4">
                            <div class="kd-course-1-tabs-card fix shadow-lg">
                                <div class="main-img">
                                    <img fetchpriority="high" decoding="async" width="352" height="235"
                                        src="assets/img/iic-cell/innovation4.jpg"
                                        class="attachment-kadu-400x235 size-kadu-400x235 wp-post-image" alt=""
                                        sizes="(max-width: 352px) 100vw, 352px" />
                                </div>
                                <div class="content">
                                    <h4 style="font-size: 20px;" class="title kd-heading-1 kd-font-900">
                                        <a aria-label="name">Bio Gas Plant
                                        </a>
                                    </h4>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="kd-course-1-tabs-card fix shadow-lg">
                                <div class="main-img">
                                    <img fetchpriority="high" decoding="async" width="352" height="235"
                                        src="assets/img/iic-cell/innovation5.jpg"
                                        class="attachment-kadu-400x235 size-kadu-400x235 wp-post-image" alt=""
                                        sizes="(max-width: 352px) 100vw, 352px" />
                                </div>
                                <div class="content">
                                    <h4 class="title kd-heading-1 kd-font-900">
                                        <a aria-label="name">Robo Chef V1
                                        </a>
                                    </h4>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="kd-course-1-tabs-card fix shadow-lg">
                                <div class="main-img">
                                    <img fetchpriority="high" decoding="async" width="352" height="235"
                                        src="assets/img/iic-cell/innovation6.jpg"
                                        class="attachment-kadu-400x235 size-kadu-400x235 wp-post-image" alt=""
                                        sizes="(max-width: 352px) 100vw, 352px" />
                                </div>
                                <div class="content">
                                    <h4 class="title kd-heading-1 kd-font-900">
                                        <a aria-label="name">3D Printer</a>
                                    </h4>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="kd-about-3-img-wrap txaa-slide-down-1">
                                                <div style="border: 2px solid #fff;"
                                                    ...
                                                    <video width="100%" height="auto" autoplay muted
                                                        ...
                                                        <source src="assets/img/iic-cell/car-vid.mp4" type="video/mp4">
                                                    </video>
                                                </div>
                            ...
                            <div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-9b49111"
                                ...
                                <div>
                                    <div style="padding-left: 30px !important;"
                                        class="elementor-element elementor-element-c8de01e elementor-widget elementor-widget-go-s-heading"
                                        data-id="c8de01e" data-element_type="widget"
                                        data-widget_type="go-s-heading.default">
                                        <div class="elementor-widget-container">
                                            <div class="prthalign">
                                                <h1 class="headd2 pt-5 text-dark fw-bold kd-title-ani kd-split-text">
                                                    Objectives</h1>
                                                <div class="para1 text-dark kd-para-1 disc" data-splitting
                                                    style="text-align: justify;">

                                                    <ol class="list-style-1 fs-16 text-dark para1"
                                                        style="text-align: justify;">
                                                        <li>To conduct
                                                            various innovation and entrepreneurship-related activities.</li>
                                                        <li>Identify and reward innovations and share success stories.</li>
                                                        <li>Organize periodic workshops/seminars/interactions with
                                                            entrepreneurs,
                                                            investors, and professionals and create a mentor pool for
                                                            student innovators.
                                                        </li>
                                                        <li>Network with peers and national entrepreneurship development
                                                            organizations.</li>
                                                        <li>OrganizecHackathons, idea competitions, and challenges with the
                                                            involvement of
                                                            industries.
                                                        </li>
                                                        <li>To generatecawareness about Patents, Copyright, and IPRs with in
                                                            the
                                                            HEI.</li>
                                                    </ol>
                                                </div>
                ...
                <div style="background-image: url(assets/img/iic-cell/background.svg); padding: 30px 0px;">
                    ...
                    <div class="container">
                        <img src="assets/img/iic-cell/pp1.jpg" alt="">
                        <img class="pt-2" src="assets/img/iic-cell/pp2.jpg" alt="">

                        <img class="pt-2" src="assets/img/iic-cell/pp3.jpg" alt="">
                        <img class="pt-2" src="assets/img/iic-cell/pp4.jpg" alt="">
                        <img class="pt-2" src="assets/img/iic-cell/pp5.jpg" alt="">
                        <img class="pt-2" src="assets/img/iic-cell/pp6.jpg" alt="">
                        <img class="pt-2" src="assets/img/iic-cell/pp7.jpg" alt="">
                        <img class="pt-2" src="assets/img/iic-cell/pp8.jpg" alt="">
                        <img class="pt-2" src="assets/img/iic-cell/pp9.jpg" alt="">
                        <img class="pt-2" src="assets/img/iic-cell/pp10.jpg" alt="">
                        <img class="pt-2" src="assets/img/iic-cell/pp11.jpg" alt="">
                    </div>
                ...
                <div class="container">
                    ...
                    <div class="elementor-widget-container">
                        ...
                        <div class="row txaa-slide-down-1">
                            <div class="col-lg-4 col-md-6 txaa-slide-down-1-item">
                                <div class="kd-course-2-card"
                                    style="border: solid 2px rgb(225, 225, 225); min-height: 450px; background-color: #fffaf4;">
                                    <div class="main-img fix img-cover">
                                        <img fetchpriority="high" decoding="async" width="357" height="220"
                                            src="assets/img/iic-cell/a1.jpeg"
                                            class="attachment-kadu-357x220 size-kadu-357x220 wp-post-image" alt="" />
                                    </div>
                                    <br>
                                    <div class="para1" style="font-size: 16px; color: #333; line-height: 1.8;">Received 3
                                        Star rating in the year 2020-2021 by MoE/AICTE.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 txaa-slide-down-1-item">
                                <div class="kd-course-2-card "
                                    style="border: solid 2px rgb(225, 225, 225); min-height: 450px; background-color: #fffaf4;">
                                    <div class="main-img fix img-cover">
                                        <img decoding="async" width="357" height="500" src="assets/img/iic-cell/a2.jpeg"
                                            class="attachment-kadu-357x220 size-kadu-357x220 wp-post-image" alt="" />
                                    </div>

                                    <br>

                                    <div class="para1" style="font-size: 16px; color: #333; line-height: 1.8;">Received
                                        recognition from Atal Ranking of Institutions on Innovation Achievements by Ministry
                                        of Education’s Innovation Cell, Govt. of India.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 txaa-slide-down-1-item">
                                <div class="kd-course-2-card "
                                    style="border: solid 2px rgb(225, 225, 225); min-height: 450px; background-color: #fffaf4;">
                                    <div class="main-img fix img-cover">
                                        <img decoding="async" width="357" height="500" src="assets/img/iic-cell/a3.jpeg"
                                            class="attachment-kadu-357x220 size-kadu-357x220 wp-post-image" alt="" />
                                    </div>
                        ...
                        <div class="row txaa-slide-down-1">
                            <div class="col-lg-4 col-md-6 txaa-slide-down-1-item">
                                <div class="kd-course-2-card "
                                    style="border: solid 2px rgb(225, 225, 225); min-height: 420px; background-color: #fffaf4;">
                                    <div class="main-img fix img-cover">
                                        <img fetchpriority="high" decoding="async" width="357" height="220"
                                            src="assets/img/iic-cell/a5.jpeg"
                                            class="attachment-kadu-357x220 size-kadu-357x220 wp-post-image" alt="" />
                                    </div>
                                    <br>
                                    <div class="para1" style="font-size: 16px; color: #333; line-height: 1.8;">Students have
                                        demonstrated the concept of an electric car during the exhibition organized by
                                        Second Society and achieved 2nd Prize followed by IITG.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 txaa-slide-down-1-item">
                                <div class="kd-course-2-card"
                                    style="border: solid 2px rgb(225, 225, 225); min-height: 420px; background-color: #fffaf4;">
                                    <div class="main-img fix img-cover">
                                        <img decoding="async" width="357" height="500" src="assets/img/iic-cell/a4.jpeg"
                                            class="attachment-kadu-357x220 size-kadu-357x220 wp-post-image" alt="" />
                                    </div>

                                    <br>

                                    <div class="para1" style="font-size: 16px; color: #333; line-height: 1.8;">Dr. Hirak
                                        Ranjan Das was awarded as Best Mentor award for Innovation at Green Innovation
                                        Ecosystem organized by NERAMAC.
                                    </div>
                                </div>
                            </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <img src="assets/img/iic-cell/ac4.jpg">
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-lg-4">
                            <img src="assets/img/iic-cell/ac2.jpg">
                        </div>
                        <div class="col-lg-4">
                            <img src="assets/img/iic-cell/ac3.jpeg">
                        </div>
                        <div class="col-lg-4">
                            <img src="assets/img/iic-cell/ac1.jpg">
                        </div>
                    </div>
                    <hr>
                </div>
