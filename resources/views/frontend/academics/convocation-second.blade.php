...
@section('content')
    <div class="mobile">
        ...
        <div style="background-image: url(mobile-assets/second-convo/Bg.png); background-size: cover; padding-top: 90px; position: relative;">
            <div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <p class="mobile-para1" style="color: #27467A;">
                            The Second Convocation of Assam Royal Global University was held on November 11, 2022, with Governor
                            Prof. Jagdish Mukhi and Union Minister Shri Nitin Gadkari in attendance. A total of 951 graduates
                            received their degrees, including 30 Gold Medallists and 2 Chancellor’s Gold Medals. Honorary
                            degrees were awarded to Prof. Ajay Kumar Sood, Ms. Patricia Mukhim, and Dr. Ashok Kumar Mittal. The
                            university’s growth and achievements were highlighted, with a focus on research, innovation, and
      ...
      <div class="row pt-4">
          ...
          <div class="col-lg-6">
              ...
              <p class="para1" style="color: #27467A;">
                  The Second Convocation of Assam Royal Global University was held on November 11, 2022, with Governor Prof. Jagdish Mukhi and Union Minister Shri Nitin Gadkari in attendance. A total of 951 graduates received their degrees, including 30 Gold Medallists and 2 Chancellor’s Gold Medals. Honorary degrees were awarded to Prof. Ajay Kumar Sood, Ms. Patricia Mukhim, and Dr. Ashok Kumar Mittal. The university’s growth and achievements were highlighted, with a focus on research, innovation, and contributing to India’s development.
              </p>
          </div>
    ...
    <img src="mobile-assets/second-convo/web-gallery.png" alt="">
