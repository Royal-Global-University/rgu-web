...
@section('content')
    <section style="background-image: url(mobile-assets/all-faculty/bg.svg); background-size: cover;">
        ...
        <div class="container mt-5" style="padding: 20px; text-align: justify;">
            ...
            <h4 class="text-center text-dark">
                RGU secures 53rd in Physical Sciences, 89th in overall Rank in the Country
            </h4>

            <div class="container pt-5 pb-5 text-center"
                style="display: flex; justify-content: center; align-items: center; gap:10px">
                <div class="col-lg-12">
                    <img class=" rounded" src="mobile-assets/media-corner/news82/2326.jpeg"
                        style=" border: 3px solid black; height: 500px; width: 60%;" alt="">
                </div>
            </div>

            <p class="para1 text-dark pt-2">
                <span class="fw-bold"> GUWAHATI, February 27, 2026: </span>The Department of Physics at The Assam Royal
