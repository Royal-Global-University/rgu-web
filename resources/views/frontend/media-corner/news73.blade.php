...
@section('title', 'Chief Justice Ashutosh Kumar unveils Dr Ambedkar’s bust at Royal Global University')
@section('meta_description',
    'Draw Inspiration from Dr. Ambedkar’s Vision: Chief Justice Ashutosh Kumar to
    Students at RGU')
...
@section('content')
    <section style="background-image: url(mobile-assets/all-faculty/bg.svg); background-size: cover;">
        ...
        <div class="container" style="padding: 20px; text-align: justify;">
            ...
            <h4 class="text-center text-dark">Draw Inspiration from Dr. Ambedkar’s Vision: Chief Justice Ashutosh Kumar to
                Students at RGU
            </h4>
            ...
            <div class="container pt-5 pb-5 text-center"
                ...
                <div class="col-lg-6">
                    <img class=" rounded" src="/mobile-assets/media-corner/news65/1.jpeg"
                        style=" border: 3px solid black; height: 420px;" alt="">
                </div>
                <div class="col-lg-6">
                    <img class=" rounded" src="/mobile-assets/media-corner/news65/2.jpeg"
                        style=" border: 3px solid black; height: 420px;" alt="">
                </div>
            </div>

            <p class="para1 text-dark pt-2">
                <span class="fw-bold"> GUWAHATI, November 24, 2025: </span>In a momentous ceremony held today at The Assam
