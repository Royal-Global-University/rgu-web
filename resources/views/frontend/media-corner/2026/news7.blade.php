    ...
    <section style="background-image: url(mobile-assets/all-faculty/bg.svg); background-size: cover;">
        ...
        <div class="container mt-5" style="padding: 20px; text-align: justify;">
            ...
            <div class="container pt-5 pb-5 text-center"
                ...
                <div class="col-lg-12">
                    <img class=" rounded" src="/mobile-assets/media-corner/2026/mou/m-1.jpeg"
            ...
            <p class="para1 text-dark pt-2">
                <span class="fw-bold"> GUWAHATI, April 18, 2026: </span>Reinforcing its commitment to nation-building through education, The Assam Royal Global University (RGU) has signed a landmark Memorandum of Understanding (MoU) with the Meghalaya Police. The agreement was formalised yesterday at the Office of the Director General of Police in Shillong in the presence of officials from Meghalaya Police and RGU.
                <br><br>
