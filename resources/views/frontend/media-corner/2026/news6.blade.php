...
@section('title', 'Royal Global University Signs Landmark MoU with Indian Navy to Support Wards of Defence Personnel')
    ...
    <section style="background-image: url(mobile-assets/all-faculty/bg.svg); background-size: cover;">
        ...
        <div class="container mt-5" style="padding: 20px; text-align: justify;">
            ...
            <h4 class="text-center text-dark">
                RGU becomes the first private university from Northeast India to collaborate with the Indian Navy
            </h4>

            <div class="container pt-5 pb-5 text-center"
                style="display: flex; justify-content: center; align-items: center; gap:10px">
                <div class="col-lg-12">
                    <img class=" rounded" src="/mobile-assets/media-corner/2026/mou/mou-1.jpeg"
            ...
            <p class="para1 text-dark pt-2">
                <span class="fw-bold"> GUWAHATI, April 16, 2026: </span>In a significant stride towards reinforcing its
