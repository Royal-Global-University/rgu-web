    ...
    <section style="background-image: url(mobile-assets/all-faculty/bg.svg); background-size: cover;">
        ...
        <div class="container mt-5" style="padding: 20px; text-align: justify;">
            ...
            <div class="container pt-5 pb-5 text-center"
                ...
                <div class="col-lg-3">
                    <img class=" rounded" src="/mobile-assets/media-corner/2026/10/1.jpeg"
                        style=" border: 3px solid black; height: 370px; width: 100%;" alt="">
                </div>
                <div class="col-lg-3">
                    <img class=" rounded" src="/mobile-assets/media-corner/2026/10/2.jpeg"
                        style=" border: 3px solid black; height: 370px; width: 100%;" alt="">
                </div>
                <div class="col-lg-3">
                    <img class=" rounded" src="/mobile-assets/media-corner/2026/10/3.jpeg"
                        style=" border: 3px solid black; height: 370px; width: 100%;" alt="">
                </div>
                <div class="col-lg-3">
                    <img class=" rounded" src="/mobile-assets/media-corner/2026/10/4.jpeg"
                        style=" border: 3px solid black; height: 370px; width: 100%;" alt="">
                </div>
            </div>

            <p class="para1 text-dark pt-2">
                <span class="fw-bold"> GUWAHATI, April 10, 2026: </span>In a significant boost to advanced medical and translational research, the Indian Council of Medical Research (ICMR), New Delhi has awarded four prestigious research project grants worth ₹90 lakhs to faculty members of The Assam Royal Global University (RGU).
                <br><br>
