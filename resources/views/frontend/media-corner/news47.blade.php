    ...
    <section style="background-image: url(mobile-assets/all-faculty/bg.svg); background-size: cover;">
        ...
        <div class="container" style="padding: 20px; text-align: justify;">
            ...
            <div class="container pt-3 pb-4 text-center"
                ...
                <div class="col-lg-6">
                    <img class=" rounded" src="mobile-assets/media-corner/news47/1.jpg"
                        style=" border: 3px solid black; height: 420px;" alt="">
                </div>
                <div class="col-lg-6">
                    <img class=" rounded" src="mobile-assets/media-corner/news47/2.jpg"
                        style=" border: 3px solid black; height: 420px;" alt="">
                </div>
            </div>

            <p class="para1 text-dark pt-2">
                <span class="fw-bold"> GUWAHATI, September 16, 2025: </span>The Assam Royal Global University (RGU) successfully hosted a two-day national conference under the AICTE-VAANI scheme from 15th to 16th September 2025, with the theme “Resilient Futures: Indian Knowledge Systems for Energy, Sustainability, and Climate Action.” Significantly, the entire conference was conducted in the Assamese language.
                <br><br>
                ...
                style="display: flex; justify-content: center; align-items: center; gap:10px">
                <div class="col-lg-10">
                    <img class=" rounded" src="mobile-assets/media-corner/news47/3.jpg"
                        style=" border: 3px solid black; height: 420px;" alt="">
                </div>
                </div>
                <br><br>
                ...
                <br><br>
                The second day of the conference opened with a plenary session titled “Resilient Futures: A Reflection.” Sessions
                on 16th September focused on Indian Knowledge Systems and Science: Prospects for a Sustainable Future; Energy,
       Sustainability, and Cultural Applications of IKS; Green Entrepreneurship and Indigenous Innovations in Energy Transition; and the Integration of Traditional Knowledge with Modern Science for Policy and Development.
                <br><br>
