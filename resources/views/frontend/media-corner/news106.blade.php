    ...
    <section style="background-image: url(mobile-assets/all-faculty/bg.svg); background-size: cover;">
        ...
        <div class="container mt-5" style="padding: 20px; text-align: justify;">
            ...
            <h2 class="headd2 fw-bold text-center" style="color: #27467A; font-size: 30px;">
                Rhythm of the Looms: RGU hosts mega Fashion, Handloom & Textiles Conclave celebrating women artisans and
                designers of NE
            </h2>
            ...
            <div class="container pt-5 pb-5 text-center"
                ...
                <div class="col-lg-6">
                    <img class=" rounded" src="mobile-assets/media-corner/news82/9326.jpeg"
                        style=" border: 3px solid black; height: 450px; width: 95%;" alt="">
                </div>
                <div class="col-lg-6">
                    <img class=" rounded" src="mobile-assets/media-corner/news82/93261.jpeg"
                        style=" border: 3px solid black; height: 450px; width: 95%;" alt="">
                </div>
            </div>

            <p class="para1 text-dark pt-2">
                <span class="fw-bold"> GUWAHATI, March 6, 2026: </span>The Royal School of Fashion Design & Technology of
