...
@section('title', 'RGU Launches UNI News Agency Service: First Time in the North East done by a University')
    ...
    <section style="background-image: url(mobile-assets/all-faculty/bg.svg); background-size: cover;">
        ...
        <div class="container" style="padding: 20px; text-align: justify;">
            ...
            <p class="para1 text-dark pt-2">
                ...
                <br><br>
                Addressing the gathering, Shri Manish Goswami gave an insight into the concept of news. Starting from the times of Mahabharata when Sanjay reported King Dhritarashtra about the war of Kurukshetra, Shi Goswami highlighted the significance of News agencies and dependence of newspapers on news agencies for a wide range of news.
                <br><br>
                In her address, Mrs Durba Ghosh said, "The launch of the News Agency Service at RGU is a landmark step." She highlighted how the News agency journalism works, what are the learning points of the young journalists in the profession.
                <br><br>
                Royal Herald, the departmental journal, is the outcome of the untiring efforts of RSCOM students along with the guidance of the faculty. It is a chronicle of the major activities of RGU and its media department during the last six months. This biannual journal will appear twice every year in January and July. This journal is aimed at giving RGU students a hands-on experience in news reporting, news editing, photography, headline writing and page making. The function concluded with the vote of thanks offered by Dr. Florence H. Rabha, Head and Assistant Professor, RSCOM.
                <br><br>
            </p>
        </div>
