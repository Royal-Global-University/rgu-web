...
@section('content')
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8" style="padding: 0px 30px;">
                                ...
                                <section>
                                    <div class="row">
                                        <div class="col-lg-12"><img class="rounded shadow-sm border"
                                                src="mobile-assets/medical-facility/counsel.jpeg" alt=""></div>
                                    </div>
                                    ...
                                    <table
                                        ...
                                        <tbody class="text-dark mobile-para1">
                                            <tr style="background-color: #f8f9fa;">
                                                <td style="border: 1px solid #dee2e6; padding: 10px;">Ayursundra Super Specialty Hospital,
                                                    Bhabanand Boro Path, Opposite DPS School, Ahom Gaon, GARCHUK, Guwahati, Assam 781035
                                                </td>
                                                <td style="border: 1px solid #dee2e6; padding: 10px; text-align: center;">1.6 kms</td>
                                                <td style="border: 1px solid #dee2e6; padding: 10px; text-align: center;">Ph: 03617111080
                                                </td>
                                            </tr>
                                            <tr style="background-color: #e3f2fd;">
                                                ...
                                                <td style="border: 1px solid #dee2e6; padding: 10px; text-align: center;">Ph: 0361 714 0101
                                                </td>
                                            </tr>
                                            <tr style="background-color: #f8f9fa;">
                                                <td style="border: 1px solid #dee2e6; padding: 10px;">Govt Ayurvedic College & Hospital, AEC
                                                    Rd, Sundarbari, Jalukbari, Guwahati, Assam 781014</td>
                                                <td style="border: 1px solid #dee2e6; padding: 10px; text-align: center;">9 kms</td>
                                                <td style="border: 1px solid #dee2e6; padding: 10px; text-align: center;">Ph: 0361 257 0455
                                                </td>
                                            </tr>
                                            <tr style="background-color: #e3f2fd;">
                                                ...
                                                <td style="border: 1px solid #dee2e6; padding: 10px; text-align: center;">Ph: 080675 06875
                                                </td>
                                            </tr>
                                            <tr style="background-color: #e3f2fd;">
                                                <td style="border: 1px solid #dee2e6; padding: 10px;">Gauhati Medical College and Hospital,
                                                    GMC Hospital Rd, Bhangagarh, Guwahati, Assam 781032</td>
                                                <td style="border: 1px solid #dee2e6; padding: 10px; text-align: center;">12 kms</td>
                                                <td style="border: 1px solid #dee2e6; padding: 10px; text-align: center;">Ph: 0361 252 9457
                                                </td>
                                            </tr>
                                            <tr style="background-color: #e3f2fd;">
                                                ...
                                                <td style="border: 1px solid #dee2e6; padding: 10px; text-align: center;">Ph: 076370 13667
                                                </td>
                                            </tr>
                                            <tr style="background-color: #e3f2fd;">
                                                <td style="border: 1px solid #dee2e6; padding: 10px;">Guwahati Metro Hospital, Uday Nagar,
                                                ...
                                                <td style="border: 1px solid #dee2e6; padding: 10px; text-align: center;">Ph: 0361 296 2335
                                                </td>
                                            </tr>
                                            <tr style="background-color: #e3f2fd;">
                                                <td style="border: 1px solid #dee2e6; padding: 10px;">Health City Hospital, Uday Nagar,
                                                    Khanapara, Opp. Bodoland Guest House, Guwahati, Assam 781022 </td>
                                                <td style="border: 1px solid #dee2e6; padding: 10px; text-align: center;">10 kms</td>
                                                <td style="border: 1px solid #dee2e6; padding: 10px; text-align: center;">Ph: 0361 710 5000
                                                </td>
                                            </tr>
                                            <tr style="background-color: #e3f2fd;">
                                                <td style="border: 1px solid #dee2e6; padding: 10px;">Northeast Cancer Hospital, 11th Mile,
                                                    GS Rd, Amerigog, Jorabat, Assam 781023 </td>
                                                <td style="border: 1px solid #dee2e6; padding: 10px; text-align: center;">12 kms</td>
                                                <td style="border: 1px solid #dee2e6; padding: 10px; text-align: center;">Ph: 094357 07661
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
    ...
    <div class="row">
        <div class="col-lg-6"><img class="rounded shadow-sm border" src="mobile-assets/medical-facility/1b.jpeg" alt=""></div>
        <div class="col-lg-6"><img class="rounded shadow-sm border" src="mobile-assets/medical-facility/1a.jpeg" alt=""></div>
    </div>
    <h2 class="headd3 fw-bold text-dark pt-3">Infirmary & Ambulance Services</h2>
    <p class="para1 text-dark" style="text-align: justify;">
        At The Assam Royal Global University, our prime focus is on good health of our students. Infirmaries are manned by nurses available twenty-four hours a day under the guidance of a qualified doctor. Besides attending to medical needs of students in the campus, the doctors also carry out periodic medical checkup of the students. A well-equipped ambulance is also available 24*7 for the students in case of emergency. The institution also has tie ups with an exclusive city based multispecialty hospital.
    </p>
    </section>
    ...
    <section>
        <div class="row">
            <div class="col-lg-12"><img class="rounded shadow-sm border" src="mobile-assets/medical-facility/seva.jpeg" alt=""></div>
        </div>

        <h2 class="headd3 fw-bold text-dark pt-3">Royal Swasthya Seva</h2>
        <p class="para1 text-dark" style="text-align: justify;">
            Royal Swasthya Seva, a philanthropic initiative by Royal Knowledge Park was inaugurated on 12th November 2020, by the Hon’ble Chief Minister of Assam, Sri Sarbananda Sonowal. It houses experienced Senior Doctors, assisted by trained nurses catering to medical needs of the villagers around the campus along with the students of RGU. The service is available on all weekdays, and it aims to provide free consultation along with free medicines to the patients.
        </p>
        <p class="para1 text-dark" style="text-align: justify;">
            Under the Royal Swasthya Seva it has an Allopathic clinic as well as an Ayurvedic and Homeopathic clinic along with it to take care of the student community and the underprivileged population of the nearby areas.
        </p>
        <p class="para1 text-dark" style="text-align: justify;">
            Established as a component of the University’s Social Outreach initiative, Dr. A.K. Pansari, Hon’ble Chancellor, The Assam Royal Global University, conceptualised it to cater to the medical needs of underprivileged people, who may avail of the services prior to being referred to government hospitals for secondary care, if required, thereby providing free consultation with basic medicines and amenities. This initiative further has a well-equipped ambulance at its disposal for emergencies.
        </p>
    </section>
    ...
    <section>
        <div class="row">
            <div class="col-lg-12"><img class="rounded shadow-sm border" src="mobile-assets/medical-facility/counsel.jpeg" alt=""></div>
        </div>

        <h2 class="headd3 fw-bold text-dark pt-3">Counselling Cell</h2>
        <p class="para1 text-dark" style="text-align: justify;">
            Health is not only physiological but also social, cultural, and mental! In the context of university settings, students are caught up in multiple pressures from academic progression, career uncertainty, peer, parental, and societal expectations, and so on. All of these have a profound effect on their mental, physical, and emotional health. Over and above these, the COVID-19 pandemic has brought in its wake many changes that eventually affect the students’ performance and overall well-being. Against this background, an institutional mechanism is operationalized to address these critical issues affecting the students through the formation of a counselling cell under the ‘Royal Centre for Wellbeing’ (RCFW).
        </p>
        <p class="para1 text-dark" style="text-align: justify;">
        ...
        <p class="para1 text-dark">
            For Appointment write to: counselling@rgu.ac
            <br>
          <span class="fw-bold">Venue: Counselling Cell, Block -A, 1st Floor, The Assam Royal Global University</span>
        </p>
    </section>
    ...
    <div class="col-lg-4 details-card p-3">
        ...
        <div class="p-4 shadow-sm border" style="background-color: #daeeff;">
            ...
            <hr>
            <ol class="para1 text-dark">
                <li><span class="fw-bold mt-2">Ambulance: </span> <a class="text-primary" href="tel: +91 70990-18436"> +91 70990-18436</a></li>
                <li><span class="fw-bold mt-2">Infirmary: </span> <a class="text-primary" href="tel: +91 70990-38510">+91 70990-38510</a></li>
                <li><span class="fw-bold mt-2">Transport In-charge: </span> <a class="text-primary" href="tel: +91 88110-55509">+91 88110-55509</a></li>
                <li><span class="fw-bold mt-2">Emergency Helpline No: </span> <a class="text-primary" href="tel: +91 88110-03111">+91 88110-03111</a></li>
            </ol>
        </div>
        ...
        <div class="p-4 shadow-sm border mt-2" style="background-color: #daeeff;">
            ...
            <p class="text-danger para1 fw-bold">Ambulance Services</p>
            <ol class="para1 text-dark">
                <li><span class="fw-bold mt-4">Ayursundra Super Specialty Hospital: <br> </span> <a class="text-primary">+91 8811030033/ +91 8811030055</a></li>
                <li><span class="fw-bold mt-4">Apollo Excelcare Hospital: <br> </span> <a class="text-primary" href="tel: 03617140101">03617140101</a></li>
                <li><span class="fw-bold mt-4">Narayana Superspeciality Hospital: <br> </span> <a class="text-primary" href="tel: +91 8067506875">+91 8067506875</a></li>
                <li><span class="fw-bold mt-4">Critical Care Hospital & Research Institute: <br> </span> <a class="text-primary" href="tel: +91 7637013667">+91 7637013667</a></li>
                <li><span class="fw-bold mt-4">Guwahati Metro Hospital: <br> </span> <a class="text-primary">0361-296 2335/ 36/ 37</a></li>
                <li><span class="fw-bold mt-4">Health City Hospital: <br> </span> <a class="text-primary">+91 8638995504/ 0361-7105000</a></li>
                <li><span class="fw-bold mt-4">Government of Assam: <br> </span> <a class="text-primary" href="tel: 108">108</a></li>
            </ol>
        </div>
        ...
        <div class="p-4 shadow-sm border mt-2" style="background-color: #daeeff;">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
                <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10m0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6"/>
            </svg> Near the RGU main gate beside PNB ATM</p>
    ...
    <div class="custom-container">
        <div class="custom-row">
          <div class="custom-column p-4">
            ...
            <h2 class="mobile-headd1 fw-bold text-center kd-title-ani kd-split-text" style="color: #27467A; font-weight: 900;">
                Nearby <span style="color: #FF9A1E; font-weight: 500;">Hospitals</span></h2>

            <table class="table" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); border: 1px solid #dee2e6; border-collapse: collapse;">
                <thead class="table-light">
                    <tr>
                        <th class="fw-bold text-dark para1 text-center" style="border: 1px solid #dee2e6;">Hospital Name & Address</th>
                        <th class="fw-bold text-dark para1 text-center" style="border: 1px solid #dee2e6;">Distance from RGU</th>
                        <th class="fw-bold text-dark para1 text-center" style="border: 1px solid #dee2e6;">Contact</th>
                    </tr>
                </thead>
                <tbody>
                    <tr style="background-color: #f8f9fa;">
                        <td class="para1 text-dark" style="border: 1px solid #dee2e6;">Ayursundra Super Specialty Hospital, Bhabanand Boro Path, Opposite DPS School, Ahom Gaon, GARCHUK, <br> Guwahati, Assam 781035</td>
                    ...
                    <tr style="background-color: #e3f2fd;">
                        <td class="para1 text-dark" style="border: 1px solid #dee2e6;">Apollo Excel Care Hospital, NH-37, near Ganesh Mandir, Paschim Boragaon, Guwahati, Assam 781033</td>
                    ...
                    <tr style="background-color: #f8f9fa;">
                        <td class="para1 text-dark" style="border: 1px solid #dee2e6;">Govt Ayurvedic College & Hospital, AEC Rd, Sundarbari, Jalukbari, Guwahati, Assam 781014</td>
                    ...
                    <tr style="background-color: #e3f2fd;">
                        <td class="para1 text-dark" style="border: 1px solid #dee2e6;">Narayana Super Specialty Hospital, Civil Hospital Complex, Tularam Bafna, Amingaon, Guwahati, Assam 781031</td>
                    ...
                    <tr style="background-color: #f8f9fa;">
                        <td class="para1 text-dark" style="border: 1px solid #dee2e6;">Gauhati Medical College and Hospital, GMC Hospital Rd, Bhangagarh, Guwahati, Assam 781032</td>
                    ...
                    <tr style="background-color: #e3f2fd;">
                        <td class="para1 text-dark" style="border: 1px solid #dee2e6;">Critical Care Hospital & Research Institute, Lokhra, Guwahati, Assam 781029</td>
                    ...
                    <tr style="background-color: #f8f9fa;">
                        <td class="para1 text-dark" style="border: 1px solid #dee2e6;">Guwahati Metro Hospital, Uday Nagar, Khanapara, Opp. Bodoland Guest House, Guwahati, Assam 781022</td>
                    ...
                    <tr style="background-color: #e3f2fd;">
                        <td class="para1 text-dark" style="border: 1px solid #dee2e6;">Health City Hospital, Uday Nagar, Khanapara, Opp. Bodoland Guest House, Guwahati, Assam 781022</td>
                        <td class="para1 text-dark" style="border: 1px solid #dee2e6;">10 kms</td>
                        <td class="para1 text-dark" style="border: 1px solid #dee2e6;">Ph: 0361 710 5000</td>
                    </tr>
                    <tr style="background-color: #f8f9fa;">
                        <td class="para1 text-dark" style="border: 1px solid #dee2e6;">Northeast Cancer Hospital, 11th Mile, GS Rd, Amerigog, Jorabat, Assam 781023</td>
    ...
    <div class="custom-container pt-4">
        <div class="custom-row">
          <div class="custom-column p-2 text-center">
           ...
           <img class="m-4 p-2 border shadow-sm rounded" src="mobile-assets/medical-facility/medantalogo.png" alt="">

           <p class="text-dark para1 text-center">The Assam Royal Global University has corporate tie- ups with MEDANTA- The Medicity, Gurgaon. Students can avail 10% discount for all Out Patient Department (OPD) consultation, investigations (only laboratory and radiology), In- Patient (IPD) room rent and investigations (only laboratory and radiology)
           </p>
           <p class="text-success para1 fw-bold text-center">10% discount for MEDANTA- Standard Executive Health check-up.
           </p>
