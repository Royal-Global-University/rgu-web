...
<div id="page" class="site site_wrapper">
    ...
    <div data-elementor-type="wp-page" data-elementor-id="704" class="elementor elementor-704">
        <section style="background-image: url(assets/img/stationary-store/background.svg); padding-top: 30px;"
                            ...
                            <div class="elementor-widget-container">
                                <div class="kd-about-3-img-wrap txaa-slide-down-1">
                                    <div style="border: 2px solid #fff;" class="kd-about-3-img img-cover fix kd-img-ani-1">
                                        <img decoding="async" src="assets/img/stationary-store/headimg.png" alt="">
                                    </div>
    ...
    <div class="custom-container">
        <div class="custom-row">
            ...
            <div class="custom-column">
                <img style="height: 430px;" src="assets/img/stationary-store/3.png" alt="">
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid" style="padding: 20px 50px; background-color: #fff;">
        ...
        <div class="row pt-4 pb-3">
            <div class="col-lg-6">
                <div>
                    <img style="width: 100%;" class="rounded shadow-sm border" src="assets/img/stationary-store/pic1.jpg"
                        alt="">
            ...
            <div class="col-lg-6">
                <div>
                    <img style="width: 100%;" class="rounded shadow-sm border" src="assets/img/stationary-store/pic2.jpg"
                        alt="">
