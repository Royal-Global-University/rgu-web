...
@section('content')
    <div class="mobile">
        ...
        <a style="padding-top: 90px; position: relative;" target="_blank" href="https://bucket-0534zd.s3.ap-south-1.amazonaws.com/mobile-assets/internal-cc/Gender-Sentization-Cell.pdf"> <img src="https://bucket-0534zd.s3.ap-south-1.amazonaws.com/mobile-assets/internal-cc/web-icc.png" /></a>

     <div style="background-image: url(https://bucket-0534zd.s3.ap-south-1.amazonaws.com/mobile-assets/internal-cc/bg.svg); background-size: cover; padding: 20px 0px;">
                     <div class="container">
                      ...
                      <p class="para1" style="text-align: justify; color: #13223b;">
                         ...
                         Regulations, 2015, the committee has been reconstituted with the following members. The tenure of the committee
                         shall be for three years or until further notification, whichever is earlier.
                      </p>
                     </div>
     </div>
     ...
     <div class="container pt-3">
         ...
         <p class="text-dark para1 fw-bold">
     ...
     <div class="container mb-5">
             <div class="container" style="background: #1f3b6b; color: white; padding: 15px; border-radius: 10px; flex-wrap: wrap; text-align: center;">
                 <p class="mobile-mobile-headd3" style="font-weight: bold;">For any query:</p>
                 <p class="mobile-para1"><span style="font-weight: bold;">Ph. no:</span> <a href="tel: 9678009412" style="color: white; text-decoration: none;">+91 9678009412</a></p>
                 <p class="mobile-para1"><span style="font-weight: bold;">Email:</span> <a href="mailto: icc@rgu.ac" style="color: white; text-decoration: none;">icc@rgu.ac</a></p>
                 <a href="tel: 9678009412" class="mobile-call-btn fw-bold" style="text-decoration: none; background: #FF9A1E; color: white; padding: 8px 20px; border-radius: 5px; font-size: 18px; margin-top: 10px; display: inline-block;">
                     Call Now
                 </a>
             </div>
     </div>
    ...
    <div id="page" class="site site_wrapper">
     ...
     <div data-elementor-type="wp-page" data-elementor-id="704" class="elementor elementor-704">
         ...
         <!--About Section-->
             ...
             <div class="pb-3 ">
                 <h2 class="headd1 fw-bold text-center kd-title-ani kd-split-text pt-5 text-center" style="color: #27467A; font-weight: 900;">
         ...
         <td>4th Aug 2023 to 3rd Aug 2026</td>
             ...
             In addition, the following members are also included:
                 ...
                 <p class="text-dark para1">
                     Three students, if the matter involves students, who shall be enrolled at the undergraduate, master’s, and
                     research scholar levels respectively, elected through transparent democratic
                 </p>
