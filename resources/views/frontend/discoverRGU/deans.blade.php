                ...
                <div class="row">
                        ...
                        <div class="card rounded d-flex flex-column"
                            ...
                            <div class="p-3">
                                <img style="height: 290px; width: 100%;"
                                    src="mobile-assets/updated-faculty-img/Nandana.jpeg"
                    ...
                    <div class="col-lg-3 mb-4">
                        <div class="card rounded d-flex flex-column"
                            ...
                            <div class="p-3">
                                <img style="height: 290px; width: 100%;"
                                    src="/mobile-assets/updated-faculty-img/chatterjee.png"
                                    class="img-fluid rounded border" />
                            </div>
                            <div class="card-body d-flex flex-column flex-grow-1"
                                style="position: relative; padding-bottom: 50px;">
                                <h5 style="font-weight: 600; color: #27467A;" class="card-title headd2 pb-2">Prof. (Dr.) Aniruddha Chatterjee</h5>
                    ...
                    <div class="col-lg-3 mb-4">
                        <div class="card rounded d-flex flex-column"
                            ...
                            <div class="card-body d-flex flex-column flex-grow-1"
                                style="position: relative; padding-bottom: 50px;">
                                <h5 style="font-weight: 600; color: #27467A;" class="card-title headd2 pb-2">Prof. Prasanta Jyoti Baruah</h5>
                    ...
                    <div class="col-lg-3 mb-4">
                        <div class="card rounded d-flex flex-column"
                            ...
                            <div class="p-3">
                                <img style="height: 290px; width: 100%;"
                                    src="mobile-assets/all-faculty/rsbas/surajit.jpeg" class="img-fluid rounded border" />
                            </div>
                            <div class="card-body d-flex flex-column flex-grow-1"
                                style="position: relative; padding-bottom: 50px;">
                    ...
                    <div class="col-lg-3 mb-4">
                        <div class="card rounded d-flex flex-column"
                            style="background-color: #fff; border: none; box-shadow: -1px 3px 5px 0px rgba(0,0,0,0.25); height: 560px;">
                            <div class="p-3">
                                <img style="height: 310px; width: 100%;" src="/mobile-assets/updated-faculty-img/dean-rsp.jpeg"
                                    class="img-fluid rounded border" />
                            </div>
                            <div class="card-body d-flex flex-column flex-grow-1">
                                <h5 style="font-weight: 600; color: #27467A;" class="card-title headd2 pb-2">
