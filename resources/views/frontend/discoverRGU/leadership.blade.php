    ...
    <div id="page" class="site site_wrapper">
        ...
        <div class="mobile">
            ...
            <div style="position: relative; padding-top: 90px;">
                <section
                    style="background-image: url('/new-web/assets/leadership/back.webp'); background-size: cover;">
                        ...
                        <div class="row">
                            <div class="col-lg-12 pb-5">
                                <a href="leadership-chancellor"><img
                                        src="/new-web/assets/leadership/mobile-dr-ak-pansari.png" /></a>
                            </div>
                            <hr>
                            <div class="col-lg-12 pb-5">
                                <a href="leadership-anil-kumar"><img
                                        src="/new-web/assets/leadership/mobile-sri-anil-kumar-modi.png" /></a>
                            </div>
                            <hr>
                            <div class="col-lg-12 pb-5">
                                <a href="#"><img
                                        src="/new-web/assets/leadership/vc-mob.png" /></a>
                            </div>
                            {{--
                            <hr>
                            <div class="col-lg-12">
                                <a href="leadership-ankur-pansari"><img
                                        src="/new-web/assets/leadership/mobile-sri-ankur-pansari.png" /></a>
                            </div> --}}
                        </div>
                    </div>
                </section>
            ...
            <section
                ...
                <div class="container pb-5">
                    <div class="row text-center">
                        <div class="col-lg-12">
                            <a href="leadership-chancellor"><img
                                    src="/new-web/assets/leadership/1.png" /></a>
                        </div>
                        <div class="col-lg-12">
                            <a href="leadership-anil-kumar"><img
                                    src="/new-web/assets/leadership/2.png" /></a>
                        </div>
                        <div class="col-lg-12">
                            <a href="#"><img
                                    src="/new-web/assets/leadership/vc.png" /></a>
                        </div>
                        {{-- <div class="col-lg-12">
                            <a href="leadership-ankur-pansari"><img
                                    src="/new-web/assets/leadership/3.png" /></a>
                        </div> --}}
                    </div>
                </div>
