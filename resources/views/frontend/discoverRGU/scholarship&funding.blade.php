        ...
        "></span>
            ...
            <section style="background-image: url(mobile-assets/scholarship/bg.svg); padding-top: 90px; position: relative;">
                ...
                <div class="container pb-5">
                    <div>
                        <h1 class="mobile-headd3 fw-bold p-3 rounded" style="background-color: #c7daf9; color: #333;">
                        ...
                        <div>
                            <p style="text-align: justify;" class="text-dark mobile-para1">i. A student availing 100% Royal
                            ...
                            <p style="text-align: justify;" class="mobile-para1 text-dark">• In case a student, availing Royal
                                ...
                                students.</p>
                            <p style="text-align: justify;" class="mobile-para1 text-dark">• The Scholarship may not be
                                applicable for Courses
                                Governed by
                                Regulatory
                                Bodies (AICTE, COA, PCI,
                                INC, ANMHVC, BCI, etc.)</p>
                            <p style="text-align: justify;" class="mobile-para1 text-dark">• Final decision of granting
                                scholarship lies with
                                the University
                            ...
                            <p class="mobile-para1 text-dark">1. Scanned copies of the marksheets from Class X
                                onwards.</p>
                        </div>
                    </div>
                    <hr>
                    ...
                    <div>
                        <h1 class="mobile-headd3 fw-bold p-3 rounded" style="background-color: #c7daf9; color: #333;">
                            B. ROYAL ENDOWMENT & OTHER SCHOLARSHIP</h1>
                        <h3 class="mobile-headd3 text-dark fw-bold kd-split-text pt-2">
                            Eligibility Criteria</h3>
                        <div class="table-responsive">
                            <table
                                class="table-responsive overflow-hidden table text-wrap table-bordered border-top mb-5 fs-16 mobile-para1"
                                style="box-shadow: -1px 2px 5px 0px rgba(0,0,0,0.10); background-color: #fff;">
                            ...
                            <table class="overflow-hidden table text-wrap table-bordered border-top mb-5 fs-16 mobile-para1"
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td rowspan="7" class="align-middle">Students availing Endowment Scholarship
                                            should
                                            fulfill the
                                    ...
                                    <tr>
                                        <td>3</td>
                                        <td>Ward of a parent who is a teaching professional with annual income less
                                            than 8 lacs
                                        </td>
                                    ...
                                    <tr>
                                        <td>4</td>
                                        <td>Sports people who have participated in State/National level/Music and
                                            Fine Art </td>
                        ...
                        <div style="text-align: justify;">
                            <p class="mobile-para1 text-dark">i. Awardee of Royal Endowment & other Scholarship in 50% or
                                25%
                                categories are required to pay the
                                remaining percentage of fee for the 1st semester/year of his/her programme of study
                                along with
                                the Admission
                                Fee, Registration Fee and Caution money (refundable) of Rs. 10000/-. </p>
                            <p class="mobile-para1 text-dark">ii. In case a student, availing Royal Endowment & Other
                                Scholarship,
                                wishes to avail hostel/
                                ...
                                students.</p>
                            <p class="mobile-para1 text-dark">iii. The Scholarship may not be applicable for Courses
                                Governed by
                                Regulatory Bodies (AICTE, COA,
                                PCI, INC, ANMHVC, BCI, etc.).</p>
                            <p class="mobile-para1 text-dark">iv. Final decision of granting scholarship lies with the
                                University
                                Scholarship</p>

                            <h4 class="mobile-headd3 text-dark fw-bold">Continuation of Scholarship for subsequent
                                years will be
                                governed as follows –
                            </h4>
                            <p class="mobile-para1 text-dark">i. Class attendance of the students must be 75% and above in
                                all the
                                subjects in each semester from
                                the previous academic year.</p>
                            <p class="mobile-para1 text-dark">ii. To continue availing scholarship, a student must clear
                                all the papers
                                in each semester and
                                should not carry any back log in any semester from the previous academic year and
                                pass the
                                semester/annual
                                examination for promotion to the next year.</p>
                            <h4 class="mobile-headd3 text-dark fw-bold">Document Required under the above
                                mentioned of Scholarship:</h4>
                            <p class="mobile-para1 text-dark">1. Scanned copies of the marksheets from Class X onwards.</p>
                            <p class="mobile-para1 text-dark">2. Scanned copies of the certificate from the competent
                    ...
                    <div style="text-align: justify;">
                        <h1 class="mobile-headd3 fw-bold p-3 rounded" style="background-color: #c7daf9; color: #333;">
                            ...
                            ARUNACHAL PRADESH
                            AND RESPECTIVELY TO
                            THE HAJONG, KUKI, RIYANG, TIWA (LALUNG) AND KONYAK COMMUNITIES OF MEGHALAYA, MANIPUR,
                            TRIPURA,
                            ASSAMAND NAGALAND.</h1>
                        <div>
                            <h3 class="mobile-headd3 text-dark fw-bold kd-split-text pt-2">
                                Eligibility Criteria</h3>
                            <p class="mobile-para1 text-dark">i. A letter of recommendation from competent authority
                                for 100%
                            ...
                            <p class="mobile-para1 text-dark">ii. The student’s recommendation will be based on
                                screening and
                                identifying the meritorious
                                students, as laid down by the competent authority.</p>
                            <p class="mobile-para1 text-dark">iii. The students must fulfil the minimum eligibility
                                criteria of
                                admission in the programme/course
                                they have applied for, as laid down by the University. </p>
                            <p class="mobile-para1 text-dark">iv. A student availing 100% scholarship will have to pay
                                a Caution
                                Money (Refundable) of Rs.
                                10,000/- only at the time of admission.</p>
                            <p class="mobile-para1 text-dark">v. In case a student, availing 100% Scholarship, wishes
                                to avail
                                hostel/ transportation facilities,
                                he/she will have to pay the full hostel/ transportation fees as prescribed for
                                other
                                students.</p>
                            <p class="mobile-para1 text-dark">vi. The Scholarship may not be applicable for Courses
                                Governed by
                                Regulatory Bodies (AICTE, COA,
                                PCI, INC, ANMHVC, BCI, etc.).</p>
                            <p class="mobile-para1 text-dark">vii. Final decision of granting scholarship lies with the
                                University
                                Scholarship Committee and or
                                Competent Authority's.</p>
                            <h3 class="mobile-headd3 text-dark fw-bold">Continuation of Scholarship for
                            ...
                            <p class="mobile-para1 text-dark">i. Class attendance of the students must be 75% and above
                                in all the
                                subjects in each semester from
                                the previous academic year.</p>
                            <p class="mobile-para1 text-dark">ii. To continue availing scholarship, a student must
                                clear all the
                                papers in each semester and
                                should not carry any back log in any semester from the previous academic year
                                and pass the
                                semester/annual
                                examination for promotion to the next year.</p>
                            ...
                            <h3 class="mobile-headd3 text-dark fw-bold">Document Required under the above
                                mentioned of
                                Scholarship:</h3>
                            <p class="mobile-para1 text-dark">1. Scanned copies of the marksheets from Class X onwards.
                            </p>
                            <p class="mobile-para1 text-dark">2. Scanned copies of the community certificate from the
                                competent
                    ...
                    <div>
                        <div>
                            <h1 class="mobile-headd3 fw-bold p-3 rounded" style="background-color: #c7daf9; color: #333;">
                                D. 100% ROYAL SCHOLARSHIP TO THE STUDENT BELONGING TO THE ECONOMICALLY WEAKER SECTION OF
                                THE SOCIETY</h1>
                            <div style="text-align: justify;">
                                <h3 class="mobile-headd3 text-dark fw-bold kd-split-text pt-2">
                                            ...
                                            <tbody>
                                                <tr class="mobile-para1">
                                                    <td>100% on annual fee, registration fee and admission fee, other
                                                        applicable fee to
                                                        be paid</td>
                                                    <td>Must secure 60% &Above in aggregate in 10+2/ H.S./ Diploma/ UG</td>
                                                    <td>Students availing Scholarship under the scheme should fulfill the
                                                        following
                                                        criteria:
                                                        <br>
                                    ...
                                    <div class="text-dark">
                                        ...
                                        <p class="mobile-para1">ii. Awardee of 100% Royal Scholarship to the student belonging
                                            ...
                                            of the Society are required to pay Rs. 10,000.00 (Rupees Ten Thousand only) as
                                            caution money
                                            (refundable) at the
                                            time of admission.</p>
                                        ...
                                        <p class="mobile-para1">iv. The Scholarship may not be applicable for Courses Governed
                                            ...
                                            Bodies (AICTE, COA,
                                            PCI, INC, ANMHVC, BCI, etc.).</p>
                                        <p class="mobile-para1">v. Final decision of granting scholarship lies with the
                                            University
                                            Scholarship
                                            Committee and or
                                            Competent Authority's.</p>
                    ...
                    <div>
                        <div>
                            <h1 class="mobile-headd3 fw-bold p-3 rounded" style="background-color: #c7daf9; color: #333;">
                                ...
                                neighboring countries like Thailand, Bangladesh, Nepal, Bhutan and Myanmar)</h1>
                            <div>
                                <h3 class="mobile-headd3 text-dark fw-bold kd-split-text pt-2">
                                    Eligibility Criteria</h1>
                                </h3>
                                ...
                                <div class="table-responsive">
                                    <table
                                        class="overflow-hidden table text-wrap table-bordered border-top mt-5 mb-5 fs-16 mobile-para1"
                                        style="box-shadow: -1px 2px 5px 0px rgba(0,0,0,0.10); background-color: #fff;">
                                        <thead>
                                            <th>
                                                SCHOLARSHIP OFFERED
                                ...
                                <div class="text-dark mobile-para1" style="text-align: justify;">
                                    ...
                                    <h3 class="mobile-headd3 text-dark fw-bold">Scholarship for subsequent years
                                        will be
                                        governed as follows –
                                    </h3>
                                    <p class="fs-16">i. Class attendance of the students must be 75% and above in all
                                        the subjects
                                        in each semester from
                                        the previous academic year.</p>
                                    <p class="fs-16">ii. To continue availing scholarship, a student must clear all the
                                        papers in
                                        each semester and
                                        should not carry any back log in any semester from the previous academic year
                                        and pass the
                                    ...
                                    <h3 class="mobile-headd3 text-dark fw-bold">Required under the above mentioned of
                                        Scholarship:
                                    </h3>
                                    <p class="mobile-para1 text-dark">1. Scanned copies of the marksheets from Class X or
                                        equivalent
                                        onwards.</p>
                                </div>
                    ...
                    <div>
                        <div>
                            <h1 class="mobile-headd3 fw-bold p-3 rounded" style="background-color: #c7daf9; color: #333;">
                                F. ROYAL SHAURYA: FULL FREESHIP FOR WARDS OF BRAVEHEART SECURITY PERSONNELS (MILITARY/
                                ...
                                <h3 class="mobile-headd3 text-dark fw-bold kd-split-text pt-2">
                                    ...
                                    <div class="table-responsive">
                                        <table
                                            ...
                                            <tbody>
                                                <tr class="mobile-para1" style="text-align: justify;">
                                                    <td>100% on annual fee, registration fee and admission fee. Other
                                                        applicable fee, if
                                                        any, to be paid for
                                                        entire course</td>
                                    ...
                                    <p class="mobile-para1" style="text-align: justify;">A. Wards of Military/Paramilitary
                                        (CRPF/BSF, etc.) & Police (N.E.
                                        India) who
                                        have:
                                        <br>
                                        1. Laid their lives while fighting against Militants/Naxalites/Terrorists
                                        /Anti-social
                                        Elements.
                                        <br>
                                    ...
                                    <p style="text-align: justify;" class="mobile-para1">
                                        B. In case a student, availing Royal Shaurya: Full Freeship for Wards of
                                        Braveheart Security
                                        Personnels
                                        (Military/ Paramilitary/Police Personnel – N.E. only), wishes to avail hostel/
                                        transportation facilities, he/she
                                        will have to pay the full hostel/ transportation fees as prescribed for other
                                        students.</p>
                                    <p style="text-align: justify;" class="mobile-para1">C. The Scholarship may not be
                                        applicable for Courses Governed by
                                        Regulatory
                                        Bodies (AICTE, COA,
                                        PCI, INC, ANMHVC, BCI, etc.).</p>
                                    <p style="text-align: justify;" class="mobile-para1">D. A student availing Royal Shaurya:
                                        ...
                                        Braveheart
                                        Security Personnels
                                        (Military/ Paramilitary/Police Personnel – N.E. only) are required to the
                                        Caution money of
                                        Rs. 10000/-
                                        (refundable) only.</p>
                                    <p style="text-align: justify;" class="mobile-para1">E. Final decision of granting
                                        scholarship lies with the University
                                        Scholarship
                                        Committee and or
                                        Competent Authority's. </p>
                    ...
                    <div>
                        <div>
                            <h1 class="mobile-headd3 fw-bold p-3 rounded" style="background-color: #c7daf9; color: #333;">
                                G. ROYAL SURAKSHA: 50% SCHOLARSHIP FOR WARDS OF SERVING & RETIRED SECURITY PERSONNELS
                                (MILITARY/
                                PARAMILITARY/NORTH-EASTERN POLICE FORCES)</h1>
                            <div>
                                <h3 class="mobile-headd3 text-dark fw-bold kd-split-text pt-2">
                                    Eligibility Criteria</h1>
                                    ...
                                    <div class="text-dark" style="text-align: justify;">
                                        <p class="mobile-para1">a) Ward of a Défense Personnel (Military)/ Paramilitary
                                            Personnel.
                                        </p>
                                        ...
                                        <p class="mobile-para1">c) In case a student, availing Royal Suraksha: 50% Scholarship
                                            ...
                                            Wards of
                                            Serving & Retired
                                            Security Personnels (Military/ Paramilitary/Police Personnel – N.E. only),
                                            wishes to avail
                                            hostel/
                                            transportation facilities, he/she will have to pay the full hostel/
                                        ...
                                        <p class="mobile-para1">e) A student availing RoyalSuraksha: 50% Scholarship for Wards
                                            ...
                                            Serving &
                                            Retired Security
                                            Personnels (Military/ Paramilitary/Police Personnel – N.E. only) are required to
                                            the Caution
                                            money of Rs.
                                            10000/- (refundable) olong with the remaining percentage of fee for the 1st
                                            semester/year of
                                            his/her programme
                                            of study along with the Admission Fee, Registration Fee etc.</p>
                                        <p class="mobile-para1">f) Final decision of granting scholarship lies with the
                                            University
                                            Scholarship
                                            Committee and or
                                            Competent Authority's. </p>
                    ...
                    <div>
                        <div>
                            <h1 class="mobile-headd3 fw-bold p-3 rounded" style="background-color: #c7daf9; color: #333;">
                                H. HOPE FOR MANIPUR SCHOLARSHIP - 100% ADMISSION FEE WAIVER (FOR STUDENTS FROM VIOLENCE
                                AFFECTED
                                FAMILIES OF MANIPUR)</h1>
                            <div class="text-dark">
                                <h3 class="mobile-headd3 text-dark fw-bold kd-split-text pt-2">
                                    Eligibility Criteria</h3>
                                <ol class="mobile-para1" style="text-align: justify;">
            ...
            <section style="background-image: url(mobile-assets/scholarship/bg.svg);">
                ...
                <div class="container pb-5">
                    <div>
                        ...
                        <div>
                            <p style="text-align: justify;" class="text-dark para1">i. A student availing 100% Royal Merit
                                Scholarship is
                                required to
                                the
                                Caution money of Rs. 10000/-
                            ...
                            <p style="text-align: justify;" class="para1 text-dark">• The Scholarship may not be applicable for
                                ...
                                Bodies (AICTE, COA, PCI,
                                INC, ANMHVC, BCI, etc.)</p>
                            <p style="text-align: justify;" class="para1 text-dark">• Final decision of granting scholarship
                                lies with
                                the University
                                Scholarship Committee and or
                                Competent Authority's.</p>
                            ...
                            <p style="text-align: justify;" class="para1 text-dark">• Class attendance of the students must be
                                75% and
                                above in all
                                the
                                subjects in each semester from
                                the previous academic year.</p>
                            <p style="text-align: justify;" class="para1 text-dark">• To continue availing scholarship, a
                                student must
                                clear all the
                                papers in
                                each semester and should
                    ...
                    <div>
                        ...
                        <div style="text-align: justify;">
                            <p class="para1 text-dark">i. Awardee of Royal Endowment & other Scholarship in 50% or
                                25%
                                categories are required to pay the
                                remaining percentage of fee for the 1st semester/year of his/her programme of study
                                along with
                                the Admission
                                Fee, Registration Fee and Caution money (refundable) of Rs. 10000/-. </p>
                            <p class="para1 text-dark">ii. In case a student, availing Royal Endowment & Other
                                Scholarship,
                                wishes to avail hostel/
                                transportation facilities, he/she will have to pay the full hostel/ transportation
                                fees as
                                prescribed for other
                                students.</p>
                            <p class="para1 text-dark">iii. The Scholarship may not be applicable for Courses
                                Governed by
                                Regulatory Bodies (AICTE, COA,
                                PCI, INC, ANMHVC, BCI, etc.).</p>
                            <p class="para1 text-dark">iv. Final decision of granting scholarship lies with the
                                University
                                Scholarship</p>
                            ...
                            <p class="para1 text-dark">i. Class attendance of the students must be 75% and above in
                                all the
                                subjects in each semester from
                                the previous academic year.</p>
                            <p class="para1 text-dark">ii. To continue availing scholarship, a student must clear
                                all the papers
                                in each semester and
                                should not carry any back log in any semester from the previous academic year and
                                pass the
                            ...
                            <h4 class="headd3 text-dark fw-bold">Document Required under the above
                                mentioned of Scholarship:</h4>
                            <p class="para1 text-dark">1. Scanned copies of the marksheets from Class X onwards.</p>
                            <p class="para1 text-dark">2. Scanned copies of the certificate from the competent
                                authority claiming scholarship under the mentioned category.</p>
                    ...
                    <div style="text-align: justify;">
                        ...
                        <div>
                            <h3 class="headd3 text-dark fw-bold kd-split-text pt-2">
                                Eligibility Criteria</h3>
                            <p class="para1 text-dark">i. A letter of recommendation from competent authority
                                for 100%
                                Scholarship to two students from
                                each community must be submitted to the admission office along with the
                                necessary admission
                            ...
                            <p class="para1 text-dark">iii. The students must fulfil the minimum eligibility
                                ...
                                admission in the programme/course
                                they have applied for, as laid down by the University. </p>
                            <p class="para1 text-dark">iv. A student availing 100% scholarship will have to pay
                                a Caution
                                Money (Refundable) of Rs.
                                10,000/- only at the time of admission.</p>
                            <p class="para1 text-dark">v. In case a student, availing 100% Scholarship, wishes
                                to avail
                                hostel/ transportation facilities,
                                he/she will have to pay the full hostel/ transportation fees as prescribed for
                                other
                            ...
                            <p class="para1 text-dark">vi. The Scholarship may not be applicable for Courses
                                ...
                                Regulatory Bodies (AICTE, COA,
                                PCI, INC, ANMHVC, BCI, etc.).</p>
                            <p class="para1 text-dark">vii. Final decision of granting scholarship lies with the
                                University
                                Scholarship Committee and or
                                Competent Authority's.</p>
                            <h3 class="headd3 text-dark fw-bold">Continuation of Scholarship for
                            ...
                            <p class="para1 text-dark">i. Class attendance of the students must be 75% and above
                                in all the
                                subjects in each semester from
                                the previous academic year.</p>
                            ...
                            <h3 class="headd3 text-dark fw-bold">Document Required under the above
                                mentioned of
                                Scholarship:</h3>
                            <p class="para1 text-dark">1. Scanned copies of the marksheets from Class X onwards.
                            </p>
                            <p class="para1 text-dark">2. Scanned copies of the community certificate from the
                                competent
                                authority claiming scholarship
                                under the said category.</p>
                        ...
                        <div>
                            ...
                            <div style="text-align: justify;">
                                <h3 class="headd3 text-dark fw-bold kd-split-text pt-2">
                                    ...
                                    <div class="text-dark">
                                        <p class="para1">i. The Head of the Institution will nominate two students for
                                            scholarship under
                                            the said category.
                                        </p>
                                        <p class="para1">ii. Awardee of 100% Royal Scholarship to the student belonging to
                                            the
                                            Economically Weaker Section
                                            of the Society are required to pay Rs. 10,000.00 (Rupees Ten Thousand only) as
                                            caution money
                                            (refundable) at the
                                            time of admission.</p>
                                        <p class="para1">iii. In case a student, availing 100% Scholarship, wishes to avail
                                            hostel/
                                            transportation
                                            facilities, he/she will have to pay the full hostel/ transportation fees as
                                            prescribed for
                                            other students.</p>
                                        <p class="para1">iv. The Scholarship may not be applicable for Courses Governed by
                                            Regulatory
                                            Bodies (AICTE, COA,
                                            PCI, INC, ANMHVC, BCI, etc.).</p>
                                        <p class="para1">v. Final decision of granting scholarship lies with the University
                                            Scholarship
                                            Committee and or
                                            Competent Authority's.</p>

                                        <h3 class="headd3 text-dark fw-bold">Continuation of Scholarship for subsequent years
                                            will be
                                            governed as follows –
                                        </h3>
                                        <p class="para1">i. Class attendance of the students must be 75% and above in all
                                            the subjects
                                            in each semester from
                                            the previous academic year.</p>
                                        <p class="para1">ii. To continue availing scholarship, a student must clear all the
                                            papers in
                                            each semester and
                                            should not carry any back log in any semester from the previous academic year
                                            and pass the
                                        ...
                                        <h3 class="headd3 text-dark fw-bold">Document Required under the above mentioned of
                                            Scholarship:
                                        </h3>
                                        <p class="para1">1. Scanned copies of the marksheets from Class X onwards.</p>
                                        <p class="para1">2. Scanned copies of the EWS certificate from the competent
                                            authority claiming
                                            scholarship under
                                            the said category.</p>
                                    </div>
                    ...
                    <div>
                        <div>
                            ...
                            <div>
                                ...
                                <table class="overflow-hidden table text-wrap table-bordered border-top mt-5 mb-5 fs-16 para1"
                                    style="box-shadow: -1px 2px 5px 0px rgba(0,0,0,0.10); background-color: #fff;">
                                    <thead>
                                        <th>
                                            SCHOLARSHIP OFFERED
                                ...
                                <div class="text-dark para1" style="text-align: justify;">
                                    <p class="para1">i. A student availing 100% scholarship will have to pay Rs. 10000/-
                                        (Rupees Five Thousand only) as caution money (Refundable) at the time of
                                        admission.</p>
                                    <p class="para1">ii. In case a student, availing Royal Merit - On Admission 100%
                                        Scholarship to International Students, wishes to avail hostel/ transportation
                                        facilities, he/she will have to
                                        pay the full hostel/ transportation fees as prescribed for other students.</p>
                                    <p class="para1">iii. The Scholarship may not be applicable for Courses Governed by
                                        Regulatory
                                        Bodies (AICTE, COA,
                                        PCI, INC, ANMHVC, BCI, etc.).</p>
                                    <p class="para1">iv. Final decision of granting scholarship lies with the University
                                        Scholarship
                                        Committee and or
                                        Competent Authority's.</p>
                                    ...
                                    <p class="para1 text-dark">1. Scanned copies of the marksheets from Class X or equivalent
                                        onwards.</p>
                                </div>
                            ...
                            <div class="text-dark">
                                <h3 class="headd3 text-dark fw-bold kd-split-text pt-2">
                                    ...
                                    <p style="text-align: justify;" class="para1">C. The Scholarship may not be applicable for
                                        ...
                                        Bodies (AICTE, COA,
                                        PCI, INC, ANMHVC, BCI, etc.).</p>
                                    <p style="text-align: justify;" class="para1">D. A student availing Royal Shaurya: Full
                                    ...
                                    <p style="text-align: justify;" class="para1">i. Class attendance of the students must be
                                        75% and above in all
                                        the subjects
                                        in each semester from
                                        the previous academic year.</p>
                                    <p style="text-align: justify;" class="para1">ii. To continue availing scholarship, a
                                        student must clear all the
                                        papers in
                                        each semester and
                                        should not carry any back log in any semester from the previous academic year
                        ...
                        <div>
                            ...
                            <div>
                                <h3 class="headd3 text-dark fw-bold kd-split-text pt-2">
                                    ...
                                    <div class="text-dark" style="text-align: justify;">
                                        <p class="para1">a) Ward of a Défense Personnel (Military)/ Paramilitary Personnel.
                                        </p>
                                        <p class="para1">b) Ward of a Police Personnel- NE only.</p>
                                        <p class="para1">c) In case a student, availing Royal Suraksha: 50% Scholarship for
                                            Wards of
                                            Serving & Retired
                                            Security Personnels (Military/ Paramilitary/Police Personnel – N.E. only),
                                            wishes to avail
                                            ...
                                            prescribed for
                                            otherstudents.</p>
                                        <p class="para1">d) The Scholarship may not be applicable for Courses Governed by
                                            Regulatory
                                            Bodies (AICTE, COA,
                                            PCI, INC, ANMHVC, BCI, etc.)</p>
                                        <p class="para1">e) A student availing RoyalSuraksha: 50% Scholarship for Wards of
                                            Serving &
                                            Retired Security
                                            Personnels (Military/ Paramilitary/Police Personnel – N.E. only) are required to
                                            the Caution
                                            ...
                                            his/her programme
                                            of study along with the Admission Fee, Registration Fee etc.</p>
                                        <p class="para1">f) Final decision of granting scholarship lies with the University
                                            Scholarship
                                            Committee and or
                                            Competent Authority's. </p>
                                        ...
                                        <p class="para1">1. Scanned copies of the marksheets from Class X onwards.</p>
                                        <p class="para1">2. Scanned copies of the certificate from the competent authority
                                            claiming
                                            scholarship under the
                                            said category.</p>
                                    </div>
