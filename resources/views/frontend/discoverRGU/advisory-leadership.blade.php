...
@section('content')
    ...
    <div class="mobile">
      ...
      <h2 class="headd1 fw-bold text-center kd-title-ani kd-split-text" style="color: #27467A; font-weight: 900; padding-top: 100px;">
        Advisory <br><span style="color: #FF9A1E; font-weight: 500;"> Leadership</span></h2>
    </div>
