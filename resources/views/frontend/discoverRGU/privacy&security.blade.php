    ...
    <div class="mobile">
        ...
        <div style="padding-top: 90px; position: relative;">
            <div data-elementor-type="wp-page" data-elementor-id="704" class="elementor elementor-704">
                <section style="background-image: url(assets/img/bg/4.svg); padding-top: 30px;"
                                ...
                                <div class="elementor-element elementor-element-c8de01e elementor-widget elementor-widget-go-s-heading"
                                    ...
                                    <div class="elementor-widget-container">
                                        <div class="prthalign">
                                            ...
                                            <h1 class="headd3 text-dark fw-bold">
                                                Policy Statement</h1>
            ...
            <div class="container pt-4">
                ...
                <p class="para1 text-dark">
                    The information collected by the university will be within its control and in a manner consistent with
                    applicable laws,
                    existing regulations, University policies, and principles guiding such collection.
                </p>

                <h4 class="text-dark headd3 fw-bold mt-2" style="text-shadow: 2px 2px 5px rgba(0, 0, 0, 0.1);">
                    Authority
                </h4>
                <p class="text-dark para1">
                    Approved by the Registrar and the Vice Chancellor of The Assam Royal Global University, Delhi.
                </p>
                ...
                <h1 class="text-dark fw-bold fw-bold headd2 pt-2" style="text-transform: uppercase; font-size: 26px;">
                    Information Privacy
                </h1>
                ...
                <h4 class="text-dark mt-2 headd3 fw-bold" style="text-shadow: 2px 2px 5px rgba(0, 0, 0, 0.1);">
                    Exceptions
                </h4>
                <p class="para1 text-dark">
