...
@section('content')
    <div class="mobile">
        ...
        <section
            style="background-image: url('https://media.rgu.ac/governing-body/bg.svg'); background-size: cover; padding-top: 90px; position: relative;">
                ...
                <div class="row">
                        ...
                        <div class="card rounded d-flex flex-column"
                            ...
                            <div class="p-3">
                                <img style="height: 290px; width: 100%;"
                                    src="mobile-assets/governing-body/ashok-kumar-pansari.png" class="img-fluid rounded" />
                            </div>
                            <div class="card-body d-flex flex-column flex-grow-1">
                                <h5 style="font-weight: 700; color: #27467A;" class="card-title headd2 pb-2">Dr. A.K.
                                    Pansari</h5>
                                <p class="para1" style="color: #27467A; line-height: 1.3;">Chancellor, <br> The Assam Royal
                                    Global University</p>
                    ...
                    <div class="col-lg-3 mb-4">
                        ...
                        <div class="card rounded d-flex flex-column"
                            ...
                            <div class="p-3">
                                <img style="height: 290px; width: 100%;"
                                    src="mobile-assets/governing-body/ak-buragohain.png" class="img-fluid rounded" />
                            </div>
                            <div class="card-body d-flex flex-column flex-grow-1">
                                ...
                                <p class="para1" style="color: #27467A; line-height: 1.3; font-size: 15px;">
                                    Vice-Chancellor (Interim), The Assam Royal Global University; Former Chancellor,
                    ...
                    <div class="col-lg-3 mb-4">
                        ...
                        <div class="card rounded d-flex flex-column"
                            ...
                            <div class="card-body d-flex flex-column flex-grow-1">
                                <h5 style="font-weight: 700; color: #27467A; " class="card-title headd2 pb-2">Sr. Adv.
                                    Angshuman Bora</h5>
                    ...
                    <div class="col-lg-3 mb-4">
                        ...
                        <div class="card rounded d-flex flex-column"
                            ...
                            <div class="card-body d-flex flex-column flex-grow-1">
                                <h5 style="font-weight: 700; color: #27467A;" class="card-title headd2 pb-2">Ms. Harsha
                                    Pansari
                                </h5>
                    ...
                    <div class="col-lg-3 mb-4">
                        ...
                        <div class="card rounded d-flex flex-column"
                            ...
                            <div class="p-3">
                                <img style="height: 290px; width: 100%;"
                                    src="https://media.rgu.ac/governing-body/Sikha.jpg" class="img-fluid rounded" />
                            </div>
                            <div class="card-body d-flex flex-column flex-grow-1">
                                <h5 style="font-weight: 700; color: #27467A;" class="card-title headd2 pb-2">Ms. Sikha
                                    Modi Pansari
                                </h5>
                                <p class="para1" style="color: #27467A; line-height: 1.3;">
                                    Member of Gyan Sagar Foundation
                    ...
                    <div class="col-lg-3 mb-4">
                        ...
                        <div class="card rounded d-flex flex-column"
                            style="background-color: #fff; border: none; box-shadow: -1px 3px 5px 0px rgba(0,0,0,0.25);">
                            <div class="p-3">
                                <img style="height: 290px; width: 100%;" src="https://media.rgu.ac/governing-body/12.png"
                                    class="img-fluid rounded" />
                            </div>
                            <div class="card-body d-flex flex-column flex-grow-1">
                                <h5 style="font-weight: 700; color: #27467A;" class="card-title headd2 pb-2">Dr. Diganta
                                    Munshi
                                </h5>
                                <p class="para1" style="color: #27467A; line-height: 1.3; font-size: 15px;">
                ...
                <div class="row" style="display: flex; align-items: center; justify-content: center; gap: 230px;">
                    <div class="col-lg-3 mb-4">
                        ...
                        <div class="card rounded d-flex flex-column"
                            ...
                            <div class="p-3">
                                <img style="height: 290px; width: 100%;"
                                    src="mobile-assets/governing-body/ashok-kumar-pansari.png"
                                    class="img-fluid rounded" />
                            </div>
                            <div class="card-body d-flex flex-column flex-grow-1">
                                <h5 style="font-weight: 700; color: #27467A;" class="card-title headd2 pb-2">Dr. A.K.
                                    Pansari</h5>
                                <p class="para1" style="color: #27467A; line-height: 1.3;">Chancellor, <br> The Assam
                    ...
                    <div class="col-lg-3 mb-4">
                        ...
                        <div class="card rounded d-flex flex-column"
                            ...
                            <div class="card-body d-flex flex-column flex-grow-1">
                                <h5 style="font-weight: 700; color: #27467A;" class="card-title headd2 pb-2">Sri Anil
                                    Kumar Modi</h5>
                                <p class="para1" style="color: #27467A; line-height: 1.3;">Pro-Chancellor, <br>
                                    The Assam Royal Global University</p>
    ...
    <script type="application/ld+json">
{
  ...
  "founder": {
    "@type": "Person",
    "name": "Dr. A.K. Pansari",
    "jobTitle": "Chancellor & Chairman of the Governing Body"
  },
  "member": [
    {
      "@type": "Person",
    ...
    {
      "@type": "Person",
      "name": "Sri Ranjit Barthakur",
      "jobTitle": "Advisor, Governing Body",
      "description": "Founding Trustee, Balipara Foundation, and Chairperson, Royal Rajasthan Foundation"
    },
    {
      "@type": "Person",
      "name": "Sri Anil Kumar Modi",
      "jobTitle": "Pro-Chancellor"
    },
    {
      "@type": "Person",
      "name": "Sri Subramanian Ramadorai",
      "jobTitle": "Member",
      "description": "Former CEO & MD of Tata Consultancy Services and Former Chairperson of NSDC and NSDA"
    },
    {
      "@type": "Person",
      "name": "Prof. (Dr.) A.K. Buragohain",
      "jobTitle": "Member",
      "description": "Vice-Chancellor (Interim), The Assam Royal Global University; Former VC, Dibrugarh University"
    },
    {
      "@type": "Person",
      "name": "Sri Ankur Pansari",
      "jobTitle": "Member",
      "description": "Executive Vice-President, Gyan Sagar Foundation"
    },
    {
      "@type": "Person",
      "name": "Sr. Adv. Angshuman Bora",
      "jobTitle": "Member",
      "description": "Sr. Advocate, Gauhati High Court Guwahati"
    },
    {
      "@type": "Person",
      "name": "Prof. (Dr) S. P. Singh",
      "jobTitle": "Member",
      "description": "Director General (Vice Chancellor), Kaushalya The Skill University, Ahmedabad"
    },
    {
      "@type": "Person",
      "name": "Ms. Harsha Pansari",
      "jobTitle": "Member, Gyan Sagar Foundation"
    },
    {
      "@type": "Person",
      "name": "Ms. Sikha Modi Pansari",
      "jobTitle": "Member, Gyan Sagar Foundation"
    },
    {
      "@type": "Person",
