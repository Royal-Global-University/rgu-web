...
<div id="page" class="site site_wrapper">
    ...
    <section
    style="padding-top: 30px; background-image: url(assets/img/all-facilities/covers/about-background.svg);"  class="elementor-section elementor-top-section elementor-element elementor-element-f481aaf elementor-section-content-middle elementor-section-boxed elementor-section-height-default elementor-section-height-default"
                        ...
                        <div class="elementor-widget-container">
                            <div class="kd-about-3-img-wrap txaa-slide-down-1">
                                <div style="border: 2px solid #fff;" class="kd-about-3-img img-cover fix kd-img-ani-1">
                                    <img  decoding="async"
                                        src="assets/img/all-facilities/diagnostic/headimg.jpg"
                                        alt="">
                                </div>
...
<div class="container-fluid rounded mt-4 mb-5">
          ...
          <div class="new pt-4 pb-5" style="background-image: url(assets/img/patternbg/pattern1.svg); box-shadow: -1px 3px 5px 0px rgba(0,0,0,0.20);">
