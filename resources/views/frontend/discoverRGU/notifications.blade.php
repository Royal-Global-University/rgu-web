            ...
            <div style="text-align: center; padding: 30px 0px 60px 0px;">
                ...
                <div
                    ...
                    <ul class="mobile-para1" style="list-style-type: none; padding: 0; margin: 0;">
                        <li style="padding: 10px; border-bottom: 1px solid #ccc;"><a download href="https://bucket-0534zd.s3.ap-south-1.amazonaws.com/admission/phd.pdf"
                                style="text-decoration: none; color: #27467A;">Admission Open For Ph.D. 2025-2026</a> <span
                                class="new-label-pulse">NEW</span> <a href="https://bucket-0534zd.s3.ap-south-1.amazonaws.com/admission/phd.pdf" style="margin-left: 10px; color: #d9534f;"><i
                                    class="fas fa-file-pdf"></i></a></li>
                        <li style="padding: 10px; border-bottom: 1px solid #ccc;"><a download href="#"
                                style="text-decoration: none; color: #27467A;">4th Convocation - Registration Open</a><a href="#" style="margin-left: 10px; color: #d9534f;"><i
                                    class="fas fa-file-pdf"></i></a></li>
                        <li style="padding: 10px; border-bottom: 1px solid #ccc;"><a download href="#"
                                style="text-decoration: none; color: #27467A;">International Seminar by Royal Global
                                University in association with ELTAI, September, 2024</a><a href="#" style="margin-left: 10px; color: #d9534f;"><i
                                    class="fas fa-file-pdf"></i></a></li>
                        <li style="padding: 10px;"><a download href="#"
                                style="text-decoration: none; color: #27467A;">Advertisement No. : DST-SERB-01/2024<a href="#"
            ...
            <div style="text-align: center; padding: 30px 80px 60px 80px;">
                ...
                <div
                    ...
                    <ul class="para1" style="list-style-type: none; padding: 0; margin: 0;">
                        <li style="padding: 10px; border-bottom: 1px solid #ccc;"><a dowload href="https://bucket-0534zd.s3.ap-south-1.amazonaws.com/admission/phd.pdf"
                                style="text-decoration: none; color: #27467A;">Admission Open For Ph.D. 2025-2026</a> <span
                                class="new-label-pulse">NEW</span> <a href="https://bucket-0534zd.s3.ap-south-1.amazonaws.com/admission/phd.pdf" style="margin-left: 10px; color: #d9534f;"><i
                                    class="fas fa-file-pdf"></i></a></li>
