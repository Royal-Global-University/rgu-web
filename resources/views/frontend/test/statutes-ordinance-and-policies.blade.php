    ...
    <section class="uxt2-section">
        <div class="uxt2-wrapper">
            ...
            <div class="uxt2-tabs-container">
                <button class="uxt2-nav uxt2-prev" aria-label="Previous Tabs"><i
        ...
        <div class="uxt2-content">
            ...
            <div class="uxt2-panel active" id="t1">
                <div class="uxt2-card">
                    ...
                    <a href="/new-web/assets/img/discover-rgu-statute-ordinance/The-First-Statutes-min.pdf" download
                        class="uxt2-download">
            ...
            <div class="uxt2-panel" id="t4">
                ...
                <div class="uxt2-card">
                    ...
                    <a href="/new-web/assets/img/discover-rgu-statute-ordinance/Leave%20Policy.pdf"
                        class="uxt2-download">DOWNLOAD <i class="fa fa-file-pdf-o"></i></a>
                </div>

                <div class="uxt2-card">
                    <h3>Energy Policy</h3>
                    <a href="/new-web/assets/img/discover-rgu-statute-ordinance/Energy%20Policy.pdf"
                        class="uxt2-download">DOWNLOAD <i class="fa fa-file-pdf-o"></i></a>
                </div>
