...
@section('content')
    ...
    <section class="pg-hero">
        ...
        <div class="pg-hero-inner">
            <h1 class="pg-hero-title"> Accreditation And Recognition</h1>
            ...
            <div class="rgu-mem-list">
                ...
                <div class="rgu-mem-card">
                    <div class="rgu-mem-logo">
                        <img src="/new-web/assets/img/discover-rgu-recognition/AIU.png" alt="AIU Logo">
                    </div>
                    ...
                    <div class="rgu-mem-content">
                        ...
                        <p>The Governing Council of the Association of Indian Universities (AIU) at its 345th Meeting
                            held on June 22, 2017 at AIU House, New Delhi considered the application for grant of
                            provisional membership of AIU and resolved to grant the same with effect from 22.5.2017</p>
                    </div>
                ...
                <div class="rgu-mem-card">
                    <div class="rgu-mem-logo">
                        <img src="/new-web/assets/img/discover-rgu-recognition/ACU.png" alt="ACU Logo">
                    </div>
                    ...
                    <div class="rgu-mem-content">
                        ...
                        <p>The ACU is committed to delivering educational opportunities that make a positive, lasting
                            ...
                            for 2024-25. Please note that our grants offer is under review and is subject to change.</p>
                    </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            `,
                ...
                <a href="/new-web/assets/img/discover-rgu-recognition/pdf/INC1.pdf" class="rgu-recog-btn">APPROVAL LETTER <span>+</span></a>
                <br><br>
                <p>The Assam Royal Global University has fulfilled/ complied with all the criteria under Section 2f of the UGC Act, in terms of programmes, faculty, infrastructural facilities, financial viability etc. and the same has been duly accepted by UGC through its letter number F.8-30/2016(CPP-I/PU) dated 21st March 2024.</p>
                <a href="/new-web/assets/img/discover-rgu-recognition/pdf/INC2.pdf" class="rgu-recog-btn">APPROVAL LETTER <span>+</span></a>
            `,
