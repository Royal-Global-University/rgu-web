...
<head>
    ...
    <link rel="stylesheet" href="{{ secure_asset('assets/css/mobile/index.css') }}">
    <link rel="stylesheet" href="{{ secure_asset('assets/css/mobile/statute.css') }}">
...
<body
    ...
    <script src="{{ secure_asset('assets/js/frontend.min.js') }}" id="elementor-frontend-js"></script>
