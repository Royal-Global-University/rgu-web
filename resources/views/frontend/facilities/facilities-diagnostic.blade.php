...
@section('content')
        <div class="mobile">
            ...
            <div>
              ...
              <div class="new pt-3 pb-2" style="background-image: url(mobile-assets/lab-diagnostic/bg.sg); box-shadow: -1px 3px 5px 0px rgba(0,0,0,0.20);">
                          ...
                          <div class="card-body">
                              <div class="item-all-cat education-categories">
                                  <table class="table table-resposive">
                                      ...
                                      <tbody class="fs-16 mobile-para1">                                                                        <tr>
                                              <td>1</td>
                                              <td>Typhoid test </td>
                                              <td>125.00</td>
                                          </tr>
    ...
    <div data-elementor-type="wp-page" data-elementor-id="704" class="elementor elementor-704">
        <section
        style="padding-top: 30px; background-image: url(mobile-assets/lab-diagnostic/background.svg);"  class="elementor-section elementor-top-section elementor-element elementor-element-f481aaf elementor-section-content-middle elementor-section-boxed elementor-section-height-default elementor-section-height-default"
                            ...
                            <div class="elementor-widget-container">
                                <div class="kd-about-3-img-wrap txaa-slide-down-1">
                                    <div style="border: 2px solid #fff;" class="kd-about-3-img img-cover fix kd-img-ani-1">
                                        <img  decoding="async"
                                            src="mobile-assets/lab-diagnostic/headimg.jpg"
                                            alt="">
                                    </div>
                        ...
                        <div class="elementor-element elementor-element-c8de01e elementor-widget elementor-widget-go-s-heading"
                            ...
                            <div class="elementor-widget-container">
                                ...
                                <p class="text-dark para1" style="text-align: justify;">
                                    A state-of-art diagnostic laboratory under the aegis of the Royal School of Medical and Allied Sciences. The diagnostic laboratory caters to the requirements of the students pursuing a diploma and B.Sc. program in Medical and Laboratory Technology (MLT). In addition, the laboratory also extends support services to the community at large through the Royal Swasthya Seva which offers free medical services. The reports generated by the lab are used to check the primary health status of the individuals.
                                </p>
                                ...
                                <ol class="text-dark para1">
                                    <li>Give practical experience to our students of MLT, Nursing, Pharmacy, and other related departments.</li>
    ...
    <hr>
     ...
     <!-- Contact banner  -->
     <section class="container-fluid mt-2 mb-3" style="background-color: #3361A2; box-shadow: -1px 3px 5px 0px rgba(0,0,0,0.20);">
            ...
            <div style="height: 1px; background-color: #f0f8ff;"></div>
                <div class="row mt-3">
                    ...
                    <p class="para1 text-white">
                        Co-ordinator, Department of Medical Laboratory Technology, <br> The Assam Royal Global University
                    </p>
    ...
    <div class="container-fluid rounded mt-4 mb-5">
              ...
              <div class="new pt-4 pb-5" style="background-image: url(mobile-assets/lab-diagnostic/bg.svg); box-shadow: -1px 3px 5px 0px rgba(0,0,0,0.20);">

                <div class="container">
                    <p style="font-size: 32px;" class="fw-bold text-dark pb-2 text-center">Price list of Royal Diagnostic Lab
                    </p>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card mb-0">
