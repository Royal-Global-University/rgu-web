    ...
    <div id="page" class="site site_wrapper">
        ...
        <div class="pb-5">
            <div data-elementor-type="wp-page" data-elementor-id="704" class="elementor elementor-704">
                <section style="background-image: url(assets/img/all-facilities/hangouts/background.svg); padding-top: 30px;"
                                    ...
                                    <div class="elementor-widget-container">
                                        <div class="kd-about-3-img-wrap txaa-slide-down-1">
                                            <div style="border: 2px solid #fff;"
                                                ...
                                                <img decoding="async" src="assets/img/all-facilities/hangouts/headimg1.jpg"
                                                    alt="">
                                            </div>
            ...
            <div class="container pt-4">
                ...
                <div class="pt-5">
                    ...
                    <img src="assets/img/all-facilities/hangouts/gallery.png" alt="">
                </div>

                <h2 class="text-center text-dark fw-bold pt-3 pb-4 headd2">
                    Student Perspectives about Hangout Spaces</h2>
                <div class="row">
                    <div class="col-lg-4">
