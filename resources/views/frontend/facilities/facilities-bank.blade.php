...
@section('content')
    <div id="page" class="site site_wrapper">
        ...
        <!--About Section-->
        <div style="background-image: url(assets/img/all-facilities/covers/pattern1.svg);">
                    ...
                    <div class="row txaa-slide-down-1">
                            ...
                            <div class="kd-course-2-card bg-white"
                                ...
                                <div class="main-img fix img-cover">
                                    <img decoding="async" width="357" height="500"
                                        src="assets/img/all-facilities/bank/icici.jpg"
                        ...
                        <div class="col-lg-4 col-md-6 txaa-slide-down-1-item">
                            <div class="kd-course-2-card bg-white"
                                style="border: solid 2px rgb(225, 225, 225); min-height: 560px;">
                                <div class="main-img fix img-cover">
                                    <img decoding="async" width="357" height="500" src="assets/img/all-facilities/bank/axis.jpg"
                                        class="attachment-kadu-357x220 size-kadu-357x220 wp-post-image" alt="" />
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6 txaa-slide-down-1-item">
                            <div class="kd-course-2-card bg-white"
                                style="border: solid 2px rgb(225, 225, 225); min-height: 560px;">
                                <div class="main-img fix img-cover">
                                    <img decoding="async" width="357" height="500" src="assets/img/all-facilities/bank/r8-3.png"
                                        class="attachment-kadu-357x220 size-kadu-357x220 wp-post-image" alt="" />
                                </div>
                            ...
                            <div class="kd-course-2-card bg-white"
                                ...
                                <div class="main-img fix img-cover">
                                    <img fetchpriority="high" decoding="async" width="357" height="220"
                                        src="assets/img/all-facilities/bank/r8.png"
                                        class="attachment-kadu-357x220 size-kadu-357x220 wp-post-image" alt="" />
                                </div>
                                <br>
                        ...
                        <div class="col-lg-4 col-md-6 txaa-slide-down-1-item">
                            <div class="kd-course-2-card bg-white"
                                style="border: solid 2px rgb(225, 225, 225); min-height: 560px;">
                                <div class="main-img fix img-cover">
                                    <img decoding="async" width="357" height="500" src="assets/img/all-facilities/bank/r8-2.png"
                                        class="attachment-kadu-357x220 size-kadu-357x220 wp-post-image" alt="" />
                                </div>
