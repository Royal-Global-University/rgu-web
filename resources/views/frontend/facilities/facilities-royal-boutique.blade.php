...
@section('content')
    ...
    <section class="rgu-fine-arts-body">
        <section class="rgu-fine-arts-hero">
            ...
            <img src="/mobile-assets/studio/boutique/royal boutique 4.jpeg" class="rgu-fine-arts-hero-img">

            <div class="rgu-fine-arts-content">
                <h2 class="rgu-fine-arts-title">The Royal Boutique</h2>
                <p style="font-style: italic" class="text-dark">“Where creativity meets craftsmanship.” </p>

                <p class="rgu-fine-arts-text">
                    The Royal Boutique, inaugurated on 21st September 2023, stands as a unique initiative and the only
                    boutique of its kind within a university across Northeast India. It serves as a vibrant platform that
                    highlights the creative works of fashion design students, bringing their ideas to life through
        ...
        <div class="pt-4 pb-2 text-dark" style="padding-left: 50px; padding-right: 50px;">
            <p class="rgu-fine-arts-text">
                The boutique also offers customised garment services tailored to clients’ needs, crafted by experienced
                professionals, seamlessly connecting academic learning with real-world practice. Additionally, it hosts
        ...
        <section class="rgu-fine-arts-gallery">
            ...
            <div class="rgu-fine-arts-grid">
                ...
                <img src="/mobile-assets/studio/boutique/royal boutique 6.jpeg">
