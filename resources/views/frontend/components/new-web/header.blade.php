    ...
    <header class="header">
        <div class="header-inner">
            ...
            <nav class="glass-nav" id="mainNav">
                <ul class="nav-list">
                    <li class="nav-item has-mega" data-mega="about">DISCOVER RGU <span
                            style="margin-left: 3px;">+</span>
                    </li>
                    <li class="nav-item has-mega" data-mega="academics">ACADEMICS <span
                            style="margin-left: 3px;">+</span>
                    </li>
                    <li class="nav-item has-mega" data-mega="admission">ADMISSION <span
                            style="margin-left: 3px;">+</span>
                    </li>
                ...
                <div class="m-acc-item">
                    ...
                    <div class="m-acc-content-wrapper">
                        <div class="m-acc-content">
                            ...
                            <div class="m-sub-acc-item">
                                <div class="m-sub-acc-header">POLICIES & ADMINISTRATION <i
                ...
                <div class="m-acc-item">
                    ...
                    <div class="m-acc-content-wrapper">
                        <div class="m-acc-content">
                            ...
                            <div class="m-sub-acc-item">
                                <div class="m-sub-acc-header">CAMPUS FACILITIES <i class="bi bi-chevron-down"></i>
                                </div>
                                <div class="m-sub-acc-content-wrapper">
                                    <div class="m-sub-acc-content">
