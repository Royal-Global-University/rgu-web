<header class="header">
    <div class="header-inner">
        ...
        <div class="header-actions-mobile">
            <a href="https://admissions.rgu.ac/" class="mobile-apply-btn">APPLY NOW</a>
            <!-- <div class="mobile-icon-btn" onclick="openSearch()">
                    <i class="bi bi-search"></i>
                </div> -->
            <div class="mobile-icon-btn" id="mobileMenuBtn">
        ...
        <nav class="glass-nav" id="mainNav">
            <ul class="nav-list">
                <li class="nav-item has-mega" data-mega="about">DISCOVER RGU <span style="margin-left: 3px;">+</span>
                </li>
                <li class="nav-item has-mega" data-mega="academics">ACADEMICS <span style="margin-left: 3px;">+</span>
                </li>
                <li class="nav-item has-mega" data-mega="admission">ADMISSION <span style="margin-left: 3px;">+</span>
                </li>
                <li class="nav-item has-mega" data-mega="international">INTERNATIONAL <span
                        style="margin-left: 3px;">+</span></li>
                <li class="nav-item has-mega" data-mega="campus">CAMPUS <span style="margin-left: 3px;">+</span>
                </li>

                <!-- <li class="icon" id="searchToggleBtn"><i class="bi bi-search"></i></li> -->
                <li class="icon" id="menuToggle"><i class="bi bi-list"></i></li>
            </ul>

            <a href="https://admissions.rgu.ac/" class="apply-btn">
                <i class="bi bi-envelope-open"></i> APPLY NOW
            </a>
        </nav>
    ...
    <div class="mobile-drawer" id="mobileDrawer">
        <div class="mobile-drawer-card">
            ...
            <div class="m-acc-item">
                <div class="m-acc-header">ABOUT RGU <i class="bi bi-chevron-right"></i></div>
                <div class="m-acc-content-wrapper">
                    <div class="m-acc-content">

                        <div class="m-sub-acc-item">
                            <div class="m-sub-acc-header">ABOUT THE UNIVERSITY <i class="bi bi-chevron-down"></i>
                            </div>
                        ...
                        <div class="m-sub-acc-item">
                            <div class="m-sub-acc-header">LEADERSHIP & GOVERNANCE <i class="bi bi-chevron-down"></i>
                            </div>
                            <div class="m-sub-acc-content-wrapper">
                                <div class="m-sub-acc-content">
                        ...
                        <div class="m-sub-acc-item">
                            <div class="m-sub-acc-header">STATUTORY COMMITTEES <i class="bi bi-chevron-down"></i>
                            </div>
                            <div class="m-sub-acc-content-wrapper">
                                <div class="m-sub-acc-content">
                                    ...
                                    <a href="https://rgu.ac/anti-ragging" class="m-sub-acc-link">Anti Ragging
                                        Committee</a>
                                    <a href="https://rgu.ac/proctorial" class="m-sub-acc-link">Proctorial Board</a>
                                </div>
                            </div>
                        </div>

                        <div class="m-sub-acc-item">
                            <div class="m-sub-acc-header">POLICIES & ADMINISTRATION <i class="bi bi-chevron-down"></i>
                            </div>
                            <div class="m-sub-acc-content-wrapper">
                                <div class="m-sub-acc-content">
                        ...
                        <div class="m-sub-acc-item">
                            <div class="m-sub-acc-header">EXCELLENCE & COLLABORATIONS <i
                        ...
                        <div class="m-sub-acc-item">
                            <div class="m-sub-acc-header">CAMPUS & STUDENT LIFE <i class="bi bi-chevron-down"></i>
                            </div>
                            <div class="m-sub-acc-content-wrapper">
                                <div class="m-sub-acc-content">
            ...
            <!-- ACADEMICS -->
            <div class="m-acc-item">
                <div class="m-acc-header">ACADEMICS <i class="bi bi-chevron-right"></i></div>
                <div class="m-acc-content-wrapper">
                    <div class="m-acc-content">
                        ...
                        <div class="m-sub-acc-item">
                            <div class="m-sub-acc-header">STUDENT SUPPORT & DEVELOPMENT <i
                                    class="bi bi-chevron-down"></i></div>
                            <div class="m-sub-acc-content-wrapper">
                                <div class="m-sub-acc-content">
                                    <a href="https://rgu.ac/net-set-gate-coaching" class="m-sub-acc-link">NET/SET/GATE
                                        Coaching</a>
                        ...
                        <div class="m-sub-acc-item">
                            <div class="m-sub-acc-header">RESEARCH & INNOVATION <i class="bi bi-chevron-down"></i>
                            </div>
                            <div class="m-sub-acc-content-wrapper">
                                <div class="m-sub-acc-content">
            ...
            <!-- ADMISSIONS -->
            <div class="m-acc-item">
                <div class="m-acc-header">ADMISSIONS <i class="bi bi-chevron-right"></i></div>
                <div class="m-acc-content-wrapper">
                    <div class="m-acc-content">

                        <div class="m-sub-acc-item">
                            <div class="m-sub-acc-header">ADMISSION OVERVIEW <i class="bi bi-chevron-down"></i>
                            </div>
                            <div class="m-sub-acc-content-wrapper">
                                <div class="m-sub-acc-content">
                        ...
                        <div class="m-sub-acc-item">
                            <div class="m-sub-acc-header">SCHOLARSHIP & FUNDING <i class="bi bi-chevron-down"></i>
                            </div>
                            <div class="m-sub-acc-content-wrapper">
                                <div class="m-sub-acc-content">
                                    <a href="https://rgu.ac/scholarship&funding"
                                        class="m-sub-acc-link">Scholarships</a>
                                    <a href="https://rgu.ac/deans-listers" class="m-sub-acc-link">Dean's Lister</a>
                                </div>
                            </div>
                        </div>
            ...
            <!-- INTERNATIONAL -->
            <div class="m-acc-item">
                <div class="m-acc-header">INTERNATIONAL <i class="bi bi-chevron-right"></i></div>
                <div class="m-acc-content-wrapper">
                    <div class="m-acc-content">
                        <div class="m-sub-acc-content">
                            <a href="https://rgu.ac/international-faq" class="m-sub-acc-link">International FAQs</a>
            ...
            <!-- PLACEMENT -->
            <div class="m-acc-item">
                <div class="m-acc-header">PLACEMENT <i class="bi bi-chevron-right"></i></div>
                <div class="m-acc-content-wrapper">
                    <div class="m-acc-content">

                        <div class="m-sub-acc-content">
                            <a href="https://rgu.ac/placements-introduction" class="m-sub-acc-link">Introduction</a>
                            ...
                            <a href="https://rgu.ac/placements-facilities" class="m-sub-acc-link">Facilities
                                Available</a>
                            <a href="https://rgu.ac/placements-process" class="m-sub-acc-link">Placement Process</a>
            ...
            <!-- CONVOCATION -->
            <div class="m-acc-item">
                <div class="m-acc-header">CONVOCATION <i class="bi bi-chevron-right"></i></div>
                <div class="m-acc-content-wrapper">
                    <div class="m-acc-content">
...
<div class="mega-menu" id="mega-about">
    <div class="mega-inner">
        ...
        <div class="mega-column mega-left">
            <ul>
                <li class="mega-trigger active" data-target="about-1">
                    <a href="#">ABOUT THE UNIVERSITY <span>→</span></a>
                </li>
                <li class="mega-trigger" data-target="about-2">
                    <a href="#">LEADERSHIP & GOVERNANCE <span>→</span></a>
                </li>
                <li class="mega-trigger" data-target="about-3">
                    <a href="#">STATUTORY COMMITTEES <span>→</span></a>
                </li>
                <li class="mega-trigger" data-target="about-4">
                    <a href="#">POLICIES & ADMINISTRATION <span>→</span></a>
                </li>
                <li class="mega-trigger" data-target="about-5">
                    <a href="#">EXCELLENCE & COLLABORATIONS <span>→</span></a>
                </li>
                <li class="mega-trigger" data-target="about-6">
                    <a href="#">CAMPUS & STUDENT LIFE <span>→</span></a>
                </li>
            </ul>
        </div>
        ...
        <div class="mega-right">
            ...
            <div class="mega-content" data-content="about-3">
                <ul>
                    ...
                    <li><a href="https://rgu.ac/institutional-ethical-committee">Institutional Ethical Committee</a>
                    </li>
...
<div class="mega-menu" id="mega-academics">
    <div class="mega-inner">

        <!-- LEFT -->
        <div class="mega-column mega-left">
            <ul>
                <li class="mega-trigger active" data-target="acad-1">
                    <a href="#">ACADEMICS <span>→</span></a>
                </li>
                <li class="mega-trigger" data-target="acad-2">
                    <a href="#">STUDENT SUPPORT & DEVELOPMENT <span>→</span></a>
                </li>
                <li class="mega-trigger" data-target="acad-3">
                    <a href="#">RESEARCH & INNOVATION <span>→</span></a>
                </li>

                <li class="mega-trigger" data-target="acad-5">
                    <a href="#">GENERAL INFORMATION <span>→</span></a>
                </li>
            </ul>
        </div>
        ...
        <div class="mega-right">
            ...
            <div class="mega-content active" data-content="acad-1">
                <ul>
                    ...
                    <li><a href="https://rgu.ac/multi-disciplinary">Multidisciplinary/ Interdisciplinary Courses</a>
                    </li>
                </ul>
            </div>
...
<div class="mega-menu" id="mega-admission">
    <div class="mega-inner">

        <!-- LEFT -->
        <div class="mega-column mega-left">
            <ul>
                <li class="mega-trigger active" data-target="res-1">
                    <a href="#">ADMISSION OVERVIEW <span>→</span></a>
                </li>
                <li class="mega-trigger" data-target="res-2">
                    <a href="#">SCHOLARSHIP & FUNDING <span>→</span></a>
                </li>
    ...
    <div class="mega-bottom">
        <div class="mega-bottom-inner">
            <h2>Join the Best University!</h2>
            <a href="https://admissions.rgu.ac/" class="mega-cta">APPLY NOW</a>
        </div>
    </div>
</div>

<div class="mega-menu" id="mega-international">
    <div class="mega-inner">
        <!-- <div class="mega-column mega-left">
                <ul>
                    <li class="mega-trigger active" data-target="intl-1">INTERNATIONAL <span>→</span></li>
                </ul>
            </div> -->
        <div class="mega-right">
            <div class="mega-content active" data-content="intl-1">
                <ul>
                    ...
                    <li><a href="https://rgu.ac/scholarships-international">Scholarship for International Students</a>
                    </li>
    ...
    <div class="mega-bottom">
        <div class="mega-bottom-inner">
            <h2>Go Global With RGU</h2>
            <a href="https://admissions.rgu.ac/" class="mega-cta">EXPLORE OPPORTUNITIES</a>
        </div>
    </div>
</div>

<div class="mega-menu" id="mega-campus">
    <div class="mega-inner">
        <!-- LEFT -->
        <div class="mega-column mega-left">
            <ul>

                <li class="mega-trigger active" data-target="camp-1">
                    <a href="#">CAMPUS FACILITIES <span>→</span></a>
                </li>

                <li class="mega-trigger" data-target="camp-2">
                    <a href="#">STUDENT LIFE & ENGAGEMENT <span>→</span></a>
                </li>

                <li class="mega-trigger" data-target="camp-3">
                    <a href="#">HOSTEL & ACCOMMODATION <span>→</span></a>
                </li>
        ...
        <div class="mega-right">
            ...
            <div class="mega-content" data-content="camp-3">
                <ul>
                    ...
                    <li><a href="https://rgu.ac/assets/img/pdf/Hostel%20Policy%20Rules%202024.pdf">Hostel Policy</a>
                    </li>
                </ul>
            </div>
...
<div class="menu-dropdown" id="menuDropdown">
    ...
    <div class="dropdown-buttons">
        <a href="https://rgu.renocampus.com/hr/staff" class="erp-btn">ERP LOGIN</a>
        <a href="https://m365.cloud.microsoft/?auth=2" class="staff-btn">STAFF LOGIN</a>
    </div>
</div>
