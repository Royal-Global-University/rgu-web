        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav" style="width: 100%; justify-content: space-around;">
                    ...
                    <ul class="dropdown-menu p-3"
                        ...
                        <div class="row" style="display: flex;">
                            <div class="col-lg-4 p-2">
                                ...
                                <hr>
                                <li><a class="dropdown-item text-dark   para1" href="{{ route('preface') }}"
                                        style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">PREFACE
                                    </a></li>
                                <li><a class="dropdown-item text-dark   para1" href="{{ route('leadership') }}"
                                        style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">LEADERSHIP
                                        TEAM</a></li>
                                ...
                                {{-- <li><a class="dropdown-item text-dark   para1" href="{{ route('officers') }}"
                                        style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">OFFICERS</a>
                                </li> --}}
                                <li><a class="dropdown-item text-dark   para1" href="{{ route('vision-mission') }}"
                                        style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">VISION
                                        AND MISSION</a></li>
                                <li><a class="dropdown-item text-dark   para1"
                                        href="{{ route('statutes-ordinance-policies') }}"
                                        style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">STATUTES,
                                        ORDINANCE <br> AND POLICIES</a></li>
                                <li><a class="dropdown-item text-dark   para1" href="{{ route('facilities') }}"
                                        style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">FACILITIES</a>
                                </li>
                                <li><a class="dropdown-item text-dark   para1" href="{{ route('social-outreach') }}"
                                        style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">SOCIAL
                                        OUTREACH</a></li>
                                <li><a class="dropdown-item text-dark   para1" href="{{ route('footprints') }}"
                            ...
                            <div class="col-lg-4 p-2">
                                ...
                                <hr>
                                <li><a class="dropdown-item text-dark   para1"
                                        href="{{ route('recognition-accreditation') }}"
                                        style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">RECOGNITION
                                        AND <br> ACCREDITATION</a></li>
                                <li><a class="dropdown-item text-dark   para1" href="{{ route('association-tieup') }}"
                                        style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">ASSOCIATIONS
                                        AND <br> TIE UPS</a></li>
                                <li><a class="dropdown-item text-dark   para1" href="{{ route('award') }}"
                                        style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">AWARDS
                                        AND HONORS</a></li>
                                <li><a class="dropdown-item text-dark   para1" href="{{ route('top-recruiters') }}"
                                        style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">TOP
                                        RECRUITERS</a></li>
                                <li><a class="dropdown-item text-dark   para1" href="{{ route('success') }}"
                                        style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">SUCCESS
                                        STORIES</a></li>
                                <li><a class="dropdown-item text-dark   para1" href="{{ route('360-tour') }}"
                                        style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">360°
                                        TOUR</a></li>
                                <li><a class="dropdown-item text-dark   para1" href="{{ route('diversechoices') }}"
                                        style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">DIVERSE
                                        CHOICES</a></li>
                                <li><a class="dropdown-item text-dark   para1" href="{{ route('diversity-inclusion') }}"
                                        style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">DIVERSITY
                                        AND INCLUSION</a></li>
                                <li><a class="dropdown-item text-dark   para1" href="{{ route('strategic-location') }}"
                                        style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">STRATEGIC
                                        LOCATION</a></li>
                ...
                <li class="nav-item dropdown" style="position: relative;">
                    ...
                    <ul class="dropdown-menu p-3"
                        style="display: none; position: absolute; top: 100%; left: 0; background: white; border-radius: 0; box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.1); transition: opacity 0.3s ease, transform 0.3s ease; opacity: 0; transform: translateY(10px); width: 600px; overflow: hidden; border-top: 3px solid #e68900;">
                        <div class="row" style="display: flex;">
                ...
                <li class="nav-item dropdown" style="position: relative;">
                    ...
                    <ul class="dropdown-menu"
                        ...
                        <li><a class="dropdown-item text-dark para1" href="{{ route('cisr') }}"
                                        style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">CENTRE FOR INTERDISCIPLINARY<br> STUDY & RESEARCH (CISR)</a>
                                    </li>
                    </ul>
                </li>
                ...
                <li class="nav-item dropdown" style="position: relative;">
                    ...
                    <ul class="dropdown-menu"
                        ...
                        <li class="dropdown-submenu" style="position: relative;">
                            <a class="dropdown-item text-dark   dropdown-toggle para1" href="#"
                                style="font-size: 16px; font-weight: 500; padding: 6px 20px; line-height: 1.4;">AMENITIES</a>
                            <ul class="dropdown-menu"
                                style="display: none; position: absolute; top: 0; left: 100%; background: white; opacity: 0; transform: translateX(10px); transition: opacity 0.3s ease, transform 0.3s ease;">
                        ...
                        <li class="dropdown-submenu" style="position: relative;">
                            <a class="dropdown-item text-dark   dropdown-toggle para1" href="#"
                                style="font-size: 16px; font-weight: 500; padding: 6px 20px; line-height: 1.4;">EVENTS</a>
                            <ul class="dropdown-menu"
                                style="display: none; position: absolute; top: 0; left: 100%; background: white; opacity: 0; transform: translateX(10px); transition: opacity 0.3s ease, transform 0.3s ease;">
                                <li><a class="dropdown-item text-dark   para1" href="{{ route('happy-happening') }}"
                                        style="font-size: 16px; font-weight: 500; padding: 6px 20px; line-height: 1.4;">HAPPY
                        ...
                        <li><a class="dropdown-item text-dark   para1" href="{{ route('games&sports') }}"
                                style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">GAMES
                                AND SPORTS</a></li>

                        <li class="dropdown-submenu" style="position: relative;">
                            <a class="dropdown-item text-dark   dropdown-toggle para1" href="#"
                                style="font-size: 16px; font-weight: 500; padding: 6px 20px; line-height: 1.4;">HOSTEL</a>
                            <ul class="dropdown-menu"
                                style="display: none; position: absolute; top: 0; left: 100%; background: white; opacity: 0; transform: translateX(10px); transition: opacity 0.3s ease, transform 0.3s ease;">
                        ...
                        <li><a class="dropdown-item text-dark   para1" href="{{ route('infrastructure') }}"
                                style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">INFRASTRUCTURE</a>
                        </li>
                        <li><a class="dropdown-item text-dark   para1" href="{{ route('clubs') }}"
                                style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">CLUBS</a>
                        </li>
                        <li><a class="dropdown-item text-dark   para1" href="{{ route('student-affairs') }}"
                                style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">STUDENT
                                AFFAIRS</a></li>
                ...
                <li class="nav-item dropdown" style="position: relative;">
                    ...
                    <ul class="dropdown-menu"
                        ...
                        <li><a class="dropdown-item text-dark   para1" href="{{ route('placements-introduction') }}"
                                style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">INTRODUCION</a>
                        </li>
                        <li><a class="dropdown-item text-dark   para1" href="{{ route('placements-activities') }}"
                                style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">ACTIVITES
                                UNDERTAKEN</a></li>
                        <li><a class="dropdown-item text-dark   para1" href="{{ route('placements-facilities') }}"
                                style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">FACILITIES
                                AVAILABLE</a></li>
                        <li><a class="dropdown-item text-dark   para1" href="{{ route('placements-process') }}"
                                style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">PLACEMENT
                                PROCESS</a></li>
                        <li><a class="dropdown-item text-dark   para1" href="{{ route('placements-events') }}"
                                style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">RCCR
                                EVENTS</a></li>
                        <li><a class="dropdown-item text-dark   para1" href="{{ route('top-recruiters') }}"
                                style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">RECRUITERS</a>
                        </li>
                        <li><a class="dropdown-item text-dark   para1" href="{{ route('success') }}"
                                style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">TESTIMONIAL</a>
                        </li>
                        <li><a class="dropdown-item text-dark   para1" href="{{ route('placement-contacts') }}"
                                style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">CONTACTS</a>
                        </li>
                ...
                <li class="nav-item dropdown" style="position: relative;">
                    ...
                    <ul class="dropdown-menu"
                        style="display: none; position: absolute; top: 100%; left: -40%; background: white; border-radius: 0; box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.1); transition: opacity 0.3s ease, transform 0.3s ease; opacity: 0; transform: translateY(10px); width: 260px; border-top: 3px solid #e68900;">
                        ...
                        <li><a class="dropdown-item text-dark   para1" href="{{ route('international-faq') }}"
                                style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">INTERNATIONAL
                                FAQs</a></li>
                        <li><a class="dropdown-item text-dark   para1" href="{{ route('frro-process') }}"
                                style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">FRRO
                                PROCESS</a></li>
                        ...
                        <li><a class="dropdown-item text-dark   para1"
                                ...
                                style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">INTERNATIONAL
                                STUDENT <br> HELPLINE</a></li>
                        <li><a class="dropdown-item text-dark   para1" href="{{ route('campus-job') }}"
                                style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">ON
                                CAMPUS JOB</a></li>
                        <li><a class="dropdown-item text-dark   para1" href="{{ route('pre-arrival') }}"
                                style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">PRE-ARRIVAL,
                                POST-ARRIVAL</a></li>
                        <li><a class="dropdown-item text-dark   para1" href=""
                                style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">SCHOLARSHIP
                                FOR <br> INTERNATIONAL STUDENTS</a></li>
                        <li><a class="dropdown-item text-dark   para1" href="{{ route('visa-information') }}"
                                style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">VISA
                                INFORMATION</a></li>
                        <li><a class="dropdown-item text-dark   para1" href="{{ route('why-india') }}"
                                style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">WHY
                                INDIA?</a></li>
