<nav class="navbar navbar-expand-lg" style="background-color: transparent; padding: 10px 60px; box-shadow: none; position: absolute !important;">
            <div class="container-fluid">
                ...
                <a class="navbar-brand" href="/">
                    <img  src="mobile-assets/logo/light_logo.png" alt="Logo" style="height: 110px;">
                </a>
                                ...
                                <div class="row" style="display: flex;">
                                    <div class="col-lg-4 p-2">
                                        ...
                                        <li><a class="dropdown-item text-dark   para1" href="{{ route('advisory-leadership') }}"
                                                style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">ADVISORY LEADERSHIP</a>
                                        </li>
                                    ...
                                    <div class="col-lg-4 p-2">
                                        ...
                                        <li><a class="dropdown-item text-dark   para1" href="{{ route('proctorial') }}"
                                                ...
                                                BOARD</a></li>
                                        <li><a class="dropdown-item text-dark   para1" href="{{ route('organogram-planning') }}"
                                                style="font-size: 16px; font-weight: 500; padding: 6px 20px; transition: background 0.3s ease; line-height: 1.4;">ORGANOGRAM
                                                AND <br> PLANNING</a></li>
                                    </div>
                                </div>
