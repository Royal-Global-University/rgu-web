<div class="main-container" style="margin-top: 100px; margin-bottom: 100px; position: relative;">
    <section class="button-container">
        <div class="button-row">
            ...
            <a href="doctoral-management" class="button para1">Business Administration</a>
        ...
        <div class="button-row">
            <a href="#" class="button para1">Food Technology</a>
        ...
        <div class="button-row">
            <a href="doctoral-com-sc-engg" class="button para1">Information Technology</a>
        ...
        <div class="button-row">
            ...
            <a href="doctoral-physical-education-and-sports" class="button para1">Physical Education and Sports</a>
