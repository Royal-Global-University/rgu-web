...
@section('content')
      <div class="website">
            ...
            <main style="background-image: url(mobile-assets/research-development/bg.svg); background-size: cover;">
                ...
                <!-- eco system  -->
                <section
                    style="background-image: url(mobile-assets/research-development/bg-try1.png); background-size: cover;">
                    <style>
                        /* --- Animation Setup --- */
    ...
    */
                ...
                <section style="background-color: #1a3258; padding-bottom: 40px;">
                    ...
                    <script>
                        ...
                        let startReverse = { x: 0, y: 0 };
                        let panReverse = { x: 0, y: 0 };

                        function updateReverseImageTransform() {
                            lightboxImgReverse.style.transform = `translate(calc(-50% + ${panReverse.x}px), calc(-50% + ${panReverse.y}px)) scale(${scaleReverse})`;
                        }
                        ...
                        lightboxImgReverse.addEventListener('mousedown', (e) => {
                            if (scaleReverse > 1) {
                                ...
                                startReverse = { x: e.clientX - panReverse.x, y: e.clientY - panReverse.y };
                        ...
                        window.addEventListener('mousemove', (e) => {
                            if (isDraggingReverse) {
                                e.preventDefault();
                                panReverse = { x: e.clientX - startReverse.x, y: e.clientY - startReverse.y };
                                updateReverseImageTransform();
                            }
                        });
                                    ...
                                    <table class="gpa-data-table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>14-08-2025</td>
                                                <td>Commemoration of Partition Horrors Remembrance Day 2025, Seminar on "Partition and It's Remembrances"</td>
                                                <td></td>
                                                <td></td>
                                            </tr>
                                        </tbody>
                                    ...
                                    <table class="gpa-data-table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>16-05-2025</td>
                                                <td>role of incubation centers in nurturing start-up ideas and translating academic research into viable business ventures </td>
                                                <td></td>
                                                <td><img src="mobile-assets/research-development/mou/pic1.png" alt="MoU Image"></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <div class="gpa-pagination-controls"></div>
                                    ...
                                    <table class="gpa-data-table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>Basics of Stock Trading, Investment Options in the Financial Market, Understanding Derivatives and their Applications</td>
                                                <td><img src="mobile-assets/research-development/mou/pic2.png" alt="MoU Image"></td>
                                            </tr>
                                             ...
                                             <tr>
                                                ...
                                                <td>Career prospects, the implications of NEP 2020 and future knowledge partnership with RGU</td>
                                                <td><img src="mobile-assets/research-development/mou/pic3.png" alt="MoU Image"></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <div class="gpa-pagination-controls"></div>
                        ...
                        (function () {
                            ...
                            function initializeGpaComponent() {
                                ...
                                tables.forEach(table => {
                                    ...
                                    if (!paginationControls || !paginationControls.classList.contains('gpa-pagination-controls')) {
