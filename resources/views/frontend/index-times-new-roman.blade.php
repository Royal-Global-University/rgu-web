...
@section('content')
    ...
    <section class="mobile">
        ...
        <div id="carouselExample" class="carousel slide mobile-image-slider" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="https://bucket-0534zd.s3.ap-south-1.amazonaws.com/landing/about-mobile.png"
                        class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="https://bucket-0534zd.s3.ap-south-1.amazonaws.com/landing/research-mobile.png"
                        class="d-block w-100" alt="...">
                </div>
        ...
        <!-- happening at rgu  -->
        <section
            style="padding: 30px; background-image: url(https://d20cs3cmzywuh.cloudfront.net/mobile-assets/index/bg.svg);">
            ...
            <div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="https://bucket-0534zd.s3.ap-south-1.amazonaws.com/events/may-mob-03.jpeg"
            ...
            <div class="row mobile-marquee-row align-items-center">
                ...
                <div class="col-9 overflow-hidden">
                    <div class="mobile-marquee">
                        <span class="mobile-headd3">📢 Admission Open For Ph.D. 2025-2026 | 📢 International Seminar by The
                            Assam Royal Global University in
                                ...
                                <div class="prthalign">
                                    ...
                                    <h6 class="mobile-headd2 kd-subtitle-1 kd-subtitle-ani-1 elementor-kadu-sub">
                                        <img style="width: 40x; height: 40px;"
                                            src="https://d20cs3cmzywuh.cloudfront.net/mobile-assets/index/cap.svg" alt="">
                                        Info
                                    </h6>
                ...
                <div class="kd-course-2-card" style="border: solid 2px rgb(225, 225, 225);">
                    <div class="main-img fix img-cover">
                        <img fetchpriority="high" decoding="async" width="357" height="220"
                            src="https://d20cs3cmzywuh.cloudfront.net/mobile-assets/index/c6.svg"
                    ...
                    <div class="carousel-item">
                        ...
                        <a href="lab-engineering_drawing">
                            <div class="card d-flex flex-column shadow-sm"
                                ...
                                <div class="p-3">
                                    <img style="height: 300px; width: 100%;"
                                        src="https://d20cs3cmzywuh.cloudfront.net/mobile-assets/index/engineering1.jpg"
                                        class="img-fluid rounded" />
                                </div>
                                <div class="card-body d-flex flex-column flex-grow-1">
                    ...
                    <div class="carousel-item">
                        ...
                        <a href="lab-foodteach">
                            <div class="card d-flex flex-column shadow-sm"
                                ...
                                <div class="p-3">
                                    <img style="height: 300px; width: 100%;"
                                        src="https://d20cs3cmzywuh.cloudfront.net/mobile-assets/index/foodtech1.jpg"
                                        class="img-fluid rounded" />
                                </div>
                                <div class="card-body d-flex flex-column flex-grow-1">
                                ...
                                <div class="kd-about-4-left ">
                                    <div class="mb-5 fix img-cover">
                                        <img decoding="async" class="rounded" style="height: 400px !important;"
                                            src="https://d20cs3cmzywuh.cloudfront.net/mobile-assets/index/mobileadvpic.png"
                                            alt="">
                                    </div>
                                    <div class="kd-about-4-img-2 fix img-cover txxa-add-class">
                                        <img decoding="async" style="height: 600px !important;"
                                            src="https://d20cs3cmzywuh.cloudfront.net/mobile-assets/index/mobileyellow.png"
                                            alt="">
                                    </div>
                                </div>
                            </div>
        ...
        <!--Mobile Testimonial-->
        <section
            style="padding: 40px 30px; background-image: url(https://d20cs3cmzywuh.cloudfront.net/mobile-assets/index/s2-bg-img-1.webp);">
            ...
            <div class="row" style="display: flex; flex-direction: column;">
                <a href="success"><img class="pb-3"
                        src="https://d20cs3cmzywuh.cloudfront.net/mobile-assets/index/alumni-student.png" /></a>
                <a href="top-recruiters"><img class="pb-3"
                        src="https://d20cs3cmzywuh.cloudfront.net/mobile-assets/index/recruiters.png" /></a>
                <a href="footprints"><img class="pb-3"
                        src="https://d20cs3cmzywuh.cloudfront.net/mobile-assets/index/dignitaries.png" /></a>
            </div>
                            ...
                            <div id="imageCarousel" class="carousel slide carousel-container" data-bs-ride="carousel"
                                ...
                                <section class="container border mb-3"
                                    ...
                                    <div class="row"
                                        ...
                                        <div class="col-lg-9">
                                            <h2 style="color: #fff; font-size: 28px;" class="headd2 fw-bold">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="https://bucket-0534zd.s3.ap-south-1.amazonaws.com/landing/about-website.png"
                                            alt="Slide 1">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="https://bucket-0534zd.s3.ap-south-1.amazonaws.com/landing/research-website.png"
                                            alt="Slide 2">
                                    </div>
                                    <!-- <div class="carousel-item">
                ...
                <div class="container" style="padding: 30px 0px;">
                    <div class="row">
                        <div class="col-lg-7" style="display: flex; flex-direction: column;">
                            ...
                            <div id="slider" style="width: 620px; overflow: hidden; margin: auto; position: relative;">
                                ...
                                <div id="slides" style="display: flex; transition: transform 0.5s ease;">
                                    ...
                                    <img class="zoomable"
                                        src="https://bucket-0534zd.s3.ap-south-1.amazonaws.com/events/may-03.jpeg"
                                        style="width:400px; height: 530px; margin-right: 20px; border: 2px solid #e68900; border-radius: 10px;">
                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="card"
                                style="height: 530px; overflow: hidden; position: relative; background-color: #faebd7;">
                                <div class="notification-wrapper"
                                    ...
                                    <div class="notification-item text-dark para1">
                                        <a href="https://bucket-0534zd.s3.ap-south-1.amazonaws.com/admission/phd.pdf"
                                            style="display: block; padding: 15px; border-bottom: 1px solid #ddd; text-decoration: none; color: inherit;"><img
                                                style="width: 50px;"
                                                src="https://bucket-0534zd.s3.ap-south-1.amazonaws.com/admission/output-onlinegiftools.gif"
                                                alt=""> Admission Open For Ph.D. 2025-2026 </a>
                                    </div>
                                    <div class="notification-item text-dark para1">
                                        <a href="#"
                                            style="display: block; padding: 15px; border-bottom: 1px solid #ddd; text-decoration: none; color: inherit;"><img
                                                style="width: 30px;" src="assets/img/event-img/arrow-new.png" alt="">
                                            International
                                            Seminar by Royal Global University in association with ELTAI, September, 2024
                                        </a>
                                    </div>
                                    <div class="notification-item text-dark para1">
                                        <a href="#"
                                    ...
                                    <div class="notification-item text-dark para1">
                                        <a href="#"
                                            ...
                                            Zone Vice Chancellors' Meet, 2023 on 'Integrating Bharatiya Knowledge System
                                            (BKS) with
                                            Higher Education'</a>
                                    </div>
                            ...
                            <a href="https://rgu.ac/notifications">
                                <h2 class="para1 fw-bold pt-3 text-center" style="color: #27467A;">View All Notifications ->
                                </h2>
                            </a>
                        </div>
                        ...
                        <div class="row" style="background-color: #f2f2f2;">
                            <div class="col-lg-4" style="background-color: #a1d0f9;">
                                <div class="text-center p-5">
                                    ...
                                    <a href="notifications" target="_blank" class="bg-danger text-white rounded"
                                    ...
                                    <div class="elementor-widget-container">
                                        <div class="prthalign">
                                            <h6 class="para1 kd-subtitle-1 kd-subtitle-ani-1 elementor-kadu-sub">
                                                <img style="width: 40x; height: 40px;"
                                                    src="https://d20cs3cmzywuh.cloudfront.net/mobile-assets/index/cap.svg"
                                                    alt="">
                                                Info
                                            </h6>
                                    ...
                                    <div class="elementor-widget-container">
                                        <div class="kd-course-3-area p-relative pt-105 pb-60 fix">
                                            <div class="kd-course-1-bg-img img-cover fix">
                                                <img decoding="async"
                                                    src="https://d20cs3cmzywuh.cloudfront.net/mobile-assets/index/head2.svg"
                                                    alt="">
                                            </div>
                                                        ...
                                                        <div class="kd-course-3-tabs-content">
                                                            ...
                                                            <div class="right-content">
                                                                <div class="kd-course-3-tabs-content-video img-cover fix">
                                                                    <img decoding="async"
                                                                        src="https://d20cs3cmzywuh.cloudfront.net/mobile-assets/index/residence.jpg"
                                                                        alt="">
                                                    ...
                                                    <div class="tab-pane fade animated fadeInUp " id="home2" role="tabpanel"
                                                        ...
                                                        <div class="kd-course-3-tabs-content">
                                                            ...
                                                            <div class="right-content">
                                                                <div class="kd-course-3-tabs-content-video img-cover fix">
                                                                    <img decoding="async"
                                                                        src="https://d20cs3cmzywuh.cloudfront.net/mobile-assets/index/sports.jpg"
                                                                        alt="">
                                                    ...
                                                    <div class="tab-pane fade animated fadeInUp " id="home3" role="tabpanel"
                                                        ...
                                                        <div class="kd-course-3-tabs-content">
                                                            ...
                                                            <div class="right-content">
                                                                <div class="kd-course-3-tabs-content-video img-cover fix">
                                                                    <img decoding="async"
                                                                        src="https://d20cs3cmzywuh.cloudfront.net/mobile-assets/index/amenities.jpg"
                                                                        alt="">
                                            ...
                                            <div class="kd-about-4-according-item mb-20">
                                                <div class="item-header" id="heading449027-a06e874">
                                                    <button class="item-title kd-heading-2 kd-font-700 " type="button"
                                                        ...
                                                        <span
                                                            style="font-weight: 400; font-size: 25px; font-family: 'Host Grotesk', times, serif;"
                                            ...
                                            <div class="kd-about-4-according-item mb-20">
                                                <div class="item-header" id="heading449027-d109252">
                                                    <button class="item-title kd-heading-2 kd-font-700 collapsed"
                                                        ...
                                                        <span
                                                            style="font-weight: 400; font-size: 30px; font-family: 'Host Grotesk', times, serif;"
