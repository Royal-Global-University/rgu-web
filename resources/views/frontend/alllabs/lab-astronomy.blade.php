...
@section('content')
    <div class="mobile">
        ...
        <div style="padding-top: 90px; position: relative;">
            <img src="mobile-assets/lab-observatory/mobileastronomylab1.png" alt="">
            <img src="mobile-assets/lab-observatory/mobileastronomylab2.png" alt="">
        </div>
    </div>
    ...
    <div class="website">
        ...
        <div data-elementor-type="wp-page" data-elementor-id="704" class="elementor elementor-704">
            <section style="padding-top: 30px; background-image: url(mobile-assets/lab-observatory/background.svg);"
                                ...
                                <div class="elementor-widget-container">
                                    <div class="kd-about-3-img-wrap txaa-slide-down-1">
                                        <div style="border: 2px solid #fff;"
                                            ...
                                            <img decoding="async" src="mobile-assets/lab-observatory/headimg.jpg" alt="">
                                        </div>
                                ...
                                <div class="elementor-widget-container">
                                    <div class="prthalign">
                                        ...
                                        <p class="text-dark para1" style="text-align: justify;">
                                            The Royal Astronomical Observatory at The Assam Royal Global University stands
                                            as a gateway to the
                                            cosmos, inviting students, researchers, and enthusiasts to explore the wonders
                                            of the universe. Officially
                                            inaugurated on 19th November 2024 by Prof. Madhurjya P. Bora, Coordinator of
                                            ISRO RAC-S,
                ...
                <div class="custom-row">
                    ...
                    <div class="custom-column">
                        ...
                        <dl class="pt-2">
                            ...
                            <dd class="para1 text-dark">Perfect for observing faint deep-sky objects like nebulae and
                                galaxies</dd>
                    ...
                    <div class="custom-column">
                        ...
                        <dl class="pt-2">
                            ...
                            <dd class="para1 text-dark">The observatory is equipped with advanced tools and mounts to
                                capture stunning celestial images, inspiring both amateur and professional
                                astrophotographers</dd>
                        </dl>
                    </div>
                </div>
            </div>
            ...
            <div style="padding: 30px 50px;">
                ...
                <p class="text-dark para1" style="text-align: justify;">
                    ...
                    cosmos, inviting students, researchers, and enthusiasts to explore the wonders of the universe.
                    Officially
                ...
                <dl class="ol text-dark para1">
                    ...
                    <dd>
                        <ol>
                            <li>Students gain practical experience in telescope operations, celestial navigation, and data
                                collection.</li>
                            <li>Workshops and observation sessions allow participants to delve deeper into the mysteries of
                                the universe.</li>
                        </ol>
                    </dd>
                    ...
                    <dd>
                        <ol>
                            <li>Faculty and students are encouraged to develop research proposals, particularly in
                                collaboration with ISRO RAC-S, Gauhati University.</li>
                        </ol>
                    </dd>
                    ...
                    <dd>
                        <ol>
                            <li>The newly formed Astronomy Club under the observatory aims to nurture young minds with a
                                passion for stargazing and astrophysics.</li>
                            <li>Regular events and discussions will inspire students to think beyond the confines of Earth.
                            </li>
                        </ol>
                    </dd>
                </dl>
                ...
                <p class="text-dark para1" style="text-align: justify;">
                    ...
                    faculty, and students. Prof. Bora shared captivating insights into the scale of the universe and
                    discussed
                    how observatories like this can serve as hubs for educational outreach and groundbreaking research.
                </p>

                <img src="mobile-assets/lab-observatory/gallery2.svg" alt="">

                <p class="text-dark para1" style="text-align: justify;">
                    The chief guest also appreciated the quality and versatility of the equipment, expressing his optimism
                    for
                ...
                <ol class="text-dark para1">
                    <li>Observe breathtaking celestial phenomena such as planetary transits, meteor showers, and lunar
                        eclipses.</li>
                ...
                <p class="para1 text-dark">Experience the universe like never before at The Royal Astronomical Observatory.
                    Whether you’re a student, researcher, or a curious observer, the observatory offers a unique opportunity
                    to connect with the stars. Step in, look up, and let the cosmos ignite your imagination!</p>
                <blockquote class="text-success text-center">“The cosmos is within us. We are made of star-stuff. We are a
                    way for the universe to know itself.” – Carl Sagan</blockquote>
