...
@section('content')
    <div class="mobile">
        ...
        <div style="padding-top: 90px; position: relative;">
            <h1 class="text-center pt-2 text-dark fw-bold kd-title-ani kd-split-text">
                Forensic Science
            </h1>
            <img decoding="async" class="p-2 rounded" src="mobile-assets/lab-forensic/headimg.JPG" alt="">
            <div class="p-3 text-dark">
                ...
                <p class="text-dark para1" style="text-align: justify;">
                    ...
                    independent research in the discipline.
                </p>
            </div>
        </div>
    </div>
                                ...
                                <div class="elementor-widget-container">
                                    <div class="kd-about-3-img-wrap txaa-slide-down-1">
                                        <div style="border: 2px solid #fff;"
                                            ...
                                            <img decoding="async" src="mobile-assets/lab-forensic/headimg.JPG"
                                                alt="">
                                        </div>
        ...
        <div class="custom-row">
            <div class="custom-column p-4">
                ...
                <div class="row pt-3 pb-3 text-center">
                    <div class="col-lg-6">
                        <img style="height: 500px; width: 500px;" src="/mobile-assets/Forensic Science/COMPARISON MICROSCOPE.jpg"/>
                    </div>
                    <div class="col-lg-6">
                        <img style="height: 500px; width: 500px;" src="/mobile-assets/Forensic Science/STEREO MICROSCOPE WITH CAMERA.jpg"/>
                    </div>
                </div>
            </div>
        </div>
