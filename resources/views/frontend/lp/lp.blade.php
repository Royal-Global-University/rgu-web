                        ...
                        <div class="container">
                            <div class="row align-items-center gx-5">
                                <div class="col-lg-6">
                                    ...
                                    <h2 class="headd kd-title-ani kd-split lp-half-underline" style="color: #264273; font-weight: 700;">
                                        Why RGU</h2>
                                ...
                                <div class="col-lg-6">
                                    <div class="kd-about-3-img-wrap txaa-slide-down-1">
                                        <div>
                                            <img class="rounded" decoding="async" style="height: 660px;" src="mobile-assets/lp/pic2.png"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-8 lp-program-wrapper">
                                ...
                                <div id="lp-ug-list" class="lp-program-box d-none">
                                    ...
                                    <ul>
                                        ...
                                        <li class="fw-bold text-dark">B.A Public Administration with Integrated Civil Service Program
                                        </li>
