        ...
        <div>
            ...
            <div style="padding: 0px 60px;">
                ...
                <ul class="nav nav-tabs justify-content-center mb-4" id="galleryTabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active fw-bold" id="photo-mob-tab" data-toggle="tab" href="#photo-mob"
                            role="tab" aria-controls="photo-mob" aria-selected="true">
                            Photo Gallery
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link fw-bold" id="video-mob-tab" data-toggle="tab" href="#video-mob"
                            role="tab" aria-controls="video-mob" aria-selected="false">
                            Video Gallery
                        </a>
                    </li>
                </ul>
                ...
                <div class="tab-content" id="galleryTabsContent">
                    ...
                    <!-- Photo Gallery -->
                    <div class="tab-pane fade show active" id="photo-mob" role="tabpanel"
                        aria-labelledby="photo-mob-tab">
                        <div class="row ">
    ...
    <div class="website">
        ...
        <div>
                    ...
                    <div id="lpCarousel" class="carousel slide" data-ride="carousel" data-interval="2500">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="row">
                                    <div class="col-md-6">
                                        <img src="https://media.rgu.ac/lp/slidepic1.png" class="d-block w-100"
                                            alt="Image 1">
                                    </div>
                                    <div class="col-md-6">
                                        <img src="https://media.rgu.ac/lp/slidepic2.png" class="d-block w-100"
                                            alt="Image 2">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-8 lp-program-wrapper">
                        ...
                        <div id="lp-ugmob-list" class="lp-program-box">
                            ...
                            <ul>
                                ...
                                <li class="fw-bold text-dark">B.A Public Administration with Integrated Civil Service
                                    Program</li>
                                <li class="fw-bold text-dark">B.A Political Science with Integrated Civil Service Program
                                </li>
            ...
            <div style="padding: 0px 60px;">
                ...
                <ul class="nav nav-tabs justify-content-center mb-4" id="galleryTabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active fw-bold" id="photo-tab" data-toggle="tab" href="#photo"
                            role="tab" aria-controls="photo" aria-selected="true">
                            Photo Gallery
                        </a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content" id="galleryTabsContent">
                    ...
                    <div class="tab-pane fade show active" id="photo" role="tabpanel" aria-labelledby="photo-tab">
                        <div class="row ">
                            <div class="col-lg-12"><img src="https://media.rgu.ac/lp/gallery2.png"
                                    class="img-fluid rounded" alt="Photo 1"></div>
