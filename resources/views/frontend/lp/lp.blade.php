...
@section('content')
                    ...
                    <div class="container">
                        <div class="row align-items-center gx-5">
                            <div class="col-lg-6">
                                ...
                                <h5 class="headd kd-title-ani kd-split lp-half-underline"
                                    style="color: #264273; font-weight: 700; font-size: 35px !important;">Why RGU</h5>
                                <p class="para1 pt-3" style="color: #333; text-align: justify;">
                                    The Assam Royal Global University stands out for its excellent academic programs, experienced
                                    faculty, modern facilities, and emphasis on holistic development, making it a top choice for
                                    students seeking quality education in various disciplines. It is recognized by the University
                                    Grants Commission (UGC) and it holds recognition and accreditation from relevant professional
                                    bodies for specific programs, ensuring that the education provided meets high standards and is
                            ...
                            <div class="col-lg-6">
                                <div class="kd-about-3-img-wrap txaa-slide-down-1">
                                    <div class="text-center">
                                        <img class="rounded pt-3" decoding="async" style="height: 500px;"
                                            src="mobile-assets/lp/pic2.png" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div style="padding: 0px 60px;">
                    ...
                    <div class="tab-content" id="galleryTabsContent">
                        ...
                        <div class="tab-pane fade show active" id="photo" role="tabpanel" aria-labelledby="photo-tab">
                            <div class="row ">
                                <div class="col-lg-12"><img src="mobile-assets/lp/gallery2.png" class="img-fluid rounded"
                                        alt="Photo 1"></div>
          ...
          <section style="padding: 50px 0px;">
            ...
            <div class="row align-items-center gx-5">
                <div class="col-lg-6">
                    ...
                    <h2 class="headd kd-title-ani kd-split lp-half-underline" style="color: #264273; font-weight: 700;">Why RGU</h2>
                  ...
                  <div class="kd-about-3-img-wrap txaa-slide-down-1">
                      <div >
                          <img class="rounded" decoding="async"
                             style="height: 660px;" src="mobile-assets/lp/pic2.png"
                              alt="">
                      </div>
                  </div>
              </div>
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <img src="mobile-assets/lp/slidepic2.png" class="d-block w-100" alt="Image 2">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="carousel-item">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <img src="mobile-assets/lp/slidepic2.png" class="d-block w-100" alt="Image 4">
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <li>M.Sc.Nursing - OBE Nursing *</li>
          ...
          <ul class="nav nav-tabs justify-content-center mb-4" id="galleryTabs" role="tablist">
            <li class="nav-item">
              <a class="nav-link active fw-bold" id="photo-tab" data-toggle="tab" href="#photo" role="tab" aria-controls="photo" aria-selected="true">
                Photo Gallery
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link fw-bold" id="video-tab" data-toggle="tab" href="#video" role="tab" aria-controls="video" aria-selected="false">
                Video Gallery
              </a>
            </li>
                </ul>
          ...
          <div class="tab-content" id="galleryTabsContent">
            ...
            <div class="tab-pane fade show active" id="photo" role="tabpanel" aria-labelledby="photo-tab">
              <div class="row ">
                <div class="col-lg-12"><img src="mobile-assets/lp/gallery2.png" class="img-fluid rounded" alt="Photo 1"></div>
