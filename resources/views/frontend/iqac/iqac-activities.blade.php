                ...
                <div class="row" style="display: flex; align-items: center; justify-content: center;">
                    <div class="col-lg-4">
                        ...
                        <h2 class="mobile-headd2 fw-bold" style="color: #27467A; font-weight: 900;">
                            IQAC <span style="color: #FF9A1E; font-weight: 500;">Meetings</span></h2>

                        <ol class="mobile-para1" style="color: #27467A;">
                            <li>1st IQAC meeting: 24.04.2018</li>
                            <li>2nd IQAC meeting: 26.11.2018</li>
                            <li>3rd IQAC meeting: 24.04.2019</li>
                            <li>4th IQAC meeting: 16.09.2019</li>
                            <li>5th IQAC meeting: 09.03.2021</li>
                            <li>6th IQAC meeting: 29.04.2021</li>
                            <li>7th IQAC meeting: 09.11.2021</li>
                            <li>8th IQAC meeting: 21.04.2022</li>
                            <li>9th IQAC meeting: 20.12.2022</li>
                            <li>10th IQAC meeting: 22.03.2023</li>
                            <li>11th IQAC meeting: 21.08.2023</li>
                            <li>12th IQAC meeting: 04.12.2023</li>
                        </ol>
            ...
            <div style="padding: 20px">
                ...
                <div class="row" style="display: flex; align-items: center; justify-content: center;">
                    ...
                    <div class="col-lg-6">
                        ...
                        <p class="mobile-para1 fw-bold" style="color: #27467A;">
                            Chairperson- Prof. (Dr) L. K. Nath (Dean RSP) Members-
                        </p>
            ...
            <div style="padding: 20px">
                ...
                <div class="row" style="display: flex; align-items: center; justify-content: center;">
                    ...
                    <div class="col-lg-12">
                        ...
                        <h2 class="mobile-headd2 fw-bold" style="color: #27467A; font-weight: 900;">
                            Report of external academic & administrative audit <span
            ...
            <div style="padding: 20px">
                ...
                <div class="row" style="display: flex; align-items: center; justify-content: center;">
                    ...
                    <div class="col-lg-6">
                        ...
                        <h2 class="mobile-headd2 fw-bold" style="color: #27467A; font-weight: 900;">
                            FOP on <span style="color: #FF9A1E; font-weight: 500;">"Data analysis using machine learning
                                software"</span></h2>
            ...
            <div style="padding: 20px">
                ...
                <div class="row" style="display: flex; align-items: center; justify-content: center;">
                    ...
                    <div class="col-lg-12">
                        ...
                        <h2 class="mobile-headd2 fw-bold" style="color: #27467A; font-weight: 900;">
                            Activity Report on <span style="color: #FF9A1E; font-weight: 500;">"Lecture Discussion on
                                LOCF"</span></h2>
            ...
            <div style="padding: 20px">
                ...
                <div class="row" style="display: flex; align-items: center; justify-content: center;">
                    ...
                    <div class="col-lg-12">
                        ...
                        <h2 class="mobile-headd2 fw-bold" style="color: #27467A; font-weight: 900;">
                            A Report On One Day Seminar On <span style="color: #FF9A1E; font-weight: 500;">"Focus towards
                                Quality Research"</span></h2>

                        <p class="headd3 fw-bold" style="color: #27467A; text-align: justify;">
                            Date: June 17, 2022
                        </p>
                        ...
                        <p class="mobile-para1" style="color: #27467A; text-align: justify;">
                            Prof J P Verma and Prof L Ladu Singh were the eminent speakers for the Technical Session I where
                            they spoke on "Writing a good research paper - reviewer's perspective" and "Sampling weight and
            ...
            <div style="padding: 20px">
                ...
                <div class="row" style="display: flex; align-items: center; justify-content: center;">
                    ...
                    <div class="col-lg-12">
                        ...
                        <h2 class="mobile-headd2 fw-bold" style="color: #27467A; font-weight: 900;">
                            Panel Discussion on <span style="color: #FF9A1E; font-weight: 500;">Curriculum Development and
                                related Issues in the context of NEP 2020</span></h2>
                        ...
                        <ol class="mobile-para1" style="color: #27467A;">
                            <li>Curriculum development in the light of NEP - 2020</li>
                            <li>Multiple Entry Exit System (MEES)</li>
                            <li>Academic Bank of Credits (ABCs)</li>
                        </ol>
                        ...
                        <p class="headd3 fw-bold" style="color: #27467A; text-align: justify;">
                            The resource persons of the Panel discussions were:
                        </p>
            ...
            <div style="padding: 20px">
                ...
                <div class="row" style="display: flex; align-items: center; justify-content: center;">
                    ...
                    <div class="col-lg-12">
                        ...
                        <h2 class="mobile-headd2 fw-bold" style="color: #27467A; font-weight: 900;">
                            Internal Academic <span style="color: #FF9A1E; font-weight: 500;">Audit 2022</span></h2>

                        <p class="headd3 fw-bold" style="color: #27467A; text-align: justify;">
                            Internal Academic Audit was conducted from 17th to 22nd August 2022 with the committee mentioned
                            below:
                        </p>

                        <ol class="mobile-para1" style="color: #27467A;">
                            <li>Prof. H.C. Gautam, RSCOM</li>
                            <li>Prof. Diganta Munshi, Registrar</li>
                            <li>Prof. Ankur Ganguly, Dean Academics, Dean 1/C RSET</li>
                            <li>Prof. Anuradha Devi, Dean RSAP and Coordinator, IQAC</li>
                            <li>Prof. Anupam Chatterjee, Dean RSBSC</li>
                            <li>Prof. P. J. Mahanta, RSL</li>
                            <li>Chairman</li>
                            <li>Members</li>
                        </ol>
            ...
            <div style="padding: 20px">
                ...
                <div class="row" style="display: flex; align-items: center; justify-content: center;">
                    ...
                    <div class="col-lg-12">
                        ...
                        <h2 class="mobile-headd2 fw-bold" style="color: #27467A; font-weight: 900;">
                            IQAC Office <span style="color: #FF9A1E; font-weight: 500;">Inaugration</span></h2>

                        <p class="mobile-para1" style="color: #27467A; text-align: justify;">
                            The Assam Royal Global University inaugurated its IQAC Office on 28th September 2022, with an
                            official ceremony at the D block seminar hall, 1st floor. The Chief Guest for the same was Prof.
                            Madhurjya
                        </p>
            ...
            <div style="padding: 20px">
                ...
                <div class="row" style="display: flex; align-items: center; justify-content: center;">
                    ...
                    <div class="col-lg-12">
                        ...
                        <h2 class="mobile-headd2 fw-bold" style="color: #27467A; font-weight: 900;">
                            Internal Benchmarking through <span style="color: #FF9A1E; font-weight: 500;">Assessment &
            ...
            <div style="padding: 20px 80px;">
                ...
                <div class="row" style="display: flex; align-items: center; justify-content: center;">
                    ...
                    <div class="col-lg-6">
                        ...
                        <p class="para1 fw-bold" style="color: #27467A;">
                            Chairperson- Prof. (Dr) L. K. Nath (Dean RSP) Members-
                        </p>
