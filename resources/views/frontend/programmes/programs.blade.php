...
@section('content')
    ...
    <div class="mobile">
        ...
        <div style="padding-top: 90px; position: relative;">
            <img src="mobile-assets/admission-fee-and-programmee/mob-admission-programme.png" alt="">
        </div>
            ...
            <div class="container text-center">
                <div class="row pt-3">
                    <div class="col-lg-6 d-flex">
                        <h6 class="fw-bold text-dark">Search By Schools :</h6>
                    ...
                    <div class="col-lg-6 d-flex pt-4">
                        <h6 class="fw-bold text-dark">Search By Courses :</h6>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 pt-3">
                                    <a href="programs-M.Tech.CE in-Structural-Engineering.html"
                                        class="text-center text-dark fw-bold d-flex align-items-center justify-content-center">
                                        <div class="border p-2 rounded flex-grow-1" style="background-color: #006A67;">
                                            <p class="m-0 p-0 text-white fw-bold para1">M.Tech. CE in Structure Engineering
                                            </p>
                                            <p class="text-center text-white para1">2 Years</p>
                                        </div>
                                    </a>
