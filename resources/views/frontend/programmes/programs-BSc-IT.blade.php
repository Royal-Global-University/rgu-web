...
@section('meta_description', 'Royal Global University offers a comprehensive B.Sc IT program to help you build a solid
    foundation and successful career in information technology.')
            ...
            <div class="section-body">
                <div class="tabs-container">
                    ...
                    <div id="eligibility" class="tab-content mobile-para1">
                        ...
                        <p class="text-dark">
                            10+2 or equivalent from a recognized Board/Council with Mathematics/ Computer Science /
                            Information
                            Technology as one of the compulsory subjects, with minimum 45% marks or equivalent grade (5%
                            relaxation to
