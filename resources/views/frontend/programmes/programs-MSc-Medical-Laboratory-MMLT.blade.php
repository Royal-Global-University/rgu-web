...
@section('meta_description', 'Royal Global University offers an industry-focused M.Sc Medical Lab Technology program in Assam with advanced labs, experienced faculty, and strong placement support.')
...
<div style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">
            ...
            <h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">M.Sc. - Medical Laboratory Technology (MMLT)
            </h2>
