...
@section('title', 'Best Master of Travel and Tourism Management | Royal Global University')
@section('meta_description', 'Explore world-class education in tourism with Royal Global University’s Master of Travel and Tourism Management. Equip yourself for global hospitality and travel leadership careers.')
@section('meta_keywords', 'Master of Travel and tourism management')
@section('content')
      ...
      <div class="section-body">
        <div class="tabs-container">
          ...
          <div id="eligibility" class="tab-content mobile-para1">
            ...
            <p class="text-dark">
              Bachelor’s Degree in Travel & Tourism Management /
              Major from any recognized University/Institution with
              minimum 45% marks or equivalent grade (5%
              relaxation to SC/ST/OBC – Non-Creamy Layer) Or
              Bachelor’s Degree in any stream with minimum 45%
              marks in aggregate (5% relaxation to SC/ST/OBC –
              Non-Creamy Layer).
            </p>
          ...
          <div id="brochure" class="tab-content mobile-para1">
            ...
            <div
              ...
              <a target="_blank" class="text-danger fw-bold mobile-headd3 pt-2"
                href="https://www.rgu.ac/mobile-assets/Domestic/brochure%20for%20web_compressed-min.pdf">Download
                Brochure
