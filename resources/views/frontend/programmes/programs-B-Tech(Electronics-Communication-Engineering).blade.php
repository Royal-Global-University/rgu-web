        ...
        <div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            ...
            <p class="d-flex justify-content-center gap-4 rounded pb-3 pt-3 text-center">
                <button type="button" class="btn p-3 text-white active" data-bs-toggle="button"
                    ...
                    style="padding-left: 40px !important; padding-right: 40px !important; font-size: 20px; font-weight: 600; background-color: #004085; border: 2px solid #007bff; border-radius: 8px; box-shadow: 2px 2px 8px rgba(0,0,0,0.2); transition: transform 0.3s, box-shadow 0.3s; cursor: pointer;">
                    Fee
                </button>
                <button type="button" class="btn p-3 text-white" data-bs-toggle="button"
                    onclick="setActiveButton(this); openCity('Eligibility')"
                    style="font-size: 20px; font-weight: 600; background-color: #007bff; border: 2px solid #007bff; border-radius: 8px; box-shadow: 2px 2px 8px rgba(0,0,0,0.2); transition: transform 0.3s, box-shadow 0.3s; cursor: pointer;">
                    Eligibility
                </button>
                <button type="button" class="btn p-3 text-white" data-bs-toggle="button"
            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">i)10+2 or equivalent from a recognized Board/Council, ii) with Physics,
                            Mathematics (Mandatory) and any one from the following: Chemistry/ Computer
                            Science/Electronics/Information Technology/Biology/Informatics Practices/ Biotechnology/ Technical
                            Vocational subject/ Agriculture/ Engineering Graphics/Business Studies/Entrepreneurship. iii) having
                            minimum 50% marks or equivalent grade (5% relaxation to SC/ST/OBC-Non-Creamy Layer) in the above
                            subjects together.</p>
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a
                                href="assets/programme-pdf/JEE 2024 _compressed for web.pdf">Brochure 2024-25<i
