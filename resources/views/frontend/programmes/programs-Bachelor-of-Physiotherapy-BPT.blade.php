...
@section('title', 'Best Bachelor of Physiotherapy Degree at Royal Global University, Assam')
@section('meta_description', 'Study Bachelor of Physiotherapy at Royal Global University and develop advanced skills in physiotherapy, rehabilitation, and patient management.')
@section('meta_keywords', 'Bachelor of Physiotherapy')
@section('content')
    ...
    <div class="mobile">
      ...
      <p class="mobile-headd1 text-center" style="color: #24477f;">
        Duration - (4 Yrs + 1 Yr internship)
      </p>
      ...
      <div class="section-body">
        <div class="tabs-container">
          ...
          <div id="fee" class="tab-content active mobile-para1">
            ...
            <ol class="text-dark">
              <li>
                Yearly Payment (Rs. - 135000.00)
              </li>
              <li>
                Semester Payment (Rs. - 69000.00)
              </li>
            </ol>
            </p>
          ...
          <div id="eligibility" class="tab-content mobile-para1">
            ...
            <ol>
              <li class="text-dark">
                Candidate must have passed 10+2 or equivalent with Physics, Chemistry and Biology (or Botany & Zoology) with minimum 50% aggregate marks and English as a passing subject.
              </li>
              <li class="text-dark">
                For SC/ST/OBC (NCL)/PwD/PwBD candidates, the minimum aggregate marks required in PCB shall be 40%.
              </li>
            </ol>
          ...
          <div id="brochure" class="tab-content mobile-para1">
            ...
            <div
              ...
              <a target="_blank" class="text-danger fw-bold mobile-headd3 pt-2"
                href="https://rgu.ac/mobile-assets/Domestic/brochure%20for%20web_compressed-min.pdf">Download
                Brochure
