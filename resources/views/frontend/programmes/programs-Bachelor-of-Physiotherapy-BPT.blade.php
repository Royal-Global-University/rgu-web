...
@section('content')
    ...
    <div style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">
                ...
                <h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">Bachelor of Physiotherapy (BPT)

                </h2>

                <p class="mobile-headd3 text-dark text-center" style="line-height: 1.3;">Duration - 4.6 Years <br> Royal School of Medical & Allied Sciences (RSMAS)
                </p>
            ...
            <div class="container mt-4" style="max-width: 900px;">
                ...
                <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
                    ...
                    <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                        ...
                        <p class="mobile-para1 text-dark">10+2 in science stream with minimum 50% marks or equivalent grade in Physics, Chemistry, Biology and English as a core subject from a recognized Board/Council.
                            (5% relaxation to SC/ST/OBC - Non-Creamy Layer).
                            Age Limit: Minimum 17 years and maximum 30 years of age as on 31st December of the year in which the admission is sought.
                        ...
                        <p class="mobile-para1 text-dark">Personal Interview which will assess Candidates personality, communication skills, and suitability for the BPT program.</p>
                ...
                <div class="container pb-5">
                    ...
                    <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                        <div class="card-body para1">
                            ...
                            <p class="text-dark pt-2 m-0">10+2 in science stream with minimum 50% marks or equivalent grade in Physics, Chemistry, Biology and English as a core subject from a recognized Board/Council.
                                (5% relaxation to SC/ST/OBC - Non-Creamy Layer).
                                Age Limit: Minimum 17 years and maximum 30 years of age as on 31st December of the year in which the admission is sought.
