...
@section('meta_description', 'Study Bachelor of Physiotherapy at Royal Global University and develop advanced skills in
    physiotherapy, rehabilitation, and patient management.')
            ...
            <div class="section-body">
                <div class="tabs-container">
                    ...
                    <div id="eligibility" class="tab-content mobile-para1">
                        ...
                        <ol>
                            <li class="text-dark">
                                Candidate must have passed 10+2 or equivalent with Physics, Chemistry and Biology (or Botany
                                & Zoology) with minimum 50% aggregate marks and English as a passing subject.
                            </li>
                            <li class="text-dark">
                                For SC/ST/OBC (NCL)/PwD/PwBD candidates, the minimum aggregate marks required in PCB shall
                                be 40%.
                            </li>
                        </ol>
