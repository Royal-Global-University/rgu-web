            ...
            <div class="section-body">
                <div class="tabs-container">
                    ...
                    <div id="eligibility" class="tab-content mobile-para1">
                        ...
                        <ol>
                            <li class="text-dark">
                                10+2 in science stream or equivalent from a recognized Board/Council, with a minimum of 45%
                                marks or
                                equivalent grade in Physics, Chemistry, and Biology taken together (5% relaxation for
                                SC/ST/OBC –
                                Non-Creamy Layer).
                            </li>
                        </ol>
