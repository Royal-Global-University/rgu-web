...
@section('content')
            <div class="mobile">
                ...
                <h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">M.Sc. - Emergency and Critical Care
                </h2>

                <p class="mobile-headd3 text-dark text-center" style="line-height: 1.3;">Duration - 02 Years <br> Royal School of Medical & Allied Sciences (RSMAS)
                </p>
            ...
            <div class="container mt-4" style="max-width: 900px;">
                ...
                <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
                    ...
                    <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                        ...
                        <p class="mobile-para1 text-dark">A candidate with Bachelor's degree (3 or 4 years) in Emergency Medical Technology/ B.Sc. Critical Care Technology/ MBBS/ BHMS/ BAMS or an equivalent degree with a minimum of 50% marks in the B.Sc. exam.
                        </p>
                    ...
                    <div class="text-center">
                        ...
                        <a href="assets/img/programme-pdf/brochure for web_compressed-min.pdf" target="_blank" class="btn mobile-para1" style="background-color: #27467A; color: white; font-weight: bold; padding: 10px 15px; border-radius: 5px; text-decoration: none; line-height: 1.3; display: flex; align-items: center; justify-content: center; gap: 8px;">
                ...
                <div class="container pb-5">
                    ...
                    <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                        <div class="card-body para1">
                            ...
                            <p class="text-dark pt-2 m-0">A candidate with Bachelor's degree (3 or 4 years) in Emergency Medical Technology/ B.Sc. Critical Care Technology/ MBBS/ BHMS/ BAMS or an equivalent degree with a minimum of 50% marks in the B.Sc. exam.
                            </p>
