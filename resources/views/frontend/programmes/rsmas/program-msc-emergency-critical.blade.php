...
@section('content')
                ...
                <div style="padding: 20px 0px 0px 0px;">
                    <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent">
                        ...
                        <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                            ...
                            <p class="mobile-para1 text-dark">A candidate with Bachelor's degree (3 or 4 years) in Emergency
                                Medical Technology/ B.Sc. Critical Care Technology/ MBBS/ BHMS/ BAMS or an equivalent degree
                                with a minimum of 50% marks in the B.Sc. exam.
                            </p>
    ...
    <div class="website">
        ...
        <div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">M.Sc. - Emergency and Critical Care</h2>
            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">A candidate with Bachelor's degree (3 or 4 years) in Emergency
                            Medical Technology/ B.Sc. Critical Care Technology/ MBBS/ BHMS/ BAMS or an equivalent degree
                            with a minimum of 50% marks in the B.Sc. exam.
                        </p>
