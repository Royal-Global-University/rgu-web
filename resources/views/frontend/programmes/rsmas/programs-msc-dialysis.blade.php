        ...
        @section('content')
            <div class="mobile">
                ...
                <div
                    style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">

                    <h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center"
                        style="color: #264273; font-weight: 700;">M.Sc. - Dialysis
                    </h2>

                    <p class="mobile-headd3 text-dark text-center" style="line-height: 1.3;">Duration - 02 Years <br> Royal
                    ...
                    <div class="container mt-4" style="max-width: 900px;">
                        ...
                        <ul class="nav nav-tabs justify-content-center border-0 shadow-sm" id="infoTabs" role="tablist"
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active border" id="tab1-tab" data-bs-toggle="tab"
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link border" id="tab3-tab" data-bs-toggle="tab" data-bs-target="#tab3"
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link border" id="tab4-tab" data-bs-toggle="tab" data-bs-target="#tab4"
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link border" id="tab5-tab" data-bs-toggle="tab" data-bs-target="#tab5"
                        ...
                        <div style="padding: 20px 0px 0px 0px;">
                            <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent">
                                <div class="tab-pane fade show active" id="tab1" role="tabpanel"
                                    ...
                                    <p class="mobile-headd3 fw-bold text-dark">A.) Registration & Admission Fees (To Be Paid
                                        Once Only)
                                    </p>
                                ...
                                <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                                    ...
                                    <p class="mobile-para1 text-dark">B.Sc./ Bachelor in Dialysis from a recognized
                                        University & with minimum 50% marks in aggregate or equivalent grade (5% relaxation
                                        to SC/ST/OBC – Non-Creamy Layer)
                                    </p>
                                ...
                                <div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tab3-tab">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <a href="assets/img/programme-pdf/brochure for web_compressed-min.pdf"
                                            target="_blank" class="btn mobile-para1"
                                ...
                                <div class="tab-pane fade" id="tab4" role="tabpanel" aria-labelledby="tab4-tab">
                                    ...
                                    <p class="mobile-para1 text-dark">Royal Global University offers several scholarships
                                        to help students pay for their education. <br>
                                        Generally, merit scholarships are reserved for students with special qualifications,
                                        such as academic performance, athletic or artistic talent and other endowment
                                        schemes.
                                    </p>
                                    ...
                                    <p class="mobile-para1 text-dark">
                                        Students seeking Scholarships will have to submit an application as per the category
                                        for which the student seeks scholarship. <br>
                                        For fresh students seeking admission, if interested for applying scholarship can
                                        select the scholarship facility during the online application process. <br>
                                        Existing students can seek help from their departmental coordinators to keep
                                        themselves updated for the scholarship application deadlines and process.
                                    </p>

                                    <p class="mobile-headd3 fw-bold text-dark">For More Details,</p>
                                    <a href="scholarship&funding.html" target="_blank" class="btn mobile-para1"
                                        style="background-color: #27467A; color: white; font-weight: bold; padding: 10px 15px; border-radius: 5px; text-decoration: none; line-height: 1.3; display: flex; align-items: center; justify-content: center; gap: 8px;">
                                        Click Here
                                    </a>
                                ...
                                <div class="tab-pane fade" id="tab5" role="tabpanel" aria-labelledby="tab5-tab">
                                    ...
                                    <p class="mobile-para1 text-dark">Admission to Royal Global University is highly
                                        competitive. You need to meet both admissions & subject requirements before we make
                                        an unconditional offer of admission. At RGU you will learn from outstanding
                                        teachers, access groundbreaking research and state-of-the-art facilities, and make
                                        invaluable contacts and lifelong friends.
                                    </p>
                    ...
                    <div class="container pb-5">
                        <div id="Fee" class="w3-container city card p-5 shadow" style="display:block">
                            <div class="card-body para1">
                                <p class="text-dark pt-2 fw-bold m-0"> A.) Registration & Admission Fees (To Be Paid Once
                                    Only)
                                </p>
                                <p class="text-dark pt-2 m-0">a. Prospectus & Form - 1500.00</p>
                                <p class="text-dark pt-2 m-0">b. Registration(To be paid during the admission for all
                                    courses) -
                                    10000.00</p>
                                <p class="text-dark pt-2 m-0">c. Admission Fee - 60000.00</p>
                                <p class="text-dark pt-2 m-0">d. Caution Money (Common for all streams) - Refundable
                                    10000.00
                                </p>
                        ...
                        <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                            <div class="card-body para1">
                                ...
                                <p class="text-dark pt-2 m-0">B.Sc./ Bachelor in Dialysis from a recognized University &
                        ...
                        <div id="Scholarship" class="w3-container city card p-5 shadow" style="display:none">
                            <div class="card-body para1">
                                ...
                                <p class="text-dark pt-2 m-0">
                                    ...
                                    For fresh students seeking admission, if interested for applying scholarship can select
                                    the
                                ...
                                <p class="pt-2 fw-bold" style="color: #FF9A1E;"><a href="scholarship&funding.html">More
                                        details, click to view...</a></p>
                            </div>
                        </div>
                        <div id="Apply" class="w3-container city card p-5 shadow" style="display:none">
                            <div class="card-body para1">
                                ...
                                <p class="text-dark pt-2 m-0">
                                    Admission to Royal Global University is highly competitive. You need to meet both
                                    admissions
                                    &
                                    subject requirements before we make an unconditional offer of admission. At RGU you will
                                    learn
                                    from outstanding teachers, access groundbreaking research and state-of-the-art
                                    facilities,
                                    and
                                    make invaluable contacts and lifelong friends.</p>

                                <p class="pt-2 fw-bold" style="color: #FF9A1E;"><a href="admission-how-to-apply.html">
                                        more details click to view... </a></p><br>
