...
@section('title', 'Top B Com Course in Assam : The Assam Royal Global University')
@section('meta_description', 'Join the top B Com course in Assam at Royal Global University. Get quality education, expert faculty, and great career opportunities.')
@section('meta_keywords', 'Top B Com Course in Assam')
@section('content')
<div class="mobile">
...
<div style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">
    ...
    <h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">B.Com. (Day Shift)
    </h2>

    <p class="mobile-headd3 text-dark text-center" style="line-height: 1.3;">Duration - 3/4 Yrs as per NEP <br> Royal School of Commerce (RSC)
    </p>
...
<div class="container mt-4" style="max-width: 900px;">
    ...
    <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
        <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
            ...
            <ol class="mobile-para1 text-dark">
                <li>Yearly Payment (Rs. - 143000.00)</li>
                <li>Semester Payment (Rs. - 73000.00)</li>
            </ol>
        ...
        <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
            ...
            <p class="mobile-para1 text-dark">10+2 or equivalent from a recognized Board/Council with minimum 50% marks or equivalent grade (5% relaxation to SC/ST/OBC – Non-Creamy Layer).
            </p>
        ...
        <div class="text-center">
            ...
            <a href="mobile-assets/Domestic/B.Com.pdf" target="_blank" class="btn mobile-para1" style="background-color: #27467A; color: white; font-weight: bold; padding: 10px 15px; border-radius: 5px; text-decoration: none; line-height: 1.3; display: flex; align-items: center; justify-content: center; gap: 8px;">
        ...
        <div class="tab-pane fade" id="tab4" role="tabpanel" aria-labelledby="tab4-tab">
            ...
            <p class="mobile-para1 text-dark">Royal Global University offers several scholarships to help students pay for their education.
            ...
            <p class="mobile-para1 text-dark">
                Students seeking Scholarships will have to submit an application as per the category for which the student seeks scholarship.
                For fresh students seeking admission, if interested for applying scholarship can select the scholarship facility during the online application process.
...
<div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">B.Com. (Day Shift)</h3>
                    <h3 class="text-center headd3 text-dark">Duration - 3/4 Yrs as per NEP<br>
                        <span class="text-center" style="font-size: 22px;">Royal School of Commerce (RSC)</span>
                    </h3>
            </div>
            ...
            <div class="container pb-5">
                <div id="Fee" class="w3-container city card p-5 shadow" style="display:block">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0">B.) Programmes fee to be paid Yearly / semester payment for
                            New
                            Students 2025-26</p>
                        <p class="text-dark pt-2 m-0">Yearly Payment (Rs. - 143000.00)</p>
                        <p class="text-dark pt-2 m-0">Semester Payment (Rs. - 73000.00)</p>
                    </div>
                </div>
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">10+2 or equivalent from a recognized Board/Council with minimum 50% marks or equivalent grade (5% relaxation to SC/ST/OBC – Non-Creamy Layer).
                        </p>
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a href="mobile-assets/Domestic/B.Com.pdf">Brochure
