...
@section('meta_description',
    'Join the top B Com course in Assam at Royal Global University. Get quality education,
    expert faculty, and great career opportunities.')
            ...
            <div class="section-body">
                <div class="tabs-container">
                    ...
                    <div id="fee" class="tab-content active mobile-para1">
                        ...
                        <ol class="text-dark">
                            <li>
                                Yearly Payment (Rs. - 143000.00)
                            </li>
                            <li>
                                Semester Payment (Rs. - 73000.00)
                            </li>
                        </ol>
                        </p>
                    ...
                    <div id="brochure" class="tab-content mobile-para1">
                        ...
                        <div
                            ...
                            <a target="_blank" class="text-danger fw-bold mobile-headd3 pt-2"
                                href="/mobile-assets/Domestic/B.Com.pdf">Download Brochure <i class="fa-solid fa-file-pdf"
