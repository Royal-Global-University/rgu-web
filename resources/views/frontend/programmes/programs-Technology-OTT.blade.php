...
@section('meta_description', 'Start your medical career with Royal Global University’s B.Sc OTTP course. Learn critical skills in pre- and post-operative care, surgical instruments, and sterilization.')
...
<div style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">
            ...
            <h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">B.Sc. - Operation Theatre Technology (OTT)
            </h2>
