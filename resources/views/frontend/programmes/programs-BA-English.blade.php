...
@section('title', 'Start Your Language and Literature Career with B.A English at Royal Global University')
@section('meta_description', 'Begin your journey into literature, communication, and critical thinking with the B.A English program at Royal Global University—designed to shape future writers, educators, and communicators.')
@section('meta_keywords', 'B.A English')
@section('content')
          ...
          <div id="brochure" class="tab-content mobile-para1">
            ...
            <div
              ...
              <a target="_blank" class="text-danger fw-bold mobile-headd3 pt-2"
                href="https://www.rgu.ac/mobile-assets/Domestic/BA-English.pdf">Download
                Brochure
