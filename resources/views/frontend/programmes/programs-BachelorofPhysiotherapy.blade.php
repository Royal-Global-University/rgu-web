...
@section('content')
    <div class="mobile">
        ...
        <div style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">
            ...
            <p class="mobile-headd3 text-dark text-center" style="line-height: 1.3;">Duration - 3.6 Years <br> Royal School of
                ...
                <div style="padding: 20px 0px 0px 0px;">
                    <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent">
                        ...
                        <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                            ...
                            <p class="mobile-para1 text-dark">Candidates must have a diploma in Physiotherapy or a related
                                field, with a minium of 45% aggregate marks.</p>

                            <p class="mobile-headd3 fw-bold text-dark">Selection Process
                            </p>

                            <p class="mobile-para1 text-dark">Personal Interview which will assess candidates personality,
                                communication skills, and suitability for the BPT program.</p>
    ...
    <div class="website">
        ...
        <div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">Bachelor of Physiotherapy (BPT) Lateral Entry</h2>
                <h3 class="text-center headd3 text-dark">Duration - 3.6 Years<br>
            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">Candidates must have a diploma in Physiotherapy or a related field,
                            with a minium of 45% aggregate marks.</p>
                        <p class="text-dark pt-2 fw-bold m-0">Selection Process</p>
                        <p class="text-dark pt-2 m-0">Personal Interview which will assess candidates personality,
                            communication skills, and suitability for the BPT program.</p>
                    </div>
                </div>
