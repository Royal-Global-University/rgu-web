...
@section('title', 'Royal Global University’s B.A. Culinary Course: Where Taste Meets Talent')
@section('meta_description', 'Join Royal Global University’s B.A. Culinary course and turn your love for cooking into a professional career. Learn culinary skills, global cuisines, and kitchen management from industry experts.')
@section('meta_keywords', 'B.A Culinary Arts')
@section('content')
<div class="mobile">
...
<div style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">
            ...
            <h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">BA in Culinary Arts
            </h2>
        ...
        <div class="container mt-4" style="max-width: 900px;">
            ...
            <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
                ...
                <div class="text-center">
                    ...
                    <a href="mobile-assets/Domestic/BA_Culinary_Arts.pdf" target="_blank" class="btn mobile-para1" style="background-color: #27467A; color: white; font-weight: bold; padding: 10px 15px; border-radius: 5px; text-decoration: none; line-height: 1.3; display: flex; align-items: center; justify-content: center; gap: 8px;">
...
<div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">BA in Culinary Arts</h3>
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a
                                href="mobile-assets/Domestic/BA_Culinary_Arts.pdf">Brochure 2025-26<i
