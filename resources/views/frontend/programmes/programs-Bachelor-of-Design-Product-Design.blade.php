...
@section('title', 'Join Royal Global University’s Bachelor of Designs in Product Design – Excellence in Design
    Education')
@section('meta_description', 'Royal Global University offers an outstanding Bachelor of Designs in Product Design course
    focused on innovation and creativity. Shape your career with expert mentorship and modern facilities.')
          ...
          <div id="brochure" class="tab-content mobile-para1">
            ...
            <div
              ...
              <a target="_blank" class="text-danger fw-bold mobile-headd3 pt-2"
                href="https://www.rgu.ac/mobile-assets/Domestic/Bachelor_Design(Product_Design).pdf">Download Brochure
