            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">10+2 or equivalent from a recognized Board/ Council with minimum 50% marks
                            or equivalent grade (5% relaxation to SC/ST/OBC – Non-Creamy Layer).
                        </p>
                        <p class="text-dark pt-2 fw-bold m-0">Selection Process</p>
                        <p class="text-dark pt-2 m-0">An entrance test conducted by Royal Global University followed by Personal
                            Interview. Candidates with a valid score of CLAT (Common Law Admission Test) will be exempted from
                            appearing in the entrance test conducted by Royal Global University</p>
                    </div>
                </div>
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a href="assets/programme-pdf/LLMDayShift.pdf">Brochure
