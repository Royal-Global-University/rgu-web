...
@section('meta_description', 'Advance your career with an M.Sc in Chemistry at Royal Global University—featuring expert
    faculty, modern labs, and a strong research focus.')
        ...
        <div class="tabs-container">
          ...
          <div id="eligibility" class="tab-content mobile-para1">
            ...
            <p class="text-dark">
              ...
              B.Sc.(H) from any recognized University/Institution in relevant field Or B.Sc. with minimum 45% marks in
          ...
          <div id="brochure" class="tab-content mobile-para1">
            ...
            <div
              ...
              <a target="_blank" class="text-danger fw-bold mobile-headd3 pt-2"
                href="https://www.rgu.ac/mobile-assets/Domestic/chemistry.pdf">Download Brochure <i
          ...
          <div id="scholarship" class="tab-content mobile-para1">
            ...
            <ol class="text-dark">
              <li>
                Royal Global University offers several scholarships to help students pay for their education. Generally, merit scholarships are reserved for students with special qualifications, such as academic performance, athletic or artistic talent and other endowment schemes.
              </li>
