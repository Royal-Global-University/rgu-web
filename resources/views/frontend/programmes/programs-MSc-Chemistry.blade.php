                ...
                <div class="tabs-container">
                    ...
                    <div id="eligibility" class="tab-content mobile-para1">
                        ...
                        <p class="text-dark">
                            ...
                            B.Sc.(H) from any recognized University/Institution in relevant field Or B.Sc. with minimum 45%
                            marks in
                    ...
                    <div id="scholarship" class="tab-content mobile-para1">
                        ...
                        <ol class="text-dark">
                            <li>
                                ...
                                education. Generally, merit scholarships are reserved for students with special
                                qualifications, such as academic performance, athletic or artistic talent and other
                                endowment schemes.
                            </li>
                        ...
                        <ol class="text-dark">
                            <li>
                                ...
                                which the student seeks scholarship.
                            </li>
                            <li>
