...
@section('title', 'Best B.Sc Zoology Course in Assam at Royal Global University')
@section('meta_description', 'Explore the best B.Sc Zoology course in Assam at Royal Global University, focusing on wildlife, ecology, and environmental studies for a bright career.')
@section('meta_keywords', 'B.Sc Zoology')
@section('content')
<div class="mobile">
...
<h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">B.Sc. Zoology
</h2>
...
<div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
    ...
    <div class="text-center">
        ...
        <a href="mobile-assets/Domestic/B.Sc.Zoology.pdf" target="_blank" class="btn mobile-para1" style="background-color: #27467A; color: white; font-weight: bold; padding: 10px 15px; border-radius: 5px; text-decoration: none; line-height: 1.3; display: flex; align-items: center; justify-content: center; gap: 8px;">
...
<div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">B.Sc. Zoology</h2>
            ...
            <div class="container pb-5">
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a href="mobile-assets/Domestic/B.Sc.Zoology.pdf">Brochure
