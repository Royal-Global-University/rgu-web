...
@section('title', 'M.Sc Food Technology at The Assam Royal Global University | Advance Your Career in Food Science')
@section('meta_description', 'Enroll in M.Sc Food Technology at Royal Global University—learn innovative food
    processing, quality control, and research from industry experts.')
@section('meta_keywords', 'M.Sc Food Technology')
@section('content')
    <div class="mobile">
        ...
        <div style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">
            ...
            <p class="mobile-headd3 text-dark text-center" style="line-height: 1.3;">Duration - 02 Years <br> Royal School of
                ...
                <div style="padding: 20px 0px 0px 0px;">
                    <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent">
                        ...
                        <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                            ...
                            <p class="mobile-para1 text-dark">B.Sc. Food Technology / B.Sc. Biotechnology / B.Sc.
                                Agriculture Science / B.Sc. Horticulture / B.Sc. Fisheries / B.Sc. Food Science, Nutrition &
                                Dietetics / B.Sc. Home Science / B.Sc. Botany, Zoology, Chemistry / B.Sc. Microbiology /
                                B.Sc. Dairy Technology / B.Tech. Food Technology / B.Tech. Biotechnology / B.Tech.
                                Agricultural Engineering / B.Tech. Dairy Technology with minimum 45% marks in aggregate or
                                equivalent grade from any recognized University/Institution ( 5% relaxation to SC/ST/OBC –
                                Non-Creamy Layer).</p>
                        ...
                        <div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tab3-tab">
                            ...
                            <div class="text-center">
                                ...
                                <a href="mobile-assets/Domestic/M.Sc.FoodTechnology.pdf" target="_blank"
    ...
    <div class="website">
        ...
        <div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">M.Sc. Food Technology</h3>
                    <h3 class="text-center headd3 text-dark">Duration - 02 Years<br>
                        <span class="text-center" style="font-size: 22px;">Royal School of Applied &amp; Pure Sciences
                            (RSAPS)</span>
                    </h3>
            </div>
            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">B.Sc. Food Technology / B.Sc. Biotechnology / B.Sc. Agriculture
                            Science / B.Sc. Horticulture / B.Sc. Fisheries / B.Sc. Food Science, Nutrition & Dietetics /
                            B.Sc. Home Science / B.Sc. Botany, Zoology, Chemistry / B.Sc. Microbiology / B.Sc. Dairy
                            Technology / B.Tech. Food Technology / B.Tech. Biotechnology / B.Tech. Agricultural Engineering
                            / B.Tech. Dairy Technology with minimum 45% marks in aggregate or equivalent grade from any
                            recognized University/Institution ( 5% relaxation to SC/ST/OBC – Non-Creamy Layer).</p>
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a
                                href="mobile-assets/Domestic/M.Sc.FoodTechnology.pdf">Brochure 2026-27<i
