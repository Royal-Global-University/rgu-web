...
@section('meta_description', 'Enroll in M.Sc Food Technology at Royal Global University—learn innovative food processing, quality control, and research from industry experts.')
...
<div style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">
            ...
            <h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">M.Sc. Food Technology
            </h2>

            <p class="mobile-headd3 text-dark text-center" style="line-height: 1.3;">Duration - 02 Years <br> Royal School of Applied &amp; Pure Sciences
                (RSAPS)
            </p>
        ...
        <div class="container mt-4" style="max-width: 900px;">
            ...
            <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
                ...
                <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                    ...
                    <p class="mobile-para1 text-dark">B.Sc. Food Technology / B.Sc. Biotechnology / B.Sc. Agriculture Science / B.Sc. Horticulture / B.Sc. Fisheries / B.Sc. Food Science, Nutrition & Dietetics / B.Sc. Home Science / B.Sc. Botany, Zoology, Chemistry / B.Sc. Microbiology / B.Sc. Dairy Technology / B.Tech. Food Technology / B.Tech. Biotechnology / B.Tech. Agricultural Engineering / B.Tech. Dairy Technology  with minimum 50% marks in aggregate or equivalent grade from any recognized University/Institution ( 5% relaxation to SC/ST/OBC – Non-Creamy Layer).</p>
                ...
                <div class="text-center">
                    ...
                    <a href="mobile-assets/Domestic/M.Sc.FoodTechnology.pdf" target="_blank" class="btn mobile-para1" style="background-color: #27467A; color: white; font-weight: bold; padding: 10px 15px; border-radius: 5px; text-decoration: none; line-height: 1.3; display: flex; align-items: center; justify-content: center; gap: 8px;">
            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">B.Sc. Food Technology / B.Sc. Biotechnology / B.Sc. Agriculture Science / B.Sc. Horticulture / B.Sc. Fisheries / B.Sc. Food Science, Nutrition & Dietetics / B.Sc. Home Science / B.Sc. Botany, Zoology, Chemistry / B.Sc. Microbiology / B.Sc. Dairy Technology / B.Tech. Food Technology / B.Tech. Biotechnology / B.Tech. Agricultural Engineering / B.Tech. Dairy Technology  with minimum 50% marks in aggregate or equivalent grade from any recognized University/Institution ( 5% relaxation to SC/ST/OBC – Non-Creamy Layer).</p>
