...
@section('title', 'Pursue BA LLB at Royal Global University and Shape Your Legal Career')
@section('meta_description', 'Discover your potential in law with the BA LLB program at Royal Global University—where tradition meets innovation in legal education.')
@section('meta_keywords', 'BA LLB')
@section('content')
<div class="mobile">
...
<h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">LLB (H)
</h2>

<p class="mobile-headd3 text-dark text-center" style="line-height: 1.3;">Duration - 03 Years <br> Royal School of Law &amp; Administration
    (RSLA)
</p>
...
<div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
    ...
    <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
        ...
        <p class="mobile-para1 text-dark">Bachelor’s Degree in any discipline from any recognized University/Institution with minimum 45% marks or equivalent grade for General category, 42% marks or equivalent grade for OBC category & 40% marks or equivalent grade for SC & ST category.</p>
...
<div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">LLB (H)</h3>
            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">Bachelor’s Degree in any discipline from any recognized University/Institution with minimum 45% marks or equivalent grade for General category, 42% marks or equivalent grade for OBC category & 40% marks or equivalent grade for SC & ST category.</p>
