...
@section('title', content: 'Pursue B.Sc Mathematics at Royal Global University | Best Math Degree in Assam')
@section('meta_description', 'Pursue B.Sc Mathematics at Royal Global University—build strong analytical skills with expert guidance and a future-focused curriculum.')
@section('meta_keywords', 'B.SC Mathematics')
@section('content')
<div class="mobile">
...
<div style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">
            ...
            <h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">B.Sc. - Mathematics
            </h2>

            <p class="mobile-headd3 text-dark text-center" style="line-height: 1.3;">Duration - 3/4 Yrs as per NEP <br> Royal School of Applied &amp; Pure Sciences
                (RSAPS)
            </p>
        ...
        <div class="container mt-4" style="max-width: 900px;">
            ...
            <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
                ...
                <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                    ...
                    <p class="mobile-para1 text-dark">10+2 in science stream or equivalent from a recognized Board/ Council with minimum 50% marks or equivalent grade and minimum 50% in subject opted (5% relaxation to SC/ST/OBC - Non-Creamy Layer)</p>
                ...
                <div class="text-center">
                    ...
                    <a href="mobile-assets/Domestic/B.Sc-Mathematics.pdf" target="_blank" class="btn mobile-para1" style="background-color: #27467A; color: white; font-weight: bold; padding: 10px 15px; border-radius: 5px; text-decoration: none; line-height: 1.3; display: flex; align-items: center; justify-content: center; gap: 8px;">
            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">10+2 in science stream or equivalent from a recognized Board/ Council with minimum 50% marks or equivalent grade and minimum 50% in subject opted (5% relaxation to SC/ST/OBC - Non-Creamy Layer)</p>
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a
                                href="mobile-assets/Domestic/B.Sc-Mathematics.pdf">Brochure 2025-26<i
