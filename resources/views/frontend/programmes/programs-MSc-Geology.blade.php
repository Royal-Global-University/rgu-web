...
@section('meta_description', 'Explore the top-rated M.Sc Geology course at Royal Global University. Learn from expert
    faculty, engage in field research, and build a strong foundation for careers in geology and earth exploration.')
      ...
      <div class="section-body">
        <div class="tabs-container">
          ...
          <div id="eligibility" class="tab-content mobile-para1">
            ...
            <p class="text-dark">
              Bachelor's Degree with Geology Honours or a bachelor’s degree with Geology as a subject from any
              recognized University/Institution with minimum 45% marks or equivalent grade (5% relaxation to SC/ST/OBC –
              Non-Creamy Layer).
            </p>
          ...
          <div id="brochure" class="tab-content mobile-para1">
            ...
            <div
              ...
              <a target="_blank" class="text-danger fw-bold mobile-headd3 pt-2"
                href="https://www.rgu.ac/mobile-assets/Domestic/M.Sc_Geology.pdf">Download
                Brochure
