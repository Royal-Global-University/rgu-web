      ...
      <div class="section-body">
        <div class="tabs-container">
          ...
          <div id="eligibility" class="tab-content mobile-para1">
            ...
            <p class="text-dark">
              B.Tech./BE (CS/IT) or BCA or B.Sc. (IT), from any recognized University/Institution with minimum 45% marks
              in aggregate (5% relaxation to SC/ST/OBC – Non-Creamy Layer).
            </p>
            ...
            <p class="text-dark">
              3-Year Bachelor’s Degree from any recognized University/Institution in any field with Mathematics as
              mandatory subject either in 10+2 or at
              Graduation Level and minimum 45% marks or equivalent grade (5% relaxation to SC/ST/OBC – Non-Creamy Layer)
            </p>
            ...
            <p class="text-dark">
              Candidates must obtain a valid score in JMEE or RJMEE followed by Personal Interview.
            </p>
          ...
          <div id="brochure" class="tab-content mobile-para1">
            ...
            <div
              ...
              <a target="_blank" class="text-danger fw-bold mobile-headd3 pt-2"
                href="https://www.rgu.ac/mobile-assets/Domestic/MCA.pdf">Download
                Brochure
