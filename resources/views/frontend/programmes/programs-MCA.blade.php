            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">B.Tech./BE (CS/IT) or BCA or B.Sc. (IT), from any recognized
                            University/Institution with minimum 50% marks in aggregate (5% relaxation to SC/ST/OBC –
                            Non-Creamy Layer). Or<br>
                            3-Year Bachelor’s Degree from any recognized University/Institution in any field with
                            Mathematics as mandatory subject either in 10+2 or at Graduation Level and minimum 50% marks
                            or equivalent grade (5% relaxation to SC/ST/OBC – Non-Creamy Layer)</p>
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a href="assets/programme-pdf/MCA.pdf">Brochure 2024-25<i
