...
@section('title', 'Study B.Sc Forensic Science at Royal Global University – Best Science Program in Assam')
@section('meta_description', 'Royal Global University offers a top B.Sc Forensic Science course in Assam with practical training, expert faculty, and career-focused curriculum.')
@section('meta_keywords', 'B.Sc Forensic Science')
@section('content')
      ...
      <div class="section-body">
        <div class="tabs-container">
          ...
          <div id="eligibility" class="tab-content mobile-para1">
            ...
            <p class="text-dark">
              10+2 in science stream or equivalent from a recognized Board/ Council with Physics, Chemistry, Mathematics/Biology
              as compulsory subjects and with minimum 45% marks in aggregate (5% relaxation to SC/ST/OBC - Non-Creamy Layer)
            </p>
          ...
          <div id="brochure" class="tab-content mobile-para1">
            ...
            <div
              ...
              <a target="_blank" class="text-danger fw-bold mobile-headd3 pt-2"
                href="https://www.rgu.ac/mobile-assets/Domestic/B.ScForensic_Science.pdf">Download
                Brochure
