...
@section('meta_description', 'Royal Global University offers a top B.Sc Forensic Science course in Assam with practical
    training, expert faculty, and career-focused curriculum.')
            ...
            <div class="section-body">
                <div class="tabs-container">
                    ...
                    <div id="eligibility" class="tab-content mobile-para1">
                        ...
                        <p class="text-dark">
                            10+2 in science stream or equivalent from a recognized Board/ Council with Physics, Chemistry,
                            Mathematics/Biology
                            as compulsory subjects and with minimum 45% marks in aggregate (5% relaxation to SC/ST/OBC -
                            Non-Creamy Layer)
                        </p>
