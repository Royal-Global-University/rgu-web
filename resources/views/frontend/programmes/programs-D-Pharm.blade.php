...
@section('title', 'Top D.Pharm Diploma Course in Assam | Enroll at Royal Global University')
@section('meta_description', 'Start your pharmacy career with Royal Global University’s D.Pharm course, offering expert faculty guidance and practical training for immediate job readiness.')
@section('meta_keywords', 'D Pharm')
@section('content')
      ...
      <div class="section-body">
        <div class="tabs-container">
          ...
          <div id="fee" class="tab-content active mobile-para1">
            ...
            <ol class="text-dark">
              <li>
                Yearly Payment (Rs. - 150000.00)
              </li>
              <li>
                Semester Payment (Rs. - 76500.00)
              </li>
            </ol>
            </p>
          ...
          <div id="eligibility" class="tab-content mobile-para1">
            ...
            <p class="text-dark">
              ...
              /Biology as compulsory subjects with minimum 50%
              marks or equivalent grade and minimum 50% in
              subject opted (5% relaxation to SC/ST/OBC - NonCreamy Layer)
