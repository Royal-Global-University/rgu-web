...
@section('meta_description', 'Advance your career in technology with Royal Global University’s M.Sc IT program, designed
    to enhance your skills and knowledge for the rapidly evolving digital landscape.')
            ...
            <div class="section-body">
                <div class="tabs-container">
                    ...
                    <div id="eligibility" class="tab-content mobile-para1">
                        ...
                        <p class="text-dark">
                            B.Tech./BE (CS/IT) or BCA or B.Sc. (IT), from any recognized University/Institution with minimum
                            45% marks
                        ...
                        <p class="text-dark">
                            ...
                            recognized University/Institution in any field with Mathematics as a mandatory subject either in
                            10+2 or
                            Graduation Level and minimum 45% marks or equivalent grade (5% relaxation to SC/ST/OBC –
                            Non-Creamy
                            Layer).
                        </p>
