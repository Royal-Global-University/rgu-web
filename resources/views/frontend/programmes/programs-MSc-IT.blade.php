...
@section('title', 'M.Sc IT at Royal Global University: Elevate Your Skills for the Digital Era')
@section('meta_description', 'Advance your career in technology with Royal Global University’s M.Sc IT program, designed to enhance your skills and knowledge for the rapidly evolving digital landscape.')
@section('meta_keywords', 'M.Sc IT')
@section('content')
<div class="mobile">
...
<div style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">
            ...
            <h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">M.Sc. (IT)
            </h2>
            ...
            <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
                ...
                <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                    ...
                    <p class="mobile-para1 text-dark">
                        B.Tech./BE (CS/IT) or BCA or B.Sc. (IT), from any recognized University/Institution with minimum 50% marks in aggregate (5% relaxation to SC/ST/OBC – Non-Creamy Layer).
                        Or
                        3-Year Bachelor’s Degree from any recognized University/Institution in any field with Mathematics as a mandatory subject either in 10+2 or Graduation Level and minimum 50% marks or equivalent grade (5% relaxation to SC/ST/OBC – Non-Creamy Layer).
                ...
                <div class="text-center">
                    ...
                    <a href="mobile-assets/Domestic/M.Sc.(IT).pdf" target="_blank" class="btn mobile-para1" style="background-color: #27467A; color: white; font-weight: bold; padding: 10px 15px; border-radius: 5px; text-decoration: none; line-height: 1.3; display: flex; align-items: center; justify-content: center; gap: 8px;">
...
<div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">M.Sc. (IT)</h3>
            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">B.Tech./BE (CS/IT) or BCA or B.Sc. (IT), from any recognized University/Institution with minimum 50% marks in aggregate (5% relaxation to SC/ST/OBC – Non-Creamy Layer).
                            Or
                            3-Year Bachelor’s Degree from any recognized University/Institution in any field with Mathematics as a mandatory subject either in 10+2 or Graduation Level and minimum 50% marks or equivalent grade (5% relaxation to SC/ST/OBC – Non-Creamy Layer).
                            </p>
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a href="mobile-assets/Domestic/M.Sc.(IT).pdf">Brochure
