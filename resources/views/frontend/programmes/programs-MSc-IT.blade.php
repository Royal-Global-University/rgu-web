            ...
            <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
                ...
                <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                    ...
                    <p class="mobile-para1 text-dark">
                        B.Tech./BE (CS/IT) or BCA or B.Sc. (IT), from any recognized University/Institution with minimum 45% marks in aggregate (5% relaxation to SC/ST/OBC – Non-Creamy Layer).
                        Or
                        3-Year Bachelor’s Degree from any recognized University/Institution in any field with Mathematics as a mandatory subject either in 10+2 or Graduation Level and minimum 45% marks or equivalent grade (5% relaxation to SC/ST/OBC – Non-Creamy Layer).
