            ...
            <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
                ...
                <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                    ...
                    <p class="mobile-para1 text-dark">10+2 in any stream with one year Diploma in Interior design/equivalent qualification recognized by Central/State Government.
                        OR
                        3 years diploma in Architecture/Interior Design recognized by Central/State Government with minimum 45% marks or equivalent grade (5% relaxation to SC/ST/OBC-Non- Creamy Layer.)
                    </p>
