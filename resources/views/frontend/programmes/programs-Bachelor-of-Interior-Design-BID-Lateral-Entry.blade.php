...
@section('meta_description', 'Discover Royal Global University’s Interior Design course and unlock your creative
    potential. Gain hands-on experience and build a successful career in interior design and decoration.')
      ...
      <div class="section-body">
        <div class="tabs-container">
          ...
          <div id="eligibility" class="tab-content mobile-para1">
            ...
            <p class="text-dark">
              10+2 in any stream with one year Diploma in Interior design/equivalent qualification recognized by
            ...
            <p class="text-dark">
             3 years diploma in Architecture/Interior Design recognized by Central/State
            Government with minimum 45% marks or equivalent grade (5% relaxation to SC/ST/OBC-Non- Creamy Layer).
            </p>
          ...
          <div id="brochure" class="tab-content mobile-para1">
            ...
            <div
              ...
              <a target="_blank" class="text-danger fw-bold mobile-headd3 pt-2"
                href="https://www.rgu.ac/mobile-assets/Domestic/Bachelor_Interior_Design_(BID)_Lateral_Entry.pdf">Download
                Brochure
