            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">10+2 in Arts or equivalent from a recognized board/council with
                            minimum 45% marks or equivalent grade (5% relaxation to SC/ST/OBC-Non-Creamy Layer).</p>
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a href="assets/programme-pdf/B.Sc.-BA_Geography.pdf">Brochure
                ...
                <div id="Apply" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="pt-2 fw-bold" style="color: #FF9A1E;"><a href="admission-how-to-apply"> more details
