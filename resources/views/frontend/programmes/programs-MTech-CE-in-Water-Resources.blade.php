...
@section('meta_description', 'Master water management strategies with Royal Global University M.Tech CE program. Ideal for engineers aiming to lead in sustainable development and smart water infrastructure.')
...
<div style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">
            ...
            <h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">M.Tech. CE in Water Resources Development & Management
            </h2>
        ...
        <div class="container mt-4" style="max-width: 900px;">
            ...
            <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
                ...
                <div class="text-center">
                    ...
                    <a href="mobile-assets/Domestic/M.TechCE_Water_Resources.pdf" target="_blank" class="btn mobile-para1" style="background-color: #27467A; color: white; font-weight: bold; padding: 10px 15px; border-radius: 5px; text-decoration: none; line-height: 1.3; display: flex; align-items: center; justify-content: center; gap: 8px;">
