...
@section('title', 'Best M.Tech Civil Engineering Program in Water Management at Royal Global University')
@section('meta_description', 'Master water management strategies with Royal Global University M.Tech CE program. Ideal
    for engineers aiming to lead in sustainable development and smart water infrastructure.')
...
@section('content')
                    ...
                    <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent">
                        ...
                        <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                            ...
                            <p class="mobile-para1 text-dark">B.E./B.Tech. /AMIE or its equivalent in relevant field, from
                                any recognized University/Institution, with minimum 45% marks or equivalent grade (5%
                        ...
                        <div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tab3-tab">
                            ...
                            <div class="text-center">
                                ...
                                <a href="mobile-assets/Domestic/M.TechCE_Water_Resources.pdf" target="_blank"
    ...
    <div class="website">
        ...
        <div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">M.Tech. CE in Water Resources Development & Management</h3>
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a
                                href="mobile-assets/Domestic/M.TechCE_Water_Resources.pdf">Brochure 2026-27<i
