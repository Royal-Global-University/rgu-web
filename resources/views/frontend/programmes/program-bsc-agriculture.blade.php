...
@section('content')
                ...
                <div style="padding: 20px 0px 0px 0px;">
                    <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent">
                        <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
                            ...
                            <ol class="mobile-para1 text-dark">
                                <li>Yearly Payment (Rs. - 1,40,000.00)</li>
                                <li>Semester Payment (Rs. - 71,500.00)</li>
                            </ol>
                        ...
                        <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                            ...
                            <p class="mobile-para1 text-dark">Physics, Chemistry and Biology/ Physics Chemistry, Agriculture
                                with 50% marks in aggregate in 10+2/ Higher Secondary/
    ...
    <div class="website">
        ...
        <div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">B.Sc. Agriculture</h3>
                    <h3 class="text-center headd3 text-dark">Duration - 04 Years<br>
                        <span class="text-center" style="font-size: 22px;">ROYAL SCHOOL OF AGRICULTURE (RSAG)</span>
                    </h3>
            </div>
            ...
            <div class="container pb-5">
                <div id="Fee" class="w3-container city card p-5 shadow" style="display:block">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0">B.) Programmes fee to be paid Yearly / semester payment for
                            New
                            Students 2026-27</p>
                        <p class="text-dark pt-2 m-0">Yearly Payment (Rs. - 1,40,000.00)</p>
                        <p class="text-dark pt-2 m-0">Semester Payment (Rs. - 71,500.00)</p>
                    </div>
                </div>
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">Physics, Chemistry and Biology/ Physics Chemistry, Agriculture with
                            50% marks in aggregate in 10+2/ Higher Secondary/
                            Intermediate examination</p>
