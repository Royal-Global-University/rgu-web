        ...
        <div class="tabs-container">
          ...
          <div id="eligibility" class="tab-content mobile-para1">
            ...
            <p class="text-dark">
              ...
              Bachelor`s Degree in any branch of Biology (B.Sc. in Botany/Zoology/Biotechnology/Food
              Science/Nutrition/Agriculture Sciences etc.), Medical Sciences (MBBS/B.Pharm), Veterinary Sciences
              (B.V.Sc.)/Bio-Tech/Biomedical Eng. (B.E/B.Tech.) or Ayurveda (BAMS) from any recognized
              University/Institution with minimum 45% marks or equivalent grade (5% relaxation to SC/ST/OBC – Non-Creamy
              Layer)
