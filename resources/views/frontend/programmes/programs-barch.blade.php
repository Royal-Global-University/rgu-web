...
@section('meta_description',
    'Join the B.Arch program at Royal Global University and build a future in architecture with
                ...
                <div class="tabs-container">
                    ...
                    <div id="eligibility" class="tab-content mobile-para1">
                        ...
                        <p class="text-dark">
                            ...
                            10+2 or equivalent from a recognized Board/Council with minimum 45% marks or equivalent grade in
                            aggregate
                            (5% relaxation to SC/ST/OBC – Non-Creamy Layer) with Physics and Mathematics as compulsory
                            subjects along
                            with either Chemistry or Biology or Technical Vocational subject or Computer Science or
                            Information
                        ...
                        <p class="text-dark">
                            ...
                            10+3 - Years Diploma, recognized by Central/State Government with minimum 45% marks or
                            equivalent grade in
                            aggregate (5% relaxation to SC/ST/OBC – Non-Creamy Layer) along with Mathematics as compulsory
                            subjects.
                    ...
                    <div id="brochure" class="tab-content mobile-para1">
                        ...
                        <div
                            ...
                            <a target="_blank" class="text-danger fw-bold mobile-headd3 pt-2"
                                href="/mobile-assets/Domestic/B.Arch..pdf">Download Brochure <i class="fa-solid fa-file-pdf"
                                    style="color: #e66363;"></i> </a>
                        </div>
