...
@section('meta_description', 'Join the B.Arch program at Royal Global University and build a future in architecture with
      ...
      <div class="section-body">
        <div class="tabs-container">
          ...
          <div id="fee" class="tab-content active mobile-para1">
            ...
            <ol class="text-dark">
              <li>
                Yearly Payment (Rs. - 170000.00)
              </li>
              <li>
                Semester Payment (Rs. - 86500.00)
              </li>
            </ol>
            </p>
          ...
          <div id="eligibility" class="tab-content mobile-para1">
            ...
            <p class="text-dark">
              ...
              10+2 or equivalent from a recognized Board/Council with minimum 45% marks or equivalent grade in aggregate
              (5% relaxation to SC/ST/OBC – Non-Creamy Layer) with Physics and Mathematics as compulsory subjects along
              with either Chemistry or Biology or Technical Vocational subject or Computer Science or Information
              Technology or Informatics Practices or Engineering Graphics or Business Studies
            ...
            <p class="text-dark">
             ...
             Candidates must obtain a valid score in NATA (National Aptitude Test in Architecture) or JEE Main Paper 2
             (Subject to clearance by COA) followed by Personal Interview.
          ...
          <div id="brochure" class="tab-content mobile-para1">
            ...
            <div
              ...
              <a target="_blank" class="text-danger fw-bold mobile-headd3 pt-2" href="https://www.rgu.ac/mobile-assets/Domestic/B.Arch..pdf">Download Brochure <i
          ...
          <div id="apply" class="tab-content mobile-para1">
            ...
            <div style="padding: 15px 40px; border: 1px solid #e68a1a; border-radius: 10px; background-color: #FFF8F0; margin-top: 20px;">
