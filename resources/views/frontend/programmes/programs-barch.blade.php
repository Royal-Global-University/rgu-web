...
@section('title', 'B Arch Course at The Assam Royal Global University')
@section('meta_description', 'Join the B.Arch program at Royal Global University and build a future in architecture with expert guidance and cutting-edge facilities.')
@section('meta_keywords', 'b arch course')
@section('content')
    <div class="mobile">
    @include('frontend/components/mobileheader')
    <div style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">
    <h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">B.Arch.
    </h2>

    <p class="mobile-headd3 text-dark text-center" style="line-height: 1.3;">Duration - 05 Years <br> Royal School of Architecture (RSA)
    </p>
    ...
    <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
        <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
            ...
            <ol class="mobile-para1 text-dark">
                <li>Yearly Payment (Rs. - 170000.00)</li>
                <li>Semester Payment (Rs. - 86500.00)</li>
            </ol>
        ...
        <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
            ...
            <p class="mobile-para1 text-dark">10+2 or equivalent from a recognized Board/Council with minimum 45% marks or equivalent grade in aggregate (5% relaxation to SC/ST/OBC – Non-Creamy Layer) with Physics and Mathematics as compulsory subjects along with either Chemistry or Biology or Technical Vocational subject or Computer Science or Information Technology or Informatics Practices or Engineering Graphics or Business Studies
                <br><span class="fw-bold">OR</span> <br>
                 10+3-Years Diploma, recognized by Central/State Government with minimum 45% marks or equivalent grade in aggregate (5% relaxation to SC/ST/OBC – Non-Creamy Layer) along with Mathematics as compulsory subjects.
               </p>

            <p class="mobile-headd3 fw-bold text-dark">Selection Process
            </p>

            <p class="mobile-para1 text-dark">Candidates must obtain a valid score in NATA (National Aptitude Test in Architecture) or JEE (Mains) Paper II (Subject to clearance by COA) followed by Personal Interview.
            </p>
        ...
        <div class="text-center">
            ...
            <a href="mobile-assets/Domestic/B.Arch..pdf" target="_blank" class="btn mobile-para1" style="background-color: #27467A; color: white; font-weight: bold; padding: 10px 15px; border-radius: 5px; text-decoration: none; line-height: 1.3; display: flex; align-items: center; justify-content: center; gap: 8px;">
    ...
    <div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
                <div class="text-center">
                    <h2 class="text-center headd2 text-dark">B.Arch.</h2>
                    <h3 class="text-center headd3 text-dark">Duration - 05 Years<br>
                        <span class="text-center">Royal School of Architecture (RSA)</span>
                    </h3>
                </div>
                ...
                <div class="container pb-5">
                    <div id="Fee" class="w3-container city card p-5 shadow" style="display:block">
                        <div class="card-body para1">
                            ...
                            <p class="text-dark pt-2 fw-bold m-0">B.) Programmes fee to be paid Yearly / semester payment for
                                New
                                Students 2025-26</p>
                            <p class="text-dark pt-2 m-0">Yearly Payment (Rs. - 170000.00)</p>
                            <p class="text-dark pt-2 m-0">Semester Payment (Rs. - 86500.00)</p>
                        </div>
                    </div>
                    <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                        <div class="card-body para1">
                            ...
                            <p class="text-dark pt-2 m-0">
                                10+2 or equivalent from a recognized Board/Council with minimum 45% marks or equivalent grade in aggregate (5% relaxation to SC/ST/OBC – Non-Creamy Layer) with Physics and Mathematics as compulsory subjects along with either Chemistry or Biology or Technical Vocational subject or Computer Science or Information Technology or Informatics Practices or Engineering Graphics or Business Studies
                             <br><span class="fw-bold">OR</span><br>
                              10+3-Years Diploma, recognized by Central/State Government with minimum 45% marks or equivalent grade in aggregate (5% relaxation to SC/ST/OBC – Non-Creamy Layer) along with Mathematics as compulsory subjects.
                            </p>
                            <p class="text-dark pt-2 fw-bold m-0">Selection Process</p>
                            <p class="text-dark pt-2 m-0">
                                Candidates must obtain a valid score in NATA (National Aptitude Test in Architecture) or JEE (Mains) Paper II (Subject to clearance by COA) followed by Personal Interview.
                            </p>
                        </div>
                    </div>
                    <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                        <div class="card-body text-center">
                            ...
                            <p class="text-dark pt-2 fw-bold m-0"><a href="mobile-assets/Domestic/B.Arch..pdf">Brochure
