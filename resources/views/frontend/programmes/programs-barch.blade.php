        ...
        <div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                ...
                <h3 class="text-center headd3 text-dark">Duration - 05 Years<br>
                    <span class="text-center">Royal School of Applied &amp; Pure Sciences
                        (RSA)</span>
                </h3>
            </div>
            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">10+2 or equivalent from a recognized Board/Council with minimum
                            50% marks or equivalent grade in aggregate (5% relaxation to SC/ST/OBC – Non-Creamy Layer)
                            with Physics and Mathematics as compulsory subjects along with either Chemistry or Biology
                            or Technical Vocational subject or Computer Science or Information Technology or Informatics
                            Practices or Engineering Graphics or Business Studies<br>
                            or<br>
                            10+3-Years Diploma, recognized by Central/State Government with minimum 50% marks or
                            equivalent grade in aggregate (5% relaxation to SC/ST/OBC – Non-Creamy Layer) along with
                            Mathematics as compulsory subjects. Candidates must obtain a valid score in NATA (National
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a href="assets/programme-pdf/B.Arch..pdf">Brochure
