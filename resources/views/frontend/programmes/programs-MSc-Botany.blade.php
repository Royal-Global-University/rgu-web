      ...
      <div class="section-body">
        <div class="tabs-container">
          ...
          <div id="eligibility" class="tab-content mobile-para1">
           ...
           <p class="text-dark">
              B.Sc.(H) from any recognized University/ Institution in relevant field
            </p>
            ...
            <p class="text-dark">
               B.Sc. with minimum 45% marks in
              aggregate and minimum 45% in subject opted, from any recognized University/Institution or equivalent grade
          ...
          <div id="brochure" class="tab-content mobile-para1">
            ...
            <div
              ...
              <a target="_blank" class="text-danger fw-bold mobile-headd3 pt-2"
                href="https://www.rgu.ac/mobile-assets/Domestic/M.Sc.Botany.pdf">Download
                Brochure
