...
@section('meta_description', 'Pursue a Bachelor’s in Medical Laboratory Technology (BMLT) at Royal Global University, Assam. Get hands-on training, expert faculty, and industry-ready skills for a successful healthcare career.')
...
<h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">B.Sc. - Medical Laboratory Technology (BMLT)
</h2>

<p class="mobile-headd3 text-dark text-center" style="line-height: 1.3;">Duration - 3 Yrs+1 Yr Internship <br> Royal School of Medical & Allied Sciences (RSMAS)
</p>
