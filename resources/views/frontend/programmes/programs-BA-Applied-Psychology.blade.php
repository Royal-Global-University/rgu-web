...
@section('title', 'BA Applied Psychology at The Assam Royal Global University')
@section('meta_description', 'Join the BA Applied Psychology program at Royal Global University—gain practical insights into human behavior with hands-on learning and expert mentorship.')
@section('meta_keywords', 'BA Applied Physcology')
@section('content')
<div class="mobile">
@include('frontend/components/mobileheader')
<div style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">

<h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">BA - Applied Psychology
</h2>

<p class="mobile-headd3 text-dark text-center" style="line-height: 1.3;">Duration - 3/4 Yrs as per NEP <br> Royal School of Behavioral &amp; Allied
    Sciences
    (RSBAS)
</p>
...
<div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
    ...
    <div class="text-center">
        ...
        <a href="mobile-assets/Domestic/BA-Applied-Psychology.pdf" target="_blank" class="btn mobile-para1" style="background-color: #27467A; color: white; font-weight: bold; padding: 10px 15px; border-radius: 5px; text-decoration: none; line-height: 1.3; display: flex; align-items: center; justify-content: center; gap: 8px;">
...
<div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">BA - Applied Psychology</h3>
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a
                                href="mobile-assets/Domestic/BA-Applied-Psychology.pdf">Brochure 2025-26<i
