...
@section('meta_description', 'Royal Global University offers the best M.A Political Science program with a focus on
    research, policy analysis, and leadership development for a successful career.')
            ...
            <div class="section-body">
                <div class="tabs-container">
                    ...
                    <div id="eligibility" class="tab-content mobile-para1">
                        ...
                        <p class="text-dark">
                            Bachelor’s Degree with Political Science Honours/
                            Major from any recognized University/Institution with
                            minimum 45% marks or equivalent grade (5%
                            relaxation to SC/ST/OBC – Non-Creamy Layer) <br>
                            Or <br>
                    ...
                    <div id="brochure" class="tab-content mobile-para1">
                        ...
                        <div
                            ...
                            <a target="_blank" class="text-danger fw-bold mobile-headd3 pt-2"
                                href="https://www.rgu.ac/mobile-assets/Domestic/B.Arch..pdf">Download
                                Brochure
