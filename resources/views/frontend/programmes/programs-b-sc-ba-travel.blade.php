    ...
    <div class="mobile">
      ...
      <div class="container" style="padding-top: 120px; position: relative;">
        ...
        <h2 class="mobile-headd1 fw-bold text-center pt-2" style="color: #27467A; font-weight: 900;">
          BA(H)/ B.Sc.(H) Travel & Tourism Management
        </h2>
      ...
      <div class="section-body">
        <div class="tabs-container">
          ...
          <div id="eligibility" class="tab-content mobile-para1">
            ...
            <p class="text-dark">
            <ol class="text-dark">
              <li>10+2 or equivalent from a recognized Board/ Council
            ...
            <p class="text-dark">
              ...
              in last examination followed by
              Personal Interview.
            </p>
          ...
          <div id="brochure" class="tab-content mobile-para1">
            ...
            <div
              ...
              <a target="_blank" class="text-danger fw-bold mobile-headd3 pt-2"
                href="https://www.rgu.ac/mobile-assets/Domestic/brochure%20for%20web_compressed-min.pdf">Download Brochure
