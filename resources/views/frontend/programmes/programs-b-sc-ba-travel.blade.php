...
@section('title', 'Best B.Sc/BA Travel and Tourism Course at Royal Global University')
@section('meta_description', 'Royal Global University’s B.Sc/BA Travel and Tourism Management – a leading program in Assam for students passionate about travel, culture, and hospitality.')
@section('meta_keywords', 'b.sc/ba travel and tourism management')
@section('content')
<div class="mobile">
...
<h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">B.Sc./BA Travel & Tourism Management
</h2>

<p class="mobile-headd3 text-dark text-center" style="line-height: 1.3;">Duration - 3/4 Yrs as per NEP <br> Royal School of Travel & Tourism Management (RSTTM)
</p>
...
<div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">B.Sc./BA Travel & Tourism Management</h2>
