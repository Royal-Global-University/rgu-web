...
@section('title', 'B.Pharm Lateral Entry at Royal Global University | Fast-Track Pharmacy Degree in Assam')
@section('meta_description', 'Royal Global University’s B.Pharm Lateral Entry program to continue your pharmacy education with advanced coursework and practical training for a quick degree completion.')
@section('meta_keywords', 'B.Pharm.Lateral Entry')
@section('content')
      ...
      <div class="section-body">
        <div class="tabs-container">
          ...
          <div id="fee" class="tab-content active mobile-para1">
            ...
            <ol class="text-dark">
              <li>
                Yearly Payment (Rs. - 173000.00)
              </li>
              <li>
                Semester Payment (Rs. - 88000.00)
              </li>
            </ol>
            </p>
          ...
          <div id="eligibility" class="tab-content mobile-para1">
            ...
            <p class="text-dark">
              D.Pharm from PCI recognized Institute with minimum
              50% marks in aggregate or equivalent grade (5%
