...
@section('meta_description', 'Join Royal Global University’s General Nursing & Midwifery program to develop essential
    nursing and midwifery skills with expert guidance and practical training.')
            ...
            <div class="section-body">
                <div class="tabs-container">
                    ...
                    <div id="eligibility" class="tab-content mobile-para1">
                        ...
                        <ol>
                            <li class="text-dark">
                                10+2 with English and must have obtained a minimum of 40% at the qualifying examination and
                                English individually from any recognized board. Candidates are also eligible from State Open
                                School recognized by State Government and National Institute of Open School (NIOS)
                                recognized by Central Government. However, Science is preferable. Three (core elective)
                                subject marks may be taken for calculating the percentage of marks excluding the marks in
                                English. Also, it has to be ensured the candidate has pass marks in English.
                            </li>
                            <li class="text-dark">
                                10+2 with English having 40% of marks in vocational ANM course from the school recognized by
                  ...
                  aggregate (5% relaxation to SC/ST/OBC – Non-Creamy Layer) along with Mathematics as compulsory subjects.
                    ...
                    <div id="scholarship" class="tab-content mobile-para1">
                        ...
                        <p class="mobile-para1 text-dark">
                            ...
                            Generally,
                            merit scholarships are reserved for students with special qualifications, such as academic
                            performance,
                        ...
                        <p class="mobile-para1 text-dark">
                            ...
                            Students seeking Scholarships will have to submit an application as per the category for which
                            the student
                            seeks scholarship. For fresh students seeking admission, if interested for applying scholarship
                            can select
                            the scholarship facility during the online application process. Existing students can seek help
                            from their
                            departmental coordinators to keep themselves updated for the scholarship application deadlines
                            and
                            process.
