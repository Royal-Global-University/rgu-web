...
@section('meta_description', 'Royal Global University offers an M.Sc Hotel Management course designed to provide
    world-class training, industry insights, and managerial expertise for a successful hospitality career.')
            ...
            <div class="section-body">
                <div class="tabs-container">
                    ...
                    <div id="eligibility" class="tab-content mobile-para1">
                        ...
                        <p class="text-dark">
                            Bachelor’s Degree in Hotel Management from any
                    ...
                    <div id="brochure" class="tab-content mobile-para1">
                        ...
                        <div
                            ...
                            <a target="_blank" class="text-danger fw-bold mobile-headd3 pt-2"
                                href="https://www.rgu.ac/mobile-assets/Domestic/M.Sc.HotelManagement-MHM.pdf">Download
                                Brochure
