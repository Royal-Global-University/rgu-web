...
@section('title', 'Royal Global University’s BCA Program: Your Gateway to the Tech Industry')
@section('meta_description', 'Become a future IT professional with Royal Global University’s BCA program, blending theoretical knowledge with hands-on training and industry insights.')
@section('meta_keywords', 'BCA')
@section('content')
    ...
    <div class="mobile">
        ...
        <div style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">
            ...
            <p class="mobile-headd3 text-dark text-center" style="line-height: 1.3;">Duration - 3/4 Yrs as per NEP <br>
                ...
                <div style="padding: 20px 0px 0px 0px;">
                    <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent">
                        ...
                        <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                            ...
                            <p class="mobile-para1 text-dark">10+2 or equivalent from a recognized Board/Council with
                                Mathematics/ Computer Science / Information Technology as one of the compulsory subjects,
                        ...
                        <div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tab3-tab">
                            ...
                            <div class="text-center">
                                ...
                                <a href="mobile-assets/Domestic/BCA.pdf" target="_blank" class="btn mobile-para1"
    ...
    <div class="website">
        ...
        <div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">BCA</h3>
                    <h3 class="text-center headd3 text-dark">Duration - 3/4 Yrs as per NEP<br>
                        <span class="text-center" style="font-size: 22px;">Royal School of Information Technology
                            (RSIT)</span>
                    </h3>
            </div>
            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">10+2 or equivalent from a recognized Board/Council with Mathematics/
                            Computer Science / Information Technology as one of the compulsory subjects, with minimum 45%
                            marks or equivalent grade (5% relaxation to SC/ST/OBC – Non-Creamy Layer)
                        </p>
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a href="mobile-assets/Domestic/BCA.pdf">Brochure 2025-26<i
                ...
                <div id="Scholarship" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="pt-2 fw-bold" style="color: #FF9A1E;"><a href="scholarship&funding">More details, click to
                                view...</a></p>
                    </div>
                </div>
