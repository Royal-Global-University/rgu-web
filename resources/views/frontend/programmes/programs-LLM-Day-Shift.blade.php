...
@section('title', 'Royal Global University’s LL.M Day Shift Program: Specialize and Succeed in Law')
@section('meta_description', 'Royal Global University’s LL.M Day Shift program is designed for law graduates seeking specialization and success in the legal profession through focused, full-time learning.')
@section('meta_keywords', 'LL.M Day Shift Program')
@section('content')
      ...
      <div class="section-body">
        <div class="tabs-container">
          ...
          <div id="fee" class="tab-content active mobile-para1">
            ...
            <ol class="text-dark">
              <li>
                Yearly Payment (Rs. - 130000.00)
              </li>
              <li>
                Semester Payment (Rs. - 65000.00)
              </li>
            </ol>
            </p>
          ...
          <div id="eligibility" class="tab-content mobile-para1">
            ...
            <p class="text-dark">
              Bachelor’s degree in law, from any recognized
              University/Institution with minimum 50% marks or
          ...
          <div id="brochure" class="tab-content mobile-para1">
            ...
            <div
              ...
              <a target="_blank" class="text-danger fw-bold mobile-headd3 pt-2"
                href="https://www.rgu.ac/mobile-assets/Domestic/LLMDayShift.pdf">Download
                Brochure
