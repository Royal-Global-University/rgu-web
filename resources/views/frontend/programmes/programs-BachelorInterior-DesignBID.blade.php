        ...
        <div class="mobile">
            ...
            <div class="container" style="padding-top: 80px; position: relative;">
                ...
                <h2 class="mobile-headd1 fw-bold text-center pt-2" style="color: #27467A; font-weight: 900;">
                    Bachelor of Design - Interior Design (BID)
                </h2>
            ...
            <div class="section-body">
                <div class="tabs-container">
                    ...
                    <div id="eligibility" class="tab-content mobile-para1">
                        ...
                        <p class="text-dark">
                            10+2 or 3-Years Diploma in any branch, recognized by Central/State Government or equivalent
                            qualification
                            from any board with minimum 45% marks or equivalent grade (5% relaxation to SC/ST/OBC –
                            Non-Creamy Layer)
                        </p>
