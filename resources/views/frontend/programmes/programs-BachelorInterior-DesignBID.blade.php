...
@section('title', 'Royal Global University’s Interior Design Course – Explore Your Design Career')
@section('meta_description', 'Discover Royal Global University’s Interior Design course and unlock your creative potential. Gain hands-on experience and build a successful career in interior design and decoration.')
@section('meta_keywords', ' Interior Designs')
@section('content')
<div class="mobile">
@include('frontend/components/mobileheader')
<div style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">

<h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">Bachelor of Interior Design (BID)
</h2>

<p class="mobile-headd3 text-dark text-center" style="line-height: 1.3;">Duration - 04 Years <br> Royal School of Design (RSD)
</p>
...
<div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
    <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
        ...
        <ol class="mobile-para1 text-dark">
            <li>Yearly Payment (Rs. - 110000.00)</li>
            <li>Semester Payment (Rs. - 56500.00)</li>
        </ol>
    ...
    <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
        ...
        <p class="mobile-para1 text-dark">10+2 or 3-Years Diploma in any branch, recognized by Central/State Government or equivalent qualification from any board with minimum 45% marks or equivalent grade (5% relaxation to SC/ST/OBC – Non-Creamy Layer)
        </p>
    ...
    <div class="text-center">
        ...
        <a href="mobile-assets/Domestic/Bachelor_Interior_Design(BID).pdf" target="_blank" class="btn mobile-para1" style="background-color: #27467A; color: white; font-weight: bold; padding: 10px 15px; border-radius: 5px; text-decoration: none; line-height: 1.3; display: flex; align-items: center; justify-content: center; gap: 8px;">
...
<div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">Bachelor of Interior Design (BID)</h3>
                    <h3 class="text-center headd3 text-dark">Duration - 04 Years<br>
                        <span class="text-center" style="font-size: 22px;">Royal School of Design (RSD)</span>
                    </h3>
            </div>
            ...
            <div class="container pb-5">
                <div id="Fee" class="w3-container city card p-5 shadow" style="display:block">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0">B.) Programmes fee to be paid Yearly / semester payment for
                            New
                            Students 2025-26</p>
                        <p class="text-dark pt-2 m-0">Yearly Payment (Rs. - 110000.00)</p>
                        <p class="text-dark pt-2 m-0">Semester Payment (Rs. - 56500.00)</p>
                    </div>
                </div>
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">10+2 or 3-Years Diploma in any branch, recognized by Central/State Government or equivalent qualification from any board with minimum 45% marks or equivalent grade (5% relaxation to SC/ST/OBC – Non-Creamy Layer)
                        </p>
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a
                                href="mobile-assets/Domestic/Bachelor_Interior_Design(BID).pdf">Brochure 2025-26<i
