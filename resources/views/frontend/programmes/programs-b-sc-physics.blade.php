...
@section('meta_description', 'Apply now for B.Sc Physics at Royal Global University—learn from top faculty, access
    modern labs, and build a strong foundation in science.')
          ...
          <div id="brochure" class="tab-content mobile-para1">
            ...
            <div
              ...
              <a target="_blank" class="text-danger fw-bold mobile-headd3 pt-2"
                href="https://www.rgu.ac/mobile-assets/Domestic/B.Sc-Physics.pdf">Download Brochure <i
          ...
          <div id="scholarship" class="tab-content mobile-para1">
            ...
            <ol class="text-dark">
              ...
              <li>
                ...
                student seeks scholarship. For fresh students seeking admission, if interested for applying scholarship
                can select the scholarship facility during the online application process. Existing students can seek
                help from their departmental coordinators to keep themselves updated for the scholarship application
