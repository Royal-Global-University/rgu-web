...
@section('title', 'Best M.Tech Artificial Intelligence Program in Assam at Royal Global University')
@section('meta_description', 'Join Royal Global University’s top-ranked M.Tech AI program in Assam. Master AI
    technologies, machine learning, and deep learning with practical experience and expert faculty.')
@section('meta_keywords', 'M.Tech in Artificial Intelligence')
@section('content')
    <div class="mobile">
        ...
        <div style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">
            <h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">
                M.Tech. CSE in Artifical Intelligence
            </h2>
                ...
                <div style="padding: 20px 0px 0px 0px;">
                    <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent">
                        ...
                        <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                            ...
                            <p class="mobile-para1 text-dark">B.E./B.Tech. /AMIE/MCA/M.Sc. (IT) or its equivalent in
                                relevant field, from any recognized University/Institution, with minimum 45% marks or
                                equivalent grade (5% relaxation to SC/ST/OBC – Non-Creamy Layer)</p>
                        ...
                        <div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tab3-tab">
                            ...
                            <div class="text-center">
                                ...
                                <a href="mobile-assets/Domestic/M.Tech.CSE_Artifical_Intelligence.pdf" target="_blank"
    ...
    <div class="website">
        ...
        <div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">M.Tech. CSE in Artifical Intelligence</h3>
            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">B.E./B.Tech. /AMIE/MCA/M.Sc. (IT) or its equivalent in relevant
                            field, from any recognized University/Institution, with minimum 45% marks or equivalent grade
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a
                                href="mobile-assets/Domestic/M.Tech.CSE_Artifical_Intelligence.pdf">Brochure 2026-27<i
