            ...
            <div class="container mt-4" style="max-width: 900px;">
                ...
                <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
                    ...
                    <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                        ...
                        <p class="mobile-para1 text-dark">THREE years / TWO years (Lateral Entry) Diploma examination with at least 45% marks (5% relaxation to
                        SC/ST/OBC-Non-Creamy Layer) in ANY branch of Engineering and Technology.
                        OR
                        Passed B.Sc. Degree from a recognized University as defined by UGC, with at least 45% marks (5% relaxation to
                    ...
                    <div class="text-center">
                        ...
                        <a href="mobile-assets/Domestic/B.Tech-CSE-CE-ME(Lateral Entry).pdf" target="_blank" class="btn mobile-para1" style="background-color: #27467A; color: white; font-weight: bold; padding: 10px 15px; border-radius: 5px; text-decoration: none; line-height: 1.3; display: flex; align-items: center; justify-content: center; gap: 8px;">
                ...
                <div class="container pb-5">
                    ...
                    <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                        <div class="card-body para1">
                            ...
                            <p class="text-dark pt-2 m-0">THREE years / TWO years (Lateral Entry) Diploma examination with at least 45% marks (5% relaxation to
