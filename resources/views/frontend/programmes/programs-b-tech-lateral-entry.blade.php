    ...
    <div class="mobile">
        ...
        <div style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">
            ...
            <h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">
                B.Tech CE/CSE/ME/AI & Data Science - (Lateral Entry)
            </h2>
                ...
                <div style="padding: 20px 0px 0px 0px;">
                    <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent">
                        ...
                        <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                            ...
                            <p class="mobile-para1 text-dark">THREE years / TWO years (Lateral Entry) Diploma examination
                                with at least 45% marks (5% relaxation to
                                SC/ST/OBC-Non-Creamy Layer) in ANY branch of Engineering and Technology.
                                OR
                                Passed B.Sc. Degree from a recognized University as defined by UGC, with at least 45% marks
                                (5% relaxation to
                                SC/ST/OBC-Non-Creamy Layer) and passed 10+2 examination with Mathematics as a subject.</p>

                            <p class="mobile-headd3 fw-bold text-dark">Selection Process
                            </p>

                            <p class="mobile-para1 text-dark">Candidates must obtain a valid score in JEE/CEE or R-JEE
                                (Royal
                                Joint Entrance Examinations) followed by Personal Interview.
                            </p>
                        ...
                        <div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tab3-tab">
                            ...
                            <div class="text-center">
                                ...
                                <a href="mobile-assets/Domestic/B.Tech-CSE-CE-ME(Lateral Entry).pdf" target="_blank"
            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">THREE years / TWO years (Lateral Entry) Diploma examination with at
                            least 45% marks (5% relaxation to
                            SC/ST/OBC-Non-Creamy Layer) in ANY branch of Engineering and Technology.<br>
                            <span class="fw-bold">OR</span><br>
                            Passed B.Sc. Degree from a recognized University as defined by UGC, with at least 45% marks (5%
                            relaxation to
                            SC/ST/OBC-Non-Creamy Layer) and passed 10+2 examination with Mathematics as a subject.
                        </p>
                        <p class="mobile-headd3 fw-bold text-dark">Selection Process
                        </p>

                        <p class="mobile-para1 text-dark">Candidates must obtain a valid score in JEE/CEE or R-JEE (Royal
                            Joint Entrance Examinations) followed by Personal Interview.
                        </p>
                    </div>
                </div>
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a
                                href="mobile-assets/Domestic/B.Tech-CSE-CE-ME(Lateral Entry).pdf">Brochure 2025-26<i
