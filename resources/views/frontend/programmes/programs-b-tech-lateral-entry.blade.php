        ...
        <div class="container mt-4" style="max-width: 900px;">
            ...
            <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
                ...
                <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                    ...
                    <p class="mobile-para1 text-dark">i)10+2 or equivalent from a recognized Board/Council, ii) with Physics, Chemistry & Mathematics as compulsory subjects iii) having minimum 50% marks or equivalent grade (5% relaxation to SC/ST/OBC-Non-Creamy Layer) in the above subjects together.
                    </p>
            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">i)10+2 or equivalent from a recognized Board/Council, ii) with Physics, Chemistry & Mathematics as compulsory subjects iii) having minimum 50% marks or equivalent grade (5% relaxation to SC/ST/OBC-Non-Creamy Layer) in the above subjects together.</p>
                        <p class="mobile-headd3 fw-bold text-dark">Selection Process
                        </p>
