      ...
      <div class="section-body">
        <div class="tabs-container">
          ...
          <div id="eligibility" class="tab-content mobile-para1">
            ...
            <ol>
              <li class="text-dark">
                B.Sc. Food Technology / B.Sc. Biotechnology / B.Sc. Agriculture Science / B.Sc. Horticulture / B.Sc.
                Fisheries / B.Sc. Food Science, Nutrition & Dietetics / B.Sc. Home Science / B.Sc. Botany, Zoology,
                Chemistry / B.Sc. Microbiology / B.Sc. Dairy Technology / B.Tech. Food Technology / B.Tech.
                Biotechnology / B.Tech. Agricultural Engineering / B.Tech. Dairy Technology with a minimum of 45% marks
                in aggregate or equivalent grade from any recognized University/Institution (5% relaxation for SC/ST/OBC
                – Non-Creamy Layer).
              </li>
            </ol>
