...
@section('title', 'B.Tech CE at Royal Global University – Innovative and Industry-Focused Education')
@section('meta_description', 'Royal Global University’s B.Tech CE course combines advanced technology and practical
    exposure to prepare you for leadership roles in civil engineering.')
@section('meta_keywords', 'B Tech CE')
@section('content')
    <div class="mobile">
                ...
                <div style="padding: 20px 0px 0px 0px;">
                    <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent">
                        ...
                        <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                            ...
                            <p class="mobile-para1 text-dark"> i) 10+2 or equivalent from a recognized Board/Council,
                                ii) with Physics, Chemistry & Mathematics as compulsory subjects
                        ...
                        <div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tab3-tab">
                            ...
                            <div class="text-center">
                                ...
                                <a href="mobile-assets/Domestic/B.Tech.(CE).pdf" target="_blank" class="btn mobile-para1"
    ...
    <div class="website">
        ...
        <div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">B.Tech. (CE)</h3>
            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">
                            i) 10+2 or equivalent from a recognized Board/Council<br>
                            ii) with Physics, Chemistry & Mathematics as compulsory subjects<br>
                            iii) having minimum 45% marks or equivalent grade (5% relaxation to SC/ST/OBC-Non-Creamy Layer)
                            in the above subjects together.
                        </p>
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a href="mobile-assets/Domestic/B.Tech.(CE).pdf">Brochure
