...
@section('title', 'Royal Global University’s LL.M Morning Shift: Balance, Brilliance, and Legal Excellence')
@section('meta_description', 'Experience top-tier legal education with the LL.M Morning Shift at Royal Global University, where balance meets academic rigor and career success.')
@section('meta_keywords', 'LL.M Morning Shift')
@section('content')
<div class="mobile">
...
<div style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">
            ...
            <h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">LLM Morning Shift
            </h2>

            <p class="mobile-headd3 text-dark text-center" style="line-height: 1.3;">Duration - 01 Year <br> Royal School of Law & Administration
                (RSLA)
            </p>
            ...
            <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
                <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
                    ...
                    <ol class="mobile-para1 text-dark">
                        ...
                        <li>Semester Payment (Rs. - 75000.00)</li>
                    </ol>
                ...
                <div class="text-center">
                    ...
                    <a href="mobile-assets/Domestic/LLM_Morning_Shift.pdf" target="_blank" class="btn mobile-para1" style="background-color: #27467A; color: white; font-weight: bold; padding: 10px 15px; border-radius: 5px; text-decoration: none; line-height: 1.3; display: flex; align-items: center; justify-content: center; gap: 8px;">
                ...
                <div class="tab-pane fade" id="tab4" role="tabpanel" aria-labelledby="tab4-tab">
                    ...
                    <p class="mobile-para1 text-dark">Royal Global University offers several scholarships to help students pay for their
                        education.<br>
                    ...
                    <p class="mobile-para1 text-dark">
                        Students seeking Scholarships will have to submit an application as per the category for
                            ...
                            updated
                            for
                            the scholarship application deadlines and process.
                    </p>
...
<div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">LLM Morning Shift</h3>
                    <h3 class="text-center headd3 text-dark">Duration - 01 Year<br>
                ...
                <div id="Fee" class="w3-container city card p-5 shadow" style="display:block">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0">B.) Programmes fee to be paid Yearly / semester payment for
                            New
                            Students 2025-26</p>
                        <p class="text-dark pt-2 m-0">Yearly Payment (Rs. - 150000.00)</p>
                        <p class="text-dark pt-2 m-0">Semester Payment (Rs. - 75000.00)</p>
                    </div>
                </div>
