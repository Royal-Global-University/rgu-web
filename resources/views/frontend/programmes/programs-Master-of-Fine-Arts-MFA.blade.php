...
<div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
    ...
    <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
        ...
        <p class="mobile-para1 text-dark">Based on Overall Performance in the last examination with minimum 45% marks in aggregate or equivalent grade (5%relaxation to SC/ST/OBC Non-Creamy Layer)followed by personal interview.
        </p>
            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">Based on Overall Performance in the last examination with minimum 45% marks in aggregate or equivalent grade (5%relaxation to SC/ST/OBC Non-Creamy Layer)followed by personal interview.</p>
                    </div>
                </div>
