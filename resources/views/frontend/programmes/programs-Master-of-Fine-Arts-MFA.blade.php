...
<h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">Master of Fine Arts (MFA)
</h2>

<p class="mobile-headd3 text-dark text-center" style="line-height: 1.3;">Duration - 02 Years <br> Royal School of Fine Arts (RSFA)
</p>
...
<div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
    ...
    <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
        ...
        <p class="mobile-para1 text-dark">Bachelors Degree in Fine Arts or Visual Arts from any recognized University/ Institution</p>
        <p class="mobile-headd3 fw-bold text-dark">Selection Process
        </p>
        <p class="mobile-para1 text-dark">Based on Overall Performance in the last examination with minimum 50% marks in aggregate or equivalent grade (5%relaxation to SC/ST/OBC Non-Creamy Layer)followed by personal interview.
        </p>
    ...
    <div class="text-center">
        ...
        <a href="mobile-assets/Domestic/Master_FineArts(MFA).pdf" target="_blank" class="btn mobile-para1" style="background-color: #27467A; color: white; font-weight: bold; padding: 10px 15px; border-radius: 5px; text-decoration: none; line-height: 1.3; display: flex; align-items: center; justify-content: center; gap: 8px;">
...
<div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">Master of Fine Arts (MFA)</h2>
                <h3 class="text-center headd3 text-dark">Duration - 02 Years<br>
                    <span class="text-center">Royal School of Fine Arts (RSFA)</span>
                </h3>
            </div>
            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">Bachelors Degree in Fine Arts or Visual Arts from any recognized University/ Institution</p>
                        <p class="text-dark pt-2 fw-bold m-0">Selection Process</p>
                        <p class="text-dark pt-2 m-0">Based on Overall Performance in the last examination with minimum 50% marks in aggregate or equivalent grade (5%relaxation to SC/ST/OBC Non-Creamy Layer)followed by personal interview.</p>
                    </div>
                </div>
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a
                                href="mobile-assets/Domestic/Master_FineArts(MFA).pdf">Brochure 2025-26<i
