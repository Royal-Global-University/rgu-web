      ...
      <div class="section-body">
        <div class="tabs-container">
          ...
          <div id="eligibility" class="tab-content mobile-para1">
            ...
            <p class="text-dark">
              Bachelors Degree in Fine Arts or Visual Arts from any recognized University/ Institution with minimum 45%
            ...
            <p class="text-dark">
              Based on Overall Performance in the last examination followed by personal interview.
            </p>
          ...
          <div id="brochure" class="tab-content mobile-para1">
            ...
            <div
              ...
              <a target="_blank" class="text-danger fw-bold mobile-headd3 pt-2"
                href="https://www.rgu.ac/mobile-assets/Domestic/Master_FineArts(MFA).pdf">Download
                Brochure
