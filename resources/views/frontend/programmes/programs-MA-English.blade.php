...
@section('title', 'Empower Your Voice and Vision with M.A English at Royal Global University')
@section('meta_description', 'Royal Global University’s M.A English course nurtures your voice as a scholar and communicator, blending classic literature with modern linguistic insights.')
@section('meta_keywords', 'M.A English')
@section('content')
<div class="mobile">
...
<div style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">
            ...
            <h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">MA - English
            </h2>

            <p class="mobile-headd3 text-dark text-center" style="line-height: 1.3;">Duration - 02 Years <br> Royal School of Languages (RSL)
            </p>
        ...
        <div class="container mt-4" style="max-width: 900px;">
            ...
            <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
                ...
                <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                    ...
                    <p class="mobile-para1 text-dark">Bachelor’s Degree with English Honours/ Major from any recognized University/Institution with minimum 50% marks or equivalent grade (5% relaxation to SC/ST/OBC – Non-Creamy Layer) Or Bachelor’s Degree in any stream with minimum 50% marks or equivalent grade (5% relaxation to SC/ST/OBC – Non-Creamy Layer)</p>
                ...
                <div class="text-center">
                    ...
                    <a href="mobile-assets/Domestic/MA-English.pdf" target="_blank" class="btn mobile-para1" style="background-color: #27467A; color: white; font-weight: bold; padding: 10px 15px; border-radius: 5px; text-decoration: none; line-height: 1.3; display: flex; align-items: center; justify-content: center; gap: 8px;">
...
<div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">MA - English</h3>
                    <h3 class="text-center headd3 text-dark">Duration - 02 Years<br>
                        <span class="text-center" style="font-size: 22px;">Royal School of Languages (RSL)</span>
                    </h3>
            </div>
            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">Bachelor’s Degree with English Honours/ Major from any recognized University/Institution with minimum 50% marks or equivalent grade (5% relaxation to SC/ST/OBC – Non-Creamy Layer) Or Bachelor’s Degree in any stream with minimum 50% marks or equivalent grade (5% relaxation to SC/ST/OBC – Non-Creamy Layer)</p>
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a href="mobile-assets/Domestic/MA-English.pdf">Brochure
