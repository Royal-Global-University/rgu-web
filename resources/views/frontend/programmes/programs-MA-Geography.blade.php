...
@section('meta_description', 'Join Royal Global University’s MA Geography program in Assam and deepen your understanding
    of geographical concepts, research methods, and spatial analysis for a strong academic or professional career.')
      ...
      <div class="section-body">
        <div class="tabs-container">
          ...
          <div id="eligibility" class="tab-content mobile-para1">
            ...
            <p class="text-dark">
              Bachelor’s Degree in Geography/ Major from any recognized University/ Institution with minimum 45% marks
              or equivalent grade (5% relaxation to SC/ST/OBC – Non-Creamy Layer)
            </p>
            <p class="text-dark"  style="color: #27467A;">
              OR
            </p>
          ...
          <div id="brochure" class="tab-content mobile-para1">
            ...
            <div
              ...
              <a target="_blank" class="text-danger fw-bold mobile-headd3 pt-2"
                href="https://www.rgu.ac/mobile-assets/Domestic/MA_Geography.pdf">Download
                Brochure
