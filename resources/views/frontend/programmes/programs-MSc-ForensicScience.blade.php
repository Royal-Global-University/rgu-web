...
@section('title', 'Best M.Sc Forensic Science Program in Assam | Royal Global University')
@section('meta_description', 'Advance your forensic career with Royal Global University’s top-rated M.Sc Forensic Science program in Assam—complete with practical exposure and modern lab facilities.')
@section('meta_keywords', 'M.Sc Forensic Science')
@section('content')
      ...
      <div class="section-body">
        <div class="tabs-container">
          ...
          <div id="eligibility" class="tab-content mobile-para1">
            ...
            <p class="text-dark">
              B.Sc in Forensic Science/ Physics/ Chemistry/ Life Sciences/ Biology/ Biotechnology/ Biochemistry/
              Microbiology / Environmental Science / Botany / Zoology / Genetics / Applied Botany / Applied Zoology Home
              Science / Sericulture / Biological Science / B.Sc. Agriculture/ Horticulture/ Forestry/ Bachelor’s degree
              in Medicine / Fisheries/ Veterinary / Diary and B.Tech. Biotechnology and allied fields with minimum 45%
              marks in aggregate or equivalent grade from any recognized University/Institution (5% relaxation to
          ...
          <div id="brochure" class="tab-content mobile-para1">
            ...
            <div
              ...
              <a target="_blank" class="text-danger fw-bold mobile-headd3 pt-2"
                href="https://www.rgu.ac/mobile-assets/Domestic/M.Sc.ForensicScience.pdf">Download
                Brochure
          ...
          <div id="scholarship" class="tab-content mobile-para1">
            ...
            <p class="mobile-para1 text-dark">
              Royal Global University offers several scholarships to help students pay for their education. Generally,
              merit scholarships are reserved for students with special qualifications, such as academic performance,
              athletic or artistic talent and other endowment schemes.
            </p>
            ...
            <p class="mobile-para1 text-dark">
              ...
              Students seeking Scholarships will have to submit an application as per the category for which the student
              seeks scholarship. For fresh students seeking admission, if interested for applying scholarship can select
              the scholarship facility during the online application process. Existing students can seek help from their
              departmental coordinators to keep themselves updated for the scholarship application deadlines and
              process.
          ...
          <div id="apply" class="tab-content mobile-para1">
            ...
            <p class="mobile-para1 text-dark">
              Admission to Royal Global University is highly competitive. You need to meet both admissions & subject
              requirements before we make an unconditional offer of admission. At RGU you will learn from outstanding
              teachers, access groundbreaking research and state-of-the-art facilities, and make invaluable contacts and
              lifelong friends.
            </p>
