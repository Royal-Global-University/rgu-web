...
@section('meta_description', 'Join Royal Global University’s top-rated M.Sc Geoinformatics course and master tools in
    spatial analysis, remote sensing, and digital mapping for a high-demand tech career.')
      ...
      <div class="section-body">
        <div class="tabs-container">
          ...
          <div id="eligibility" class="tab-content mobile-para1">
            ...
            <p class="text-dark">
              B.Sc.(H) from any recognized University/Institution in
              Physics / Mathematics / Computer Applications /
              Computer Science / Disaster Management / Ecology &
              Environmental Sciences / Geology / GIS / Information
              Science / Forestry / Geography / Agriculture /
              Atmospheric Sciences / Botany / Chemistry / Fisheries
              / Oceanography / Soil Science / Statistics / Town
              Planning / Zoology / allied disciplines with minimum
              45% marks in aggregate or equivalent grade ( 5%
          ...
          <div id="brochure" class="tab-content mobile-para1">
            ...
            <div
              ...
              <a target="_blank" class="text-danger fw-bold mobile-headd3 pt-2"
                href="https://www.rgu.ac/mobile-assets/Domestic/M.Sc._Geoinformatics.pdf">Download
                Brochure
