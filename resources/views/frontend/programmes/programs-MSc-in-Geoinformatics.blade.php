            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">B.Sc.(H) from any recognized University/Institution in Physics /
                            Mathematics / Computer Applications / Computer Science / Disaster Management / Ecology &
                            Environmental Sciences / Geology / GIS / Information Science / Forestry / Geography /
                            Agriculture / Atmospheric Sciences / Botany / Chemistry / Fisheries / Oceanography / Soil
                            Science / Statistics / Town Planning / Zoology / allied disciplines with minimum 50% marks
                            in aggregate or equivalent grade ( 5% relaxation to SC/ST/OBC – Non Creamy Layer)</p>
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a href="assets/programme-pdf/M.Sc._Geoinformatics.pdf">Brochure
