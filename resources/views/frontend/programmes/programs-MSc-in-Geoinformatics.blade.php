...
@section('title', 'Top M.Sc Geoinformatics Course at Royal Global University')
@section('meta_description', 'Join Royal Global University’s top-rated M.Sc Geoinformatics course and master tools in spatial analysis, remote sensing, and digital mapping for a high-demand tech career.')
@section('meta_keywords', 'M.SC Geoinformatics')
@section('content')
<div class="mobile">
...
<h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">M.Sc. in Geoinformatics
</h2>
...
<div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
    ...
    <div class="text-center">
        ...
        <a href="mobile-assets/Domestic/M.Sc._Geoinformatics.pdf" target="_blank" class="btn mobile-para1" style="background-color: #27467A; color: white; font-weight: bold; padding: 10px 15px; border-radius: 5px; text-decoration: none; line-height: 1.3; display: flex; align-items: center; justify-content: center; gap: 8px;">
...
<div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">M.Sc. in Geoinformatics</h3>
            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">B.Sc.(H) from any recognized University/Institution in  Physics / Mathematics / Computer Applications / Computer Science / Disaster Management / Ecology & Environmental Sciences / Geology / GIS / Information Science / Forestry / Geography / Agriculture / Atmospheric Sciences / Botany / Chemistry / Fisheries / Oceanography / Soil Science / Statistics / Town Planning / Zoology / allied disciplines  with minimum 45% marks in aggregate or equivalent grade ( 5% relaxation to SC/ST/OBC – Non Creamy Layer)</p>
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a
                                href="mobile-assets/Domestic/M.Sc._Geoinformatics.pdf">Brochure 2025-26<i
