...
@section('title', 'Royal Global University B.Sc Nursing Basic – Quality Nursing Training in Assam')
@section('meta_description', 'Advance your nursing career with Royal Global University’s B.Sc Nursing Basic course,
    combining theoretical learning with practical clinical experience.')
@section('meta_keywords', 'B.SC Nursing Basic post')
@section('content')
    <div class="mobile">
        ...
        <div style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">
            ...
            <p class="mobile-headd3 text-dark text-center" style="line-height: 1.3;">Duration - 2 Years <br> Royal School of
                Nursing (RSN)
            </p>
            ...
            <div class="container mt-4" style="max-width: 900px;">
                ...
                <ul class="nav nav-tabs justify-content-center border-0 shadow-sm" id="infoTabs" role="tablist"
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active border" id="tab1-tab" data-bs-toggle="tab" data-bs-target="#tab1"
                ...
                <div style="padding: 20px 0px 0px 0px;">
                    <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent">
                        <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
                            <p class="mobile-headd3 fw-bold text-dark">A.) Registration & Admission Fees (To Be Paid Once
                                Only)
                            </p>
                        ...
                        <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                            ...
                            <p class="mobile-para1 text-dark">
                                i) Passed the Higher Secondary or Senior Secondary or Intermediate or 10+2 or an equivalent
                                examination recognized by the university for this purpose. Those who have done 10+1 in or
                                before 1986, will be eligible for admission.
                                Obtained a certificate in General Nursing and Midwifery and registered as R.N.R.M. with the
                                State Nurses Registration Council. A male nurse, trained before the implementation of the
                                new integrated course besides being registered as a nurse with State Nurses Registration
                                Council, shall produce evidence of training approved by Indian Nursing Council for a similar
                        ...
                        <div class="tab-pane fade" id="tab4" role="tabpanel" aria-labelledby="tab4-tab">
                            ...
                            <p class="mobile-para1 text-dark">Royal Global University offers several scholarships to help
                                students pay for their education. <br>
                                Generally, merit scholarships are reserved for students with special qualifications, such as
                                academic performance, athletic or artistic talent and other endowment schemes.
                            </p>
                            ...
                            <p class="mobile-para1 text-dark">
                                ...
                                updated for the scholarship application deadlines and process.
                            </p>

                            <p class="mobile-headd3 fw-bold text-dark">For More Details,</p>
                            <a href="scholarship&funding" target="_blank" class="btn mobile-para1"
                                style="background-color: #27467A; color: white; font-weight: bold; padding: 10px 15px; border-radius: 5px; text-decoration: none; line-height: 1.3; display: flex; align-items: center; justify-content: center; gap: 8px;">
                                Click Here
                            </a>
                        ...
                        <div class="tab-pane fade" id="tab5" role="tabpanel" aria-labelledby="tab5-tab">
                            ...
                            <p class="mobile-para1 text-dark">Admission to Royal Global University is highly competitive.
                                You need to meet both admissions & subject requirements before we make an unconditional
                                offer of admission. At RGU you will learn from outstanding teachers, access groundbreaking
                                research and state-of-the-art facilities, and make invaluable contacts and lifelong friends.
                            </p>
    ...
    <div class="website">
        ...
        <div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">B.Sc. Nursing (Post Basic)</h2>
                <h3 class="text-center headd3 text-dark">Duration - 2 Years<br>
                    <span class="text-center">Royal School of Nursing (RSN)</span>
                </h3>
            </div>
            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">
                            i) Passed the Higher Secondary or Senior Secondary or Intermediate or 10+2 or an equivalent
                            examination recognized by the university for this purpose. Those who have done 10+1 in or before
                            1986, will be eligible for admission.
                            Obtained a certificate in General Nursing and Midwifery and registered as R.N.R.M. with the
                            State Nurses Registration Council. A male nurse, trained before the implementation of the new
                            integrated course besides being registered as a nurse with State Nurses Registration Council,
                            shall produce evidence of training approved by Indian Nursing Council for a similar duration in
                            lieu of midwifery in any one of the following areas:
                            o O.T. Techniques
                            o Ophthalmic Nursing
                            o Leprosy Nursing
                            o TB Nursing
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a
                                href="mobile-assets/Domestic/brochure for web_compressed-min.pdf">Brochure 2026-27<i
                ...
                <div id="Apply" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="pt-2 fw-bold" style="color: #FF9A1E;"><a href="how-to-apply"> more details click to
                                view... </a></p><br>
