...
@section('meta_description', 'Choose Royal Global University for a practical and comprehensive B.Sc in Dialysis Technology. Build expertise in dialysis procedures and patient monitoring.')
...
<div style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">
            ...
            <h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">B.Sc. - Dialysis Tech
            </h2>
