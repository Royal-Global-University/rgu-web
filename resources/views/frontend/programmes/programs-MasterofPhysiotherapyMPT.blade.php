...
@section('meta_description', 'Advance your expertise in physiotherapy with Royal Global University’s Master of
    Physiotherapy, combining hands-on training and academic excellence.')
            ...
            <div class="section-body">
                <div class="tabs-container">
                    ...
                    <div id="eligibility" class="tab-content mobile-para1">
                        ...
                        <ol class="text-dark">
                            <li>
                                Candidates must have passed Bachelor of Physiotherapy (B.PT) on regular mode from recognised
                                university.
                            </li>
                            ...
                            <li>
                                Post Graduate entrance criteria requires to be compulsory registered member of National
                                Commission for Allied and Healthcare Professions (NCAHP).
                            </li>

                            <li>
                                Medical fitness certificate is mandatory to submit and it is to be endorsed by Government
                                medical officer.
                            </li>
                            <li>
                                Reservation policy for admission in post graduate programs shall be as per the State/Centre
                                Government norms.
                            </li>
                        </ol>

                        <p class="text-dark" style="font-weight: 700;">Foreign students’ admission process in Post Graduate
                            (PG):</p>

                        <ol class="text-dark">
                            <li>
                                Foreign national students intending to study PG program in India, shall have to take
                                equivalence certificate of eligibility certificate from respective State Allied and
                                Healthcare Council.
                            </li>
                            <li>
                                Admission of foreign national students, merit list will be based on University Entrance
                                Exam.
                            </li>
                            <li>
                                Verification of Valid Visa and valid Visa duration of foreign national students, to be
                                verified by respective institution & University before enrolling students for program.
                            </li>
                    ...
                    <div id="brochure" class="tab-content mobile-para1">
                        ...
                        <div
                            ...
                            <a target="_blank" class="text-danger fw-bold mobile-headd3 pt-2"
                                href="https://www.rgu.ac/assets/programme-pdf/brochure%20for%20web_compressed-min.pdf">Download
                                Brochure
