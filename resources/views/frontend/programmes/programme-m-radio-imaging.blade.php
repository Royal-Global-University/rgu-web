        ...
        <div class="mobile">
            ...
            <div class="container" style="padding-top: 120px; position: relative;">
                ...
                <h2 class="mobile-headd1 fw-bold text-center pt-2" style="color: #27467A; font-weight: 900;">
                    Masters of Medical Radiology and Imaging Technology
                </h2>
                    ...
                    <div id="eligibility" class="tab-content mobile-para1">
                        ...
                        <ol>
                            <li class="text-dark">
                                ...
                                Radiodiagnosis and Imaging Technology (B.MRIT) / B.Sc. Radiological Technology / B.Sc.
                                Radiography /
                                B.Sc. Medical Radiology & Imaging Technology / B.Sc. Radiography & Imaging Technology or any
                                other
                                equivalent course with B.MRIT on regular mode from any recognized University.
                            </li>
                            <li class="text-dark">
                                OR B.Sc. Life Sciences with PG Diploma / Advance Diploma (2 years) in the related field on
                                regular mode
