            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">Bachelor`s Degree in any branch of Biology (B.Sc. in
                            Botany/Zoology/Biotechnology/Food Science/Nutrition/Agriculture Sciences etc.), Medical
                            Sciences (MBBS/B.Pharm), Veterinary Sciences (B.V.Sc.)/Bio-Tech/Biomedical Eng.
                            (B.E/B.Tech.) or Ayurveda (BAMS) from any recognized University/Institution with minimum 50%
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a href="assets/programme-pdf/M.ScBio-Technology.pdf">Brochure
