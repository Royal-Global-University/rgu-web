...
@section('title', 'Top M.Tech Civil Engineering in Structural Design at Royal Global University')
@section('meta_description', 'Shape resilient and smart structures with Royal Global University’s M.Tech Civil
    Engineering in Structural Design – Assam’s top choice for advanced study.')
@section('meta_keywords', 'M Tech.CE in Structural Engineering')
@section('content')
    <div class="mobile">
                ...
                <div style="padding: 20px 0px 0px 0px;">
                    <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent">
                        ...
                        <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                            ...
                            <p class="mobile-para1 text-dark">B.E./B.Tech. /AMIE or its equivalent in relevant field, from
                                any recognized University/Institution, with minimum 50% marks or equivalent grade (5%
                        ...
                        <div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tab3-tab">
                            ...
                            <div class="text-center">
                                ...
                                <a href="mobile-assets/Domestic/M.TechCE_Structure_Engineering.pdf" target="_blank"
    ...
    <div class="website">
        ...
        <div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">M.Tech. CE in Structural Engineering</h3>
            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">B.E./B.Tech. /AMIE or its equivalent in relevant field, from any
                            recognized University/Institution, with minimum 45% marks or equivalent grade (5% relaxation to
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a
                                href="mobile-assets/Domestic/M.TechCE_Structure_Engineering.pdf">Brochure 2026-27<i
