...
@section('meta_description', 'Study B.Sc Geology at Royal Global University, Assam, and benefit from advanced labs,
    experienced faculty, and real-world geological projects to enhance your employability.')
          ...
          <div id="brochure" class="tab-content mobile-para1">
            ...
            <div
              ...
              <a target="_blank" class="text-danger fw-bold mobile-headd3 pt-2"
                href="https://www.rgu.ac/mobile-assets/Domestic/B.Sc.Geology.pdf">Download
                Brochure
