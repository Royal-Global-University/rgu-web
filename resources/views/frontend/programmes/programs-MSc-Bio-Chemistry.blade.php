...
@section('content')
    ...
    <div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
        <div class="text-center">
            <h2 class="text-center headd2 text-dark">M.Sc. - Physics</h3>
        ...
        <p class="d-inline-flex gap-5 container rounded pb-5">
            <button type="button" class="btn p-3 text-white active" data-bs-toggle="button" onclick="openCity('Fee')"
                style="font-size: 22px; font-weight: 600; background-color: #162b50;">Fee</button>
            <button type="button" class="btn p-3 text-white" data-bs-toggle="button" onclick="openCity('Eligibility')"
                style="font-size: 22px; font-weight: 600; background-color: #162b50;">Eligibility</button>
            <button type="button" class="btn p-3 text-white" data-bs-toggle="button" onclick="openCity('Brochure')"
                style="font-size: 22px; font-weight: 600; background-color: #162b50;">Brochure</button>
            <button type="button" class="btn p-3 text-white" data-bs-toggle="button" onclick="openCity('Scholarship')"
                style="font-size: 22px; font-weight: 600; background-color: #162b50;">Scholarship</button>
            <button type="button" class="btn p-3 text-white" data-bs-toggle="button" onclick="openCity('Apply')"
                style="font-size: 22px; font-weight: 600; background-color: #162b50;">How To Apply</button>
        </p>
        <div class="container pb-5">
            ...
            <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                <div class="card-body para1">
                    ...
                    <p class="text-dark pt-2 m-0">B.Sc.(H) from any recognized University/Institution in relevant
                        field
                        Or B.Sc. with minimum 50%
                        marks in aggregate and minimum 50% in subject opted, from any recognized
            ...
            <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                <div class="card-body para1">
                    <h3>Brochure</h3>
                    <p class="text-dark pt-2 fw-bold m-0">Brochure 2024-25.</p>
                </div>
            </div>
