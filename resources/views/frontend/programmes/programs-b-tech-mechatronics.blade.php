...
@section('content')
                    ...
                    <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent">
                        ...
                        <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                            ...
                            <p class="mobile-para1 text-dark">i)10+2 or equivalent from a recognized Board/Council,
                                ...
                                iii) having minimum 50% marks or equivalent grade (5% relaxation to SC/ST/OBC-Non-Creamy
                            ...
                            <p class="mobile-para1 text-dark">Candidates must obtain a valid score in JEE/CEE or R-JEE
                                (Royal Joint Entrance Examinations) followed by Personal Interview.
                            </p>
                        ...
                        <div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tab3-tab">
                            ...
                            <div class="text-center">
                                ...
                                <a href="mobile-assets/Domestic/B.Tech.-Mechatronics.pdf" target="_blank"
    ...
    <div class="website">
        ...
        <div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">B.Tech. - Mechatronics</h3>
            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">i)10+2 or equivalent from a recognized Board/Council,
                            ii) with Physics, Chemistry & Mathematics as compulsory subjects
                            iii) having minimum 50% marks or equivalent grade (5% relaxation to SC/ST/OBC-Non-Creamy Layer)
