...
@section('title', 'Best M.Pharm Pharmacognosy Program in North East India | Royal Global University')
@section('meta_description', 'Royal Global University’s M.Pharm in Pharmacognosy equips students with deep knowledge in plant-based therapeutics, herbal drug formulation, and pharmacological research.')
@section('meta_keywords', 'M pharm in Pharmacognosy')
@section('content')
      ...
      <div class="section-body">
        <div class="tabs-container">
          ...
          <div id="fee" class="tab-content active mobile-para1">
            ...
            <ol class="text-dark">
              <li>
                Yearly Payment (Rs. - 145000.00)
              </li>
              <li>
                Semester Payment (Rs. - 74500.00)
              </li>
            </ol>
            </p>
          ...
          <div id="eligibility" class="tab-content mobile-para1">
            ...
            <p class="text-dark">
              B.Pharm from PCI recognized Institute with minimum
              55% marks in aggregate or equivalent grade (5%
