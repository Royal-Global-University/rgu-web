            ...
            <div class="tabs-container">
                ...
                <div id="scholarship" class="tab-content mobile-para1">
                    ...
                    <ol class="text-dark">
                        ...
                        <li>
                            Existing students can seek help from their departmental coordinators to keep themselves updated
                            for the
                ...
                <div id="apply" class="tab-content mobile-para1">
                    ...
                    <a target="_blank" class="mobile-headd3 fw-bold" style="color: #FF9A1E;" href="/how-to-apply">For more
                        details, click to view</a>
