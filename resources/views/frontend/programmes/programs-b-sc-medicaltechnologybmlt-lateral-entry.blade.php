...
@section('content')
    ...
    <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
        ...
        <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
            ...
            <p class="mobile-para1 text-dark">Candidates must have a diploma in Medical Lab Technology or a related field, with a minium of 50% aggregate marks.</p>
                ...
                <div class="container pb-5">
                    ...
                    <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                        <div class="card-body para1">
                            ...
                            <p class="text-dark pt-2 m-0">Candidates must have a diploma in Medical Lab Technology or a related field, with a minium of 50% aggregate marks.</p>
