...
@section('meta_description', 'Enroll in the best MSc Geography course in Assam at Royal Global University. Gain in-depth
    knowledge, hands-on research experience, and prepare for careers in academics, planning, and environmental studies.')
      ...
      <div class="section-body">
        <div class="tabs-container">
          ...
          <div id="eligibility" class="tab-content mobile-para1">
            ...
            <p class="text-dark">
              Bachelor’s degree in science from any recognized University/Institution with minimum 45% marks or equivalent grade (5% relaxation to SC/ST/OBC-Non-Creamy Layer)
            </p>
          ...
          <div id="brochure" class="tab-content mobile-para1">
            ...
            <div
              ...
              <a target="_blank" class="text-danger fw-bold mobile-headd3 pt-2"
                href="https://www.rgu.ac/mobile-assets/Domestic/M.Sc.Geography.pdf">Download
                Brochure
