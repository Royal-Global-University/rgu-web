        ...
        <div class="container mt-4" style="max-width: 900px;">
            ...
            <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
                ...
                <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                    ...
                    <p class="mobile-para1 text-dark">Bachelor’s Degree in any field from recognized University/Institution with minimum 45% marks or equivalent grade (5% relaxation to SC/ST/OBC-Non-Creamy Layer)
                    </p>
            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">Bachelor’s Degree in any field from recognized University/Institution with minimum 45% marks or equivalent grade (5% relaxation to SC/ST/OBC-Non-Creamy Layer)
                        </p>
