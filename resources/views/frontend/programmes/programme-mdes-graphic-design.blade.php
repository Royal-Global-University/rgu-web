      ...
      <div class="section-body">
        <div class="tabs-container">
          ...
          <div id="eligibility" class="tab-content mobile-para1">
            ...
            <p class="text-dark">
              Bachelor’s degree in Graphic Design/Design/
              Engineering (Any stream)/ Architecture/ Interior
              Design/Fine Arts/ Visual Arts or in any relevant
              field/discipline from a recognized university with
