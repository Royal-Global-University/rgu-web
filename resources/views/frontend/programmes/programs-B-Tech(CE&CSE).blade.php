                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">
                            Passed Diploma examination with at least 50% Marks ( 45% Marks in case of SC/ST/OBC Non – Creamy).
                            Or, Passed B. Sc Degree from a recognized University with at least 50% Marks (45% Marks in case of
                            SC/ST/OBC Non – Creamy ) and passed 10+2 examination with Mathematics as a subject. Or, Passed B.
                            Voc/3Year D. Voc Stream in the same or allied sector.
                            <br>
                            Note :
                            <br>
                            (1) Mode of Conduct of Classes shall be as applicable for Regular Programs.<br>
                            (2) Timings for conduct of classes normally shall be in the evening hours/any flexible convenient
                            timings in alignment with timings of Industry / Organization.<br>
                            (3) Syllabus shall be same as applicable to regular students.<br>
                            (4) As per the AICTE Regulation up to 40% of credit transfer is permitted through MOOCs/ SWAYAM.<br>
                            (5) Examination shall be same as the regular students.
                        </p>
