...
@section('meta_description', content: 'Study M.Optometry at Royal Global University, Assam, and become a skilled eye care professional with comprehensive clinical exposure.')
      ...
      <div class="section-body">
        <div class="tabs-container">
          ...
          <div id="eligibility" class="tab-content mobile-para1">
            ...
            <ol>
              <li class="text-dark">
                Passed B. Optometry on regular mode from a recognised university.
              </li>
              <li class="text-dark">
