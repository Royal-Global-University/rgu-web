            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">B. Optometry or equivalent from a recognized University /
                            Institution with minimum 50% marks in aggregate or equivalent grade (5% relaxation to
