...
@section('content')
                    ...
                    <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent">
                        ...
                        <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                            ...
                            <p class="text-dark pt-2 m-0">
                                10+2 in science stream or equivalent from a recognized Board/ Council with minimum 45% marks
                                or equivalent grade and minimum 45% in subject opted (5% relaxation to SC/ST/OBC -
                                Non-Creamy Layer)
    ...
    <div class="website">
        ...
        <div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">B.Sc. Mathematics - Integrated with Civil Service Program</h3>
                    <h3 class="text-center headd3 text-dark">Duration - 03 Years<br>
                        <span class="text-center" style="font-size: 22px;">Royal School of Applied & Pure Sciences</span>
                    </h3>
            </div>
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">
                            ...
                            equivalent grade and minimum 45% in subject opted (5% relaxation to SC/ST/OBC - Non-Creamy
                            Layer)
                        </p>
                        <p class="text-dark pt-2 fw-bold m-0">Selection Process</p>
