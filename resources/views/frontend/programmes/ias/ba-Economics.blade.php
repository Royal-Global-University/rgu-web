...
@section('content')
    <div class="mobile">
        ...
        <div style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">
            ...
            <h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">
                B.A. Economics - Integrated with Civil Service Program
            </h2>
                ...
                <div style="padding: 20px 0px 0px 0px;">
                    <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent">
                        ...
                        <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
                            ...
                            <ol type="A">
                                <li>
                                    ...
                                    <ol type="a">
                                        <li>Application fees - 1000.00</li>
                        ...
                        <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                            ...
                            <p class="text-dark pt-2 m-0">10+2 or equivalent from a recognized Board/ Council with minimum
                                45% marks in aggregate or equivalent grade (5% relaxation to SC/ ST/ OBC – Non-Creamy Layer)
                                along with Mathematics or Economics as one of the compulsory subjects.
                        ...
                        <div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tab3-tab">
                            ...
                            <div class="text-center">
                                ...
                                <a href="mobile-assets/Domestic/LLMDayShift.pdf" target="_blank" class="btn mobile-para1"
    ...
    <div class="website">
        ...
        <div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">B.A. Economics - Integrated with Civil Service Program</h3>
                    <h3 class="text-center headd3 text-dark">Duration - 03 Years<br>
                        <span class="text-center" style="font-size: 22px;">Royal School of Humanities & Social
                            Sciences</span>
                    </h3>
            </div>
            ...
            <div class="container pb-5">
                <div id="Fee" class="w3-container city card p-5 shadow" style="display:block">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">a. Application fees - 1000.00</p>
                        <p class="text-dark pt-2 m-0">b. Registration fees -
                            10000.00</p>
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">10+2 or equivalent from a recognized Board/ Council with minimum 45%
                            marks in aggregate or equivalent grade (5% relaxation to SC/ ST/ OBC – Non-Creamy Layer) along
                            with Mathematics or Economics as one of the compulsory subjects.
