...
@section('meta_description', 'Become a future leader in the hospitality sector with Royal Global University’s Bachelor
    of Hotel Management course designed for career-focused students.')
            ...
            <div class="section-body">
                <div class="tabs-container">
                    ...
                    <div id="fee" class="tab-content active mobile-para1">
                        ...
                        <ol class="text-dark">
                            <li>
                                Yearly Payment (Rs. - 105000.00)
                            </li>
                            <li>
                                Semester Payment (Rs. - 54000.00)
                            </li>
                        </ol>
                        </p>
                    ...
                    <div id="brochure" class="tab-content mobile-para1">
                        ...
                        <div
                            ...
                            <a target="_blank" class="text-danger fw-bold mobile-headd3 pt-2"
                                href="https://www.rgu.ac/mobile-assets/Domestic/B.Sc.-BA-Hotel_Management.pdf">Download
                                Brochure
