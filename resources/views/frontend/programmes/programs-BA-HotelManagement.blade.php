...
@section('title', 'Royal Global University’s Bachelor of Hotel Management: Shaping Future Hospitality Professionals')
@section('meta_description', 'Become a future leader in the hospitality sector with Royal Global University’s Bachelor of Hotel Management course designed for career-focused students.')
@section('meta_keywords', 'Bachleor of Hotel Mangement')
@section('content')
<div class="mobile">
...
<div style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">
            ...
            <h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">B.Sc./BA Hotel Management
            </h2>

            <p class="mobile-headd3 text-dark text-center" style="line-height: 1.3;">Duration - 3/4 Yrs as per NEP <br> Royal School of Hotel Management
                (RSHM)
            </p>
        ...
        <div class="container mt-4" style="max-width: 900px;">
            ...
            <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
                <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
                    ...
                    <ol class="mobile-para1 text-dark">
                        <li>Yearly Payment (Rs. - 105000.00)</li>
                        <li>Semester Payment (Rs. - 54000.00)</li>
                    </ol>
                ...
                <div class="text-center">
                    ...
                    <a href="mobile-assets/Domestic/B.Sc.-BA-Hotel_Management.pdf" target="_blank" class="btn mobile-para1" style="background-color: #27467A; color: white; font-weight: bold; padding: 10px 15px; border-radius: 5px; text-decoration: none; line-height: 1.3; display: flex; align-items: center; justify-content: center; gap: 8px;">
...
<div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">B.Sc./BA Hotel Management</h3>
                    <h3 class="text-center headd3 text-dark">Duration - 3/4 Yrs as per NEP<br>
                        <span class="text-center" style="font-size: 22px;">Royal School of Hotel Management
                            (RSHM)</span>
                    </h3>
            </div>
                ...
                <div id="Fee" class="w3-container city card p-5 shadow" style="display:block">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0">B.) Programmes fee to be paid Yearly / semester payment for
                            New
                            Students 2025-26</p>
                        <p class="text-dark pt-2 m-0">Yearly Payment (Rs. - 105000.00)</p>
                        <p class="text-dark pt-2 m-0">Semester Payment (Rs. - 54000.00)</p>
                    </div>
                </div>
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a
                                href="mobile-assets/Domestic/B.Sc.-BA-Hotel_Management.pdf">Brochure 2025-26<i
