...
@section('meta_description', 'Get ready for a successful career in dietetics and nutrition with Royal Global
    University’s top-ranked B.Sc Nutrition and Dietetics program.')
            ...
            <div class="section-body">
                <div class="tabs-container">
                    ...
                    <div id="eligibility" class="tab-content mobile-para1">
                        ...
                        <ol>
                            <li class="text-dark">
                                10+2 or equivalent with Physics, Chemistry, and Biology with 50% marks and English as a
                                subject.
                            </li>
                            <li class="text-dark">
