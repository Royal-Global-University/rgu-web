...
@section('title', 'Royal Global University’s B.Sc Nutrition and Dietetics – Excellence in Diet and Health Science')
@section('meta_description', 'Get ready for a successful career in dietetics and nutrition with Royal Global University’s top-ranked B.Sc Nutrition and Dietetics program.')
@section('meta_keywords', 'B.Sc Nutrition and Dietetics')
@section('content')
  <div style="background-image: url(mobile-assets/programme-details/bg.svg); background-size: cover;">
    ...
    <div class="mobile">
      ...
      <p class="mobile-headd1 text-center" style="color: #24477f;">
        Duration - (4 Yrs including six months
      ...
      <div class="section-body">
        <div class="tabs-container">
          ...
          <div id="eligibility" class="tab-content mobile-para1">
            ...
            <ol>
              <li class="text-dark">
                10+2 or equivalent with Physics, Chemistry, and Biology with 50% marks and English as a subject.
              </li>
              <li class="text-dark">
