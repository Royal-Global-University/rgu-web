...
<div style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">
            ...
            <h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">B.Des - FD(Fashion Design)
            </h2>
        
            <p class="mobile-headd3 text-dark text-center" style="line-height: 1.3;">Duration - 04 Years <br> Royal School of Fashion Design & Technology (RSFT)
            </p>
...
<div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">B.Des - FD(Fashion Design)</h3>
                    <h3 class="text-center headd3 text-dark">Duration - 04 Years<br>
                        <span class="text-center" style="font-size: 22px;">Royal School of Fashion Design & Technology (RSFT)</span>
                    </h3>
            </div>
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a
                                href="mobile-assets/Domestic/Bachelor_Design(Fashion_Design)(B.Des.FD).pdf">Brochure
