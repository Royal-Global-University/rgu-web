...
<div style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">
            ...
            <h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">MBA
            </h2>
        
            <p class="mobile-headd3 text-dark text-center" style="line-height: 1.3;">
                (Finance, Marketing, HRM, Operations Management,
                    Entrepreneurship & Small Business Management, Business Analytics)<br>
                    Duration - 02 Years <br>Royal School of Business (RSB)
            </p>
        ...
        <div class="container mt-4" style="max-width: 900px;">
            ...
            <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
                <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
                    ...
                    <ol class="mobile-para1 text-dark">
                        <li>Yearly Payment (Rs. - 300000.00)</li>
                        <li>Semester Payment (Rs. - 152500.00)</li>
                    </ol>
                ...
                <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                    ...
                    <p class="mobile-para1 text-dark">Bachelor’s Degree in any discipline from any recognized University/Institution with minimum 50% marks or equivalent grade (5% relaxation to SC/ST/OBC – Non-Creamy Layer).</p>
                    <p class="mobile-headd3 fw-bold text-dark">Selection Process
                    </p>
        
                    <p class="mobile-para1 text-dark">An entrance test conducted by Royal Global University followed by Group Discussion and Personal Interview.
                        Candidates with a valid score of CAT/ XAT/ GMAT /MAT/ CMAT or any other all India entrance test with minimum 75 percentile will be exempted from appearing in the entrance test conducted by the University.
                    </p>
                ...
                <div class="text-center">
                    ...
                    <a href="mobile-assets/Domestic/MBA-HRM.pdf" target="_blank" class="btn mobile-para1" style="background-color: #27467A; color: white; font-weight: bold; padding: 10px 15px; border-radius: 5px; text-decoration: none; line-height: 1.3; display: flex; align-items: center; justify-content: center; gap: 8px;">
...
<div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h3 class="text-center m-0 text-dark">MBA</h3>
                <h3 class="text-center headd3 text-dark">(Finance, Marketing, HRM, Operations Management,
                    Entrepreneurship & Small Business Management, Business Analytics)<br>
                    <h3 class="text-center headd3 text-dark">Duration - 02 Years<br>
                        <span class="text-center" style="font-size: 22px;">Royal School of Business (RSB)</span>
                    </h3>
            </div>
            ...
            <div class="container pb-5">
                <div id="Fee" class="w3-container city card p-5 shadow" style="display:block">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0">B.) Programmes fee to be paid Yearly / semester payment for
                            New
                            Students 2025-26</p>
                        <p class="text-dark pt-2 m-0">Yearly Payment (Rs. - 300000.00)</p>
                        <p class="text-dark pt-2 m-0">Semester Payment (Rs. - 152500.00)</p>
                    </div>
                </div>
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">Bachelor’s Degree in any discipline from any recognized University/Institution with minimum 50% marks or equivalent grade (5% relaxation to SC/ST/OBC – Non-Creamy Layer).</p>
                       
                        <p class="text-dark pt-2 fw-bold m-0">Selection Process</p>
                        <p class="text-dark pt-2 m-0">An entrance test conducted by Royal Global University followed by Group Discussion and Personal Interview.
                            Candidates with a valid score of CAT/ XAT/ GMAT /MAT/ CMAT or any other all India entrance test with minimum 75 percentile will be exempted from appearing in the entrance test conducted by the University.
                        </p>
                    </div>
                </div>
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a href="mobile-assets/Domestic/MBA-HRM.pdf">Brochure
