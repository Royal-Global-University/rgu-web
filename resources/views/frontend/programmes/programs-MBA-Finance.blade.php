        ...
        <div class="mobile">
            ...
            <div class="container">
                ...
                <h2 class="mobile-headd3 fw-bold text-center pt-2" style="color: #27467A; font-weight: 900;">
                    (Finance, Marketing, HRM, Operations Management, Entrepreneurship & Small Business Management, Business
                    Analytics)
                </h2>
            ...
            <div class="section-body">
                <div class="tabs-container">
                    ...
                    <div id="fee" class="tab-content active mobile-para1">
                        ...
                        <ol class="text-dark">
                            <li>
                                Yearly Payment (Rs. - 300000.00)
                            </li>
                            <li>
                                Semester Payment (Rs. - 152500.00)
                            </li>
                        </ol>
                        </p>
                    ...
                    <div id="eligibility" class="tab-content mobile-para1">
                        ...
                        <p class="text-dark">
                            ...
                            An entrance test conducted by Royal Global University followed by Group Discussion and Personal
                            Interview.
                            Candidates with a valid score of CAT/ XAT/ GMAT /MAT/ CMAT or any other all India entrance test
                            with
                            minimum 75 percentile will be exempted from appearing in the entrance test conducted by the
                            University.
                    ...
                    <div id="brochure" class="tab-content mobile-para1">
                        ...
                        <div
                            ...
                            <a target="_blank" class="text-danger fw-bold mobile-headd3 pt-2"
                                href="/mobile-assets/Domestic/MBA-HRM.pdf">Download Brochure <i class="fa-solid fa-file-pdf"
