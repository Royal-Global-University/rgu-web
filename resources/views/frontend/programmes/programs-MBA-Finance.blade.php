            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">Bachelor’s Degree in any discipline from any recognized
                            University/Institution with minimum 50% marks or equivalent grade(5% relaxation to SC/ST/OBC
                            – Non-Creamy Layer).</p>
                        <p class="text-dark pt-2 fw-bold m-0">Selection Process</p>
                        <p class="text-dark pt-2 m-0">An entrance test conducted by Royal Global University followed by
                            Group Discussion and Personal Interview. Candidates with a valid score of CAT/ XAT/ GMAT
                            /MAT/ CMAT or any other all India entrance test with minimum 75 percentile will be exempted
                            from appearing in the entrance test conducted by the University.</p>
                    </div>
                </div>
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a href="assets/programme-pdf/MBA-HRM.pdf">Brochure
