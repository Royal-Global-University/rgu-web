...
@section('meta_description', 'Enroll in the M.A. J&MC program at Royal Global University, Assam. Gain hands-on media training, expert guidance, and launch a successful career in journalism and communication.')
        ...
        <div class="container mt-4" style="max-width: 900px;">
            ...
            <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
                ...
                <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                    ...
                    <p class="mobile-para1 text-dark">Bachelor’s Degree in relevant field from any recognized University/Institution with minimum 45% marks or equivalent grade (5% relaxation to SC/ST/OBC – Non-Creamy Layer)
                        <br>
                        Or
                        <br> A Bachelor’s Degree in any field with 1-year diploma in relevant field, from any recognized University/Institution with minimum 45% marks or equivalent grade (5% relaxation to SC/ST/OBC – Non-Creamy Layer)
                      </p>
                ...
                <div class="text-center">
                    ...
                    <a href="mobile-assets/Domestic/MA-J&MC.pdf" target="_blank" class="btn mobile-para1" style="background-color: #27467A; color: white; font-weight: bold; padding: 10px 15px; border-radius: 5px; text-decoration: none; line-height: 1.3; display: flex; align-items: center; justify-content: center; gap: 8px;">
            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">Bachelor’s Degree in relevant field from any recognized University/Institution with minimum 45% marks or equivalent grade (5% relaxation to SC/ST/OBC – Non-Creamy Layer)
                            <br>
                            Or
                            <br> A Bachelor’s Degree in any field with 1-year diploma in relevant field, from any recognized University/Institution with minimum 45% marks or equivalent grade (5% relaxation to SC/ST/OBC – Non-Creamy Layer)
                          </p>
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a href="mobile-assets/Domestic/MA-J&MC.pdf">Brochure
