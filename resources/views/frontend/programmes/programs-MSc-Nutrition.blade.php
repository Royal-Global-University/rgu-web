...
<div style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">
            ...
            <h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">M.Sc. - Nutrition and Dietetics
            </h2>
        ...
        <div class="container mt-4" style="max-width: 900px;">
            ...
            <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
                ...
                <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                    ...
                    <p class="mobile-para1 text-dark">B.Sc in Home Science / Life Sciences / Clinical Nutrition / Nutrition & Dietetics / Microbiology / Bio-Chemistry / Bio-technology / B Sc Food Science & Quality Control / B Sc Food Science /B Sc Food Technology / BAMS (Ayurveda)/ PG Diploma in Dietetics and Nutrition from any recognized University/Institution with minimum 50% marks in aggregate or equivalent grade ( 5% relaxation to SC/ST/OBC – Non Creamy Layer)
                    </p>
            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">B.Sc in Home Science / Life Sciences / Clinical Nutrition / Nutrition & Dietetics / Microbiology / Bio-Chemistry / Bio-technology / B Sc Food Science & Quality Control / B Sc Food Science /B Sc Food Technology / BAMS (Ayurveda)/ PG Diploma in Dietetics and Nutrition from any recognized University/Institution with minimum 50% marks in aggregate or equivalent grade ( 5% relaxation to SC/ST/OBC – Non Creamy Layer)
                        </p>
