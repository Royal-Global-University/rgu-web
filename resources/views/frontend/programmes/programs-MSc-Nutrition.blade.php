            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">B Sc in Home Science / Life Sciences / Clinical Nutrition /
                            Nutrition & Dietetics / Microbiology / Bio-Chemistry / Bio-technology / B Sc Food Science &
                            Quality Control / B Sc Food Science /B Sc Food Technology / BAMS (Ayurveda)/ PG Diploma in
                            Dietetics and Nutrition from any recognized University/Institution with minimum 50% marks in
                            aggregate or equivalent grade ( 5% relaxation to SC/ST/OBC – Non Creamy Layer)
                        </p>
