...
@section('title', 'Royal Global University M.Sc Nutrition – Top Postgraduate Course in Assam')
@section('meta_description', 'Study M.Sc Nutrition at Royal Global University and develop critical skills in nutritional assessment, diet planning, and wellness management.')
@section('meta_keywords', 'M.Sc Nutrition')
@section('content')
      ...
      <div class="section-body">
        <div class="tabs-container">
          ...
          <div id="fee" class="tab-content active mobile-para1">
            ...
            <ol class="text-dark">
              <li>
                Yearly Payment (Rs. - 113000.00)
              </li>
              <li>
                Semester Payment (Rs. - 58000.00)
              </li>
            </ol>
            </p>
          ...
          <div id="eligibility" class="tab-content mobile-para1">
            ...
            <ol>
              <li class="text-dark">
                Passed Bachelor of Nutrition and Dietetics (Honours) / B.Sc. Nutrition and Dietetics (Honours) / B.Sc.
                Food and Nutrition on regular mode from any recognized University.
              </li>
              <li class="text-dark">
