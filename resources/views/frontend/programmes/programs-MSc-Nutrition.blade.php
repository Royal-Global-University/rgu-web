...
@section('meta_description', 'Study M.Sc Nutrition at Royal Global University and develop critical skills in nutritional
    assessment, diet planning, and wellness management.')
            ...
            <div class="section-body">
                <div class="tabs-container">
                    ...
                    <div id="eligibility" class="tab-content mobile-para1">
                        ...
                        <ol>
                            <li class="text-dark">
                                Passed Bachelor of Nutrition and Dietetics (Honours) / B.Sc. Nutrition and Dietetics
                                (Honours) / B.Sc.
                            ...
                            <li class="text-dark">
                                Postgraduate entrance eligibility requires compulsory registration with the National
                                Commission for
