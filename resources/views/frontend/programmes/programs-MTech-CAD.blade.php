...
@section('title', 'Best M.Tech CAD/CDC Course in Assam at Royal Global University')
@section('meta_description', 'Master advanced CAD and CDC technologies with Royal Global University’s best M.Tech
    program in Assam. Prepare for a successful career in design and engineering.')
@section('meta_keywords', 'M tech.CAD/CDC')
@section('content')
    <div class="mobile">
                    ...
                    <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent">
                        ...
                        <div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tab3-tab">
                            ...
                            <div class="text-center">
                                ...
                                <a href="mobile-assets/Domestic/M.Tech.-CAD.pdf" target="_blank" class="btn mobile-para1"
    ...
    <div class="website">
        ...
        <div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">M.Tech. CAD/CDC</h3>
            ...
            <div class="container pb-5">
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a href="mobile-assets/Domestic/M.Tech.-CAD.pdf">Brochure
