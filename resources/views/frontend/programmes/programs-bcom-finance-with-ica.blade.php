...
@section('meta_description', 'Pursue B.Com Finance at Royal Global University, Assam. Learn from expert faculty, explore
    industry-focused curriculum, and build a strong career in finance.')
    ...
    <div style="background-image: url(mobile-assets/programme-details/bg.svg); background-size: cover;">
        ...
        <div class="mobile">
            ...
            <div class="container" style="padding-top: 80px; position: relative;">
                ...
                <h2 class="mobile-headd1 fw-bold text-center pt-2" style="color: #27467A; font-weight: 900;">
                    Banking & Finance/Finance & Accounts (with ICA)
                </h2>
                    ...
                    <div id="brochure" class="tab-content mobile-para1">
                        ...
                        <div
                            ...
                            <a target="_blank" class="text-danger fw-bold mobile-headd3 pt-2"
                                href="https://www.rgu.ac/mobile-assets/Domestic/B.Com-Finance_ICA.pdf">Download Brochure <i
