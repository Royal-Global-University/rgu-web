    ...
    <div id="page" class="site site_wrapper">
        ...
        <div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                ...
                <h3 class="text-center headd3 text-dark" style="font-size: 20px;">(with ACCA / with CMA / Finance with
                    ICA)<br></h3>
                <h3 class="text-center headd3 text-dark" style="font-size: 20px;">Duration -3/4 Yrs as per NEP<br>
            ...
            <div class="container pb-5">
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1 text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a href="assets/programme-pdf/B.Com-Finance_ICA.pdf">Brochure
