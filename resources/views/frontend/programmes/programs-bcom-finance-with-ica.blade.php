...
@section('title', 'Study B.Com Finance at Royal Global University | Top Commerce Program in Assam')
@section('meta_description', 'Pursue B.Com Finance at Royal Global University, Assam. Learn from expert faculty, explore industry-focused curriculum, and build a strong career in finance.')
@section('meta_keywords', 'B.Com Finance')
@section('content')
<div class="mobile">
...
<div style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">
            ...
            <h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">B.Com
            </h2>

            <p class="mobile-headd3 text-dark text-center" style="line-height: 1.3;">
                (with ACCA / with CMA / Finance with ICA) <br>
                Duration - 3/4 Yrs as per NEP <br> Royal School of Commerce
                (RSC)
            </p>
        ...
        <div class="container mt-4" style="max-width: 900px;">
            ...
            <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
                ...
                <div class="text-center">
                    ...
                    <a href="mobile-assets/Domestic/B.Com-Finance_ICA.pdf" target="_blank" class="btn mobile-para1" style="background-color: #27467A; color: white; font-weight: bold; padding: 10px 15px; border-radius: 5px; text-decoration: none; line-height: 1.3; display: flex; align-items: center; justify-content: center; gap: 8px;">
...
<div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">B.Com</h2>

                <h3 class="text-center headd3 text-dark" style="font-size: 20px;">
                    (with ACCA / with CMA / Finance with ICA) <br>
                    Duration -3/4 Yrs as per NEP<br>
                    <span class="text-center headd3 text-dark" style="font-size: 20px;">Royal School of Commerce
                        (RSC)</span>
                </h3>
            </div>
            ...
            <div class="container pb-5">
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1 text-center">
                        <img class="rounded shadow" src="assets/img/File/brochurethumb.png">
                        <p class="text-dark pt-2 fw-bold m-0"><a
                                href="mobile-assets/Domestic/B.Com-Finance_ICA.pdf">Brochure 2025-26<i
