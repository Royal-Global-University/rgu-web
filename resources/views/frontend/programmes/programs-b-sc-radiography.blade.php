...
@section('title', 'Top B.Sc Radiography & Imaging Program in Assam | Royal Global University')
@section('meta_description',
    'Explore advanced diagnostic techniques with Royal Global University’s B.Sc in Radiography
    & Imaging. Get hands-on hospital training and industry-aligned education.')
@section('meta_keywords', 'B.SC Radiography and advanced Imagine Technology')
@section('content')
    <div class="mobile">
                ...
                <div style="padding: 20px 0px 0px 0px;">
                    <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent">
                        ...
                        <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                            ...
                            <p class="mobile-para1 text-dark">10+2 in science stream or equivalent from a recognized
                                Board/Council, with minimum 50% marks or equivalent grade in Physics, Chemistry & Biology
                                taken together (5% relaxation to SC/ST/OBC-Non-Creamy Layer)
                            </p>
    ...
    <div class="website">
        ...
        <div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">B.Sc. - Radiography and Advance Imaging Technology</h2>
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">10+2 in science stream or equivalent from a recognized Board/Council,
                            with minimum 50% marks or equivalent grade in Physics, Chemistry & Biology taken together (5%
