...
@section('meta_description', 'Royal Global University’s B.Sc Nursing program for a rewarding career in healthcare. Get
    hands-on experience and theoretical knowledge in a supportive learning environment.')
                    ...
                    <div id="eligibility" class="tab-content mobile-para1">
                        ...
                        <ul>
                            ...
                            <li class="text-dark">
                                ...
                                examination (10+2) and must have obtained a minimum of 45% ( 40% for ST/ SC/ OBC Non creamy)
                                marks in Physics, Chemistry and Biology taken together. The candidate must have pass marks
                                in English.
                            </li>
                            <li class="text-dark">
