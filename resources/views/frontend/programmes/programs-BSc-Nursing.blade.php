    ...
    <div id="page" class="site site_wrapper">
        ...
        <div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">B.Sc. Nursing</h2>
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">
                            i) 10+2 in Science Stream and should have passed in PCB & English as compulsory subject ii)
                            Scored, minimum 50% marks in PCB taken together iii) (5% relaxation to SC/ST/OBC –
                            Non-Creamy layer) iv) Student should be medically fit and, v) Student must be minimum 17
                            years of age as on 31st December of the year in which admission is sought.
                        </p>
