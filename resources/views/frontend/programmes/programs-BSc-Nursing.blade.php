...
<p class="mobile-headd3 text-dark text-center" style="line-height: 1.3;">Duration - 04 Years <br> Royal School of Nursing (RSN)
</p>
...
<div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
    ...
    <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
        ...
        <p class="mobile-para1 text-dark">i) 10+2 in Science Stream and should have passed in PCB & English as compulsory subject
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">
                            i) 10+2 in Science Stream and should have passed in PCB & English as compulsory subject
                            ii) Scored, minimum 50% marks in PCB taken together
                            iii) (5% relaxation to SC/ST/OBC – Non-Creamy layer)
                            iv) Student should be medically fit and,
                            v) Student must be minimum 17 years of age as on 31st December of the year in which admission is sought.                            
