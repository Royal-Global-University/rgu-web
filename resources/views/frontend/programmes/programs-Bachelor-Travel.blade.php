...
@section('title', 'Best Bachelor of Travel and Tourism Management in Assam | Royal Global University')
@section('meta_description', 'Kickstart your career in the travel industry with Royal Global University’s new Bachelor
    of Travel and Tourism Management. Learn global tourism trends, hospitality, and destination management.')
@section('meta_keywords', 'Bachleor of travel and tourism management')
@section('content')
    <div class="mobile">
        ...
        <div style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">
            ...
            <p class="mobile-headd3 text-dark text-center" style="line-height: 1.3;">Duration - 04 Years <br> Royal School of
                Travel & Tourism Management (RSTTM)
            </p>
    ...
    <div class="website">
        ...
        <div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">Bachelor of Travel & Tourism Management (BTTM)</h2>
                <h3 class="text-center headd3 text-dark">Duration - 04 Years<br>
                    <span class="text-center">Royal School of Travel & Tourism Management (RSTTM)</span>
                </h3>
            </div>
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">
                            10+2 or equivalent from a recognized Board/ Council with minimum 45% marks or equivalent grade
