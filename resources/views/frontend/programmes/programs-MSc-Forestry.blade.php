...
@section('meta_description', 'Royal Global University’s M.Sc Forestry in Assam equips you with advanced skills in forest
    planning, conservation techniques, and climate adaptation strategies.')
            ...
            <div class="section-body">
                <div class="tabs-container">
                    ...
                    <div id="eligibility" class="tab-content mobile-para1">
                        ...
                        <p class="text-dark">
                            B.Sc. in Agriculture/Forestry/Horticulture /Biology or related field with minimum 45% marks in
                            aggregate
                            or equivalent grade from any recognized University/Institution (5% relaxation to SC/ST/OBC – Non
                            Creamy
                            Layer)
                        </p>
