...
@section('title', 'Royal Global University M.Sc Forestry – Best Postgraduate Program in Assam')
@section('meta_description', 'Royal Global University’s M.Sc Forestry in Assam equips you with advanced skills in forest planning, conservation techniques, and climate adaptation strategies.')
@section('meta_keywords', 'M.Sc Forestry')
@section('content')
      ...
      <div class="section-body">
        <div class="tabs-container">
          ...
          <div id="eligibility" class="tab-content mobile-para1">
            ...
            <p class="text-dark">
              B.Sc. in Agriculture/Forestry/Horticulture /Biology or related field with minimum 45% marks in aggregate
              or equivalent grade from any recognized University/Institution (5% relaxation to SC/ST/OBC – Non Creamy
              Layer)
            </p>
          ...
          <div id="brochure" class="tab-content mobile-para1">
            ...
            <div
              ...
              <a target="_blank" class="text-danger fw-bold mobile-headd3 pt-2"
                href="https://www.rgu.ac/mobile-assets/Domestic/M.Sc.Forestry.pdf">Download
                Brochure
