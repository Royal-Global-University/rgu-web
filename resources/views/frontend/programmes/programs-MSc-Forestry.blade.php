...
<div style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">
            ...
            <h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">M.Sc. Forestry
            </h2>
        ...
        <div class="container mt-4" style="max-width: 900px;">
            ...
            <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
                ...
                <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                    ...
                    <p class="mobile-para1 text-dark">B.Sc. in Agriculture/Forestry/Horticulture /Biology or related field with minimum 45% marks in aggregate or equivalent grade from any recognized University/Institution (5% relaxation to SC/ST/OBC – Non Creamy Layer)</p>
                ...
                <div class="text-center">
                    ...
                    <a href="mobile-assets/Domestic/M.Sc.Forestry.pdf" target="_blank" class="btn mobile-para1" style="background-color: #27467A; color: white; font-weight: bold; padding: 10px 15px; border-radius: 5px; text-decoration: none; line-height: 1.3; display: flex; align-items: center; justify-content: center; gap: 8px;">
...
<div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">M.Sc. Forestry</h2>
            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">B.Sc. in Agriculture/Forestry/Horticulture /Biology or related field with minimum 45% marks in aggregate or equivalent grade from any recognized University/Institution (5% relaxation to SC/ST/OBC – Non Creamy Layer)</p>
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a href="mobile-assets/Domestic/M.Sc.Forestry.pdf">Brochure
