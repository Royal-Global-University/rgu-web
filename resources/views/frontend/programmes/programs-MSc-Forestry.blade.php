            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">B.Sc. in Agriculture/Forestry/Horticulture /Biology or related
                            field with minimum 50% marks in aggregate or equivalent grade from any recognized
                            University/Institution (5% relaxation to SC/ST/OBC – Non-Creamy Layer)</p>
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a href="assets/programme-pdf/M.Sc.Forestry.pdf">Brochure
