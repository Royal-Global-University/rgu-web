...
@section('meta_description', 'Discover innovative learning with Royal Global University’s Bachelor of Designs in
    Communications course. Build your future in media, advertising, and digital communication.')
                    ...
                    <div id="brochure" class="tab-content mobile-para1">
                        ...
                        <div
                            ...
                            <a target="_blank" class="text-danger fw-bold mobile-headd3 pt-2"
                                href="https://rgu.ac/mobile-assets/Domestic/Bachelor_Design_(Communication_Design).pdf">Download
                                Brochure
