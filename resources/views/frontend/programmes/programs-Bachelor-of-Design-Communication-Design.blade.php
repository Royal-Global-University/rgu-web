...
@section('title', 'Top Bachelor of Designs in Communications Course at Royal Global University, Assam')
@section('meta_description', 'Discover innovative learning with Royal Global University’s Bachelor of Designs in Communications course. Build your future in media, advertising, and digital communication.')
@section('meta_keywords', 'Bachelor of Designs - communications')
@section('content')
<div class="mobile">
@include('frontend/components/mobileheader')
<div style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">
            <h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">Bachelor of Design (Communication Design)
            </h2>
...
<div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">Bachelor of Design (Communication Design)</h3>
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a
                                href="mobile-assets/Domestic/Bachelor_Design_(Communication_Design).pdf">Brochure
