...
@section('title', 'B.Sc Food Technology at The Assam Royal Global University | Innovating the Future of Food')
@section('meta_description', 'Build a career in food science with B.Sc Food Technology at Royal Global University—learn
    modern processing techniques, quality control, and innovation.')
@section('meta_keywords', 'B.Sc Food Technology')
@section('content')
    <div class="mobile">
                    ...
                    <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent">
                        ...
                        <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                            ...
                            <p class="mobile-para1 text-dark">10+2 in science stream or equivalent from a recognized Board/
                                ...
                                as compulsory subjects with minimum 45% marks or equivalent grade (5% relaxation to
                        ...
                        <div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tab3-tab">
                            ...
                            <div class="text-center">
                                ...
                                <a href="mobile-assets/Domestic/B.Sc-FoodTechnology.pdf" target="_blank"
    ...
    <div class="website">
        ...
        <div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">B.Sc. - Food Technology</h3>
                    <h3 class="text-center headd3 text-dark">Duration - 3/4 Yrs as per NEP<br>
                        <span class="text-center" style="font-size: 22px;">Royal School of Bio Sciences (RSBSC)</span>
                    </h3>
            </div>
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">10+2 in science stream or equivalent from a recognized Board/ Council
                            ...
                            compulsory subjects with minimum 45% marks or equivalent grade (5% relaxation to SC/ST/OBC -
                            Non-Creamy Layer)</p>
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a
                                href="mobile-assets/Domestic/B.Sc-FoodTechnology.pdf">Brochure 2025-26<i
