            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">10+2 in science stream or equivalent from a recognized Board/
                            ...
                            as compulsory subjects with minimum 50% marks or equivalent grade (5% relaxation to
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a href="assets/programme-pdf/B.Sc-FoodTechnology.pdf">Brochure
