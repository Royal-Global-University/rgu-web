...
@section('meta_description', 'Join the M.Sc Microbiology program at Royal Global University—explore microbial science
    with advanced labs, research opportunities, and expert faculty.')
        ...
        <div class="tabs-container">
          ...
          <div id="eligibility" class="tab-content mobile-para1">
            ...
            <p class="text-dark">
             ...
             B.Sc(H) from any recognized University/Institution in relevant field Or B.Sc with minimum 45% marks in aggregate
             and minimum 45% in subject opted, from any recognized University/Institution or equivalent grade(5% relaxation to SC/ST/OBC – Non-Creamy Layer)
          ...
          <div id="brochure" class="tab-content mobile-para1">
            ...
            <div
              ...
              <a target="_blank" class="text-danger fw-bold mobile-headd3 pt-2"
                href="https://www.rgu.ac/assets/img/programme-pdf/M.ScBio-Technology.pdf">Download Brochure <i
