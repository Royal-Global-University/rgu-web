        ...
        <div class="container mt-4" style="max-width: 900px;">
            ...
            <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
                ...
                <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                    ...
                    <p class="mobile-para1 text-dark">Passed Diploma examination with at least 50% Marks ( 50% marks in case of SC/ST/OBC Non – Creamy). Or, Passed B. Sc Degree from a recognized University with at least 50% Marks (50% marks in case of SC/ST/OBC Non – Creamy ) and passed 10+2 examination with Mathematics as a subject. Or, Passed B. Voc/3Year D. Voc Stream in the same or allied sector.
                        <br>Note : <br>
                        <ol class="text-dark para1">
                            ...
                            <li>
                                Timings for conduct of classes normally shall be in the evening hours/any flexible convenient timings in alignment with timings of Industry / Organization.
                            </li>
                            <li>
                    ...
                    <p class="mobile-para1 text-dark"> <ol class="para1 text-dark">
                        <li>
                        Professionals working in Registered Industry / Organization (Central / State) / Private/ Public Limited Company/ MSMEs located within 50 KM radial distance from place of residence/working place to the enrolled institutions.
                        </li>
                    <li>
            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">Passed Diploma examination with at least 50% Marks ( 50% marks in case of SC/ST/OBC Non – Creamy). Or, Passed B. Sc Degree from a recognized University with at least 50% Marks (50% marks in case of SC/ST/OBC Non – Creamy ) and passed 10+2 examination with Mathematics as a subject. Or, Passed B. Voc/3Year D. Voc Stream in the same or allied sector.
                            <br>Note : <br>
                            <ol class="text-dark">
                                <li>
                                    Mode of Conduct of Classes shall be as applicable for Regular Programs.
