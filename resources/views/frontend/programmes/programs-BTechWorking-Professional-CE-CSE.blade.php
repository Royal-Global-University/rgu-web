...
@section('content')
    <div class="mobile">
        ...
        <div style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp); padding-top: 90px; position: relative;">
            ...
            <p class="mobile-headd3 text-dark text-center" style="line-height: 1.3;">Duration - 03 Years <br>Royal School of
                ...
                <div style="padding: 20px 0px 0px 0px;">
                    <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent">
                        ...
                        <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
                            ...
                            <p class="mobile-para1 text-dark">Passed Diploma examination with at least 50% Marks ( 50% marks
                                in case of SC/ST/OBC Non – Creamy). Or, Passed B. Sc Degree from a recognized University
                                with at least 50% Marks (50% marks in case of SC/ST/OBC Non – Creamy ) and passed 10+2
                                examination with Mathematics as a subject. Or, Passed B. Voc/3Year D. Voc Stream in the same
                                or allied sector.
                                <br>Note : <br>
                            <ol class="text-dark para1">
                                <li>
                                    Mode of Conduct of Classes shall be as applicable for Regular Programs.
                                </li>
                                <li>
                                    Timings for conduct of classes normally shall be in the evening hours/any flexible
                                    convenient timings in alignment with timings of Industry / Organization.
                                </li>
                                <li>
                                    Syllabus shall be same as applicable to regular students.
                                </li>
                                <li>
                                    As per the AICTE Regulation up to 40% of credit transfer is permitted through MOOCs/
                                    SWAYAM.
                                </li>
                                <li>
                                    Examination shall be same as the regular students.
                                </li>
                            </ol>
                            </p>
                            ...
                            <ol class="para1 text-dark">
                                <li>
                                    Professionals working in Registered Industry / Organization (Central / State) / Private/
                                    Public Limited Company/ MSMEs located within 50 KM radial distance from place of
                                    residence/working place to the enrolled institutions.
                                </li>
                                <li>
                        ...
                        <div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tab3-tab">
                            ...
                            <div class="text-center">
                                ...
                                <a href="mobile-assets/Domestic/JEE%202024%20_compressed%20for%20web.pdf" target="_blank"
            ...
            <div class="container pb-5">
                ...
                <div id="Eligibility" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 m-0">Passed Diploma examination with at least 50% Marks ( 50% marks in
                            case of SC/ST/OBC Non – Creamy). Or, Passed B. Sc Degree from a recognized University with at
                            least 50% Marks (50% marks in case of SC/ST/OBC Non – Creamy ) and passed 10+2 examination with
                            Mathematics as a subject. Or, Passed B. Voc/3Year D. Voc Stream in the same or allied sector.
                            <br>Note : <br>
                        <ol class="text-dark">
                            <li>
                                Mode of Conduct of Classes shall be as applicable for Regular Programs.
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a
                                href="mobile-assets/Domestic/JEE%202024%20_compressed%20for%20web.pdf">Brochure 2025-26<i
