      ...
      <div class="section-body">
        <div class="tabs-container">
          ...
          <div id="eligibility" class="tab-content mobile-para1">
            ...
            <ol>
              <li class="text-dark">
                10+2 or equivalent with Physics, Chemistry, and Biology/Mathematics with a minimum of 50% marks in
                aggregate.
              </li>
              <li class="text-dark">
              ...
              <li class="text-dark">
                Lateral entry to candidates in the second year (3rd semester) who have passed a Diploma in Optometry /
