        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" style="height: 450px; width: 400px;" src="/mobile-assets/updated-faculty-img/B-J-Dutta.jpg"
                alt="">
            </div>
          </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i><span>Neurodegenerative disorders, Diabetes</span></li>
            </ul>
