                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Ph.D. (Thesis submitted),Birla Institute of Technology,
                                    Mesra</span></li>
                            <li><i class="fa fa-circle"></i> <span>M. Pharm, Birla Institute of Technology, Mesra</span>
                            </li>
                            <li><i class="fa fa-circle"></i> <span>B. Pharm, Assam University, Silchar</span></li>
                        </ul>

                        <h2 class="faculty-bio-sub-heading">Academic Experience:</h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Senior Research Fellow under the DST-SERB-EMEQ sponsored
                                    project, Government of India</span></li>
                        </ul>

                        <h2 class="faculty-bio-sub-heading">Research (outside teaching): </h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Training program at the Regional Drugs Testing
                                    Laboratory, Directorate General of Health Services, Government of India, Guwahati</span>
                            </li>
                        </ul>

                        <h2 class="faculty-bio-sub-heading">Research Interests:</h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i><span>Formulation and development</span></li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Gold Medal in Bachelor's Degree in Pharmacy, Assam
                                    University, Silchar</span></li>
                            <li><i class="fa fa-circle"></i> <span>Qualified Graduate Pharmacy Aptitude Test (GPAT),
                                    National Testing Agency (NTA)</span></li>
                            <li><i class="fa fa-circle"></i> <span>Selected for Ishan Uday Special Scholarship Scheme for
                                    North Eastern Region, University Grants Commission (UGC)</span></li>
                        </ul>
