        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" src="https://rgu.ac/mobile-assets/updated-faculty-img/nayanika.jpeg"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Ph.D.(Pursuing)- Girijananda Chowdhury University, Guwahati, Assam</span></li>
              <li><i class="fa fa-circle"></i> <span>M.Pharm (Pharmacology)- ASTU, GIPS, Guwahati.</span></li>
              <li><i class="fa fa-circle"></i> <span>B.Pharm -  ASTU, GIPS, Guwahati.</span></li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i><span>Worked in the scientific intramural project at ICMR-Headquarters, New Delhi (Assisted scientist in writing scoping review)</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Research Interests:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i><span>Rheumatoid Arthritis, Pharmacological Study, In-vivo study, Clinical trials</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>1 (Utility Patent)</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Qualified GPAT-2020</span></li>
              <li><i class="fa fa-circle"></i> <span>University Programme Topper</span></li>
