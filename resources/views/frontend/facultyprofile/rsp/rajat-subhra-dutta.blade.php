        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" style="height: 450px; width: 400px;" src="/mobile-assets/updated-faculty-img/rajat.png"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Ph.D. in Pharmaceutical Science (Dibrugarh University)</span></li>
              <li><i class="fa fa-circle"></i> <span>M.Pharm in Pharmaceutics specialization (Dibrugarh University)</span></li>
              <li><i class="fa fa-circle"></i> <span>B.Pharm (Dibrugarh University)</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Total Experience:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>13 years</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Academic Experience:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>11 years</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i><span>Modern Pharmaceutics</span></li>
              <li><i class="fa fa-circle"></i><span>Biopolymers</span></li>
              <li><i class="fa fa-circle"></i><span>Biomaterials</span></li>
              <li><i class="fa fa-circle"></i><span>Novel Drug Delivery Systems</span></li>
              <li><i class="fa fa-circle"></i><span>Dosage form design</span></li>
              <li><i class="fa fa-circle"></i><span>Nanotechnology and Natural products based drug delivery systems</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>1. Received LSRB-DRDO Fellowship for Life Sciences Research Board-Defence Research Development Organization, Govt. of India funded project.</span></li>
              <li><i class="fa fa-circle"></i> <span>2. Received the “Promising Researcher Award-2024, Girijananda Chowdhury University” on the occasion of 2nd Foundation Day of Girijananda Chowdhury University for research contribution during the year 2023-2024.</span></li>
            </ul>
