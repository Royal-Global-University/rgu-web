        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" src="https://www.rgu.ac/mobile-assets/updated-faculty-img/Prof-Bipul-Nath-RSP.png"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Ph.D. : Pharmaceutical Sciences, Department of Pharmaceutical Sciences, Dibrugarh University</span></li>
              <li><i class="fa fa-circle"></i> <span>M.Pharm : Pharmaceutics, Department of Pharmaceutical Sciences, Dibrugarh University</span></li>
              <li><i class="fa fa-circle"></i> <span>B.Pharm : Pharmacy, Department of Pharmaceutical Sciences, Dibrugarh University</span></li>
              <li><i class="fa fa-circle"></i> <span>D.Pharm: Pharmacy, Assam Medical College, Dibrugarh University.</span></li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>19 years</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>14 years</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Research Interests:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i><span>Anti-diabetic, anti-arthritic, brain targeted drug delivery, Novel Drug Delivery, Targeted DDS, Polyherbal formulation research</span></li>
            </ul>


            <h2 class="faculty-bio-sub-heading">Paper Publications in Journals:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>National: 09</span></li>
              <li><i class="fa fa-circle"></i> <span>International: 37</span></li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>02 [GATE qualified, Best Researcher award 2026]</span></li>
            </ul>
