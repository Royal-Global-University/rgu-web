        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" style="height: 450px; width: 400px;" src="/mobile-assets/updated-faculty-img/Manowara Begum-website.png"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Ph.D. (Pharmaceutics), SSUHS under Srimanta Sankardeva University of Health Sciences</span></li>
              <li><i class="fa fa-circle"></i> <span>M.Pharm (Pharmaceutics), Department of Pharmaceutical Sciences, Dibrugarh University</span></li>
              <li><i class="fa fa-circle"></i> <span>B.Pharm, GIPS, Gauhati University</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Total Experience:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>7.5 Years</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i><span>Pharmaceutics, Novel Drug Delivery Systems</span></li>
            </ul>
