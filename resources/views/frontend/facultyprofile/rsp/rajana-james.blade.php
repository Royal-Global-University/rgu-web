                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Pursuing Ph.D. in Pharmaceutical Science, Dibrugarh
                                    University</span></li>
                            <li><i class="fa fa-circle"></i> <span>M. Pharmacy (Pharmacology), KLE COLLEGE of Pharmacy,
                                    HUBLIKLE UNIVERSITY</span></li>
                            <li><i class="fa fa-circle"></i> <span>B. Pharmacy, GIRIJANANDA CHOWDHURY INSTITUTE OF
                                    PHARMACEUTICAL SCIENCES, GUWAHATI UNIVERSITY</span></li>
                        </ul>

                        <h2 class="faculty-bio-sub-heading">Total Experience:</h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span> 10 years and 8 months</span></li>
                        </ul>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i><span>My research interest includes Pharmacology,
                                    Neurodegenerative disorder and plant based Therapeutics.</span></li>
