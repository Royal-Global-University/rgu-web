        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" src="https://www.rgu.ac/mobile-assets/updated-faculty-img/Pranabesh-Sikdar-RSP.png"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Ph.D. (Pharmaceutical Science)- JNTUH, Hyderabad</span></li>
              <li><i class="fa fa-circle"></i> <span>M.Pharm (Pharmaceutical Chemistry)- JSS College of Pharmacy, Ooty, Tamil Nadu Dr. M.G.R. Medical University</span></li>
              <li><i class="fa fa-circle"></i> <span>B. Pharm - RGUHS, Bangaluru</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Total Experience:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>16 years 10 months</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Academic Experience:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>16 years 09 months</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Research Interests:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i><span>Natural Product Chemistry, Synthetic Chemistry, and pharmacological investigations focusing on wound healing and hepatoprotective activity.</span></li>
            </ul>
