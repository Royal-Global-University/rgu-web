        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" src="https://www.rgu.ac/mobile-assets/updated-faculty-img/Kamal-Deka-RSP.png"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Ph.D.- Department of Pharmacy, The Assam Royal Global University</span></li>
              <li><i class="fa fa-circle"></i> <span>M. Pharm, HIMALAYAN PHARMACY INSTITUTE Under Sikkim University, Sikkim, India</span></li>
              <li><i class="fa fa-circle"></i> <span>B. Pharm, HIMALAYAN PHARMACY INSTITUTE Under North Bengal University</span></li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i><span>Pharmaceutical formulation, Novel drug delivery system</span></li>
            </ul>
