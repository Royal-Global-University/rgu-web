        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" src="https://www.rgu.ac/mobile-assets/updated-faculty-img/Pallab-Kumar-Nath-RSP.png"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Ph.D (Pursuing) (Jan 2025 Batch) The Assam Royal Global University</span></li>
              <li><i class="fa fa-circle"></i> <span>M.Pharm (Pharmacognosy), 2021, Himalayan Pharmacy Institute, Sikkim University.</span></li>
              <li><i class="fa fa-circle"></i> <span>B.Pharm, 2019, Himalayan Pharmacy Institute, Sikkim University.</span></li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i><span>Phytopharmaceuticals, Nanomedicine, Biomaterials, Drug Delivery.</span></li>
            </ul>
