                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img class="faculty-bio-img" src="/assets/mobile-assets/Chayanika%20Talukdar.jpg" alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>M. Pharmacy, 2023 – 2025 – Ms. Ramaiah University of
                                    Applied
                                    Science, Bangalore, Karnataka</span></li>
                            <li><i class="fa fa-circle"></i> <span>B. Pharmacy, 2019 – 2023 – The Assam Royal Global
                                    University,
                                    Guwahati</span></li>
                        </ul>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>
                                    Medicinal plants, phytochemistry, natural product drug discovery, neuropharmacology,
                                    herbal
                                    therapeutics for neurodegenerative disorders, molecular docking and dynamics, zebrafish
                                    disease
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Presented “Exploring the Anticancer Potential of
                                    Rhamnetin” at the
                                    International Conference on Advances in Pharmaceutical Science Research: Traditional to
                                    Novel
                                    Approaches.</span></li>
                            <li><i class="fa fa-circle"></i> <span>Showcased poster at National Conference “PHARMAGYANAV”
                                    held in
