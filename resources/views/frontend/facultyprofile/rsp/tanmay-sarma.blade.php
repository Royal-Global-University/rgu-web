                        ...
                        <div class="col-lg-6 text-center">
                            <div class="text-center">
                                <img style="margin-top: 70px; width: 380px; border: 1px solid #27467A;"
                                    src="mobile-assets/updated-faculty-img/Mr-Tanmay-Sarma-RSP.png" alt="">
                            </div>
                        </div>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <span style="display: block;">
                                            Ph.D. Pursuing (Pharmacology) - School of Pharmaceutical Sciences, Girijananda
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            M.Pharm (Pharmacology) - Girijananda Chowdhury Institute of Pharmaceutical
                                            Science, Assam Science and Technology University </span>
                                    </li>
                                    <li
                                        style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            B.Pharm - Girijananda Chowdhury Institute of Pharmaceutical Science, Assam
                                            Science and Technology University </span>
                                    </li>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            My research interest lies in drug discovery, focusing on gastrointestinal
                                            disorders such as peptic ulcers. I am keen to explore novel therapeutic agents
                                            and molecular mechanisms involved in the pathophysiology and treatment of peptic
                                            ulcers. My broader interest in gastroenterology drives me to investigate
                                            innovative strategies that can enhance the efficacy and safety of drugs
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        M.Pharm (Pharmacology) - Girijananda Chowdhury Institute of Pharmaceutical Science,
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        B.Pharm - Girijananda Chowdhury Institute of Pharmaceutical Science, Assam Science
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        My research interest lies in drug discovery, focusing on gastrointestinal disorders
                                        such as peptic ulcers. I am keen to explore novel therapeutic agents and molecular
                                        mechanisms involved in the pathophysiology and treatment of peptic ulcers. My
                                        broader interest in gastroenterology drives me to investigate innovative strategies
                                        that can enhance the efficacy and safety of drugs targeting the gastrointestinal
                                        tract.
                                    </span>
                                </li>
