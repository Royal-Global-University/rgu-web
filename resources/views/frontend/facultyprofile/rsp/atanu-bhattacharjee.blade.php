                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img class="faculty-bio-img" src="/mobile-assets/updated-faculty-img/atanu-bhattacharjee-rsp.jpeg"
                                alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Ph.D.- Pharmaceutical Sciences, Nitte University</span>
                            </li>
                            <li><i class="fa fa-circle"></i> <span>M. Pharm- Pharmacognosy JSS College of Pharmacy, Ooty,
                                    Tamilnadu.</span></li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Awarded Senior Research Fellowship (SRF) from Central
                                    Council of Research in Ayurvedic Sciences (CCRAS), New Delhi, India on the project
                                    entitled “Evaluation of safety profile of herbs used in Ayurveda with CYP450 enzymes
                                    inhibition method”.</span></li>
                        </ul>

                        <h2 class="faculty-bio-sub-heading">Research Interests:</h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i><span>Phytochemical and neuro-pharmacological evaluation of
                                    traditional medicinal plants</span></li>
                            <li><i class="fa fa-circle"></i><span>Determination of safety profile of medicinal plant</span>
                            </li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Received the “Young Scientist Award-2021” in the
                                    International Scientist Awards on Engineering, Science and Medicine, held on 8th & 9th
                                    January2021, Salem, India, organized by VDGOOD Professional Association.</span></li>
                        </ul>
