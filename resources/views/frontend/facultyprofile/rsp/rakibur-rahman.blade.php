                        ...
                        <div class="col-lg-6 text-center">
                            <div class="text-center">
                                <img style="margin-top: 70px; width: 380px; border: 1px solid #27467A;"
                                    src="mobile-assets/updated-faculty-img/Rakibur-Rahman-RSP.png" alt="">
                            </div>
                        </div>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Pharm D (PB) – Sri Adichunchanagiri College of Pharmacy, Rajiv Gandhi University
                                            of Health
                                            Sciences
                                        </span>
                                    </li>
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            B. Pharm (Pharmaceutical Science) – Girijananda Chowdhury Institute of
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Hospital based - Drug prescribing patterns, Drug Utilization patterns, Drug
                                            related problems
                                            (DPRs), Medication Errors, Antibiotic resistance, Pharmacogenomics,
                                            Pharmacoeconomics and
                                            Development of treatment guideline & Pharmaceutical care plan etc.
                                        </span>
                                    </li>
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        Pharm D (PB) – Sri Adichunchanagiri College of Pharmacy, Rajiv Gandhi University of
                                        Health Sciences
                                    </span>
                                </li>
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        Hospital based - Drug prescribing patterns, Drug Utilization patterns, Drug related
                                        problems (DPRs),
                                        Medication Errors, Antibiotic resistance, Pharmacogenomics, Pharmacoeconomics and
                                        Development of
                                        treatment guideline & Pharmaceutical care plan etc.
                                    </span>
                                </li>
