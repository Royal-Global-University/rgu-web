        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" style="height: 450px; width: 400px;" src="/mobile-assets/updated-faculty-img/rubina.png"
                alt="">
            </div>
          </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>2 Years 8 Months</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i><span>Drug Design and Development</span></li>
              <li><i class="fa fa-circle"></i><span>Computer Aided Drug Design</span></li>
              <li><i class="fa fa-circle"></i><span>Natural Products</span></li>
              <li><i class="fa fa-circle"></i><span>Synthetic and Medicinal Chemistry</span></li>
            </ul>


            <h2 class="faculty-bio-sub-heading">Paper Publications in Journals:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>National: 06</span></li>
              <li><i class="fa fa-circle"></i> <span>International: 06</span></li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>1. Governor’s Gold medal in M. Pharm from Dibrugarh University.</span></li>
              <li><i class="fa fa-circle"></i> <span>2. Represented North East India in the Final round of ‘IPA-Devinder Pal- National Elocution Competition, 2022’ during 72 IPC (after qualifying three rounds i.e. Institutional, State/Zonal and Semi Final) and secured4 Position among nine finalists all across India.</span></li>
              <li><i class="fa fa-circle"></i> <span>3. Received Best Poster Award-II for poster presentation on REDIMAP-2021.</span></li>
              <li><i class="fa fa-circle"></i> <span>4. Received various awards and certificates in recitation, writing and painting in school, college and university level.</span></li>
            </ul>
