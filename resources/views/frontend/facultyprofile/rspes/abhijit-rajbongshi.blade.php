                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img src="/mobile-assets/updated-faculty-img/abhijit-sports.jpeg" class="faculty-bio-img" style="height: 400px; width: 400px;" src="" alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Masters in physical education: Rashtrasant Tukadoji
                                    Maharaj Nagpur University, 2023</span></li>
                            <li><i class="fa fa-circle"></i> <span>B. PED: Bharati Vidyapeeth University, Pune, 2020</span>
                            </li>
                            <li><i class="fa fa-circle"></i> <span>Bachelors in physical education: Sant Gadge Baba Amravati
                                    University, 2018</span></li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>UGC NET: 2024</span></li>
                            <li><i class="fa fa-circle"></i> <span>AIFF D LICENSE HOLDER.</span></li>
                        </ul>
