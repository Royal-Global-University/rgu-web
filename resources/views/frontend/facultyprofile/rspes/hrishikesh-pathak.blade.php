                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img src="/mobile-assets/updated-faculty-img/hrishikesh-sports.jpeg" class="faculty-bio-img" style="height: 400px; width: 400px;" src="" alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Masters in physical education: Bharati Vidyapeeth Deemed
                                    University, College of Physical Education, Pune: 2017</span></li>
                            <li><i class="fa fa-circle"></i> <span> Bachelors in physical education: Lakshmibai National
                                    Institute of Physical Education, NERC Guwahati: 2015</span></li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Conducted 15 numbers of AIU Sports events as an
                                    organising secretary.</span></li>
