        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" src="mobile-assets/updated-faculty-img/monalisha.jpeg"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Ph.D. (Animal Genetics & Breeding) – Assam Agricultural
                  University</span></li>
              <li><i class="fa fa-circle"></i> <span>MVSc (Animal Genetics & Breeding) – Assam Agricultural
                  University</span></li>
              <li><i class="fa fa-circle"></i> <span>BVSc & AH – Assam Agricultural University</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Academic & Administrative Experience:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>8 years</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Research Experience (Medical, Veterinary & Applied Biology):</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>8 years</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i>
                <span>
                  Immunogenetics; Molecular genetics; Medical and Cancer genetics; Animal genetics & breeding; Molecular
                  diagnostics (RT-PCR, HLA typing-Flowcytometry and Molecular Typing); Interdisciplinary Life Sciences.
                </span>
              </li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              ...
              <li><i class="fa fa-circle"></i> <span>National: 6</span></li>
            </ul>
            ...
            <h2 class="faculty-bio-sub-heading">Design Patent Granted:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>1</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>4 (ICMR, DST, AAU)</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Any Other Achievements/Awards:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Krantijyoti Savitribai Phule Women Achiever’s Award – 2024</span>
              </li>
              <li><i class="fa fa-circle"></i> <span>Northeast Women Leader Recognition – 2024</span></li>
            </ul>
