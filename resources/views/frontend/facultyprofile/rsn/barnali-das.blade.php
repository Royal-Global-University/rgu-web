        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" style="height: 450px; width: 400px;" src="/mobile-assets/updated-faculty-img/Barnali-Das.png"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Msc Nursing</span></li>
              <li><i class="fa fa-circle"></i> <span>Speciality- Obstetrics and gynecological Nursing</span></li>
              <li><i class="fa fa-circle"></i> <span>Institute- CPMS college of nursing</span></li>
              <li><i class="fa fa-circle"></i> <span>University- Srimanta Sankaradeva University of health sciences</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Total experience:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>3years 6month</span></li>

            </ul>

            <h2 class="faculty-bio-sub-heading">Teaching experience:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>2yrs</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Industry experience:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>1yr 6 month</span></li>
            </ul>

             <h2 class="faculty-bio-sub-heading">Paper publication in journal:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span> 1 in international journal </span></li>
            </ul>
          </div>
        </div>
      </div>
