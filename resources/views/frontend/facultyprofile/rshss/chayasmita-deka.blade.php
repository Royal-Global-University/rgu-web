                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img class="faculty-bio-img" style="height: 400px; width: 400px;"
                                src="https://rgu.ac/mobile-assets/updated-faculty-img/chayasmita.jpeg" alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Ph.D. (Economics), Indian Institute of Technology (IIT),
                                    Guwahati</span></li>
                            <li><i class="fa fa-circle"></i> <span>M.A. (Applied Economics), Christ University,
                                    Bangalore</span></li>
                            <li><i class="fa fa-circle"></i> <span>B.A. Economics (Hons), University of Delhi</span></li>

                        </ul>

                        <h2 class="faculty-bio-sub-heading">Total Experience:</h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>4.7 years</span></li>
                        </ul>


                        <h2 class="faculty-bio-sub-heading">Academic Experience:</h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>1.4 years</span></li>
                        </ul>

                        <h2 class="faculty-bio-sub-heading">Research (outside teaching): </h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>3.3 years</span></li>
                        </ul>

                        <h2 class="faculty-bio-sub-heading">Research Interests:</h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i><span>Behavioural Economics, Environmental Economics,
                                    Sustainability Transition</span></li>
                        </ul>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>3</span></li>
                        </ul>

                        <h2 class="faculty-bio-sub-heading">Any Other Achievements/Awards:</h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Young Scientist Summer Program (YSSP) Fellowship 2022,
                                    Laxenburg, Austria</span></li>
                            <li><i class="fa fa-circle"></i> <span>Secured a research grant from Austrian Climate Research
                                    Program (ACRP) FFG, Austria as a Co-PI/ project manager.</span></li>
                        </ul>
