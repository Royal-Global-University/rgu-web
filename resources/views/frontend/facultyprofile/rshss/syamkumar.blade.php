                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img class="faculty-bio-img" style="height: 400px; width: 400px;"
                                src="/mobile-assets/updated-faculty-img/syamkumar.jpeg" alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Ph.D. (International Organization) - Jawaharlal Nehru
                                    University, New Delhi.</span></li>
                            <li><i class="fa fa-circle"></i> <span>M.Phil. (International Organization) - Jawaharlal Nehru
                                    University, New Delhi</span></li>
                            <li><i class="fa fa-circle"></i> <span>M.A. (Political Science) - Department of Political
                                    Science, Kariavattom Campus, University of Kerala</span></li>
                            <li><i class="fa fa-circle"></i> <span>B.A. (Political Science) - St. Gregorius College,
                                    Kottarakkara, University of Kerala</span></li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i><span>United Nations, African Union, Climate Change, Children’s
                                    Rights, and Conflicts in Africa, Migration, and Refugees</span></li>
                        </ul>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>First prize in the All-India Elocution Competition
                                    conducted by the UGC –Nehru Studies, University of Kerala as a part of 131st birth
                                    anniversary celebrations of Pandit Jawaharlal Nehru</span></li>
