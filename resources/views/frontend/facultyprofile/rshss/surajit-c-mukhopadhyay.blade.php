                        ...
                        <div class="col-lg-6 text-center">
                            <div class="text-center">
                                <img style="margin-top: 70px; width: 380px; border: 1px solid #27467A;"
                                    src="mobile-assets/updated-faculty-img/Prof-Surajit-Mukhopadhyay..png" alt="">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 pt-4 pb-4">
                            ...
                            <h2 class="headd3 mb-5 pt-3 fw-bold half-underline" style="color: #fff; font-weight: 700;">
                                Dean, RSHSS and RSBAS; Director, Centre for Inter-disciplinary Studies
                            </h2>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            BA (Honours) St. Xavier’s College, Calcutta (CU)
                                        </span>
                                    </li>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Political Sociology; Sociological Theory; Research Methodology; Sociology of
                                            Pedagogy
                                        </span>
                                    </li>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Consultant to several international and national bodies on research.
                                            Commonwealth Staff Scholar (UK): NORAD Scholar (Norway); Social Science Research
                                            Council South Asia Fellow (New York); Maison de Sciences de l’Homme, Indo-French
                                            Fellow, Paris
                                        </span>
                                    </li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-5">
                        ...
                        <h2 class="headd3 mb-5 fw-bold"
                            ...
                            Dean, RSHSS and RSBAS; Director, <br>Centre for Inter-disciplinary Studies
                        </h2>
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        Consultant to several international and national bodies on research. Commonwealth
                                        Staff Scholar (UK): NORAD Scholar (Norway); Social Science Research Council South
                                        Asia Fellow (New York); Maison de Sciences de l’Homme, Indo-French Fellow, Paris
                                    </span>
                                </li>
                            </ul>
