                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img class="faculty-bio-img"
                                src="https://rgu.ac/mobile-assets/updated-faculty-img/victor-narzary.jpeg" alt="">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-7 pt-5 faculty-bio-desktop-display">
                        <div class="faculty-bio-name-pad">
                            ...
                            <h2 class="faculty-bio-designation mb-5 faculty-bio-underline-effect">
                                Associate Professor & Programme Coordinator, NSS
                            </h2>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Ph.D. in Social Work, Assam Don Bosco University
                                    (ADBU)</span></li>
                            <li><i class="fa fa-circle"></i> <span>M.A. in Social Work, TISS Mumbai</span></li>
                            <li><i class="fa fa-circle"></i> <span>BA (History), Gauhati University </span></li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i><span>Social Work Education, Community Engagement, Peace and
                                    Wellbeing, Northeast India</span></li>
                        </ul>
