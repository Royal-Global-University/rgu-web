                ...
                <aside class="rgu-fp-sidebar">
                    ...
                    <div class="rgu-fp-profile-card">
                        ...
                        <div class="rgu-fp-image">
                            ...
                            <img src="https://rgu.ac/mobile-assets/updated-faculty-img/Rituparna.png"
                                alt="Dr. Rituparna Dey">
                ...
                <div class="rgu-fp-content">
                    ...
                    <section class="rgu-fp-section">
                        ...
                        <ul class="rgu-fp-list">
                            ...
                            <li>Ph.D. in Social Work – Department of Social Work, University of Delhi</li>
                            <li>M.A. in Social Work, Specialization in Rural Development – Tata Institute of Social
                                Sciences (TISS)</li>

                            <li>B.A. in Social Sciences – Tata Institute of Social Sciences (TISS)</li>
     ...
     -->
                    ...
                    <section class="rgu-fp-section">
                        ...
                        <ul class="rgu-fp-list">
                            ...
                            <li>
                                Transgender Studies; LGBTQIA+ Studies; Gender and Sexuality; Mental Health; Social Work
                                Practice; Community Organization and Mobilization; Rural Development; Sustainable
                                Development; Green/Eco-Social Work; Climate Change and Environment; Social Exclusion and
                                Marginalized Communities; Public Health; Period Poverty; Child Protection and
                                Trafficking; Social Work Research; Digital Technology and Artificial Intelligence in
                                Social Work.
                    ...
                    <section class="rgu-fp-section">
                        ...
                        <ul class="rgu-fp-list">
                            ...
                            <li>Institute Gold Medal for Academics, TISS.</li>

                            <li>Institute Best Research Project, TISS.</li>

                            <li>Co-Chairperson, Nation Building, Vision 2030 and Social Work Profession conference
                                organized by NAPSWI.</li>


                            <li>Headed the session “Green Social Work: Response to Climate Change and Environmental
                                Issues”, University of Karabuk and Turkish Association of Social Workers.</li>

                            <li>Core Committee, National Seminar at Visva-Bharati University.</li>

                            <li>Appreciation letter from Medha Patkar.</li>

                            <li>Participation in Oracle Foundation activities.</li>

                            <li>National Rural Youth Festival – Singing category.</li>

                            <li>Appreciation for English language.</li>

                            <li>Sports activities.</li>

                            <li>National Rural Entrepreneur Meet.</li>

                            <li>UGC-NET in Social Work, 2019.</li>
