        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" src="https://www.rgu.ac/mobile-assets/updated-faculty-img/Baiarbha.jpeg"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Ph.D. in Social Work, Department of Social Work, University of
                  Delhi</span></li>
              <li><i class="fa fa-circle"></i> <span>M.Phil in Psychiatric Social Work, LGBRIMH, Tezpur</span></li>
              <li><i class="fa fa-circle"></i> <span>MSW with specialization in Medical and Psychiatric Social Work,
                  Assam Don Bosco University, Guwahati</span></li>
              <li><i class="fa fa-circle"></i> <span>BSW from St. Edmund’s College, NEHU</span></li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>3 years, 4 Months</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Industry Experience:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>1 year, 9 Months</span></li>
            </ul>


            <h2 class="faculty-bio-sub-heading">Research Interest:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Adolescence and Youth Mental Health, School Mental Health, Social
                  Media and Internet Addiction</span></li>
            </ul>
