                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Ph.D. (Gandhian Thought and Peace Studies) – Central
                                    University of Gujarat, Vadodara (2025)</span></li>
                            <li><i class="fa fa-circle"></i> <span>M.Phil. (Gandhian Thought and Peace Studies) – Central
                                    University of Gujarat, Vadodara (2022)</span></li>
                            <li><i class="fa fa-circle"></i> <span>M.A. Political Science (Gold Medalist) – Central
                                    University of Gujarat, Vadodara (2019)</span></li>
                            <li><i class="fa fa-circle"></i> <span>B.A. (Hons.) Political Science with subsidiary History –
                                    Barkatullah University, Bhopal (2017)</span></li>
                        </ul>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>UGC JRF & SRF in Political Science (2019–2024)</span>
                            </li>
                            <li><i class="fa fa-circle"></i> <span>UGC NET Qualified (July & December 2018)</span></li>
                            <li><i class="fa fa-circle"></i> <span>Gold Medal in M.A. Political Science</span></li>
                            <li><i class="fa fa-circle"></i> <span>Best Paper Award, International Conference: Why Does
                                    Gandhi Matter (2023)</span></li>
