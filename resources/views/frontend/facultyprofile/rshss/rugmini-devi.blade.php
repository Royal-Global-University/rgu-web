                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Ph.D. (Political Science), Department of Political
                                    Science, University of Kerala (2025)</span></li>
                            <li><i class="fa fa-circle"></i> <span>M.A. (Political Science), University of Kerala
                                    (2018)</span></li>
                            <li><i class="fa fa-circle"></i> <span>B.A. (Social Sciences), Tata Institute of Social Sciences
                                    (2016)</span></li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i><span>Science, Technology and Innovation in International
                                    Relations, Energy Transition, International Cooperation and International
                                    Development</span></li>
                        </ul>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Member, Earth System Governance (Brasilia)</span></li>
                            <li><i class="fa fa-circle"></i> <span>CLAS Exchange Fellow at Institute of International
                                    Relations, University of Brasilia (2022)</span></li>
                            <li><i class="fa fa-circle"></i> <span>ICSSR Centrally Administered Doctoral Fellowship
                                    (2022)</span></li>
                            <li><i class="fa fa-circle"></i> <span>UGC-NET in Political Science (2018)</span></li>
                            <li><i class="fa fa-circle"></i> <span>Second Rank, Master’s in Political Science (2018)</span>
                            </li>
                            <li><i class="fa fa-circle"></i> <span>Fostering India Scholarship (2017), Government of
                                    Kerala</span></li>
