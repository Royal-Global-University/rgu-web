        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" src="https://rgu.ac/mobile-assets/updated-faculty-img/Debangana.jpg"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Ph.D. in Development Studies, Tata Institute of Social Sciences, Mumbai</span></li>
              <li><i class="fa fa-circle"></i> <span>M.Phil in Development Studies, Tata Institute of Social Sciences, Mumbai</span></li>
              <li><i class="fa fa-circle"></i> <span>Master of Arts in Social Work, Tata Institute of Social Sciences, Mumbai</span></li>
              <li><i class="fa fa-circle"></i> <span>B.A. (Hons) in Philosophy, I.P. College for Women, University of Delhi</span></li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Migration, Urbanization, City and Social Justice, Labour and Informal Economy, Entrepreneurship, Livelihood, Citizenship, Youth Studies.</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span> DAAD Research Fellow, Centre for Modern Indian Studies (CeMIS), University of Goettingen, BMBF-DAAD, ILO-Aajeevika Bureau</span></li>
