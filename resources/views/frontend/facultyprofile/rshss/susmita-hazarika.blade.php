                  ...
                  <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                    ...
                    <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                      <i class="fa fa-circle"
                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                      <span style="display: block;">
                        MA (History)-NEHU (Specialisation in Ancient History)
                      </span>
                    </li>
                    <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                      <i class="fa fa-circle"
                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                      <span style="display: block;">
                        TDC (History)- Cotton College, Guwahati
                      </span>
                    </li>
                  ...
                  <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                    ...
                    <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                      <i class="fa fa-circle"
                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                      <span style="display: block;">
                        Academic Experience: 24 years of teaching experience in HEIs.
                      </span>
                    </li>
                  ...
                  <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                    ...
                    <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                      <i class="fa fa-circle"
                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                      <span style="display: block;">
                        2 years as an ICHR Junior Research fellow.
                      </span>
                    </li>
                  ...
                  <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                    ...
                    <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                      <i class="fa fa-circle"
                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                      <span style="display: block;">
                        Ancient Indian History with a focus on the historical development of Assam; the socio-political and the cultural development of Assam from antiquity to modern times; and gender history, especially the roles, representations and agency of women within Assamese society across historical periods.
                       </span>
                    </li>
                  ...
                  <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                    ...
                    <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                      <i class="fa fa-circle"
                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                      <span style="display: block;">
                        Best Paper award for the research paper titled, “The process of State-Formation and the Ancient Kingdom of Pragjyotisha-Kamarupa” in the National Seminar on Revisiting the Sources of the History of   Assam: Horizontal and Vertical Spaces sponsored by the ICHR, ICSSR, and the Archaeological Survey of India, New Delhi held at the Sibsagar College, Joysagar, Assam on the 9th and 10th Jan, 2017.
                      </span>
                    </li>
                    <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                      <i class="fa fa-circle"
                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                      <span style="display: block;">
                        Life Member- Kamarupa Anusandhana Samiti (KAS estd. in 1912)
                      </span>
                    </li>
                    <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                      <i class="fa fa-circle"
                    ...
                    <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                        <i class="fa fa-circle"
                          style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                        <span style="display: block;">
                            Member of the participatory team of the ongoing intramural project of Deori Sahitya Sabha, Dibrugarh, Assam titled, Documentation of the Ancient History of the Deori Community of Assam (2024-2026).
                        </span>
                      </li>
                      ...
                      <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                        <i class="fa fa-circle"
                          style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                        <span style="display: block;">
                            Convenor of 7-Day History Department FDP (Hybrid Mode) themed, “Revisiting Historiography: Labour, Language, Identity and Politics” held from 24th April, 2023.
                        </span>
                      </li>
                      <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                        <i class="fa fa-circle"
