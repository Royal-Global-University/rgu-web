                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img class="faculty-bio-img" style="height: 350px; width: 320px;"
                                src="https://rgu.ac/mobile-assets/updated-faculty-img/Dr.%20Maitrayee%20Patar.png" alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Ph.D. (Sociology) - Tezpur University</span></li>
                            <li><i class="fa fa-circle"></i> <span>M.Phil (Women's Studies), Tata Institute of Social Sciences, Mumbai</span>
                            </li>
                            <li><i class="fa fa-circle"></i> <span>M.A. (Sociology), Delhi School of Economics</span>
                            </li>
                            <li><i class="fa fa-circle"></i> <span>B.A. Hons (Sociology), Kamala Nehru College, University of Delhi</span>
                            </li>
                        </ul>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i><span>Tribal Women, Gender, Indigenous People and Knowledge, Identities, Religious Practices and Agency
                                </span></li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>4</span>
                            </li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>1</span>
                            </li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>UGC NET-JRF </span></li>
                            <li><i class="fa fa-circle"></i> <span>Krishnaraj Fellowship by Delhi School of Economics</span></li>
                            <li><i class="fa fa-circle"></i> <span>Acclaimed Assamese Poet, Performing artist of National Repute</span></li>
                        
                        </ul>

                        <h2 class="faculty-bio-sub-heading">Recipient of</h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>1st Niru Sharma Parajuli Memorial Award for Literature and Art for contribution to art and literature by Lekhika Santha, Assam</span></li>
                            <li><i class="fa fa-circle"></i> <span>the Biju Phukan Recognition Award for outstanding contribution to music,</span></li>
                            <li><i class="fa fa-circle"></i> <span>Filmfare Assamese (2026) nominee for best female singer</span></li>
                           <li><i class="fa fa-circle"></i> <span>Prag Cine Awards (2024) nominee for best female singer</span></li>
                        </ul>
