        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Ph.D. (International Finance), Indian Institute of Information Technology Guwahati, IIITG (2025)</span></li>
              <li><i class="fa fa-circle"></i> <span>M.A. (Environmental Economics), Banaras Hindu University (2020)</span></li>
              <li><i class="fa fa-circle"></i> <span>B.A. (Economics), Cotton University (2018)</span></li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>3 months as an Institute Post-Doctoral Fellow, IISER Bhopal</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i><span>Open Economy Macroeconomics, International Finance and Time Series Economics</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>1st Best Paper Award in IIFT Kolkata</span></li>
              <li><i class="fa fa-circle"></i> <span>UGC NET-JRF</span></li>
              <li><i class="fa fa-circle"></i> <span>1st Class 1st in BA Economics, Cotton University</span></li>
