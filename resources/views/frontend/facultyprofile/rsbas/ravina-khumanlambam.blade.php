                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Doctor of Public Health (Health Education and Behavioral
                                    Sciences), Mahidol University, Bangkok, Thailand</span></li>
                            <li><i class="fa fa-circle"></i> <span>M.Sc. (Applied Psychology), Pondicherry University</span>
                            </li>
                            <li><i class="fa fa-circle"></i> <span>M.Sc. (Counselling and Family Therapy), IGNOU</span></li>
                            <li><i class="fa fa-circle"></i> <span>B.A (Psychology, Sociology and English Literature)
                                    (CHRIST, Bangalore)</span></li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i><span>Mental Health Promotion, Adolescent Mental Health,
                                    Positive Psychology</span></li>
                        </ul>
