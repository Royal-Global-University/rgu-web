        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" style="height: 400px; width: 400px;" src="https://www.rgu.ac/mobile-assets/updated-faculty-img/Dr.%20Siddharth%20Shahi.jpeg"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Ph.D. (Neuroscience), Ruhr University Bochum, Germany</span></li>
              <li><i class="fa fa-circle"></i> <span>M.Sc. (Neuropsychology), National Forensic Sciences University, Gandhinagar</span></li>
              <li><i class="fa fa-circle"></i> <span>B.A. (H) Applied Psychology, Amity University, Rajasthan</span></li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i><span>Neuroscience, Cognitive Science, AI</span></li>
            </ul>
