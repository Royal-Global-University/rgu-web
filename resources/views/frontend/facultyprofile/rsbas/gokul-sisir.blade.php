                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    ...
                                    <span style="display: block;">
                                        M.Sc. Clinical Psychology (2018), CHRIST (Deemed to be University)
                                    </span>
                                </li>
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        BA Psychology (Honours) (2016), Christ University.
                                    </span>
                                </li>
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        Scientific creativity; public response to science
                                    </span>
                                </li>
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        International Journals: 1 <br><br> (Sisir, G. (2025). Facts as the products and
                                        microprocesses as the
                                        interactions:
                                        Explaining scientific creativity using an expanded systems model. Journal of
                                        Theoretical and Philosophical Psychology, 45(3), 247–
                                        264 <a target="_blank" style="color: #1df800;" class=" fw-bold"
                                            href="https://doi.org/10.1037/teo0000283">https://doi.org/10.1037/teo0000283</a>
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        C Certificate (B grade) with rank of Corporal
                                    </span>
                                </li>
