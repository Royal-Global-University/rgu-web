                        ...
                        <div class="col-lg-6 text-center">
                            <div class="text-center">
                                <img style="margin-top: 70px; width: 380px; border: 1px solid #27467A;"
                                    src="mobile-assets/updated-faculty-img/Asif-Iqbal-Mazid-RSFT.png" alt="">
                            </div>
                        </div>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <span style="display: block;">
                                            M.Sc. (Information Technology) – Krishna Kanta Handiqui State Open University
                                            (Pursuing). Fashion Management (Dept of FMS) National Institute of Fashion
                                            Technology , Mumbai. Advanced Diploma in Fashion Design – IITC, Mumbai. Diploma
                                            in Network-Centric Information Technology (DNIIT) – NIIT Ltd., India. B.Sc. in
                                            Anthropology Guwahati University.
                                        </span>
                                    </li>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Neuromorphic E-Textiles: Integration of smart fabrics with brain-inspired, AI
                                            Sustainable Fashion Innovation, Fashion-Tech & Smart Wearables, Cultural
                                            Anthropology in Contemporary Fashion
                                        </span>
                                    </li>
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    ...
                                    <span style="display: block;">
                                        M.Sc. (Information Technology) – Krishna Kanta Handiqui State Open University
                                        (Pursuing). Fashion Management (Dept of FMS) National Institute of Fashion
                                        Technology , Mumbai. Advanced Diploma in Fashion Design – IITC, Mumbai. Diploma in
                                        Network-Centric Information Technology (DNIIT) – NIIT Ltd., India. B.Sc. in
                                        Anthropology Guwahati University.
                                    </span>
                                </li>
