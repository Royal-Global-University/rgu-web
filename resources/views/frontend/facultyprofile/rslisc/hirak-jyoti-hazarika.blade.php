                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>PH.D. from North Eastern Hill University,
                                    Meghalaya</span></li>
                            <li><i class="fa fa-circle"></i> <span>MLISC from North Eastern Hill University,
                                    Meghalaya</span></li>
                            <li><i class="fa fa-circle"></i> <span>Graduation from Guahati University, Assam</span></li>
                        ...
                        <ul class="faculty-bio-info-list">
                            ...
                            <li><i class="fa fa-circle"></i> <span>User Education</span></li>
                            <li><i class="fa fa-circle"></i> <span>Digitization</span></li>
                            <li><i class="fa fa-circle"></i> <span>Web 2.0</span></li>
                            <li><i class="fa fa-circle"></i> <span>Library 2.0</span></li>
                            <li><i class="fa fa-circle"></i> <span>Scientometrics/ Bibliometric/ Altmetrics</span></li>
                            <li><i class="fa fa-circle"></i> <span>Health Information</span></li>
                            <li><i class="fa fa-circle"></i> <span>Cloud Computing in Libraries</span></li>
                        ...
                        <ul class="faculty-bio-info-list">
                            ...
                            <li><i class="fa fa-circle"></i> <span>International: 24</span></li>
                        </ul>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Best Employee Award by The Assam Don Bosco University,
                                    Guwahati, Assam</span></li>
                            <li><i class="fa fa-circle"></i> <span>Best Researcher Award by The Assam Don Bosco University,
                                    Guwahati, Assam.</span></li>
                            <li><i class="fa fa-circle"></i> <span>Editorial Advisory Board Member – Collection and Curation
                                    (Scoups - Q1), Emerald Publishing House, UK.</span></li>
                            <li><i class="fa fa-circle"></i> <span>Editorial Advisory Board Member – Library Management
                                    (Scoups - Q1), Emerald Publishing House, UK.</span></li>
                            <li><i class="fa fa-circle"></i> <span>Editor – RGU Journal of Social Science and Research, The
                                    Assam Royal Global University, India.</span></li>
                            <li><i class="fa fa-circle"></i> <span>Assistant Editor - Prajnalok: the Academic Enlightenment
                                    National Journal published by Charaibahi College, Assam.</span></li>

                        </ul>

                        <h2 class="faculty-bio-sub-heading">Professional Bodies Membership:</h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Member - Library and Information Science Professional
                                    Association.</span></li>
                            <li><i class="fa fa-circle"></i> <span>Member - Assam Library Association.</span></li>
                            <li><i class="fa fa-circle"></i> <span>Member - Indian Association of Special Libraries and
                                    Information Centres.</span></li>
                        </ul>
                    </div>
                </div>
            </div>
