        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" src="https://www.rgu.ac/mobile-assets/updated-faculty-img/Nilanjana-Purkayastha-RSLIC.png"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Ph.D. – Assam University, Siilchar</span></li>
              <li><i class="fa fa-circle"></i> <span>M.Phil – Assam University, Siilchar</span></li>
              <li><i class="fa fa-circle"></i> <span>M.A (Library and Information Science) – Assam University, Siilchar</span></li>
              <li><i class="fa fa-circle"></i> <span>B.A (English Honours) – Assam University, Siilchar</span></li>
              <li><i class="fa fa-circle"></i> <span>PGDCA – C-DAC</span></li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>9 Months</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Research Interest:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Web Applications in Libraries, Digital Literacy, AI-Driven Learning and Social Media Tools, Digital Library and Institutional Repository, Learning Management Systems</span></li>
            ...
            <ul class="faculty-bio-info-list">
            <li><i class="fa fa-circle"></i> <span>NET (2018, 2019)</span></li>
            </ul>
