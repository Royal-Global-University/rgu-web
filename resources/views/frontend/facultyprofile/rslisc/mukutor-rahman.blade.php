                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img class="faculty-bio-img" src="/mobile-assets/all-faculty/rslisc/MukutorRahman.jpg"
                                alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Ph.D. – University of Science & Technology,
                                    Meghalaya</span></li>
                            <li><i class="fa fa-circle"></i> <span>MLISC (Library Science) – IGNOU, New Delhi</span></li>
                            <li><i class="fa fa-circle"></i> <span>BLISC (Library Science) – Gauhati University,
                                    Guwahati</span></li>
                            <li><i class="fa fa-circle"></i> <span>BSC (Botany) – Arya Vidyapeeth College, Guwahati</span>
                            </li>
