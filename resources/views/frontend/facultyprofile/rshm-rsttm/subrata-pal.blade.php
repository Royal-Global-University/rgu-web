                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Ph.D – Pursuing Last year- North East Christian
                                    University.</span></li>
                            <li><i class="fa fa-circle"></i> <span>PG- M.Sc. In Hotel Management.- Annamalai
                                    University.</span></li>
                            <li><i class="fa fa-circle"></i> <span>UG- B.Sc. In Hotel Management & Tourism- Annamalai
                                    University.</span></li>
                            <li><i class="fa fa-circle"></i> <span>Diploma – 3yrs. Diploma In Hotel Management catering &
                                    Applied nutrition.</span></li>

                        </ul>

                        <h2 class="faculty-bio-sub-heading">Total Experience:</h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>28 years.</span></li>
                        </ul>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>8 years</span></li>
                        </ul>

                        <h2 class="faculty-bio-sub-heading">Research Interests:</h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i><span>Lost Recipes & Ancient food Habit of Bengal.</span></li>
                        ...
                        <h2 class="faculty-bio-sub-heading">Patents Granted: 1</h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>1</span></li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Initial University Syllabus prepared for the program
                                    B.Sc. Culinary Arts.</span></li>
                            <li><i class="fa fa-circle"></i> <span>Train the trainer program (Swad O Pusti) of Govt. West
                                    Bengal.</span></li>
                            <li><i class="fa fa-circle"></i> <span>Soft Skill & Image building Training to Bihar Police &
                                    Bihar Police STF.</span></li>
                            <li><i class="fa fa-circle"></i> <span> “Cake Décor”. A work Shop on icing in association of
                                    “RICH” cream.</span></li>
                            <li><i class="fa fa-circle"></i> <span>Food Festivals (“Dawat- E- Khas”, a Mughlai delight,
                                    “Slik Rout- Chinese & south Asian Cuisine, “ Europanier” European cuisine.)</span></li>
                            <li><i class="fa fa-circle"></i> <span>3 International conference at Previous
