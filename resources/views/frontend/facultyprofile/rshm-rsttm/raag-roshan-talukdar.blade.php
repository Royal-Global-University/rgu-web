        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img style="height: 400px; width: 400px;" class="faculty-bio-img" src="/mobile-assets/updated-faculty-img/Raag-Roshan.jpeg" alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>M.Sc. Hospitality Administration</span></li>
              <li><i class="fa fa-circle"></i> <span>B.Sc. Hospitality & Hotel Administration</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>10 Months</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Industry Experience:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>03 Months</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Research Interests:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Sustainable Tourism</span></li>
              <li><i class="fa fa-circle"></i> <span>Hospitality Analytics</span></li>
               <li><i class="fa fa-circle"></i> <span>Consumer Behavior</span></li>
                <li><i class="fa fa-circle"></i> <span>Service Excellence</span></li>
                 <li><i class="fa fa-circle"></i> <span>Hotel Operations Management</span></li>
            </ul>
