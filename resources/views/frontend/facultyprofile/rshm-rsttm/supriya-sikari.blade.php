                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img class="faculty-bio-img" src="/mobile-assets/updated-faculty-img/supriya.png" alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Ph.D. (Destination Marketing Strategy) - University of
                                    Burdwan</span></li>
                            <li><i class="fa fa-circle"></i> <span>Masters of Tourism Administration (Travel Agency and Tour
                                    Operation) - Regional College of Management Bhubaneswar - Utkal University</span></li>
                            <li><i class="fa fa-circle"></i> <span>Masters in Business Administration (Marketing) - Fakir
                                    Mohan University, Balasore</span></li>
                            <li><i class="fa fa-circle"></i> <span>BA (Tourism and Travel Management) - Krishnanath College
                                    Murshidabad - University of Calcutta</span></li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Destination Marketing, Spiritual Tourism, Craft
                                    Tourism</span></li>
                        </ul>
