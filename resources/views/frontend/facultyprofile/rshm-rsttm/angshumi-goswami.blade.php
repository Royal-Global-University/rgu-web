        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" src="https://rgu.ac/mobile-assets/updated-faculty-img/angshumi.png"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>MTTM, Tezpur University</span></li>
              <li><i class="fa fa-circle"></i> <span>Bachelor of Commerce, Human Resource Management, Gauhati Commerce College, Gauhati University</span></li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>8.5 years</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i><span>Destination Management Organisations, Destination Management, Destination Marketing, Digital Marketing, Assam Tourism </span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Gold Medalist in MTTM, Tezpur University; ICSSR Fellow</span></li>
            </ul>
