        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" src="https://www.rgu.ac/demo-assets/Ajeet.png" alt="">
            </div>
          </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Awarded “Best Director in Hospitality for the year 2025” at Global
                  Hospitality and Tourism Leadership Awards, on the occasion of 10th International Conference
                  (ATITHI-2025) at Subharti University, Meerut in December 2025.</span></li>

              <li><i class="fa fa-circle"></i> <span>Awarded “Best Director” (Jaipur Region) in Hotel Management and
                  Catering Technology for the years 2022–23 and 2023–24 by Aahaar Way Awards.</span></li>

              <li><i class="fa fa-circle"></i> <span>Awarded Certificate of Appreciation by Excellence Book of Records
                  in coordination with Socially Point Foundation for outstanding achievements and remarkable
                  contributions in academics on 17th May 2024. Certificate No: EBR-IN-445353.</span></li>

              <li><i class="fa fa-circle"></i> <span>Awarded “Best Director in Hospitality for the year 2023” at IHMS
                  Kotdwar in Academic Excellence Award 2023.</span></li>

              <li><i class="fa fa-circle"></i> <span>Awarded Certificate of Appreciation in recognition of active
                  participation in the National Intellectual Property Awareness Mission (NIPAM), launched by Government
                  of India under “Azadi Ka Amrit Mahotsav” for creating awareness on Intellectual Property
                  Rights.</span></li>

              <li><i class="fa fa-circle"></i> <span>Awarded “Best Research Collaboration Excellence in Hospitality
                  Academia” at the 8th International Conference on Advanced Technologies and Innovations in Tourism and
                  Hospitality Industry (ATITHI 2023).</span></li>

              <li><i class="fa fa-circle"></i> <span>Awarded “Best Ph.D Dissertation Award” at 1st International
                  Hospitality Conclave & Awards 2020, Visionary Trends in Hospitality Industry, Delhi Technical Campus
                  (GGSIP University, New Delhi) on 12 February 2020.</span></li>

              <li><i class="fa fa-circle"></i> <span>UGC NET qualified in Tourism Administration & Management.</span>
              </li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Lifetime Member of World Association of Master Chefs – South Asia
                  and India.</span></li>

              <li><i class="fa fa-circle"></i> <span>Member, All India Council for Technical Skill Development.</span>
              </li>

              <li><i class="fa fa-circle"></i> <span>Affiliate Member of International Association of Academic Plus
                  Corporate.</span></li>

              <li><i class="fa fa-circle"></i> <span>Editorial Board Member of International Journal of
                  Multi-Disciplinary Research and Technology (IJMRT) ISSN 252-7359 and Multi-Disciplinary Research
                  Perspective (IJMRP) ISSN 2584-0029 (Online).</span></li>

              <li><i class="fa fa-circle"></i> <span>Member of DRC, Hotel Management, Vivekananda Global University
                  (VGU), Jaipur for a period of 3 years w.e.f. 29/11/2022.</span></li>

              <li><i class="fa fa-circle"></i> <span>Member of Governing Body of the AICTE approved P.G. Diploma in
                  Hospitality Management.</span></li>

              <li><i class="fa fa-circle"></i> <span>Lifetime Member of Indian Hospitality Congress (Membership No:
                  1014, issued on 29/01/2018).</span></li>

              <li><i class="fa fa-circle"></i> <span>Lifetime Member of Indian Culinary Forum (Membership No:
                  1104).</span></li>

              <li><i class="fa fa-circle"></i> <span>Lifetime Member of Indian Academicians and Researchers Association
                  (Membership No: M/M 1080).</span></li>

              <li><i class="fa fa-circle"></i> <span>Member, Board of Studies for Hotel Management and Catering
                  Technology at Guru Kashi University, Bathinda; Shree Shakti College of Hotel Management; and
