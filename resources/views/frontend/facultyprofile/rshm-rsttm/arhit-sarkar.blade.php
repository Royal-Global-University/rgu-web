        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>M.Sc in Hospitality Administration at IHM Guwahati with specialisation in Sales and Marketing</span></li>
              <li><i class="fa fa-circle"></i> <span>B.Sc in Hospitality and Hotel Administration at IHM Guwahati with specialisation in Food and Beverage Service</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>1 years</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Enology, Hospitality</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Any Other Achievements/Awards:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>The first proposal dossier for the Category 2 Centre in Geoparks in Riyadh.</span></li>
            </ul>
