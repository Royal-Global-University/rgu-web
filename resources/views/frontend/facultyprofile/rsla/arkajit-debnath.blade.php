                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img class="faculty-bio-img" src="/mobile-assets/updated-faculty-img/Arkajit.jpeg" alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Ph.D. (Cyber law and Phishing attacks) - ICFAI University
                                    Tripura</span></li>
                            <li><i class="fa fa-circle"></i> <span>LLM (International Commercial Arbitration) -GD Goenka
                                    University</span></li>
