            ...
            <div class="col-lg-6 text-center">
              <div class="text-center">
                <img style="margin-top: 70px; width: 380px; border: 1px solid #27467A;"
                  src="https://www.rgu.ac/mobile-assets/updated-faculty-img/Meghna.png" alt="">
              </div>
            </div>
              ...
              <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                ...
                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                  <i class="fa fa-circle"
                    style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                  <span style="display: block;">
                    Administrative Law, Reproductive Rights, Reproductive Rights of LGBTQIA+, Rights of Disabled Persons.
                  </span>
                </li>
              ...
              <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                ...
                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                  <i class="fa fa-circle"
                    style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                  <span style="display: block;">
                    Best Paper Presenter at the National Seminar on Convergence of Health Laws & Practice: Recent Developments and Contemporary Challenges organized by IMS University, Dehradun, Uttarakhand, India (VIRTUAL) on February25-26, 2022
                  </span>
                </li>
                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                  <i class="fa fa-circle"
                    style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                  <span style="display: block;">
                   Quiz Master in an Inter Law College Quiz Competition organized by All Assam Law Students’ Union Kamrup District Committee
                  </span>
                </li>
