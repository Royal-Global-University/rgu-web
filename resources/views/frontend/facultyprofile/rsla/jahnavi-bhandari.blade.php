        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" style="height: 420px;" src="https://rgu.ac/mobile-assets/updated-faculty-img/jahnavi-b.jpeg"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Ph.D. (Solid Waste Management Laws and Sustainable Development: A Study in Assam), Sikkim University, Gangtok Sikkim</span></li>
               <li><i class="fa fa-circle"></i> <span>LL.M. (Business Law) from Sikkim University, Gangtok, Sikkim.</span></li>
              <li><i class="fa fa-circle"></i> <span>BA.LLB Gauhati University, Jalukbari, Guwahati </span></li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i><span>Environmental Law and Business Law</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Gold Medalist in LL.M.</span></li>
