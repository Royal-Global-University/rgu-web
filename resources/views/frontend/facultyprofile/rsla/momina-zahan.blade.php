        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" style="height: 400px;" src="https://rgu.ac/mobile-assets/updated-faculty-img/momina.jpeg"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
               <li><i class="fa fa-circle"></i> <span>Ph.D. (Pre- Trial Procedures & Victims of Sexual Violence) - Banasthali Vidyapith</span></li>
               <li><i class="fa fa-circle"></i> <span>LL.M. (Criminal Justice Administration) - King’s College, University of Aberdeen (UK)</span></li>
               <li><i class="fa fa-circle"></i> <span>M.B.A. (Marketing & HR) - Glendale University (US)</span></li>
               <li><i class="fa fa-circle"></i> <span>LL.B. - Campus Law Centre, University of Delhi</span></li>
              <li><i class="fa fa-circle"></i> <span>B.Sc. Zoology - Gauhati University</span></li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i><span>Women’s Rights, Victim’s Right, Criminal Justice Administration, Artificial Intelligence and Law, Indian Knowledge System, etc.</span></li>
            </ul>
