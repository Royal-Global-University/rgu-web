                ...
                <aside class="rgu-fp-sidebar">
                    ...
                    <div class="rgu-fp-profile-card">
                        ...
                        <div class="rgu-fp-image">
                            ...
                            <img src="https://www.rgu.ac/mobile-assets/updated-faculty-img/Laishram.png"
                                alt="Dr. Laishram Malem Mangal">
                ...
                <div class="rgu-fp-content">
                    ...
                    <section class="rgu-fp-section">
                        ...
                        <ul class="rgu-fp-list">
                            ...
                            <li>Ph.D. – NEHU (2022)</li>
                            <li>M.Phil. – JNU (2015)</li>
                            <li>LL.M. – Manipur University (2011)</li>
                            <li>BA.LL.B. – Bharati Vidyapeeth University (2008)</li>
                    ...
                    <section class="rgu-fp-section">
                        ...
                        <ul class="rgu-fp-list">
                            ...
                            <li>International Humanitarian & Refugee Law</li>

                            <li>International Criminal Law</li>

                            <li>Constitutional Law</li>

                            <li>Law of Territorial Occupation</li>

                            <li>Right to Self-Determination</li>

                            <li>Geo-Politics, Regional Security & Peace</li>
                    ...
                    <section class="rgu-fp-section">
                        ...
                        <ul class="rgu-fp-list">
                            ...
                            <li>Invited as a Reviewer by Asian Ethnicity published by Routledge (Taylor & Francis) to review
                                the manuscript titled “Applicability of Sixth Schedule in the Hill Areas of Manipur: A
                                Constitutional and Political Analysis”.</li>
                            <li>Invited as a Reviewer by International Law Research published by the Canadian Center for
                                Science and Education to review a manuscript titled “When Registration Becomes Restriction:
                                Humanitarian Organizations and the Law of Occupation after Israel’s 2026 NGO Registration
                                Litigation”.</li>
