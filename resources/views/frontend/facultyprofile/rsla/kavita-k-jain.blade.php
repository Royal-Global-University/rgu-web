        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" style="height: 420px; width: 380px;" src="/mobile-assets/updated-faculty-img/kavita-kumari-jain.jpeg"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Ph.D. (Natural ​Justice ​and Income Tax Laws: A Critical Appraisal), Gauhati University.</span></li>
               <li><i class="fa fa-circle"></i> <span>LL.M. (Criminology & Penology, Human Rights) from Gauhati University.</span></li>
              <li><i class="fa fa-circle"></i> <span>BA.LLB Gauhati University </span></li>
              <li><i class="fa fa-circle"></i> <span>B.A.(H) Economics</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Academic & Industry Experience: 21 Years</h2>

            <h2 class="faculty-bio-sub-heading">Research Interests:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i><span>Commercial Law, Constitutional Law, Clinical Legal Education, Gender Justice.</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              ...
              <li><i class="fa fa-circle"></i> <span>International: 01</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Awarded ‘Merit Certificate’ for securing first position in order of merit in Master of Laws (LL.M.) under Gauhati University.</span></li>
                <li><i class="fa fa-circle"></i> <span>Membership of the  Gauhati High Court Bar Association( GHCBA).</span></li>
                <li><i class="fa fa-circle"></i> <span>Acted as a Resource Person of Assam State Legal Authority Services (ASLSA).</span></li>
            </ul>
