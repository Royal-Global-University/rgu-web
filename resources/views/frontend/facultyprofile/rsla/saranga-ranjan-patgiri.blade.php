                        ...
                        <div class="col-lg-6 text-center">
                            <div class="text-center">
                                <img style="margin-top: 70px; width: 380px; border: 1px solid #27467A;"
                                    src="mobile-assets/updated-faculty-img/Saranga-Ranjan Patgiri-RSBSC.png" alt="">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 pt-4 pb-4">
                            ...
                            <h2 class="headd1 fw-bold pt-4" style="color: #FF9A1E; font-weight: 700; font-size: 35px;">
                                Prof.(Dr) Saranga Ranjan Patgiri
                            </h2>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <span style="display: block;">
                                            PhD in soil microbiology, Department of botany, Gauhati University
                                        </span>
                                    </li>
                                    <li
                                        style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            MPhil, (Microbiology), Department of Botany, Gauhati University
                                        </span>
                                    </li>
                                    <li
                                        style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            MSc in Botany with specialization in Microbiology, Gauhati Unuversity
                                        </span>
                                    </li>
                                    <li
                                        style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            BSc in Botany, Cotton College, Gauhati University
                                        </span>
                                    </li>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Developed a national level microbiology module/kit for the students and general
                                            people of the country supported and financed by the Department of Science and
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Associated in College days. Naval wing of NCC. Also associated in Scout.
                                        </span>
                                    </li>
