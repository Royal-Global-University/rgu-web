                        ...
                        <div class="col-lg-6 text-center">
                            <div class="text-center">
                                <img style="margin-top: 70px; width: 380px; border: 1px solid #27467A;"
                                    src="https://bucket-0534zd.s3.ap-south-1.amazonaws.com/mobile-assets/all-faculty/rslsc/Pallabi.jpeg"
                                    alt="">
                            </div>
                        </div>
            ...
            <div style="background-color: #fff; height: 35vh; overflow: visible;">
                ...
                <div class="row">
                    <div class="col-lg-5 text-center">
                        ...
                        <div class="text-center">
                            <img style="margin-top: 100px; width: 480px; border: 1px solid #27467A; margin-left: 45px; z-index: 1000;"
                                src="https://bucket-0534zd.s3.ap-south-1.amazonaws.com/mobile-assets/all-faculty/rslsc/Pallabi.jpeg"
                                alt="">
                        </div>
