                        ...
                        <div class="col-lg-6 text-center">
                            <div class="text-center">
                                <img style="margin-top: 70px; width: 380px; border: 1px solid #27467A;"
                                    src="mobile-assets/updated-faculty-img/jintu.jpg" alt="">
                            </div>
                        </div>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <span style="display: block;">
                                            M. Design (Multimedia & Communication Design) – Central Institute of Technology,
                                            Kokrajhar, Deemed to be University
                                        </span>
                                    </li>
                                    <li
                                        style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            B. Design – Central Institute of Technology, Kokrajhar, Assam.
                                        </span>
                                    </li>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Communication Design, Interaction Design, 3D Animation and Visualization, Design
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Certificate of participation in a five-day workshop on “Outcome Based Design
                                            Education” organized by the Design Research Council of India (DRCI Research
                                            Community)
                                        </span>
                                    </li>
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Awarded “A+ Grade” in successfully completing an “Online Month-long Faculty
                                            Induction Program (FIP)” organized by MMTTC, Tezpur University from under the
                                            Pandit Madan Mohan Malviya National Mission on Teachers and Teaching Scheme of
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Awarded scholarship for meritorious students for four years while pursuing
                                            under-graduation by the Ministry of Home Affairs.
                                        </span>
                                    </li>
                        ...
                        <div class="col-lg-7 pt-4 pb-4">
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    ...
                                    <span style="display: block;">
                                        Awarded “A+ Grade” in successfully completing an “Online Month-long Faculty
                                        Induction Program (FIP)” organized by MMTTC, Tezpur University from under the Pandit
                                        Madan Mohan Malviya National Mission on Teachers and Teaching Scheme of the Ministry
