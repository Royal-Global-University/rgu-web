        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" src="https://media.rgu.ac/advisor-leadership/Prasanta.jpeg"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Ph.D. in Culture and Communication - University of Science and Technology, Meghalaya</span></li>
              <li><i class="fa fa-circle"></i> <span>MA in English, Dibrugarh University</span></li>
              <li><i class="fa fa-circle"></i> <span>BA in English, North Eastern Hill University (NEHU)</span></li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>40 years</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i><span>Media studies, Media growth, Media Management etc.</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Brahmaputra Valley Journalism Award from Assam State Journalists Union (ASJU), 2024</span></li>
              <li><i class="fa fa-circle"></i> <span>Debarshi Narad Jayanti Award, 2024</span></li>
              <li><i class="fa fa-circle"></i> <span>Lifetime Achievement Award, Dispur Press Club, 2022</span></li>
              <li><i class="fa fa-circle"></i> <span>Radhika Mohan Bhagawati Journalism Award, All Assam Journalists Union(AAJU), 2022-23</span></li>
              <li><i class="fa fa-circle"></i> <span>USTM Excellence Award for Journalism, 1997</span></li>
              <li><i class="fa fa-circle"></i> <span>Participated in the International Visitor Program of the United States Department of State</span></li>
              <li><i class="fa fa-circle"></i> <span>“US Foreign Policy Decision Making Process”, October 9-30, 2003</span></li>
              <li><i class="fa fa-circle"></i> <span>Dr Laksminandan Bora Award, 2022</span></li>
              <li><i class="fa fa-circle"></i> <span>Special Felicitation, Guwahati Press Club, Golden Jubilee Celebrations, 2023</span></li>
              <li><i class="fa fa-circle"></i> <span>DPRC Award for Journalism, 2023</span></li>
