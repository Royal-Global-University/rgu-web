                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img class="faculty-bio-img"
                                src="/mobile-assets/updated-faculty-img/Dr-Nishanta-Sahariah-RSEES.png" alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Ph.D. (Sedimentology), Department of Applied Geology,
                                    Dibrugarh University</span></li>
                            <li><i class="fa fa-circle"></i> <span>M.Sc. (Applied Geology), Department of Applied Geology,
                                    Dibrugarh University</span></li>
                            <li><i class="fa fa-circle"></i> <span>B.Sc. (Geology), Cotton College, Gauhati
                                    University</span></li>
                        </ul>
                        ...
                        <ul class="faculty-bio-info-list">
                            ...
                            <li><i class="fa fa-circle"></i> <span>OIL INDIA LIMITED, DULIAJAN
                                    (03/07/2012-21/07/2012)</span></li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>International Young Scientist Best Oral Presentation
                                </span></li>
