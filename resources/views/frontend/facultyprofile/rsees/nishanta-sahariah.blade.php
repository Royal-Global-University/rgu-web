        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" src="https://www.rgu.ac/mobile-assets/updated-faculty-img/Dr-Nishanta-Sahariah-RSEES.png"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Ph.D. (Sedimentology), Department of Applied Geology, Dibrugarh University</span></li>
              <li><i class="fa fa-circle"></i> <span>M.Sc. (Applied Geology), Department of Applied Geology, Dibrugarh University</span></li>
              <li><i class="fa fa-circle"></i> <span>B.Sc. (Geology), Cotton College, Gauhati University</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>2 years 4 months</span></li>
            </ul>

             <h2 class="faculty-bio-sub-heading">Internship:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>SCHLUMBERGER, MUMBAI (10/01/2012-10/02/2012)</span></li>
              <li><i class="fa fa-circle"></i> <span>OIL INDIA LIMITED, DULIAJAN (03/07/2012-21/07/2012)</span></li>
            ...
            <ul class="faculty-bio-info-list">
              ...
              <li><i class="fa fa-circle"></i> <span>Sediment Geochemistry</span></li>
              <li><i class="fa fa-circle"></i> <span>U-Pb Geochronology</span></li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>International Young Scientist Best Oral Presentation </span></li>
              <li><i class="fa fa-circle"></i> <span>INSPIRE Fellowship holder</span></li>
              <li><i class="fa fa-circle"></i> <span>Gold medalist in M.Sc.</span></li>
              <li><i class="fa fa-circle"></i> <span>Silver medalist in B.Sc.</span></li>
