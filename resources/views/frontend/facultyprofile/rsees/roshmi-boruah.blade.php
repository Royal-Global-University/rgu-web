                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img class="faculty-bio-img" src="/mobile-assets/updated-faculty-img/Dr-Roshmi-Boruah-RSEES.png"
                                alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Ph.D. in Geology (Sedimentology): Department of
                                    Geological Sciences, Gauhati University</span></li>
                            <li><i class="fa fa-circle"></i> <span>M.Sc. in Geology: Department of Applied Geology,
                                    Dibrugarh University</span></li>
                            <li><i class="fa fa-circle"></i> <span>B.Sc. (Geology-H, Physics, Mathematics): Department of
                                    Geology, Sibsagar College, Joysagar, Dibrugarh University</span></li>
                        </ul>
