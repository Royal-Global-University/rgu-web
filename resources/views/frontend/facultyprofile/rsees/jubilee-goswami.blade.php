                        ...
                        <div class="col-lg-6 text-center">
                            <div class="text-center">
                                <img style="margin-top: 70px; width: 380px; border: 1px solid #27467A;"
                                    src="mobile-assets/updated-faculty-img/Jubilee-Goswami-RSEES.png" alt="">
                            </div>
                        </div>
                                        ...
                                        <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                            <li
                                                ...
                                                <span style="display: block;">
                                                    Ph.D. (Pursuing) – Gauhati University
                                                </span>
                                            </li>
                                            <li
                                                style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                                <i class="fa fa-circle"
                                                    style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                                <span style="display: block;">
                                                    M.Sc. (Geoinformatics) – Central University of Karnataka
                                                </span>
                                            </li>
                                            <li
                                                style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                                <i class="fa fa-circle"
                                                    style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                                <span style="display: block;">
                                                    B.Sc. (Geography) – Gauhati University
                                                </span>
                                            </li>
                                        </ul>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Riverine Landscape, Planetary Science and Climate Change.
                                        </span>
                                    </li>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Secured All India Rank 1 in the national merit list for M.Sc. in Applied
                                            Geography and
                                            Geoinformatics (2017) admission at the Central University of Karnataka through
                                            the Central
                                            Universities Common Entrance Test (CUCET), 2017.
                                        </span>
                                    </li>
                                    <li
                                        style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Conferred with the <i>Gunin (Visarad)</i> title in Sattriya dance, achieving
                                            first position in the
                                            Nartan class from Sangit Sattra, Chandmari, Guwahati.
                                        </span>
                                    </li>
                                </ul>
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        Secured All India Rank 1 in the national merit list for M.Sc. in Applied Geography
                                        and
                                        Geoinformatics (2017) admission at the Central University of Karnataka through the
                                        Central
                                        Universities Common Entrance Test (CUCET), 2017.
                                    </span>
                                </li>
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        Conferred with the <i>Gunin (Visarad)</i> title in Sattriya dance, achieving first
                                        position in the
                                        Nartan class from Sangit Sattra, Chandmari, Guwahati.
                                    </span>
                                </li>
