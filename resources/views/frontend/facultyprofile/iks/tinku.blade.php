                        ...
                        <div class="col-lg-6 text-center">
                            <div class="text-center">
                                <img style="margin-top: 70px; width: 380px; border: 1px solid #27467A;"
                                    src="https://media.rgu.ac/iks/Mr.TinkuMoniDas.jpeg" alt="">
                            </div>
                        </div>
                            ...
                            <div>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <span style="display: block;">
                                            PhD, Pursuing – Linguistics, The English & Foreign Languages University
                                        </span>
                                    </li>
                                    <li
                                        style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            MA, 2017 – Linguistics, The English & Foreign Languages University
                                        </span>
                                    </li>
                                    <li
                                        style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            BA, 2015 – English, Tezpur University
                                        </span>
                                    </li>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <span style="display: block;">
                                            UGC CARE listed: <br>
                                            • Eco-Spiritual Practices in Indigenous Faith: A Study of Dehal Worship Among
                                            the Karbis, Journal
                                            Name: History Research Journal (UGC Care approved), (Volume: 31, Issue 01,
                                            January-February 2025),
                                            ISSN 0976-5425 (P) IF- 7.86
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            SCOPUS-indexed Journal: <br>
                                            Indigenous Knowledge Systems and Sustainable Learning: A Comprehensive Regional
                                            Analysis Of
                                            Northeast India, published in <i>International Journal of Environmental
                                                Sciences</i>, Vol. 11, No.
                                            16s, 2025, Pages 1999-2012, July 2025, ISSN: 2229-7359
                                        </span>
                                    </li>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <span style="display: block;">
                                            ...
                                            Bridging Ancient
                                            Wisdom and Modern Knowledge: Indian Knowledge Systems (pp. 15-64). The Assam
                                            Royal Global
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Bridging Ancient Wisdom and Modern Knowledge: Indian Knowledge Systems, ISBN
                                            978-81-980420-5-7
                        ...
                        <div class="col-lg-7 pt-4 pb-4">
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    ...
                                    <span style="display: block;">
                                        UGC CARE listed: <br>
                                        • Eco-Spiritual Practices in Indigenous Faith: A Study of Dehal Worship Among the
                                        Karbis, Journal
                                        Name: History Research Journal (UGC Care approved), (Volume: 31, Issue 01,
                                        January-February 2025),
                                        ISSN 0976-5425 (P) IF- 7.86
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    ...
                                    <span style="display: block;">
                                        ...
                                        and Modern Knowledge: Indian Knowledge Systems (pp. 15-64). The Assam Royal Global
                                        University, ISBN:
                                        978-81-980420-5-7
                                    </span>
                                </li>
