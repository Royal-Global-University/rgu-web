                        ...
                        <div class="col-lg-6 text-center">
                            <div class="text-center">
                                <img style="margin-top: 70px; width: 380px; border: 1px solid #27467A;"
                                    src="mobile-assets/updated-faculty-img/Kshetrimayum-Renubebeta-Devi.jpeg" alt="">
                            </div>
                        </div>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Self-assembly of magnetic nanoparticles, Quantum dots, hierarchical
                                            nanostructures
                                        </span>
                                    </li>
                                </ul>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            PI of the NPDF project entitled “Development of novel hierarchical magnetic
                                            ferrite–
                                            semiconductor heterostructures for efficient photocatalytic
                                            application’.
                                            Funding agency: DST-SERB, Govt. of India
                                            Amount: Rs. 19,20,000/
                                            (Nineteen Lakhs twenty thousand rupees only)
                                            Host institute: Department of Physics, IIT Guwahati
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        Self-assembly of magnetic nanoparticles, Quantum dots, hierarchical nanostructures
                                    </span>
                                </li>
                            </ul>
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        PI of the NPDF project entitled “Development of novel hierarchical magnetic ferrite–
                                        semiconductor heterostructures for efficient photocatalytic
                                        application’.
                                        Funding agency: DST-SERB, Govt. of India
                                        Amount: Rs. 19,20,000/
