                ...
                <aside class="rgu-fp-sidebar">
                    ...
                    <div class="rgu-fp-profile-card">
                        ...
                        <div class="rgu-fp-image">
                            ...
                            <img src="https://www.rgu.ac/mobile-assets/updated-faculty-img/Amlan-jypti.jpeg"
                                alt="Dr. Amlan Jyoti Oza">
                ...
                <div class="rgu-fp-content">
                    ...
                    <section class="rgu-fp-section">
                        ...
                        <ul class="rgu-fp-list">
                            <li>Ph.D. in Mathematics, Gauhati University, Guwahati, Assam, India</li>
                            <li>M.Sc. in Mathematics, Gauhati University, Guwahati, Assam, India</li>
                            <li>B.Sc. in Mathematics, North Lakhimpur College (Autonomous), Lakhimpur, Assam, India</li>
                    ...
                    <section class="rgu-fp-section">
                        ...
                        <ul class="rgu-fp-list">
                            ...
                            <li>
                                Topology, Soft Computing, Social Network Analysis, Artificial Intelligence (Theoretical)
                    ...
                    <section class="rgu-fp-section">
                        ...
                        <ul class="rgu-fp-list">
                            ...
                            <li> Qualified SET in Mathematical Sciences.</li>
                            <li>Best Paper Presentation Award, International Seminar on Interdisciplinary Scopes of
                                Mathematical and Computational Logic (ISISMCL-2024), Gauhati University.</li>
                            <li>Anundoram Borooah Memorial Award (2012) for distinction in HSLC examination.</li>
                            <li>Highest marks in Advanced Mathematics in HSLC Examination (2012, SEBA).
                            </li>
