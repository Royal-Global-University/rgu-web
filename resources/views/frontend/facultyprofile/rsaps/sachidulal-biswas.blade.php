                        ...
                        <div class="col-lg-6 text-center">
                            <div class="text-center">
                                <img style="margin-top: 70px; width: 380px; border: 1px solid #27467A;"
                                    src="mobile-assets/updated-faculty-img/Dr-Sachidulal-Biswas.png" alt="">
                            </div>
                        </div>
                ...
                <div class="container">
                  ...
                  Member of Advisory Board, The Assam Royal Global University
                            ...
                            <div>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <span style="display: block;">
                                            Ph. D Bioinorganic Chemistry ,Department of Chemistry, NIT Sikkim,
                                            Ravangla Campus, Barfung Block, Sikkim 737139, India. (2016-2021)
                                        </span>
                                    </li>
                                    <li
                                        style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            M. Sc. Chemistry (Inorganic) University of North Bengal, Darjeeling, West
                                            Bengal, India. (2011-2013)
                                        </span>
                                    </li>
                                    <li
                                        style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            B. Sc. Chemistry (H), Physics, Maths University of North Bengal, Darjeeling,
                                            West Bengal, India. (2008-2011)
                                        </span>
                                    </li>
                                ...
                                <h2 class="headd3 mb-3 fw-bold mt-4"
                                    style="color: #FF9A1E; font-weight: 700; font-style: italic;">
                                    Research (Outside Teaching):3 Year
                                </h2>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Postdoctoral Research Associate: Indian Association for the Cultivation of
                                            Science, 2021 – 2022. Supervisor: Prof. Tapan Kanti Paine
                                        </span>
                                    </li>
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Postdoctoral Research Associate: Trinity College Dublin, 2022-2025. Supervisor:
                                            Prof. Aidan R. Mcdonald
                                        </span>
                                    </li>
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        Ph. D Bioinorganic Chemistry ,Department of Chemistry, NIT Sikkim, Ravangla Campus,
                                        Barfung Block, Sikkim 737139, India. (2016-2021)
                                    </span>
                                </li>
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        M. Sc. Chemistry (Inorganic) University of North Bengal, Darjeeling, West Bengal,
                                        India. (2011-2013)
                                    </span>
                                </li>
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        B. Sc. Chemistry (H), Physics, Maths University of North Bengal, Darjeeling, West
                                        Bengal, India. (2008-2011)
                                    </span>
                                </li>
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        Postdoctoral Research Associate: Indian Association for the Cultivation of Science,
                                        2021 – 2022. Supervisor: Prof. Tapan Kanti Paine
                                    </span>
                                </li>
