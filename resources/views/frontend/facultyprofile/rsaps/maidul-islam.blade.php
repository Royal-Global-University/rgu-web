                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    <li
                                        ...
                                        <span style="display: block;">
                                            Ph.D. in Physics : Indian Institute of Technology Guwahati
                                        </span>
                                    </li>
                                    <li
                                        style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            M.Sc. in Physics : Aligarh Muslim University
                                        </span>
                                    </li>
                                    <li
                                        style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            B.Sc. in Physics : Aligarh Muslim University
                                        </span>
                                    </li>
                                    ...
                                    <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                        <li
                                            ...
                                            <i class="fa fa-circle"
                                                style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                            <span style="display: block;">
                                                Terahertz photonics devices and applications
                                            </span>
                                        </li>
                                    </ul>
                                    ...
                                    <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                        ...
                                        <li
                                            ...
                                            <i class="fa fa-circle"
                                                style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                            <span style="display: block;">
                                                PI of ANRF (SERB) Core Research Grant CRG/2023/000392, dated 16th May 2024
                                                for the project entitled ”Exploring Parity-Time symmetry effect in
                                                metasurfaces for terahertz photonics” of Amount Rs. 26,74,892
                                            </span>
                                        </li>
                                    </ul>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            PI of ANRF (SERB) Core Research Grant CRG/2023/000392, dated 16th May 2024 for
                                            the project entitled ”Exploring Parity-Time symmetry effect in metasurfaces for
                                            terahertz photonics” of Amount Rs. 26,74,892
                                        </span>
                                    </li>
                                </ul>
