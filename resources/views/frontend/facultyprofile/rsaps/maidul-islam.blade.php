                ...
                <div class="col-lg-6 text-center">
                  <div class="text-center">
                    <img style="margin-top: 70px; width: 380px; border: 1px solid #27467A;"
                      src="https://bucket-0534zd.s3.ap-south-1.amazonaws.com/mobile-assets/all-faculty/rsaps/24.jpeg" alt="">
                  </div>
                </div>
                  ...
                  <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                    ...
                    <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                      <i class="fa fa-circle"
                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                      <span style="display: block;">
                        PI of ANRF (SERB) Core Research Grant CRG/2023/000392, dated 16th May 2024 for the project entitled ”Exploring Parity-Time symmetry effect in metasurfaces for terahertz photonics” of Amount Rs. 26,74,892
                      </span>
                    </li>
                  </ul>
          ...
          <div style="background-color: #fff; height: 40vh; overflow: visible;">
            ...
            <div class="row">
              ...
              <div class="col-lg-7 pt-5">
                ...
                <h2 class="headd3 mb-5 fw-bold faculty-underline" style="color: #27467A; font-weight: 700; font-size: 26px;">
                  Assistant Professor, The Assam Royal Global University
                </h2>
