                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img class="faculty-bio-img" src="/mobile-assets/updated-faculty-img/Rupak.jpeg" alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Ph.D. in Mathematics(Harmonic Analysis), IIT
                                    Guwahati</span></li>
                            <li><i class="fa fa-circle"></i> <span>M.Sc. in Pure Mathematics, University of Hyderabad</span>
                            </li>
                            <li><i class="fa fa-circle"></i> <span>B.Sc. in Mathematics and Computing, Institute of
                                    Mathematics Applications, Bhubaneswar</span></li>
