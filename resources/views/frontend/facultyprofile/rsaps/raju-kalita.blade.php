                        ...
                        <div class="col-lg-6 text-center">
                            <div class="text-center">
                                <img style="margin-top: 70px; width: 380px; border: 1px solid #27467A;"
                                    src="mobile-assets/all-faculty/rsaps/30.jpeg"
                                    alt="">
                            </div>
                        </div>
                                    ...
                                    <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                        <li
                                            ...
                                            <i class="fa fa-circle"
                                                style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                            <span style="display: block;">
                                                Weather Research & Forecasting, Climate Change
                                            </span>
                                        </li>
                                    </ul>
                                    ...
                                    <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                        ...
                                        <li
                                            ...
                                            <i class="fa fa-circle"
                                                style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                            <span style="display: block;">
                                                Project-JRF by Department of Physics, NEHU Shillong
                                            </span>
                                        </li>
                                        ...
                                        <li
                                            ...
                                            <i class="fa fa-circle"
                                                style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                            <span style="display: block;">
                                                Best Paper award by Indian Meteorological Society (TROPMET-2020)
                                            </span>
                                        </li>
