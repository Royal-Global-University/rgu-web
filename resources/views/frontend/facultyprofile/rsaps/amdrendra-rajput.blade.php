                        ...
                        <div class="col-lg-6 text-center">
                            <div class="text-center">
                                <img style="margin-top: 70px; width: 380px; border: 1px solid #27467A;"
                                    src="mobile-assets/all-faculty/rsaps/4.jpg" alt="">
                            </div>
                        </div>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <span style="display: block;">
                                            Ph.D. in Physics : Indian Institute of Technology Madras
                                        </span>
                                    </li>
                                    <li
                                        style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            B.Sc. and M.Sc. in Physics : Delhi University
                                        </span>
                                    </li>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Quantum Field Theory, Condensed Matter Physics, Cosmology.
                                        </span>
                                    </li>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            International: 25 (In prestigious Journals from USA, UK, GERMANY, FRANCE,
                                            CANADA)
                                        </span>
                                    </li>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Prof. Rajput was selected by the UNDF as an expatriate professor of theoretical
                                            Physics at Haramaya
                                            University Ethiopia. It is a University founded by U.S.A. Worked there from 2007
                                            to 2016. While
                                            abroad, Prof. Rajput collaborated with a few universities in Europe in UN funded
                                            projects. He had
                                            been recognized as very successful teacher with awards for 5 years at a stretch.
                                            <br><br>
                                            Recently, Prof. Rajput was felicitated with a certificate of honor for his
                                            exemplary contribution to
                                            Physics teaching and research in a meeting held at Cotton University, Guwahati
                                            organized by Physics
                                            Academy of North East in April 2025.
                                            <br><br>
                                            Sir's theoretical work on rare earth metals was globally highlighted by the Iowa
                                            state University,
                                            USA in their bi-annual news bulletin.
                                        </span>
                                    </li>
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        International: 25 (In prestigious Journals from USA, UK, GERMANY, FRANCE, CANADA)
                                    </span>
                                </li>
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    ...
                                    <span style="display: block;">
                                        Prof. Rajput was selected by the UNDF as an expatriate professor of theoretical
                                        Physics at Haramaya
                                        University Ethiopia. It is a University founded by U.S.A. Worked there from 2007 to
                                        2016. While
                                        abroad, Prof. Rajput collaborated with a few universities in Europe in UN funded
                                        projects. He had
                                        been recognized as very successful teacher with awards for 5 years at a stretch.
                                        <br><br>
                                        Recently, Prof. Rajput was felicitated with a certificate of honor for his exemplary
                                        contribution to
                                        Physics teaching and research in a meeting held at Cotton University, Guwahati
                                        organized by Physics
                                        Academy of North East in April 2025.
