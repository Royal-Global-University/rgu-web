                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img class="faculty-bio-img" src="/demo-assets/Dipankar.png" alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Master's in Design - Industrial Design, School of
                                    Planning and Architecture, Bhopal</span></li>
                            <li><i class="fa fa-circle"></i> <span>B. Tech - Mechanical, Mewar University, Rajasthan</span>
                            </li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i><span>Social Innovation, Assistive Product Design, Design for
                                    agriculture, Design for Health</span></li>
                        </ul>


                        <h2 class="faculty-bio-sub-heading">Paper Publications in Journals:</h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>International : Gogoi, D. (2024). Design and Development
                                    of the Customized Feeding Assistive Device “Feedsy: For People with Hand Impairment”.
                                    Presented at the 6th International Conference on Innovative Product Design and
                                    Intelligent Manufacturing Systems (IPDIMS 2024)</span></li>
                        </ul>
