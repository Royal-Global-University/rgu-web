                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img class="faculty-bio-img" src="/mobile-assets/all-faculty/rsd/2.png" alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            ...
                            <li><i class="fa fa-circle"></i> <span>Masters in Human Factors and Ergonomics, SNDT Women’s
                                    University</span></li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i><span>Product and Workstation Design, Cognitive Ergonomis,
                                    Ergonomics, Design and Work environment , Design and Occupational Health</span></li>
                        </ul>
