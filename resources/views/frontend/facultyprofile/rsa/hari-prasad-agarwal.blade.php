                    ...
                    <div class="col-lg-5 text-center">
                        ...
                        <div class="text-center">
                            <img style="margin-top: 100px; width: 480px; border: 1px solid #27467A; margin-left: 45px;"
                                src="mobile-assets/all-faculty/rsa/1.jpeg" alt="">
                        </div>
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        Ph.D. (Sustainable Architecture), 2022 – Department of Architecture, Jadavpur
                                        University, Kolkata
                                    </span>
                                </li>
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        M. Arch. (General), 2014 – Aayojan School of Architecture, Jaipur (YCMOU, Nasik)
                                    </span>
                                </li>
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        B. Arch., 1995 – MNIT Jaipur (Rajasthan University, Jaipur)
                                    </span>
                                </li>
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        Research on Green Inititives Since 2017 (under None profitable organization:
                                        Urban-khet)
                                    </span>
                                </li>
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        Organized One-day Urban Farming Workshop on 30th August 2020 on the occasion of
                                        “World Kitchen
                                        Garden Day” at 73/42 Paramhans Marg, Mansarovar, Jaipur.
                                    </span>
                                </li>
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        Organized Five-day hands-on Workshop on “Key-hole Farming” for Institutional
                                        Buildings from 30th
                                        Aug. to 3rd Sept 2021 on the occasion of “World Kitchen Garden Day” at School of
                                        Architecture, Apex
                                        Group of Institution, Sitapura, Jaipur.
                                    </span>
                                </li>
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        Organized Five-days hands-on Workshop on “Waste Management” from 30th Aug. to 3rd
                                        Sept 2022 on the
                                        occasion of “World Kitchen Garden Day” at School of Architecture, Apex Group of
                                        Institution,
                                        Sitapura, Jaipur.
                                    </span>
                                </li>
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        Organized Two-days hands-on Workshop on “Mapping of Green Initiatives” from 23rd May
                                        to 24th May
                                        2024 at Royal School of Architecture under The Assam Royal Global University,
                                        Guwahati.
                                    </span>
                                </li>
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        Waste management, Circular economy, Urban farming, Architectural Heritage &
                                        Conservation
                                    </span>
                                </li>
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        100+ (National as well as International)
                                    </span>
                                </li>
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        Best Paper Award in the International virtual conference on Entrepreneurship during
                                        Challenging
                                        times: Strategies for Success & Sustenance in Technical session: “Entrepreneurship
                                        Challenges and
                                        Opportunities” held on 19th–20th June 2021 at Mohanlal Sukhadia University, Udaipur,
                                        Rajasthan,
                                        India, for the research paper entitled “Urban Agriculture as an Entrepreneurial
                                        Opportunity: Case
                                        Studies from Various Indian Cities.”
                                    </span>
                                </li>
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        Best Paper Award in the 12th International Conference on Sustainable Waste
                                        Management & Circular
                                        Economy and IPLA Global Forum 2022 held from November 30 – December 03, 2022 at Sri
                                        Venkateswara
                                        University, Tirupati, Andhra Pradesh, India. Organized by ISWMAW and Jadavpur
                                        University. Presented
                                        a paper titled “Circular Economy Through Urban Agriculture in Indian Cities.”
                                    </span>
                                </li>
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        North East Leadership Award 2025 for outstanding contribution to the cause of
                                        education, presented
                                        by Dr. R. L. Bhatia, Founder of World Sustainability.
                                    </span>
                                </li>
