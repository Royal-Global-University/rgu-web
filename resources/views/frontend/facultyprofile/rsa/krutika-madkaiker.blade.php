        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" src="https://rgu.ac/mobile-assets/updated-faculty-img/Krutika.png"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Ph. D. (Pursuing), M.Arch (Landscape Architecture), B.Arch.</span></li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i><span>Landscape Planning, Urban Greening, Urban Ecology, Urban Heat Island, Blue-Green Infrastructure, Nature-Based Solutions</span></li>
            </ul>


            <h2 class="faculty-bio-sub-heading">Paper Publications in Journals:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>National Conference Proceedings: 03</span></li>
              <li><i class="fa fa-circle"></i> <span>International Conference Proceedings: 01</span></li>
