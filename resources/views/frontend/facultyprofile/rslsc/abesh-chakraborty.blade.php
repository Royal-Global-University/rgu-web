        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" src="https://www.rgu.ac/mobile-assets/all-faculty/rslsc/AbeshChakraborty.jpeg"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Ph.D. in Zoology (Specialization  in Entomology) from the University of Calcutta</span></li>
              <li><i class="fa fa-circle"></i> <span>M.Sc. in Marine Science (Specialization in Invertebrate Ecology) from University of Calcutta</span></li>
              <li><i class="fa fa-circle"></i> <span>B.Sc. in Genetics (Hons.) from  IGE (Affiliated to West Bengal University of Technology)</span></li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>6.9 years</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i><span>Entomology, Biodiversity and Ecology.</span></li>
            </ul>
