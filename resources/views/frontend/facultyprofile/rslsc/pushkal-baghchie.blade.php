        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" src="https://www.rgu.ac/mobile-assets/updated-faculty-img/Mr-Pushkal-Bagchie.png"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Ph.D. - Pursuing, Biofuels and renewable energy in agroforestry, North Eastern Regional Institute of Science and Technology</span></li>
              <li><i class="fa fa-circle"></i> <span>MSc - Forestry, specialization in wildlife conservation and management, Forest Research Institute University</span></li>
              <li><i class="fa fa-circle"></i> <span>BSc - Forestry, specialization in Wildlife conservation and management, North Eastern Regional Institute of Science and technology</span></li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i><span>renewable energy and biofuels</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>NSS</span></li>
            </ul>
