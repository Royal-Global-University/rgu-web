        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" src="https://rgu.ac/mobile-assets/updated-faculty-img/Diksha.jpeg"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Ph.D. in Zoology (Cancer biology), Department of Zoology, Cotton University (2025)</span></li>
              <li><i class="fa fa-circle"></i> <span>M.Sc. Zoology Honors (Specialization: Cell and Molecular Biology), Department of Zoology, Cotton University (2018)</span></li>
              <li><i class="fa fa-circle"></i> <span>B.Sc. Zoology Honors (Pass courses: Chemistry and Botany), Department of Zoology,Cotton College State University (2016)</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Total Experience:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>9.7 years</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Academic Experience:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>2.7 years</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i><span>Molecular Oncology, Cell and Molecular Biology, Toxicology, Natural Product Chemistry, Pharmacology, Drug Designing</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Paper Publications in Journals:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>National: 02</span></li>
              <li><i class="fa fa-circle"></i> <span>International: 09</span></li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>CSIR NET-SRF (2024)</span></li>
              <li><i class="fa fa-circle"></i> <span>Joint CSIR-UGC NET 2022 (June 2021 session), JRF and Lectureship, AIR 182</span></li>
              <li><i class="fa fa-circle"></i> <span>GATE 2021 (Life Sciences-XL), AIR 1417, organized by IIT Bombay</span></li>
              <li><i class="fa fa-circle"></i> <span>SLET-N.E. 2022 (Life Sciences), organized by SLET Commission, Assam</span></li>
              <li><i class="fa fa-circle"></i> <span>BEST POSTER PRESENTATION AWARD at the National Seminar on “Ethnopharmacology for Bioeconomy: The New Paradigm” (EBNP-2023) organized by CSIR-North East Institute of Science & Technology (NEIST), Jorhat in collaboration with Society for Ethnopharmacology, India, 28-30 November, 2023</span></li>
