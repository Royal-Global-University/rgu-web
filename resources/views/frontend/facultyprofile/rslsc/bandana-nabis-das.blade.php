                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img class="faculty-bio-img"
                                src="/mobile-assets/updated-faculty-img/Prof-Bandana-Nabis-Das-RSLSC.png" alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Ph.D. , MSc with Cytogenetics and Plant Breeding</span>
                            </li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>34.1 yrs</span></li>
                        </ul>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>20+ yrs</span></li>
                        </ul>

                        <h2 class="faculty-bio-sub-heading">Research Interests:</h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i><span>Cytogenetics</span></li>
                        </ul>


                        <h2 class="faculty-bio-sub-heading">Paper Publications in Journals:</h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>National: 07</span></li>
                            <li><i class="fa fa-circle"></i> <span>International: 05</span></li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Recipient of the Ram Sakhi Devi Award (Best Lady Speaker)
                                    conferred by the Department of Botany, Banaras Hindu University, Varanasi.</span></li>
                            <li><i class="fa fa-circle"></i> <span>Awarded FNRS by the International Society for
                                    Conservation of Natural Resources in 2003.</span></li>
                            <li><i class="fa fa-circle"></i> <span>One of the Five members of the team - Council for Teacher
                                    Education (CTE) in India - visited Bangladesh (Dacca and Jahangirnagar Universities) on
                                    a ‘Goodwill Mission’ in 2004. Recipient of a citation from the Council for Teacher
                                    Education in India (CTE) on ‘Goodwill Mission’ to Bangladesh, 2004.</span></li>
                            <li><i class="fa fa-circle"></i> <span>Fellow of Botanical Society of Assam, 2015.</span></li>
                            <li><i class="fa fa-circle"></i> <span>Member State Child Protection Society, Govt. of
                                    Assam</span></li>
