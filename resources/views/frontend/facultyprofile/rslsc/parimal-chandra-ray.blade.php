        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" src="https://www.rgu.ac/mobile-assets/all-faculty/rslsc/ParimalChandra.jpeg"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Ph.D. (2017) from Department of Forestry, Northeastern Regional Institute of Science and Technology, Itanagar, Arunachal Pradesh, India</span></li>
              <li><i class="fa fa-circle"></i> <span>M.Sc. in Zoology, Department of Zoology, Gauhati University, Guwahati, Assam, India</span></li>
              <li><i class="fa fa-circle"></i> <span>B.Sc. in Zoology, Arya Vidyapeeth College, Guwahati, Assam, India</span></li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>4 years and 01 month</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Research (outside teaching): </h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>12 years and 06 months</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Research Interests:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i><span>Wildlife species conservation (in-situ and ex-situ), wildlife monitoring, ecology and behavioural biology of wild animals (diurnal and nocturnal species), environmental toxicology, forest regeneration and habitat restoration, citizen-science based cum community participatory conservation of wildlife.</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>2024: Invited for a sponsored training to attend at Institute of Subtropical Agriculture, Chinese Academy of Sciences, Changsha, China</span></li>
              <li><i class="fa fa-circle"></i> <span>2016: British Ecological Society - Training and Travel grant</span></li>
              <li><i class="fa fa-circle"></i> <span>2016: Gratis Book Scheme – NHBS, United Kingdom</span></li>
