                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img class="faculty-bio-img" src="/mobile-assets/updated-faculty-img/Dr-Anushree-Baruah-RSLSC.png"
                                alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Ph.D. (Environmental Science), Tezpur Central University,
                                    Tezpur, Assam (2017)</span></li>
                            <li><i class="fa fa-circle"></i> <span>M.Sc. (Botany), Cotton College, Gauhati University, Assam
                                    (2007),1st Class</span></li>
                            <li><i class="fa fa-circle"></i> <span>B.Sc. (Botany Honours’), D.C.B. Girls College, Dibrugarh
                                    University, (2005),1st Class</span></li>

                        </ul>

                        <h2 class="faculty-bio-sub-heading">Total Experience:</h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>10 years 5 months</span></li>
                        </ul>

                        <h2 class="faculty-bio-sub-heading">Academic Experience:</h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>7 years 5 months</span></li>
                        </ul>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Sustainable Agriculture , Climate Change Mitigation ,
                                    Soil Health Management</span></li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>05</li>
                        </ul>
