                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img class="faculty-bio-img" src="/mobile-assets/updated-faculty-img/Mr-Benex-K-Babu.png"
                                alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>MSc. Forensic Science, Specialized in forensic chemistry
                                    and toxicology, Dr. A.P.J Abdul Kalam Institute of Forensic Science and Criminology,
                                    Bundelkhand University, Jhansi, UP.</span></li>
                            <li><i class="fa fa-circle"></i> <span>BSc. Forensic Science, School of Science, Jain
                                    University, JC Road, Bangalore, KA</span></li>

                        </ul>

                        <h2 class="faculty-bio-sub-heading">Total Experience:</h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>1.7 Years</span></li>
                        </ul>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Forensic Chemistry, Toxicology, Spectroscopy,
                                    Chemometrics</span></li>
                        </ul>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Certified Penetration Tester (CPT) from Redteam Hacker
                                    Academy</span></li>
                            <li><i class="fa fa-circle"></i> <span>UGC NET</span></li>
