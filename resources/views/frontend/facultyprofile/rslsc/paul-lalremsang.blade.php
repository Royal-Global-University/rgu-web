        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" src="https://www.rgu.ac/mobile-assets/updated-faculty-img/Dr-Paul-Lalremsang-RSLSC.png"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Ph.D. in Forestry (Mizoram University)</span></li>
              <li><i class="fa fa-circle"></i> <span>MSc. in Forestry (Mizoram University)</span></li>
              <li><i class="fa fa-circle"></i> <span>BSc. in Forestry (North Eastern Regional Institute of Science and Technology)</span></li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i><span>Agroforestry, Ecology, Biodiversity conservation, carbon sequestration</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              ...
              <li><i class="fa fa-circle"></i> <span>International: 11</span></li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Young Scientist Award 2017 by International Science Community Association.</span></li>
            </ul>
