                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img class="faculty-bio-img" src="/mobile-assets/updated-faculty-img/Dr-Demsai-Reang-RSLSC.png"
                                alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Ph.D. in Environmental Science, Assam Central University
                                    (Forest Ecology, Landscape management, and Remote Sensing & GIS applications).</span>
                            </li>
                            <li><i class="fa fa-circle"></i> <span>M.Sc. in Environmental Science, Assam Central
                                    University.</span></li>
                            <li><i class="fa fa-circle"></i> <span>B.Sc. in Botany, Union Christian College, NEHU,
                                    Meghalaya.</span></li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i><span>Forest and Agro-Ecology, Biodiversity Conservation; Remote
                                    Sensing & GIS, Climate vulnerability</span></li>
                        </ul>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Evaluating urban green carbon pools in Guwahati: A
                                    blueprint for mitigating climate risk and urban heat island intensity</span></li>
                            <li><i class="fa fa-circle"></i> <span>Assessing the nexus of microplastic contamination in
                                    agricultural soils of Kharupetia-Dalgaon Belt, Assam: Implications for achieving the UN
                                    SDG3</span></li>
                        </ul>
