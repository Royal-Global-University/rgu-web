                        ...
                        <div class="col-lg-6 text-center">
                            <div class="text-center">
                                <img style="margin-top: 70px; width: 380px; border: 1px solid #27467A;"
                                    src="/mobile-assets/updated-faculty-img/Manash.jpg" alt="">
                            </div>
                        </div>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <span style="display: block;">
                                            Ph. D - Thermo-fluids, NIT Silchar
                                        </span>
                                    </li>
                                    <li
                                        style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            M. Tech.- Mechanical Engineering, Tezpur University
                                        </span>
                                    </li>
                                    <li
                                        style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            B. Tech.- Mechanical Engineering, DUIET, Dibrugarh University
                                        </span>
                                    </li>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Worked as Research Scholar at NIT Silchar
                                        </span>
                                    </li>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Droplet dynamics, Electro-hydrodynamics, Bio-microfluidics,
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Best Poster presentation award at Anveshan 2.0 (Student 2020 NIT Silchar
                                            Research Convention)
                                        </span>
                                    </li>
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Institute Fellowship for Doctoral Research( 2017 MHRD)
                                        </span>
                                    </li>
                                    <li
                                        style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Gold Medalist in the M. Tech program(2017 Tezpur University)
                                        </span>
                                    </li>
                                    <li
                                        style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Institute Fellowship for Post Graduate Research(2015 MHRD)
                                        </span>
                                    </li>
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        Best Poster presentation award at Anveshan 2.0 (Student 2020 NIT Silchar Research
                                        Convention)
                                    </span>
                                </li>
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
