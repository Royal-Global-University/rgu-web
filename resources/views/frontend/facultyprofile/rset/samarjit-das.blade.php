                        ...
                        <div class="col-lg-6 text-center">
                            <div class="text-center">
                                <img style="margin-top: 70px; width: 380px; border: 1px solid #27467A;"
                                    src="mobile-assets/updated-faculty-img/Dr-Samarjit-Das-RSIT.png" alt="">
                            </div>
                        </div>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Computational Data Science and Knowledge Engineering, Fuzzy Logic, Soft
                                            Computing, and Uncertainty
                                            Modelling, Blockchain Systems, Crypto-economics, and Decentralised
                                            Infrastructures and Artificial
                                            Intelligence and Ethical Machine Learning
                                        </span>
                                    </li>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            None granted yet; 2 patent applications currently under examination.Books
                                            Published: None at
                                            present; future publication opportunities under consideration.
                                        </span>
                                    </li>
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        Computational Data Science and Knowledge Engineering, Fuzzy Logic, Soft Computing,
                                        and Uncertainty
                                        Modelling, Blockchain Systems, Crypto-economics, and Decentralised Infrastructures
                                        and Artificial
                                        Intelligence and Ethical Machine Learning
                                    </span>
                                </li>
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        None granted yet; 2 patent applications currently under examination.Books Published:
                                        None at
                                        present; future publication opportunities under consideration.
                                    </span>
                                </li>
