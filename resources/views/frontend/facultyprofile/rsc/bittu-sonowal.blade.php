                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Masters in European Studies (French)</span></li>
                            <li><i class="fa fa-circle"></i> <span>M.A in English</span></li>
                        </ul>
                        ...
                        <h2 class="faculty-bio-sub-heading">Research Experience:</h2>
                        <ul class="faculty-bio-info-list">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span> NET,JRF</span></li>
                        </ul>
