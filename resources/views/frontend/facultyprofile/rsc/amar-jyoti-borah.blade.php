                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img class="faculty-bio-img" style="height: 400px; width: 400px;"
                                src="/mobile-assets/updated-faculty-img/amar-borah.jpeg" alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Ph.D. in Commerce, 2025, Assam University (Behavioural
                                    Finance, Working Capital Management, Entrepreneurship)</span></li>
                            <li><i class="fa fa-circle"></i> <span>M.Phil. in Commerce, 2022, Assam University (Human
                                    Resource Accounting)</span></li>
                            <li><i class="fa fa-circle"></i> <span>Master of Commerce, 2018, Assam University
                                    (Specialization in Accounting)</span></li>
                            <li><i class="fa fa-circle"></i> <span>B.Com, 2015, JB College Jorhat, Dibrugarh University (
                                    Specialization in Accounting and finance)</span></li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i><span>Behavioural Finance, Entrepreneurship, Working Capital
                                    Management, Human Resource Accounting.</span></li>
                        </ul>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Qualified UGC NET 5 times (July 2018, June 2019, December
                                    2019, Merged 2020–2021, Merged 2021–2022) and Awarded Junior Research Fellowship (JRF)
                                    twice (2) through UGC NET.</span></li>
                            <li><i class="fa fa-circle"></i> <span>Reached Interview Stage of Assam Public Service
                                    Commission CCE 2024 (2026) and FMO 2023 (2024)</span></li>
                            <li><i class="fa fa-circle"></i> <span>Received Assam University M.Phil Fellowship grant
                                    (Fellowship granted to scholars without JRF).</span></li>
                            <li><i class="fa fa-circle"></i> <span>Presented research papers in national/international
                                    conferences and seminars</span></li>
                            <li><i class="fa fa-circle"></i> <span>More than 2 and half years of work experience in the
                                    Government Sector (Govt. of Assam)</span></li>
