                        ...
                        <div class="col-lg-6 text-center">
                            <div class="text-center">
                                <img style="margin-top: 70px; width: 380px; border: 1px solid #27467A;"
                                    src="mobile-assets/updated-faculty-img/Visiting%20Faculty/RSC/Upal%20J%20Baruah.jpeg" alt="">
                            </div>
                        </div>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <span style="display: block;">
                                            B.E. from Assam Engineering College and PGDM from Assam Institute of Management
                                        </span>
                                    </li>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Entrepreneurship, Data Analysis, Lean Tools, Energy Management
                                        </span>
                                    </li>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Co-PI in A Study on Impact Assessment on CSR Projects by PowerGrid Corporation
                                            of India Ltd in Feb - 2025.
                                        </span>
                                    </li>
                                    <li
                                        style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Conducted a “Feasibility Study and the Identification of Key Elements to be
                                            included in Bodoland Heritage Conservation Center” for a Consultancy Project
                                            titled “Bodoland Heritage Conservation Centre: Feasibility and Detailed
                                            Engineering Proposal” for Wildlife Trust of India (WTI), Noida, Delhi (India)
                                            along with Associated Builders, Guwahati in Jan - 2024.
                                        </span>
                                    </li>
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        Co-PI in A Study on Impact Assessment on CSR Projects by PowerGrid Corporation of
                                        India Ltd in Feb - 2025.
                                    </span>
                                </li>
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        Conducted a “Feasibility Study and the Identification of Key Elements to be included
                                        in Bodoland Heritage Conservation Center” for a Consultancy Project titled “Bodoland
                                        Heritage Conservation Centre: Feasibility and Detailed Engineering Proposal” for
                                        Wildlife Trust of India (WTI), Noida, Delhi (India) along with Associated Builders,
                                        Guwahati in Jan - 2024.
                                    </span>
                                </li>
