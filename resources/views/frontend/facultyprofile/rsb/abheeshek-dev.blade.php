                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img class="faculty-bio-img" style="height: 300px; width: 300px;"
                                src="/mobile-assets/updated-faculty-img/Abheeshek.png" alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Ph.D. in Marketing (June 2021– March 2026), Indian
                                    Institute of Management Kozhikode</span></li>
                            <li><i class="fa fa-circle"></i> <span>PGDM in Development Studies (2017–2019), Entrepreneurship
                                    Development Institute of India, Gandhinagar</span></li>
                            <li><i class="fa fa-circle"></i> <span>B.Tech in Electrical and Electronics Engineering
                                    (2010–2014), SRM University, Chennai</span></li>
                        </ul>
                        ...
                        <ul class="faculty-bio-info-list">
                            ...
                            <li><i class="fa fa-circle"></i><span>Digital Payments Adoption & Financial Inclusion</span>
                            </li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Participated in the Doctoral Participant-Centred Learning
                                    workshop in Mumbai by Harvard Business School India Research Centre (2025)</span></li>
                            <li><i class="fa fa-circle"></i> <span>Delivered instructional sessions on Systematic Literature
                                    Review Methodology, Picture elicitation interview method, Marketing & Poverty for first
                                    and second year doctoral candidates at IIM Kozhikode (2024 & 2025)</span></li>
                            <li><i class="fa fa-circle"></i> <span>Guest Lecturer on Business Communication at Gujarat Law
                                    University (2021)</span></li>
                            <li><i class="fa fa-circle"></i> <span>Journal Reviewer: International Journal of Consumer
                                    Studies, IIM Kozhikode Society & Management Review</span></li>
                            <li><i class="fa fa-circle"></i> <span>Conference Reviewer: American Marketing Association (AMA)
                                    Summer Conference (2024), Australia and New Zealand Marketing Academy (ANZMAC)
                                    Conference (2023)</span></li>
