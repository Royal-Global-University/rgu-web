        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" src="https://www.rgu.ac/mobile-assets/updated-faculty-img/Pranati-Das-RSBSC.png"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Ph.D. (Food Science & Nutrition), Acharya N.G.Ranga Agricultural University, Hyderabad. India</span></li>
              <li><i class="fa fa-circle"></i> <span>M.Sc. (Food  & Nutrition), G.B.Pant university of Agriculture & , Pantnagar, India </span></li>
              <li><i class="fa fa-circle"></i> <span>B.Sc. (Home Sc.), Assam Agricultural University, Jorhat, Assam</span></li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Nutritional quality of traditional foods, Micronutrient bioavailability New product development, Health/ low glycemic  food development, Public health nutrition.</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Awarded Best Researcher from Assam Agricultural University in 2018</span></li>
              <li><i class="fa fa-circle"></i> <span>Research Excellence Award Samagra Vikash society, Lucknow & Bbasaheb Bhimrao Ambedkar University, Lucknow in 2018</span></li>
              <li><i class="fa fa-circle"></i> <span>International Union of Nutritional Sciences - INSA National Committee Member from 2024-2026</span></li>
              <li><i class="fa fa-circle"></i> <span>Executive Committee member of Nutrition Society of India from 2021-2023</span></li>
              <li><i class="fa fa-circle"></i> <span>MHRD- Team leader in the Joint Review team of MID Day Meal for Tripura & Assam 2013</span></li>
              <li><i class="fa fa-circle"></i> <span>Technical Coordinator for Food & Nutrition for All India Coordinated Research Project by ICAR from 2007-2019</span></li>
              <li><i class="fa fa-circle"></i> <span>Project completed from ICAR, BARC, DBT, USAID, ICMR</span></li>
              <li><i class="fa fa-circle"></i> <span>HOD Food Science & Nutrition, Assam Agricultural University, Jorhat from 2011-2021</span></li>
              <li><i class="fa fa-circle"></i> <span>Dean Incharge of College of Community Science from 2019-2021</span></li>
