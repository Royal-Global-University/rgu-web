        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" src="https://www.rgu.ac/mobile-assets/updated-faculty-img/Dr-Robbarts-Nongmaithem.png"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Ph.D. (Biological Engineering), University of Saskatchewan, Canada</span></li>
              <li><i class="fa fa-circle"></i> <span>M.Tech. (Food Process Engineering), Indian Institute of Technology, Kharagpur, India</span></li>
              <li><i class="fa fa-circle"></i> <span>B.Tech. (Agricultural Engineering), College of Agricultural Engineering and Post Harvest Technology, Ranipool, Sikkim, India</span></li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span> New product development, Food valorisation, Drying, Extrusion and Extraction.</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>International Student and Study Abroad Centre (ISSAC)- Travel award-2016</span></li>
              <li><i class="fa fa-circle"></i> <span>International Dean's Scholarship, University of Saskatchewan 2014-2016</span></li>
              <li><i class="fa fa-circle"></i> <span>Global Institute of Food Security, Canada-2014</span></li>
              <li><i class="fa fa-circle"></i> <span>ICAR-NET-2015</span></li>
              <li><i class="fa fa-circle"></i> <span>GATE-2010</span></li>
