                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Ph.D. Food Technology (Pursuing), The Assam Royal Global
                                    University, Guwahati.</span></li>
                            <li><i class="fa fa-circle"></i> <span>MSc Food Technology, Shoolini University, Himachal
                                    Pradesh</span></li>
                            <li><i class="fa fa-circle"></i> <span>B. Sc Food and Nutrition (Food science and quality
                                    control), The Maharaja Sayajirao University of Baroda, Gujrat.</span></li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>4 years,2 months</span></li>
                        </ul>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>4 months</span></li>
                        </ul>


                        <h2 class="faculty-bio-sub-heading">Research Interest:</h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Product development, Waste by-product
                                    utilization.Functional food</span></li>
                        </ul>


                        <h2 class="faculty-bio-sub-heading">Any Other Achievements/Awards:</h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Regional Seminar on “Food Product Development-Concept to
                                    Consumer” organized by the department of Foods and nutrition {UGC DSA-III}.</span></li>
