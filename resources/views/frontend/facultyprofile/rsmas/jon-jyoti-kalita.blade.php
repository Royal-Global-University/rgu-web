        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" src="https://rgu.ac/mobile-assets/updated-faculty-img/Jon-Jyoti-Kalita.png"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Ph.D. -Indian Institute of Technology Guwahati, Food safety and aptamer-based bioassay</span></li>
              <li><i class="fa fa-circle"></i> <span>M.Tech -Tezpur University, Food Engineering and Technology</span></li>
              <li><i class="fa fa-circle"></i> <span>B.E. -MVJ College of Engineering, Biotechnology</span></li>

            </ul>

            <h2 class="faculty-bio-sub-heading">Total Experience:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>2.4 Years</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Academic Experience:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>1.4 Year</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Food safety, Aptamer based bioassays, Bioactive peptides</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Any Other Achievements/Awards: GATE, MHRD Fellowship</span></li>
