                        ...
                        <div class="col-lg-6 text-center">
                            <div class="text-center">
                                <img style="margin-top: 70px; width: 380px; border: 1px solid #27467A;"
                                    src="mobile-assets/updated-faculty-img/Madhusmita-Koch.png" alt="">
                            </div>
                        </div>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    <li
                                        ...
                                        <span style="display: block;">
                                            Ph.D. – 2022 (Assam down town University, Guwahati, Assam).
                                        </span>
                                    </li>
                                    <li
                                        style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Master of Physiotherapy (MPT- Musculoskeletal & Sports Physiotherapy) - GOLD
                                            MEDALIST (87%) in 2012 from Rajiv Gandhi University of Health Sciences,
                                            Bangalore, Karnataka.
                                        </span>
                                    </li>
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Bachelor of Physiotherapy (BPT) - GOLD MEDALIST (79.7%) in 2009 from Rajiv
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Musculoskeletal and sports physiotherapy, Osteoarthritis, Women’s health
                                        </span>
                                    </li>
                                </ul>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Expert speaker in Physiofest 2025 - 15th Physiotherapy Summit, An International
                                            Conference held at RK University, Gujarat
                                        </span>
                                    </li>
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Expert speaker in Assam Physiocon 2024 – A National Physiotherapy Conference
                                            held at Gauhati Medical College and Hospital
                                        </span>
                                    </li>
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Awarded as the Best Faculty Speaker in 2017 by Assam down town University
                                        </span>
                                    </li>
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Gold Medalist in BPT & MPT, Rajiv Gandhi University of Health Sciences,
                                            Bangalore
                                        </span>
                                    </li>
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Invited as Guest speaker to different colleges and universities in academic
                                            programs
                                        </span>
                                    </li>
                        ...
                        <div class="col-lg-7 pt-4 pb-4">
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    ...
                                    <span style="display: block;">
                                        Master of Physiotherapy (MPT- Musculoskeletal & Sports Physiotherapy) - GOLD
                                        MEDALIST (87%) in 2012 from Rajiv Gandhi University of Health Sciences, Bangalore,
                                        Karnataka.
                                    </span>
                                </li>
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        Bachelor of Physiotherapy (BPT) - GOLD MEDALIST (79.7%) in 2009 from Rajiv Gandhi
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        Expert speaker in Assam Physiocon 2024 – A National Physiotherapy Conference held at
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        Gold Medalist in BPT & MPT, Rajiv Gandhi University of Health Sciences, Bangalore
                                    </span>
                                </li>
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        Invited as Guest speaker to different colleges and universities in academic programs
                                    </span>
                                </li>
