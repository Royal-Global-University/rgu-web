                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img class="faculty-bio-img" src="/mobile-assets/updated-faculty-img/Pankaj-Jha-RSBSC.png"
                                alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Ph.D. (Chemical Engineering), Indian Institute of
                                    Technology Guwahati, Guwahati, Assam, India</span></li>
                            <li><i class="fa fa-circle"></i> <span>M.Tech. (Food Engineering & Technology), Tezpur Central
                                    University, Tezpur, Assam, India</span></li>
                            <li><i class="fa fa-circle"></i> <span>B.E. (Biotechnology), Aarupadai Veedu Institute of
                                    Technology, Vinayaka Missions University, Chennai, Tamil Nadu, India </span></li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>08 Years</span></li>
                        </ul>


                        <h2 class="faculty-bio-sub-heading">Research Interest:</h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Food Packaging, Beverage Technology, Non-Thermal Food
                                    Processing, Food Nanotechnology.</span></li>
                        </ul>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Special research student at the United Graduate School of
                                    Agricultural Science, Gifu University, Japan from 1st October, 2016 to 31st March, 2017
                                    at Gifu University, Gifu, Japan.</span></li>
                            <li><i class="fa fa-circle"></i> <span>Japan Student Services Organization (JASSO) fellowship
                                    from 1st October, 2016 to 31st March, 2017 at Gifu University, Gifu, Japan.</span></li>
                            <li><i class="fa fa-circle"></i> <span>Qualified GATE.</span></li>
