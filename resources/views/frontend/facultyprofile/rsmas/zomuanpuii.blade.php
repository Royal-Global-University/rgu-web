        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" src="https://www.rgu.ac/mobile-assets/updated-faculty-img/Zomuanpuii.png"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Ph.D. - Pursuing at Assam down town University, Guwahati.</span>
              </li>
              <li><i class="fa fa-circle"></i> <span>M.Sc. - in Emergency & Critical Care from Assam down town
                  University, Guwahati.</span></li>
              <li><i class="fa fa-circle"></i> <span>B.Sc. - in Trauma, Emergency & disaster Management from Assam down
                  town University, Guwahati.</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Cancer biology and immunotherapy</span></li>
              <li><i class="fa fa-circle"></i> <span>Cardiovascular Diseases</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Any Other Achievements/Awards:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Member of the ‘Association of Allied Health Professionals’.</span>
              </li>
            </ul>
