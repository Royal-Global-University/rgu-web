        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" style="height: 400px; width: 400px;" src="https://www.rgu.ac/mobile-assets/updated-faculty-img/Ms.%20Ankita%20Kalita.jpeg"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Pursuing Ph.D. - Assam downtown University</span></li>
              <li><i class="fa fa-circle"></i> <span>Masters of Physiotherapy (MPT), Musculoskeletal disorder and Sports, Rajiv Gandhi University of Health Sciences </span></li>
              <li><i class="fa fa-circle"></i> <span>Bachelor of Physiotherapy, Rajiv Gandhi University of Health Sciences,</span></li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i><span>Sports Injuries, Orthopaedic Conditions, Womens Health</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>INVITATION AS CHIEF GUEST IN PHYSIOTHERPAY DAY, ASSAM KAZIRANGA UNIVERSITY</span></li>
            </ul>
