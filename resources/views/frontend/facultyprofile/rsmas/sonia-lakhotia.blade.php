                        ...
                        <div class="col-lg-6 text-center">
                            <div class="text-center">
                                <img style="margin-top: 70px; width: 380px; border: 1px solid #27467A;"
                                    src="mobile-assets/updated-faculty-img/sonia-lakhotia.jpeg" alt="">
                            </div>
                        </div>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    <li
                                        ...
                                        <span style="display: block;">
                                            Master of Physiotherapy (Adult Neurology (2012), Sikkim Manipal College of
                                            Physiotherapy, Sikkim Manipal University)
                                        </span>
                                    </li>
                                    <li
                                        style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Bachelor of Physiotherapy (2009), Oxford College of Physiotherapy, Rajiv Gandhi
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Rehabilitation of Geriatric patients, Diabetic neuropathy & Parkinson’s Disease
                                        </span>
                                    </li>
                                </ul>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Best Scientific Paper Presenter in professional category at Osteo Manual Summit
                                            2023, 2nd International Osteopathy & Manual Therapy Conference, New Delhi (26th
                                            Nov 2023)
                                        </span>
                                    </li>
                                </ul>
                        ...
                        <div class="col-lg-7 pt-4 pb-4">
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    ...
                                    <span style="display: block;">
                                        Best Scientific Paper Presenter in professional category at Osteo Manual Summit
                                        2023, 2nd International Osteopathy & Manual Therapy Conference, New Delhi (26th Nov
                                        2023)
                                    </span>
                                </li>
                            </ul>
