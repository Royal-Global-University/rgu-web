                ...
                <aside class="rgu-fp-sidebar">
                    ...
                    <div class="rgu-fp-profile-card">
                        ...
                        <div class="rgu-fp-image">
                            ...
                            <img src="https://www.rgu.ac/mobile-assets/updated-faculty-img/Ms.%20Kynjailin.png"
                                alt="Ms. Kynjailin Syiemlieh">
                        ...
                        <div class="rgu-fp-info">
                            ...
                            <h1 class="rgu-fp-name">
                                Ms. Kynjailin Syiemlieh
                            </h1>

                            <div class="rgu-fp-designation">

                                Assistant Professor & Coordinator, Dialysis Therapy Technology, Royal School of Medical
                                & Allied Sciences.
                ...
                <div class="rgu-fp-content">
                    ...
                    <section class="rgu-fp-section">
                        ...
                        <ul class="rgu-fp-list">
                            <li>Ph.D. in Dialysis - Pursuing at Assam down town University, Guwahati, Assam</li>
                            <li>M.Sc. in Renal Dialysis Technology from Yenepoya (Deemed to be University), Mangalore,
                                Karnataka</li>
                            <li>B.Sc. in Dialysis Technology from Assam down town University, Guwahati, Assam</li>
                            <li>Diploma in Dialysis Technology from Assam down town University, Guwahati, Assam</li>
                    ...
                    <section class="rgu-fp-section">
                        ...
                        <ul class="rgu-fp-list">
                            ...
                            <li>
                                Hemodialysis and Dialysis Technology
                            </li>
                            <li>Chronic Kidney Disease (CKD) </li>
                            <li>Diabetic Kidney Disease (DKD)</li>
                            <li>Intradialytic Complications </li>
                            <li>Dialysis Adequacy</li>
                            <li>Clinical Outcomes and Quality of Life in Dialysis Patients</li>
                    ...
                    <section class="rgu-fp-section">
                        ...
                        <ul class="rgu-fp-list">
                            ...
                            <li>Completed American Kidney Fund Educational Training Course as a Kidney Health Coach.
                            </li>
