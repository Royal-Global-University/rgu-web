        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" src="https://www.rgu.ac/mobile-assets/updated-faculty-img/Shagufta-Rizwana-RSBSC.png"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Ph.D. in Food Engineering and Technology, Tezpur University (2024)</span></li>
              <li><i class="fa fa-circle"></i> <span>M.Tech. in Food Engineering and Technology, Tezpur University (2019)</span></li>
              <li><i class="fa fa-circle"></i> <span>B.Tech. in Food Engineering and Technology, Tezpur University (2017)</span></li>

            </ul>

            <h2 class="faculty-bio-sub-heading">Total Experience:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>2 year, 4 months</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Academic Experience:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>2 year, 4 months (Assistant Professor, Assam Royal Global University)</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Industry/Research (outside teaching):</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>1 month as a JRF at Defence Research Laboratory, DRDO, Tezpur</span></li>
            </ul>


            <h2 class="faculty-bio-sub-heading">Research Interest:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Near-Infrared (NIR) spectroscopy for food quality analysis</span></li>
              <li><i class="fa fa-circle"></i> <span>Machine learning applications in food processing.</span></li>
              <li><i class="fa fa-circle"></i> <span>Food process kinetic modelling, mechanistic modelling, food process optimization.</span></li>
            ...
            <ul class="faculty-bio-info-list">
              ...
              <li><i class="fa fa-circle"></i> <span>International: 6</span></li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Awarded AICTE National Doctoral Fellowship (2019)</span></li>
              <li><i class="fa fa-circle"></i> <span>Finalist in Grand Finale of Smart India Hackathon, Ministry of Education, India (2022)</span></li>
              <li><i class="fa fa-circle"></i> <span>UGC JRF Award (2022)</span></li>
              <li><i class="fa fa-circle"></i> <span>Shortlisted for Travel Grant for the National Conference for Young Researcher Award ET-SAFE(2025)</span></li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>NSS Volunteer during B. Tech. for 1 year</span></li>
