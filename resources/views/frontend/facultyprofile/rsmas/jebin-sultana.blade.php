        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" src="https://www.rgu.ac/mobile-assets/updated-faculty-img/nutrition/1.png"
                alt="">
            </div>
          </div>
          ...
          <div class="col-lg-7 pt-5 faculty-bio-desktop-display">
            <div class="faculty-bio-name-pad">
              ...
              <h2 class="faculty-bio-designation mb-5 faculty-bio-underline-effect">
                Assistant Professor, Assistant Dean, Academic Affairs & Coordinator
              </h2>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Ph.D. (Pursuing), RGU</span></li>
              <li><i class="fa fa-circle"></i> <span>M.Sc (Nutrition & Dietetics), LPU</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>2.5 Years</span></li>
            </ul>


            <h2 class="faculty-bio-sub-heading">Research Interest:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Clinical Nutrition, Critical care Nutrition, Therapeutic Nutrition and Community Nutrition.</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
               <li><i class="fa fa-circle"></i> <span>Joint Secretary of Northeast Nutrition & Dietetics Association</span></li>
               <li><i class="fa fa-circle"></i> <span>Scientific committee member of Indian Association of Enteral & Parental Nutrition</span></li>
               <li><i class="fa fa-circle"></i> <span>Lifetime Member of Nutrition Society of India</span></li>
               <li><i class="fa fa-circle"></i> <span>Star Performer Award, Apollo Hospital Ghy</span></li>
               <li><i class="fa fa-circle"></i> <span>Best Dietician for critical care & Rehabilitation, Swasthya Rehabilitation Centre</span></li>
               <li><i class="fa fa-circle"></i> <span>Invited Speaker by FSSAI on Rice Fortification on AIR</span></li>
               <li><i class="fa fa-circle"></i> <span>Invited as guest speaker on inaugural session of Nutrition and Dietetic Association of Meghalaya</span></li>
