                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img class="faculty-bio-img" src="/mobile-assets/updated-faculty-img/nutrition/1.png"
                                alt="">
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Clinical Nutrition, Critical care Nutrition, Therapeutic
                                    Nutrition and Community Nutrition.</span></li>
                        </ul>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Joint Secretary of Northeast Nutrition & Dietetics
                                    Association</span></li>
                            <li><i class="fa fa-circle"></i> <span>Scientific committee member of Indian Association of
                                    Enteral & Parental Nutrition</span></li>
                            ...
                            <li><i class="fa fa-circle"></i> <span>Best Dietician for critical care & Rehabilitation,
                                    Swasthya Rehabilitation Centre</span></li>
                            <li><i class="fa fa-circle"></i> <span>Invited Speaker by FSSAI on Rice Fortification on
                                    AIR</span></li>
                            <li><i class="fa fa-circle"></i> <span>Invited as guest speaker on inaugural session of
                                    Nutrition and Dietetic Association of Meghalaya</span></li>
