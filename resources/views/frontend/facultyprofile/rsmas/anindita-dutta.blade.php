                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img class="faculty-bio-img" src="https://rgu.ac/mobile-assets/updated-faculty-img/Anindita.jpeg"
                                alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Ph.D. – Pursuing at Dept. of Biotechnology, The Assam
                                    Royal Global University</span></li>
                            <li><i class="fa fa-circle"></i> <span>M.Sc in Molecular Biology and Biotechnology, Tezpur
                                    University</span></li>
                            <li><i class="fa fa-circle"></i> <span>B.Sc (Hons) in Zoology, Cotton College, Gauhati
                                    University</span></li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>5.1 years</span></li>
                        </ul>


                        <h2 class="faculty-bio-sub-heading">Academic Experience:</h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>1.6 years</span></li>
                        </ul>

                        <h2 class="faculty-bio-sub-heading">Research (outside teaching): </h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>3.5 years</span></li>
                        </ul>

                        <h2 class="faculty-bio-sub-heading">Research Interests:</h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i><span>Clinical Microbiology, Molecular Diagnostics, Cancer
                                    Biology</span></li>
                        </ul>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Cleared SLET 2015 in Life Sciences. (Rank-01)</span></li>
                            <li><i class="fa fa-circle"></i> <span>Cleared NET LS 2015 in Life Sciences.
                                    (Rank-53/1031)</span></li>
                            <li><i class="fa fa-circle"></i> <span>Cleared GATE 2015 in Life Sciences (Rank-884).</span>
                            </li>
                            <li><i class="fa fa-circle"></i> <span>Recipient of the DBT Scholarship (2013-2015)</span></li>

                        </ul>

                        <h2 class="faculty-bio-sub-heading">NCC/NSS Association (if any): </h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Yes, NCC</span></li>
                        </ul>
