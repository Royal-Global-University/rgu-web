        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" src="https://rgu.ac/mobile-assets/updated-faculty-img/manna.png"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Ph.D. In Medical Imaging Technology,  CAM Institute of Allied Health Sciences & Technology, Bhaikaka University.</span></li>
               <li><i class="fa fa-circle"></i> <span>M.Sc. In Medical Imaging Technology,  Manipal College of Health Professions (formerly known as School of Allied Health Sciences ), Manipal Academy of Higher Education (formerly known as Manipal University)</span></li>
              <li><i class="fa fa-circle"></i> <span>B.Sc. In Medical Radio diagnosis and Imaging Technology, Tripura Institute of Paramedical Sciences, Tripura University.</span></li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i><span>T2 mapping Magnetic Resonance Imaging, Interventional Radiology, Computed Tomography Scan, Radiography Education.</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>10 (M.Sc. Thesis)</span></li>
            </ul>


            <h2 class="faculty-bio-sub-heading">Any Other Achievements/Awards:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>4 (Charusat Research Paper Award)_excluding sports.</span></li>
