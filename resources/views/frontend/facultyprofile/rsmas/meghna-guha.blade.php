                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img class="faculty-bio-img" src="/mobile-assets/updated-faculty-img/5.png" alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Ph.D. pursuing in Radiography in Royal Global
                                    University</span></li>
                            <li><i class="fa fa-circle"></i> <span>MSc. Radiography and Imaging Technology, Shree Guru
                                    Gobind Singh Tricentenary University</span></li>
                            <li><i class="fa fa-circle"></i> <span>BSc. Radiography and Advance Imaging Technology, Assam
                                    Downtown University.</span></li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i><span>Ultrasound detection of IUGR using color Doppler
                                    parameters in Kamrup District, Assam — diagnostic performance, local prevalence and
                                    correlation with fetal biometry.</span></li>
                        </ul>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Earned title of Scientific Researcher in Indian Society
                                    of Radiography technologist, INDIA
                                    Award for presenting research paper in Indian Society of Radiographer, Assam
                                    Chapter.</span></li>
