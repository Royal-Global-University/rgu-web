                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Ph.D. Pursuing in IUGR using colour Doppler in Ultrasound
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>3 years 10 months</span></li>
                        </ul>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i>
                                <span>
                                    Intrauterine Growth Restriction (IUGR) significant concern in Assam
                                </span>
                            </li>
                        </ul>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Earned title of Scientific Researcher in Indian Society
                                    of Radiography technologist.</span></li>
                        </ul>
