                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img class="faculty-bio-img"
                                src="/mobile-assets/updated-faculty-img/subarna.png" alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>PhD Pursuing from Girijananda Chowdhury University since 2024.</span></li>
                            <li><i class="fa fa-circle"></i> <span>MPT in Neurological and Psychosomatic Disorders from PEWS Group of Institutions(Under SSUHS), Guwahati in 2023.</span></li>
                            <li><i class="fa fa-circle"></i> <span>BPT from PEWS Group of Institutions (Under GU), Guwahati in 2018.</span></li>
                        </ul>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Cervical kyphosis in young adults with text neck posture.</span></li>
                        </ul>

                        <h2 class="faculty-bio-sub-heading">Paper Publication in Journals:</h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>International: Published a Journal on Journal of clinical and diagnostic research (Web of Science) on the topic “Effectiveness of Tai Chi Exercise on VO2max in Patients with Cancer after Chemotherapy: An Experimental Study” date 1/07/2025</span></li>
                        </ul>

                        <h2 class="faculty-bio-sub-heading">Book Chapters Published:</h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Published a Book Chapter on “Integrated Approach to mental Health Volume 2” Published By: Integrated Publications, H. No. 3, Pocket-H34, Sector - 3, Rohini, Delhi - 110085, India, Publication Year: 2025,Pages: 150,Paperback ISBN: 978-93-5834-876-7,E-Book https://doi.org/10.62778/int.book.662</span></li>
                        </ul>

                        <h2 class="faculty-bio-sub-heading">Any Other Achievements/Awards:</h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Received Excellent service award in the field of Physiotherapy at International Physiotherapy Conclave, Guwahati, 2026.</span></li>
                            <li><i class="fa fa-circle"></i> <span>Received academic excellence awards in the course of BPT and MPT.</span></li>
                        </ul>
                    </div>
                </div>
            </div>
