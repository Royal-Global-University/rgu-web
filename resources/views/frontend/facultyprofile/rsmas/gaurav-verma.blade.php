                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img class="faculty-bio-img" style="height: 400px; width: 400px;"
                                src="https://rgu.ac/mobile-assets/updated-faculty-img/Gaurav-Verma.png" alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>PhD Medical Microbiology (KIIT)</span></li>
                            <li><i class="fa fa-circle"></i> <span>MSc Medical Microbiology (R.B.B.S University)</span></li>
                            <li><i class="fa fa-circle"></i> <span>BSc Medical Microbiology (H.N.B.G.U Central
                                    University)</span></li>
                        </ul>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i><span>Bacteriology, Antimicrobial Resistance, Molecular Biology,
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>National: 04</span></li>
                            <li><i class="fa fa-circle"></i> <span>International: 17</span></li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Young Researcher Award-2025 by DNA Labs-CRIS, R.B.B.
                                    Subharti University.</span></li>
                            <li><i class="fa fa-circle"></i> <span>Academic Excellence Award-2024</span></li>
                            <li><i class="fa fa-circle"></i> <span>AGAR-Academic Excellence Award-2024</span></li>
                            <li><i class="fa fa-circle"></i> <span>Young Achiever Award-2023</span></li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i><span>NCC ‘B’ and ‘C’ certificate.</span></li>
                        </ul>


                        <h2 class="faculty-bio-sub-heading">Memberships:</h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Member of the Microbiology Society of London, UK</span>
                            </li>
                            <li><i class="fa fa-circle"></i> <span>Professional Member, Institute of Scholars</span></li>
                            <li><i class="fa fa-circle"></i> <span>Life Member- Indian Academic Researchers Association,
                                    TN</span></li>
                            <li><i class="fa fa-circle"></i> <span>Professional Member, International Association of
                                    Oncology (IAO)</span></li>
                            <li><i class="fa fa-circle"></i> <span>Member of the African Society of Laboratory Medicine
                                    (ASLM)</span></li>
                            <li><i class="fa fa-circle"></i> <span>Member- American Society of Microbiology (ASM)</span>
                            </li>
                            <li><i class="fa fa-circle"></i> <span>Member, Royal Society of Tropical Medicine and Hygiene
                                    (MRSTMH)</span></li>
                            <li><i class="fa fa-circle"></i> <span>Life Member, Association for Environnement and
                                    Sciences</span></li>
