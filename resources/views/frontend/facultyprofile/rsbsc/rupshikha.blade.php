                        ...
                        <div class="col-lg-6 text-center">
                            <div class="text-center">
                                <img style="margin-top: 70px; width: 380px; border: 1px solid #27467A;"
                                    src="mobile-assets/updated-faculty-img/Rupshikha-Patowary-RSBSC.png" alt="">
                            </div>
                        </div>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <span style="display: block;">
                                            Ph.D. (Biotechnology) – Institute of Advanced Study in Science and Technology
                                            (IASST), Gauhati
                                            University
                                        </span>
                                    </li>
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            B.Sc. (Biotechnology) – St. Anthony’s College, North Eastern Hill University
                                        </span>
                                    </li>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Microbial remediation of wastes, Nanotechnology.
                                        </span>
                                    </li>
                                ...
                                <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                    ...
                                    <li
                                        ...
                                        <i class="fa fa-circle"
                                            style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                        <span style="display: block;">
                                            Post GSLET, GATE, CSIR-SRF, awarded with Institutional Post Doctoral Fellowship
                                            at Indian Institute
                                            of Technology Guwahati (IITG), and IASST, Awarded with International Travel
                                            Grant Support by Govt.
                                            of India to participate in International Conference in Japan.
                                        </span>
                                    </li>
                            ...
                            <ul style="list-style: none; padding-left: 0; color: #fff;" class="para1">
                                ...
                                <li style="display: flex; align-items: flex-start; line-height: 1.8; margin-bottom: 8px;">
                                    <i class="fa fa-circle"
                                        style="font-size: 8px; margin-right: 10px; margin-top: 12px; flex-shrink: 0;"></i>
                                    <span style="display: block;">
                                        Post GSLET, GATE, CSIR-SRF, awarded with Institutional Post Doctoral Fellowship at
                                        Indian Institute
                                        of Technology Guwahati (IITG), and IASST, Awarded with International Travel Grant
                                        Support by Govt.
                                        of India to participate in International Conference in Japan.
                                    </span>
                                </li>
