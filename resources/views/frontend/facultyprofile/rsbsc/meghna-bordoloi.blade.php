        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" src="https://www.rgu.ac/mobile-assets/updated-faculty-img/Meghna-bordoloi.png"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>M.Sc. Forensic Science with Specialization in Fingerprints and Questioned Documents – National Forensic Sciences University</span></li>
              <li><i class="fa fa-circle"></i> <span>B.Sc. (Hons.) Forensic Science – Amity University, Noida</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Total Experience:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>1 year, 10 months</span></li>
            </ul>
            ...
            <ul class="faculty-bio-info-list">
            <li><i class="fa fa-circle"></i> <span>2 months (Internship at Forensic Science Laboratory, Rohini)</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Research Interests:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i><span>Fingerprints and Questioned Documents</span></li>
            </ul>
