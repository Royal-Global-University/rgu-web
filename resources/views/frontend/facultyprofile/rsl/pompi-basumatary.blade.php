                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Ph.D. in English (Translation Studies)- English and
                                    Foreign Languages University, Hyderabad</span></li>
                            <li><i class="fa fa-circle"></i> <span>MA in English Literature- English and Foreign Languages
                                    University, Hyderabad</span></li>
                            <li><i class="fa fa-circle"></i> <span>BA in English – B. Borooah College, Guwahati</span></li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Translation Studies, Folklore Studies, Northeast
                                    Literature, Postcolonial Studies, Colonial Archives, etc.</span></li>
                        </ul>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>ICSSR Doctoral Fellow</span></li>
