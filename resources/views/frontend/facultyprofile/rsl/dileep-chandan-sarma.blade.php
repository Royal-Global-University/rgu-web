                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img class="faculty-bio-img" src="/mobile-assets/updated-faculty-img/Dileep.jpeg" alt="">
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i><span>Environment & Ecology, Panchayati Raj System, Regional
                                    Journalism etc.</span></li>
                        </ul>
                        ...
                        <ul class="faculty-bio-info-list">
                            ...
                            <li><i class="fa fa-circle"></i> <span>Research Project for Centre for Northeastern Studies &
                                    Policy Research</span></li>
                            <li><i class="fa fa-circle"></i> <span>Longest Serving Editor of Newspaper in Assam</span></li>
                            <li><i class="fa fa-circle"></i> <span>Sarojini Naidu Award for journalism (2003 New
                                    Delhi)</span></li>
                            <li><i class="fa fa-circle"></i> <span>Harivansh Rai Bachchan Award for journalism (2003
                                    Mumbai)</span></li>
                            <li><i class="fa fa-circle"></i> <span>Syed Abdul Malik Literary Award for Ballad of Kaziranga,
                                    2016.</span></li>
                            <li><i class="fa fa-circle"></i> <span>The Sentinel Rural Reporting Award, 1992.</span></li>
                            <li><i class="fa fa-circle"></i> <span>National Foundation for India - Media Fellowship, 1996,
                                    New Delhi</span></li>
                            <li><i class="fa fa-circle"></i> <span>K.K.Birla Foundation Fellowship, New Delhi (Hindustan
                                    Times Group) for Journalism, 1997</span></li>
                            <li><i class="fa fa-circle"></i> <span>Represented India in Thailand at The International
                                    Seminar on Ramayana, 2000.</span></li>
