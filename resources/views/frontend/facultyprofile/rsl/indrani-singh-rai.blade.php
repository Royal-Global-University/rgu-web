                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img class="faculty-bio-img" src="/mobile-assets/all-faculty/rsl/dr-indrani-singh-rai.jpg"
                                alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Ph.D. (English - Subaltern Studies) Pt. Ravishankar
                                    Shukla University</span></li>
                            <li><i class="fa fa-circle"></i> <span>M.Phil (English) Pt. Ravishankar Shukla University</span>
                            </li>
                            <li><i class="fa fa-circle"></i> <span>MA (English Literature) Pt. Ravishankar Shukla
                                    University</span></li>
                            <li><i class="fa fa-circle"></i> <span>MA (Linguistics) Pt. Ravishankar Shukla University</span>
                            </li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Indian English Literature, South-Asian Literature,
                                    Cultural Studies. Indian Aesthetics</span></li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Ramesh-Uma Mehrotra Gold Medal for securing highest marks
                                    in PG by Pt. Ravishankar Shukla University, Raipur</span></li>
                        </ul>
