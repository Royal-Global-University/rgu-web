                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img class="faculty-bio-img" src="/mobile-assets/updated-faculty-img/Radhika.jpeg" alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            ...
                            <li><i class="fa fa-circle"></i> <span>B.A. (English Literature, Drawing and painting and
                                    Textile Designing) - Banasthali Vidyapith</span></li>
                        </ul>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Medical and Health Humanities, Modern Literature,
                                    psychoanalysis, Trauma Studies</span></li>
                        </ul>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>News article published in Eastern chronicle newspaper and
                                    editing team member of departmental magazine “Voices”. Co-ordinator roles and managerial
                                    roles in departmental seminars and conferences</span></li>
                        </ul>

                        <h2 class="faculty-bio-sub-heading">Any Other Achievements/Awards:</h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Diploma from Pracheen Kala Kendra in Vocal
                                    Classical</span></li>
                            <li><i class="fa fa-circle"></i> <span>Represented Bihar in Mini National Volleyball game</span>
                            </li>
                            <li><i class="fa fa-circle"></i> <span>Participated in music competitions and volleyball
                                    tournaments in school</span></li>
