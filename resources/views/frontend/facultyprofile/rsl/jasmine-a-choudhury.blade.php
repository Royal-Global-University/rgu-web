                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img class="faculty-bio-img" src="/mobile-assets/updated-faculty-img/Dr-Jasmine-Choudhury-RSL.png"
                                alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Ph.D. in African-American Literature, Assam University,
                                    Silchar </span></li>
                            <li><i class="fa fa-circle"></i> <span>MA in English from Assam University, Silchar</span></li>
                            <li><i class="fa fa-circle"></i> <span>UG (English Hons.) from Cachar College, Silchar, Assam
                                    University</span></li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Trauma Studies, Memory Studies, Diaspora Studies, Women’s
                                    Studies, Posthumanist Studies, Partition literature.</span></li>
