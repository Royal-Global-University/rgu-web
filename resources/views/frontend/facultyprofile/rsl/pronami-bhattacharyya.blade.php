        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" src="https://www.rgu.ac/mobile-assets/updated-faculty-img/Pronami-Bhattacharyya-RSL.png"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Ph.D. (African American Literature) Tezpur Central University</span></li>
              <li><i class="fa fa-circle"></i> <span>MA (English) - Gauhati University</span></li>
              <li><i class="fa fa-circle"></i> <span>BA (English) – Dibrugarh University</span></li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Environmental Humanities | Anthropocene Studies | Ecocriticism | Indigenous, Folklore & Cultural Studies | Postcolonial Studies | Travel Writing | African American Literature</span></li>
