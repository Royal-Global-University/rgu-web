        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" src="https://www.rgu.ac/mobile-assets/department-all/dept-assamese/deepa.png"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>MA in Assamese Literature and Diploma in Visual Art & Fine Arts</span></li>
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>"অসমৰ থলুৱা ভাষা সংস্কৃতি" & "অসমৰ চিত্ৰ চৰ্চাৰ ইতিহাসৰ সমীক্ষাত্মক ইতিবৃত্ত"</span></li>

            </ul>

            <h2 class="faculty-bio-sub-heading">Books Published:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>The book "আদৰ্শ ব্যাকৰণ ৰচনা" published by "প্ৰকাশন ভাৰতী"</span></li>
            </ul>
            <h2 class="faculty-bio-sub-heading">Projects Undertaken:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>HAP project based on eco-friendly handmade paper making</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Any Other Achievements/Awards:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>First prize winner in State level Visual Art competition.</span></li>
            </ul>
