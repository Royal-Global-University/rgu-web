                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            ...
                            <li><i class="fa fa-circle"></i> <span>M.Ed- Gauhati University</span></li>
                            <li><i class="fa fa-circle"></i> <span>M.A English, Sabitribai Phule University, Pune</span>
                            </li>
                            <li><i class="fa fa-circle"></i> <span>B.A English (Hons)- Handique Girls’ College, Gauhati
                                    University</span></li>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>17.5 years</span></li>
                        </ul>

                        <h2 class="faculty-bio-sub-heading">Academic Experience:</h2>
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>14.5 years</span></li>
                        </ul>
                        ...
                        <ul class="faculty-bio-info-list">
                            <li><i class="fa fa-circle"></i> <span>Language Education, Linguistics, Teacher Education,
                                    English Language Teaching, Oral Narratives</span></li>
