                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 text-center">
                        <div class="text-center">
                            <img class="faculty-bio-img" src="/mobile-assets/department-all/dept-sanskrit/gitarthi.png"
                                alt="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 pt-4 pb-4">
                        ...
                        <ul class="faculty-bio-info-list">
                            ...
                            <li><i class="fa fa-circle"></i> <span>নিজনত কান্দে কোনে অকলে অকলে(ebook and hardcopy)</span>
                            </li>
                            <li><i class="fa fa-circle"></i> <span>বৰজনা</span></li>
                            <li><i class="fa fa-circle"></i> <span>নীলাচলবাসিনী কামৰূপনন্দিনী - ISBN - 978 - 93 - 93342 - 41
                                    - 6</span></li>
                        </ul>
