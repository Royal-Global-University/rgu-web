        ...
        <div class="row">
          ...
          <div class="col-lg-5 text-center">
            <div class="text-center">
              <img class="faculty-bio-img" src="https://www.rgu.ac/mobile-assets/department-all/dept-sanskrit/gitarthi.png"
                alt="">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 pt-4 pb-4">
            ...
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>MA (Sanskrit)-Gauhati University</span></li>
              <li><i class="fa fa-circle"></i> <span>BA - DKD college, Dergaon</span></li>
              <li><i class="fa fa-circle"></i> <span>BEd - Sunrise university</span></li>
            ...
            <h2 class="faculty-bio-sub-heading">Books Published:3 Ebooks and 2 printed books.</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span> The night wails out.</span></li>
              <li><i class="fa fa-circle"></i> <span>নিজনত কান্দে কোনে অকলে অকলে(ebook and hardcopy)</span></li>
              <li><i class="fa fa-circle"></i> <span>বৰজনা</span></li>
              <li><i class="fa fa-circle"></i> <span>নীলাচলবাসিনী কামৰূপনন্দিনী - ISBN - 978 - 93 - 93342 - 41 - 6</span></li>
            </ul>

            <h2 class="faculty-bio-sub-heading">Projects Undertaken: </h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>Modern novel in Sanskrit</span></li>

            </ul>

            <h2 class="faculty-bio-sub-heading">Any Other Achievements/Awards:</h2>
            <ul class="faculty-bio-info-list">
              <li><i class="fa fa-circle"></i> <span>বিন্দু সাহিত্য বঁটা</span></li>
            </ul>
