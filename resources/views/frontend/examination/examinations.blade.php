        ...
        <div class="container">
            ...
            <div style="margin: 30px 0px 30px 0px;">
                <section class="row">
                    ...
                    <div class="col-lg-4 pb-3">
                        <a class="button para1"
                            style="text-decoration: none; background-color: #c4c4c4; color: white; border-radius: 5px; text-align: center; width: 300px; height: 50px; display: flex; align-items: center; justify-content: center; font-weight: bold;">
                            Announcements/Notifications
                        </a>
                    </div>
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-4">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><a target="_blank" href="mobile-assets/examination/Application Format for issuing Transcript.pdf"><button
                                            class="dropdown-item para1 fw-bold" style="color: #264273;" type="button">Transcript <i
                                                style="color: #264273;" class="fa fa-download"></i></button></a></li>
                                <li><a target="_blank"
                                        href="mobile-assets/examination/Application Form for Provisional or Duplicate Gradesheet.pdf"><button
                                            class="dropdown-item para1 fw-bold" style="color: #264273;" type="button">Provisional/
                                            Duplicate Grade Sheet <i style="color: #264273;" class="fa fa-download"></i></button></a></li>
                            </ul>
                        </div>
                    </div>
