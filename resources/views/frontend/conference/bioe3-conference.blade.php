...
@section('content')
        ...
        <div class="container pt-5">
            <p style="text-align: justify;" class="para1 text-dark">
                ...
                systems. <br>
                &nbsp&nbsp&nbsp&nbsp&nbsp Northeast India, a globally recognized
                ...
                &nbsp&nbsp&nbsp&nbsp&nbsp This conference seeks to bring together
            ...
            <div class="row" style="display: flex; justify-content: center; align-items: center;">
                <div class="col-lg-6">
                    ...
                    <h2 class="headd3 fw-bold kd-title-ani kd-split-text pt-3 pb-3"
                        style="color: #27467A; font-weight: 900;">
                        Conference<span style="color: #FF9A1E; font-weight: 500;">theme:</span>
                    </h2>

                    <ol class="para1 text-dark" style="color: #27467A; font-size: 18px; line-height: 1.6;">
                        <li>Bioresource technology</li>
                        <li>Environmental Biotechnology</li>
                        <li>Biomanufacturing</li>
                        <li>Nanobiotechnology</li>
                        <li>Crop productivity</li>
                        <li>Biotechnology and circular economy</li>
                ...
                <div class="col-lg-6">
                    <img src="mobile-assets/blog/microbio/img1.png" alt="">
                </div>
            </div>
            ...
            <div class="row" style="display: flex; justify-content: center; align-items: center;">
                ...
                <div class="col-lg-12">
                    ...
                    <ol class="para1 text-dark" style="font-size: 18px; line-height: 1.6;">
                        <li>Times New Roman font (Title 14 pt. Bold, Main text 12 pt. Normal), Single line</li>
                        <li>Spacing, Name and affiliation of Author/s followed by 3-5 key words and email ID of the
                            corresponding author (Do not insert figures and tables) </li>
                        <li>Notification on acceptance of abstract: 31st December, 2025</li>
                    </ol>
                    ...
                    <ol class="para1 text-dark" style="font-size: 18px; line-height: 1.6;">
                        <li>Best oral presentation-(01)</li>
                        <li>Best poster presentation-(03)</li>
                    </ol>
                    ...
                    <div style="display: flex; justify-content: center; align-items: center; flex-direction: column;">
                        ...
                        <div class="table-resposnive">
                            <table class="para1"
                                style="border-collapse:collapse; width:90%; color:white; border:1px solid #fff; text-align:center;">
                                <tr>
                                    <th
                                ...
                                <tr class="text-dark">
                                    <td style="border:1px solid #333; padding:12px; font-size:16px;">Students (UG/ PG)*
                                    </td>
                                    <td style="border:1px solid #333; padding:12px; font-size:16px;">₹1500/-</td>
                                    <td style="border:1px solid #333; padding:12px; font-size:16px;">₹1800/-</td>
                                    <td style="border:1px solid #333; padding:12px; font-size:16px;">₹2500/-</td>
                                </tr>
                                <tr class="text-dark">
                                    <td style="border:1px solid #333; padding:12px; font-size:16px;">PhD scholars*</td>
                                    <td style="border:1px solid #333; padding:12px; font-size:16px;">₹1800/-</td>
                                    <td style="border:1px solid #333; padding:12px; font-size:16px;">₹2100/-</td>
                                    <td style="border:1px solid #333; padding:12px; font-size:16px;">₹3000/-</td>
                                </tr>
                                <tr class="text-dark">
                                    <td style="border:1px solid #333; padding:12px; font-size:16px;">Faculty members/
                                        industry/ professionals</td>
                                    <td style="border:1px solid #333; padding:12px; font-size:16px;">₹2000/-</td>
                                    <td style="border:1px solid #333; padding:12px; font-size:16px;">₹2300/-</td>
                                    <td style="border:1px solid #333; padding:12px; font-size:16px;">₹3500/-</td>
                                </tr>
                                <tr class="text-dark">
                                    <td style="border:1px solid #333; padding:12px; font-size:16px;">International
                                        participants</td>
                                    <td style="border:1px solid #333; padding:12px; font-size:16px;">$100</td>
                                    <td style="border:1px solid #333; padding:12px; font-size:16px;">$150</td>
                                    <td style="border:1px solid #333; padding:12px; font-size:16px;">$200</td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <h2 class="headd3 text-dark mt-3 fw-bold">Address for Correspondence</h2>
                    <p class="para1 text-dark">
                        <strong>Dr. Debajit Borah</strong><br>
                        Convener<br>
                        Department of Biotechnology<br>
                        The Assam Royal Global University<br>
                        Guwahati-781035<br>
                        <strong>Ph:</strong> +91-9706394994<br>
                        <strong>Email:</strong> biodiversity2biomanufacturing@gmail.com
                    </p>

                    <h2 class="headd3 text-dark mt-3 fw-bold">About the University</h2>
                    <p class="para1 text-dark">
                        The Assam Royal Global University (RGU), one of the premium universities in India, has
                        continuously acted as a leadership platform that aligns the interests of industries,
                        entrepreneurs, and the youth since its establishment in 2017. Aimed at creating and sustaining
                        an environment wherein employment and entrepreneurship can flourish with collaborative efforts
                        amongst an extensive network of influential corporate, individual members, and academic
                        institutes, The Assam Royal Global University has been able to provide the necessary resources,
                        knowledge, and support to create effective employment and entrepreneurship opportunities.
                    </p>

                    <h2 class="headd3 text-dark mt-3 fw-bold">About Guwahati</h2>
                    <p class="para1 text-dark">
                        Nestled on the southern banks of the mighty Brahmaputra River and embraced by rolling green
                        hills, Guwahati is a city where nature and culture meet in harmonious rhythm. Known as the
                        “Gateway to the Northeast,” it is both a bustling urban hub and a serene retreat, where ancient
                        temples whisper tales of devotion and vibrant markets hum with life. The iconic Kamakhya Temple
                        crowns the Nilachal Hills, drawing pilgrims from across the world, while the gentle sunsets over
                        the Brahmaputra paint the skyline in golden hues. The city’s charm lies in its unique blend: the
                        fragrance of Assamese tea in the air, the melody of Bihu songs, the graceful sway of bamboo
                        groves, and the warm hospitality of its people. From the sacred to the scenic, from street food
                        delights to cultural festivals, Guwahati is more than just a city; it is a living tapestry of
                        traditions, nature’s beauty, and the spirit of the Northeast.
                    </p>

                    <h2 class="headd3 text-dark mt-3 fw-bold">Executive Committee</h2>
                    <ul class="para1 text-dark">
                        <li><strong>Chief Patron:</strong> Dr. A. K. Pansari, Chancellor, The Assam Royal Global
                            University, Guwahati</li>
                        <li><strong>Patron:</strong> Mr. Ankur Pansari, Executive Vice-President, Gyan Sagar Foundation
                        </li>
                        <li><strong>Chief Advisor:</strong> Prof. Alak Kumar Buragohain, Vice-Chancellor, The Assam
                            Royal Global University, Guwahati</li>
                        <li><strong>Advisor:</strong> Prof. Anupam Chatterjee, Dean, Royal School of Biosciences, The
                            Assam Royal Global University, Guwahati</li>
                        <li><strong>Convener:</strong> Dr. Debajit Borah, HOD-Biotechnology, RGU</li>
                        <li><strong>Co-convener:</strong> Dr. Bhaskarjyoti Gogoi, Asst. Prof., Dept. of Biotechnology,
                            RGU</li>
                        <li><strong>Treasurers:</strong> Prof. Amlan Das and Dr. Rupesh Kumar</li>
                        <li><strong>Organizing Secretary:</strong> Dr. Siddhartha Narayan Borah, Asst. Prof., Dept. of
                            Biotechnology, RGU</li>
                    </ul>

                    <h2 class="headd3 text-dark mt-3 fw-bold">Organizing Committee</h2>
                    <ul class="para1 text-dark">
                        <li><strong>Registration and certificate:</strong> Dr. Anuj Kumar Borah, Dr. Taranga Jyoti
                            Baruah, Dr. Mousumi Das Goswami, and Dr. Sumanta D. Chowdhury</li>
                        <li><strong>Venue:</strong> Dr. Chongtham Sovachandra Singh, Dr. Niraj Singh, Mr. Samiran
                            Buragohain, and Mr. Manoj Sharma</li>
                        <li><strong>Hospitality:</strong> Dr. Indrajit Dutta</li>
                        <li><strong>Travel and Accommodation:</strong> Dr. Dharmeswar Barhoi, Dr. Pankaj Losan Sharma,
                            and Dr. Pundarikaksha Das</li>
                        <li><strong>IT support:</strong> Dr. Hirak Jyoti Hazarika, Mr. Sashanka Baruah, and Mr. Bijoy
                            Kalita</li>
                        ...
                        <table style="width: 100%; border-collapse: collapse; margin-top: 20px; margin-bottom: 30px;">
                            ...
                            <tbody class="text-dark para1">
                                ...
                                <tr>
                                    ...
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">Registration
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">National anthem
                                    </td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;"></td>
                                </tr>
                                <tr>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">09:05–09:10 AM
                                    </td>
                                ...
                                <tr>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">09:10–09:20 AM
                                    </td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">Welcome Address
                                        and
                                ...
                                <tr>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">09:20–09:40 AM
                                    </td>
                                ...
                                <tr>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">09:40–10:00 AM
                                    </td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">Address by the
                                        Chief
                                        Patron</td>
                                ...
                                <tr>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">10:00–10:50 AM
                                    </td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">Keynote lecture
                                    </td>
                                ...
                                <tr>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">10:50–11:00 AM
                                    </td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">Vote of thanks
                                    </td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;"></td>
                                </tr>
                                <tr>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">11:00–11:20 AM
                                    </td>
                                ...
                                <tr>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">11:30-11:40 AM
                                    </td>
                                ...
                                <tr>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">11:40-12:30 PM
                                    </td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">Plenary
                                        lecture-I
                                    </td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">Prof. Shekhar
                                        Mande
                                        (Savitribai Phule University, Pune)</td>
                                </tr>
                                <tr>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">12:30-01:10 PM
                                    </td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">Invited
                                        lecture-I
                                    </td>
                                ...
                                <tr>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">01:15-02:00 PM
                                    </td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">Oral
                                        presentations
                                        (1-3)</td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;"></td>
                                </tr>
                                <tr>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">02:00-02:30 PM
                                    </td>
                                ...
                                <tr>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">02:30-03:15 PM
                                    </td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">Plenary
                                        lecture-II
                                    </td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">Prof. Gareth
                                        Jenkins
                                        (Institute of Life Science, Swansea-UK)</td>
                                </tr>
                                <tr>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">03:15-04:00 PM
                                    </td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">Invited
                                        lecture-II
                                    </td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">Prof. Mukut
                                        Gohain
                                        (API Plus Research Laboratory, South Africa)</td>
                                </tr>
                                <tr>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">04:00-04:30 PM
                                    </td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">Oral
                                        presentations
                                        (4-5)</td>
                                ...
                                <tr>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">04:30-05:30 PM
                                    </td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">Poster session -
                                        I
                                    </td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;"></td>
                                </tr>
                                <tr>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">06:00-07:30 PM
                                    </td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">Cultural
                                        Programme
                                    </td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;"></td>
                                </tr>
                                ...
                                <tr>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">09:30-10:15 AM
                                    </td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">Plenary
                                        lecture-III
                                    </td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">Dr Sanjai K
                                        Dwivedi,
                                        Scientist 'G' &amp; Director, Directorate of Personnel (DoP), DRDO</td>
                                </tr>
                                <tr>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">10:15-11:00 AM
                                    </td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">Invited
                                        lecture-III
                                    </td>
                                ...
                                <tr>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">11:00-11:15 AM
                                    </td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">Tea</td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;"></td>
                                </tr>
                                <tr>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">11:15-12:30 PM
                                    </td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">Oral
                                        presentations
                                        (6-10)</td>
                                ...
                                <tr>
                                    ...
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">Prof. Tapas
                                        Kundu
                                        (JNCASR, Bangalore)</td>
                                </tr>
                                <tr>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">01:10-01:45 PM
                                    </td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">Invited
                                        lecture-IV
                                    </td>
                                ...
                                <tr>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">01:45-02:30 PM
                                    </td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">Oral
                                        presentations
                                        (11-13)</td>
                                ...
                                <tr>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">02:30-03:00 PM
                                    </td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">Lunch</td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;"></td>
                                </tr>
                                ...
                                <tr>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">03:00-04:00 PM
                                    </td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">Poster session -
                                        II
                                    </td>
                                ...
                                <tr>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">04:00-04:20 PM
                                    </td>
                                ...
                                <tr>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">04:20-04:30 PM
                                    </td>
                                ...
                                <tr>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">04:30-04:50 PM
                                    </td>
                                ...
                                <tr>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">04:50-05:10 PM
                                    </td>
                                ...
                                <tr>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">05:10-05:15 PM
                                    </td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">Vote of Thanks
                                    </td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;"></td>
                                ...
                                <tr>
                                    ...
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;">State Anthem
                                    </td>
                                    <td style="border: 1px solid #333; text-align: left; padding: 8px;"></td>
                                </tr>
                            </tbody>
    ...
    <div class="website">
        ...
        <div class="container pt-5">
            <div class="row">
                <div class="col-lg-8">
                    <p style="text-align: justify;" class="para1 text-dark">
                        The BioE3 (Biotechnology for Economy, Environment, and Employment) Policy of India aims to
                        transform the
                        country’s biomanufacturing sector by integrating cutting-edge biotechnological processes that
                        improve
                        efficiency, sustainability, and product quality. This policy lays out a framework of principles
                        and
                        guidelines to promote high-performance biomanufacturing across multiple sectors. Key highlights
                        include
                        fostering innovation-driven research and development, and encouraging entrepreneurship in
                        priority
                        thematic areas. To speed up technology development and commercialization, the policy envisions
                        setting
                        up dedicated Biomanufacturing Hubs and Biofoundries. In addition, it emphasizes promoting
                        regenerative
                        bioeconomy models focused on green growth, expanding India’s skilled workforce, and boosting
                        employment
                        opportunities. While BioE3 is designed primarily for economic, environmental, and employment
                        purposes
                        through green biomanufacturing, its biological manufacturing infrastructure and competencies can
                        also be
                        strategically relevant to the defence sector. Through policy alignment, shared infrastructure,
                        workforce
                        readiness, and coordinated planning, India’s advancements under BioE3 in biologicals could
                        support
                        defence needs, especially in medical countermeasures, biosecurity, and rapid biological response
                        systems. <br>
                        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Northeast India, a globally
                        recognized
                        biodiversity hotspot, holds immense untapped potential with its
                        rich flora, fauna, and microbial resources that have proven value in pharmaceutical,
                        nutraceutical, and
                        industrial applications. Despite this wealth of bioresources, commercial exploration remains
                        limited.
                        Assam, in particular, has vast potential for developing bio-based healthcare, nutrition, and
                        environmental solutions. However, the region’s biomanufacturing sector and startup ecosystem are
                        still
                        at an early stage and require urgent support from the scientific community to nurture
                        entrepreneurship,
                        ensure steady raw material supply, and strengthen the agro-economy. <br>
                        &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp This conference seeks to bring
                        together
                        researchers, academicians, entrepreneurs, and policymakers from
                        biotechnology and related fields onto a shared platform. By exchanging ideas and strategies,
                        participants can help achieve the vision of the BioE3 Policy while aligning with the Sustainable
                        Development Goals (SDGs). Ultimately, this collaborative effort aims to drive inclusive economic
                        growth,
                        environmental stewardship, and social equity through sustainable biomanufacturing and
                        innovation.
                ...
                <div class="col-lg-12">
                    ...
                    <div style="display: flex; justify-content: center; align-items: center; flex-direction: column;">
                        <table class="para1"
                            ...
                            <tr class="text-dark">
                                <td style="border:1px solid #333; padding:12px; font-size:16px;">Students (UG/ PG)*</td>
                                <td style="border:1px solid #333; padding:12px; font-size:16px;">₹1500/-</td>
                                <td style="border:1px solid #333; padding:12px; font-size:16px;">₹1800/-</td>
                                <td style="border:1px solid #333; padding:12px; font-size:16px;">₹2500/-</td>
                            </tr>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="card">
                    ...
                    <p class="card-designation">Scientist F, Defence Research Laboratory DRDO, Ministry of Defence, Tezpur </p>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="card">
                    ...
                    <p class="card-designation">Professor, Jawaharlal Nehru Centre for Advanced Scientific Research, Bangalore (Former Director, CSIR-CDRI, Lucknow) </p>
                </div>
            </div>
