...
<p class="mobile-headd3 text-dark text-center" style="line-height: 1.3;">
    (Medical Surgical Nursing/OBE Nursing/Child Health
                ...
                <div id="Fee" class="w3-container city card p-5 shadow" style="display:block">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0">B.) Programmes fee to be paid Yearly / semester payment for
                            New
                            Students 2025-26</p>
                        <p class="text-dark pt-2 m-0">Tution Fee (Rs. - 160000.00)</p>
                        <p class="text-dark pt-2 m-0">Total Fee (Rs. - 81500.00)</p>
                    </div>
                </div>
                    ...
                    <div class="card-body para1">
                        <p class="text-dark pt-2 fw-bold m-0">Eligibility Criteria</p>
                            ...
                            <ol class="text-dark pt-2 m-0">
                                ...
                                <li>BSc. Nursing graduate should have a minimum of one year of experience in a hospital or in a College or in a School of Nursing or in a Community Health Program after registration in the State Nursing Council on the day of admission.</li>
                                <li>Post Basic BSc. Nursing graduate should have a minimum of one year of work experience prior or after in a hospital or in a College or in a School of Nursing or in a Community Health Program after registration in the State Nursing Council on the day of admission.</li>
                ...
                <div id="Brochure" class="w3-container city card p-5 shadow" style="display:none">
                    <div class="card-body text-center">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0"><a
                                href="mobile-assets/International/brochure for web_compressed-min.pdf">Brochure 2025-26<i
