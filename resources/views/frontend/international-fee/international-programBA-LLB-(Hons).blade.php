...
<div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
    ...
    <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
        ...
        <p class="mobile-para1 text-dark">Bachelor’s Degree in any discipline from any recognized University/Institution with minimum 45% marks or equivalent grade for General category, 42% marks or equivalent grade for OBC category & 40% marks or equivalent grade for SC & ST category.
        </p>
