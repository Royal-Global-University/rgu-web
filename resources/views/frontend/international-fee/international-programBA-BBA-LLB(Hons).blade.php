...
<h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">BBA - LLB (H)
</h2>
...
<div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
    ...
    <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
        ...
        <p class="mobile-para1 text-dark">10+2 or equivalent from a recognized Board/ Council with minimum 45% marks or equivalent grade for General category, 42% marks or equivalent grade for OBC category & 40% marks or equivalent grade for SC & ST category.
        </p>

        <p class="mobile-headd3 fw-bold text-dark">Selection Process
        </p>

        <p class="mobile-para1 text-dark">An entrance test conducted by Royal Global University followed by Personal Interview. Candidates with a valid score of CLAT (Common Law Admission Test) will be exempted from appearing in the entrance test conducted by Royal Global University
        </p>
    ...
    <div class="text-center">
        ...
        <a href="mobile-assets/International/LLMDayShift.pdf" target="_blank" class="btn mobile-para1" style="background-color: #27467A; color: white; font-weight: bold; padding: 10px 15px; border-radius: 5px; text-decoration: none; line-height: 1.3; display: flex; align-items: center; justify-content: center; gap: 8px;">
...
<div class="pt-4" style="background-image: url(assets/img/banner_adv/s2-bg-img-1.webp);">
            <div class="text-center">
                <h2 class="text-center headd2 text-dark">BBA - LLB (H)</h3>
