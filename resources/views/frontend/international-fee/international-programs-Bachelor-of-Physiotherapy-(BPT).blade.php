...
<div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
    ...
    <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
        ...
        <p class="mobile-para1 text-dark">10+2 in science stream with minimum 50% marks or equivalent grade in Physics, Chemistry, Biology and English as a core subject from a recognized Board/Council. (5% relaxation to SC/ST/OBC - Non-Creamy Layer). Age Limit: Minimum 17 years and maximum 30 years of age as on 31st December of the year in which the admission is sought.
        </p>
