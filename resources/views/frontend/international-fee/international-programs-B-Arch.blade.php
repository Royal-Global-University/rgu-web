...
<p class="mobile-headd3 text-dark text-center" style="line-height: 1.3;">Duration - 05 Years <br> Royal School of Applied &amp; Pure Sciences
    (RSA)
</p>
...
<div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
    <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
        ...
        <ol class="mobile-para1 text-dark">
            <li>Prospectus & Form - $ 14.12</li>
            <li>Registration (To be paid during the admission for all courses) - $ 120</li>
            <li>Admission Fee - $ 720</li>
