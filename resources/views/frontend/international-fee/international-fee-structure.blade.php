                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12">
                            ...
                            <table class="table border table-responsive table-striped  vertical-scroll">
                                ...
                                <tbody class="para1">
                                    <tr>
                                        ...
                                        <td>1800</td>
                                        <td>2640</td>
                                        <td><a href="{{route('international-programs-B-Arch')}}"><button type="button"
                            ...
                            <table class="table border table-responsive table-striped  vertical-scroll">
                                ...
                                <tbody class="para1">
                                    <tr>
                                        ...
                                        <td>1020</td>
                                        <td>1860</td>
                                        <td><a href="{{route('international-programs-MSc-Physics')}}"><button type="button"
                                                    class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>1020</td>
                                        <td>1860</td>
                                        <td><a href="{{route('international-programs-BSc-Physics')}}"><button type="button"
                                                    class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                        </td>
                                    </tr>
                            ...
                            <table class="table border table-responsive table-striped  vertical-scroll">
                                ...
                                <tbody class="para1">
                                    <tr>
                                        ...
                                        <td>
                                            <p>
                                                <strong style="color: #023e8a;" class="#">Course: MBA - (Finance, Marketing,
                                                    HRM, Operations Management, Entrepreneurship & Small Business
                                                    Management, Business Analytics)</strong>
                                                <br>
                                        ...
                                        <td>1800</td>
                                        <td>2640</td>
                                        <td><a href="{{route('international-programs-MBA-Finance')}}"><button type="button"
                                                    class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                        </td>
                                    </tr>
                            ...
                            <table class="table border table-responsive table-striped  vertical-scroll">
                                ...
                                <tbody class="para1">
                                    <tr>
                                        ...
                                        <td>1020</td>
                                        <td>1860</td>
                                        <td><a href="{{route('international-programs-MCom')}}"><button type="button"
                                                    class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>1200</td>
                                        <td>2040</td>
                                        <td><a href="{{route('international-programs-BCom')}}"><button type="button"
                                                    class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <p>
                                                <strong style="color: #1b4332;" class="#">Course: B.Com - Finance with ICA /
                                                    B.Com with ACCA / B.Com with CMA</strong>
                                                <br>
                                ...
                                <table class="table border table-responsive table-striped  vertical-scroll">
                                    ...
                                    <tbody class="para1">
                                        <tr>
                                            ...
                                            <td>1020</td>
                                            <td>1860</td>
                                            <td><a href="{{route('international-programs-MA-J&MC')}}"><button type="button"
                                                        class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>1020</td>
                                            <td>1860</td>
                                            <td><a href="{{route('international-programs-BA-J&MC')}}"><button type="button"
                                                        class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>1020</td>
                                            <td>1860</td>
                                            <td><a href="{{route('international-programs-MSc-Animation-Visual-Effects')}}"><button
                                                        type="button"
                                                        class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>1020</td>
                                            <td>1860</td>
                                            <td><a href="{{route('international-programs-BSc-Animation-Visual-Effects')}}"><button
                                                        type="button"
                                                        class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                            </td>
                                        </tr>
                            ...
                            <table class="table border table-responsive table-striped  vertical-scroll">
                                ...
                                <tbody class="para1">
                                    <tr>
                                        ...
                                        <td>1200</td>
                                        <td>2040</td>
                                        <td><a href="{{route('international-programs-BachelorInterior-Design(BID)')}}"><button
                                                    type="button"
                                                    class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>1200</td>
                                        <td>2040</td>
                                        <td><a href="{{route('international-programs-BDes-FD(Fashion-Design)')}}"><button
                                                    type="button"
                                                    class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p>
                                                <strong style="color: #1b4332;" class="#">Course: B.Des (FD) (Lateral
                                                    Entry)</strong>
                                                <br>
                                        ...
                                        <td>2040</td>
                                        <td><a
                                                href="{{route('international-programs-Bachelor-of-Design-(Fashion-Design)Lateral-Entry')}}"><button
                                                    type="button"
                                                    class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                        </td>
                                    </tr>
                            ...
                            <table class="table border table-responsive table-striped  vertical-scroll">
                                ...
                                <tbody class="para1">
                                    ...
                                    <tr>
                                        ...
                                        <td>1020</td>
                                        <td>1860</td>
                                        <td><a href="{{route('international-programs-MA-Geography')}}"><button type="button"
                                                    class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>1020</td>
                                        <td>1860</td>
                                        <td><a href="{{route('international-programs-MSc-Geology')}}"><button type="button"
                                                    class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>1020</td>
                                        <td>1860</td>
                                        <td><a href="{{route('international-programs-BSc-Geology')}}"><button type="button"
                                                    class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                        </td>
                                    </tr>
                                </tbody>
                                ...
                                <table class="table border table-responsive table-striped  vertical-scroll">
                                    ...
                                    <tbody class="para1">
                                        ...
                                        <tr>
                                            ...
                                            <td>1200</td>
                                            <td>2040</td>
                                            <td><a href="{{route('international-programs-MTech-CE-in-Water-Resources')}}"><button
                                                        type="button"
                                                        class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>2160</td>
                                            <td>3000</td>
                                            <td><a href="{{route('international-programs-BTech(CE)')}}"><button
                                                        type="button"
                                                        class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>2160</td>
                                            <td>3000</td>
                                            <td><a href="{{route('international-programs-BTech(CSE)')}}"><button
                                                        type="button"
                                                        class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>2160</td>
                                            <td>3000</td>
                                            <td><a href="{{route('international-programs-BTech(ME)')}}"><button
                                                        type="button"
                                                        class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>2160</td>
                                            <td>3000</td>
                                            <td><a href="{{route('international-programs-BTech(Lateral-Entry)')}}"><button
                                                        type="button"
                                                        class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>3000</td>
                                            <td><a
                                                    href="{{route('international-programs-BTech(Electrical-Electronics-Engineering)')}}"><button
                                                        type="button"
                                                        class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>3000</td>
                                            <td><a
                                                    href="{{route('international-programs-BTech(Electronics-Communication-Engineering)')}}"><button
                                                        type="button"
                                                        class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>2160</td>
                                            <td>3000</td>
                                            <td><a href="{{route('international-programs-BTech(CE&CSE)-working')}}"><button
                                                        type="button"
                                                        class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                            </td>
                                        </tr>
                                ...
                                <table class="table border table-responsive table-striped  vertical-scroll">
                                    ...
                                    <tbody class="para1">
                                        <tr>
                                            ...
                                            <td>1020</td>
                                            <td>1860</td>
                                            <td><a href="{{route('international-programs-Master-of-Fine-Arts(MFA)')}}"><button
                                                        type="button"
                                                        class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>900</td>
                                            <td>1740</td>
                                            <td><a href="{{route('international-programs-Bachelor-of-Fine-Arts(BFA)')}}"><button
                                                        type="button"
                                                        class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                            </td>
                                        </tr>
                                ...
                                <table class="table border table-responsive table-striped  vertical-scroll">
                                    ...
                                    <tbody class="para1">
                                        ...
                                        <tr>
                                            ...
                                            <td>1020</td>
                                            <td>1860</td>
                                            <td><a href="{{route('international-programs-MSW')}}"><button type="button"
                                                        class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>1020</td>
                                            <td>1860</td>
                                            <td><a href="{{route('international-programs-BSW')}}"><button type="button"
                                                        class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                            </td>
                                        </tr>
                                ...
                                <table class="table border table-responsive table-striped  vertical-scroll">
                                    ...
                                    <tbody class="para1">
                                        <tr>
                                            ...
                                            <td>1200</td>
                                            <td>2040</td>
                                            <td><a href="{{route('international-programs-BCA')}}"><button type="button"
                                                        class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>1020</td>
                                            <td>1860</td>
                                            <td><a href="{{route('international-programs-MCA')}}"><button type="button"
                                                        class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>1020</td>
                                            <td>1860</td>
                                            <td><a href="{{route('international-programs-BSc-IT')}}"><button type="button"
                                                        class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>1020</td>
                                            <td>1860</td>
                                            <td><a href="{{route('international-programs-MSc-IT')}}"><button type="button"
                                                        class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                            </td>
                                        </tr>
                                ...
                                <table class="table border table-responsive table-striped  vertical-scroll">
                                    ...
                                    <tbody class="para1">
                                        ...
                                        <tr>
                                            ...
                                            <td>1200</td>
                                            <td>2040</td>
                                            <td><a href="{{route('international-programBA-BBA-LLB(Hons)')}}"><button
                                                        type="button"
                                                        class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                            </td>
                                        </tr>
                                ...
                                <table class="table border table-responsive table-striped  vertical-scroll">
                                    ...
                                    <tbody class="para1">
                                        ...
                                        <tr>
                                            ...
                                            <td>1020</td>
                                            <td>1860</td>
                                            <td><a href="{{route('international-programs-MasterofPhysiotherapy(MPT)')}}"><button
                                                        type="button"
                                                        class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>1020</td>
                                            <td>1860</td>
                                            <td><a href="{{route('international-programs-BSc-Nutrition-and-Dietetics')}}"><button
                                                        type="button"
                                                        class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>1020</td>
                                            <td>1860</td>
                                            <td><a href="{{route('international-programs-B-ScMedical-Technology-BMLT')}}"><button
                                                        type="button"
                                                        class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>1020</td>
                                            <td>1860</td>
                                            <td><a href="{{route('international-programs-MSc-MedicalLaboratory(MMLT)')}}"><button
                                                        type="button"
                                                        class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>1020</td>
                                            <td>1860</td>
                                            <td><a href="{{route('international-programs-Technology(OTT)')}}"><button
                                                        type="button"
                                                        class="btn btn-primary btn-sm custom-details-btn">Details</button></a>
                                            </td>
                                        </tr>
                      ...
                      ">
                        ...
                        <hr />
                        <td>
                            <a href="https://heyzine.com/flip-book/3fa20e1aae"><button type="button"
