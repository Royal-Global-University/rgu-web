...
<h2 class="mobile-headd2 kd-title-ani kd-split pb-1 pt-3 text-center" style="color: #264273; font-weight: 700;">B.Tech. (CSE)
</h2>
        ...
        <div class="container mt-4" style="max-width: 900px;">
            ...
            <div class="tab-content p-4 border rounded bg-white" id="infoTabsContent" >
                <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
                    ...
                    <ol class="mobile-para1 text-dark">
                        <li>Tution Fee - $ 2160</li>
                        <li>Total Fee - $ 3000</li>
                    </ol>
                ...
                <div class="text-center">
                    ...
                    <a href="mobile-assets/International/JEE 2024 _compressed for web.pdf" target="_blank" class="btn mobile-para1" style="background-color: #27467A; color: white; font-weight: bold; padding: 10px 15px; border-radius: 5px; text-decoration: none; line-height: 1.3; display: flex; align-items: center; justify-content: center; gap: 8px;">
                ...
                <div id="Fee" class="w3-container city card p-5 shadow" style="display:block">
                    <div class="card-body para1">
                        ...
                        <p class="text-dark pt-2 fw-bold m-0">B.) Programmes fee to be paid Yearly / semester payment for
                            New
                            Students 2025-26</p>
                            <p class="text-dark pt-2 m-0">Tution Fee - $ 2160</p>
                            <p class="text-dark pt-2 m-0">Total Fee - $ 3000</p>
                    </div>
                </div>
