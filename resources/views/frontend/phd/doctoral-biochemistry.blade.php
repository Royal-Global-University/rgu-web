...
@section('content')
        ...
        <img style="padding-top: 90px; position: relative;" src="mobile-assets/phd-mobile/mob-biochemistry.png" alt="">
                                    ...
                                    <div class="elementor-widget-container">
                                        <div class="prthalign">
                                            ...
                                            <div class="para1 text-dark kd-para-1 disc" data-splitting style="text-align: justify;">
                                                <p>
                                                    Ph.D. in Biochemistry provides an extensive range of research opportunities focused on understanding the molecular mechanisms that underpin life processes. Potential areas of study encompass cellular biology and signaling, microbiology, molecular biology, natural products, and bioinformatics, to name a few. Researchers in this field also delve into applications like drug discovery and mechanistic insights of diseases. The dynamic nature of biochemistry ensures ongoing opportunities for interdisciplinary research involving laboratory based projects, seminars, and publications in peer reviewed journals.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="card mt-4 shadow-sm p-3">
                        <img class="rounded shadow-sm border" src="mobile-assets/phd-mobile/doctoral-biochemistry/1.jpeg" alt="">

                        <h2 class="pt-2 headd3 fw-bold text-dark">Dr. Sthiti Porna Dutta</h2>
                        <p class="para1 text-dark">Ph.D.</p>

                        <h2 class="para1 fw-bold text-dark ">Research Interest</h2>
                        <p class="para1 text-dark">Cancer Immunology, Protein Biochemistry, Plant Biochemistry.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-3">
                    <div class="card mt-4 shadow-sm p-3">
                        <img class="rounded shadow-sm border" src="mobile-assets/phd-mobile/doctoral-biochemistry/2.jpeg" alt="">

                        <h2 class="pt-2 headd3 fw-bold text-dark">Dr. Tarang Jyoti Baruah</h2>
                        <p class="para1 text-dark">Ph.D.</p>

                        <h2 class="para1 fw-bold text-dark ">Research Interest</h2>
                        <p class="para1 text-dark">Cancer Biology, Radiation Biology, Natural Product Chemistry
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-3">
                    <div class="card mt-4 shadow-sm p-3">
                        <img class="rounded shadow-sm border" src="mobile-assets/phd-mobile/doctoral-biochemistry/3.jpeg" alt="">

                        <h2 class="pt-2 headd3 fw-bold text-dark">Dr. Amlan Das</h2>
                        <p class="para1 text-dark">Ph.D.</p>

                        <h2 class="para1 fw-bold text-dark ">Research Interest</h2>
                        <p class="para1 text-dark">Cancer Biology, Precision Medicine, Oxidative stress, Nanotechnology
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-3">
                    <div class="card mt-4 shadow-sm p-3">
                        <img class="rounded shadow-sm border" src="mobile-assets/phd-mobile/doctoral-biochemistry/4.jpeg" alt="">

                        <h2 class="pt-2 headd3 fw-bold text-dark">Dr. Anuj Kumar Borah</h2>
                        <p class="para1 text-dark">Ph.D.</p>

                        <h2 class="para1 fw-bold text-dark ">Research Interest</h2>
                        <p class="para1 text-dark">Metabolic disorders, Cancer Biology, and Natural Product Chemistry
                        </p>
                    </div>
                </div>
