                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-12">
                        ...
                        <p class="para1 pt-3" style="color: #264273; text-align: justify;">
                            The Ph.D. programme in Design offers a rigorous and interdisciplinary program aimed at advancing
                            knowledge and innovation in design research, practice, and theory. The program provides a
                            platform for scholars to explore complex design problems across domains such as product design,
                            communication design, sustainability, and social innovation.
                        </p>

                        <p class="para1" style="color: #264273; text-align: justify;">
                            Ph.D. candidates are encouraged to engage in original research that contributes to the academic
                            body of knowledge while addressing real-world challenges. The department supports a
                            research-driven environment with access to state-of-the-art facilities, experienced faculty, and
                            a collaborative culture that spans across design, technology, and the humanities.
                        </p>
                    ...
                    <div class="row align-items-center gx-5">
                        ...
                        <div class="col-lg-6">
                            ...
                            <h2 class="headd1 fw-bold mt-3" style="color: #264273; font-weight: 700;">
                                Ph.D. Programme <span style="color: #FF9A1E; font-weight: 500;"><br>in Design</span>
                            </h2>
