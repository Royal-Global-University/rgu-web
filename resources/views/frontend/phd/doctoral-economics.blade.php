    ...
    <div id="page" class="site site_wrapper">
                                ...
                                <div class="elementor-widget-container">
                                    <div class="prthalign">
                                        ...
                                        <div class="para1 text-dark kd-para-1 disc" data-splitting style="text-align: justify;">
                                            <p>
                                                Embracing the vision of National Education Policy (NEP), 2020, the Department of
                                                Economics, Royal Global University (RGU) is geared up to create a research
                                                environment for the faculty members and the students to meet the challenges of
                                                fast changing economic dynamics of our nation. At present there are three
                                                experienced full-fledged Ph.D guides in the Department to assist and facilitate
                                                meaningful empirical research. The department has also engaged a few co-guides
                                                from other universities such as Gauhati University and Alliance University,
                                                Bangalore. A few more co-guides are likely to be added soon as our Memorandum of
                                                Understanding (MoU) with various colleges of the state takes a practical shape.
                                                As regards research areas emphasis is given to concentrate on non-theoretical
                                                issues that can enhance our understanding about the economies of Assam,
                                                North-East as well as India as a whole.
                                            </p>
                                        </div>
                                    </div>
                                </div>
        ...
        <div style="padding: 40px 60px;">
            ...
            <p class="para1 text-dark" style="text-align: justify;">
                The department is ardently focusing on emerging issues as well as to have a fresh look on studies that appears
                to be failing to answer new questions that have been thrown up by the evolving economic landscape. The
                department specializes on international trade, finance, agriculture, micro, small and medium enterprises,
                physical and social infrastructure, state, and union government sponsored welfare-oriented schemes etc. and to
                help the government to formulate policies along with issues already under study. The tools and methodologies
                followed include both traditional and emerging methods that rely extensively on using computer software and
                computer languages. Efforts will be made to upgrade both the faculties and researchers in this regard.
            </p>
            ...
            <div class="row d-flex"> <!-- Add d-flex here -->
                <div class="col-lg-4 d-flex"> <!-- Add d-flex to columns -->
                    <div class="card mt-4 shadow-sm p-3 flex-fill"> <!-- Add flex-fill to cards -->
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-economics/1.jpeg" alt="">
                ...
                <div class="col-lg-4 d-flex"> <!-- Add d-flex to columns -->
                    <div class="card mt-4 shadow-sm p-3 flex-fill"> <!-- Add flex-fill to cards -->
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-economics/2.jpeg" alt="">
                ...
                <div class="col-lg-4 d-flex"> <!-- Add d-flex to columns -->
                    <div class="card mt-4 shadow-sm p-3 flex-fill"> <!-- Add flex-fill to cards -->
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-economics/3.jpeg" alt="">
