...
@section('content')
    ...
    <div class="website">
        ...
        <div style="padding: 40px 60px;">
            ...
            <p class="text-dark para1" style="text-align: justify;">
                Our department provides a friendly and supportive research environment with guidance from experienced
                faculty members. We welcome students with a passion for mathematics and a desire to pursue research to
