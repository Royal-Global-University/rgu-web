                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-12">
                        <p class="mobile-para1 pt-5" style="color: #264273; text-align: justify;">
                            The Department of Geography and Geoinformatics at The Assam Royal Global University is dedicated
                            to advancing research and scholarship in geographical sciences with a strong emphasis on
                            interdisciplinary inquiry and contemporary relevance. The department’s doctoral programme
                            provides a rigorous academic platform for scholars to investigate complex spatial,
                            environmental, and socio-economic processes shaping regional and global landscapes. Through a
                            combination of theoretical engagement, methodological training, and field-based research, the
                            programme seeks to cultivate critical scholarship and innovative research addressing emerging
                            environmental and developmental challenges.
                        </p>
                        <p class="mobile-para1 pt-2" style="color: #264273; text-align: justify;">
                            <span class="fw-bold">Research Areas / Specializations</span><br />
                            The doctoral programme supports advanced research across diverse domains within geography and
                            allied disciplines, including:<br />
                        <ul style="color: #264273;">
                            <li>Human Geography and Social Geography</li>
                            <li>Environmental Geography and Climate Change Studies</li>
                            <li>Disaster Risk Reduction and Resilience Studies</li>
                            ...
                            <li>Rural Development and Livelihood Systems</li>
                            <li>Gender Geography and Cultural Landscapes</li>
                            <li>Tourism and Heritage Studies</li>
                        </ul><br />
                        These thematic areas enable scholars to engage with pressing global concerns while contributing to
                        regional development and environmental sustainability.
                        </p>
                        <p class="mobile-para1 pt-2" style="color: #264273; text-align: justify;">
                            <span class="fw-bold">Research Facilities and Academic Environment</span><br />
                            The department offers a dynamic and intellectually stimulating research environment supported by
                            experienced faculty members and institutional academic resources. Doctoral scholars benefit from
                            opportunities for field-based investigation, geospatial analysis, and interdisciplinary
                            collaboration. Regular seminars, workshops, conferences, and research interactions provide a
                            vibrant platform for scholarly dialogue and knowledge exchange. The programme encourages active
                            engagement with academic publishing, research networks, and collaborative projects that
                            strengthen the research culture of the department.
                        </p>
                        <p class="mobile-para1 pt-2" style="color: #264273; text-align: justify;">
                            <span class="fw-bold">Contribution to Knowledge and Society</span><br />
                            Research undertaken within the department seeks to generate critical insights into environmental
                            processes, spatial inequalities, and developmental transformations. Doctoral scholars are
                            encouraged to produce research that contributes to the advancement of geographical knowledge
                            while addressing contemporary societal concerns such as climate change adaptation, sustainable
                            resource management, disaster resilience, and inclusive urban development. Through scholarly
                            publications, academic engagements, and policy-relevant research, the department aims to
                            contribute meaningfully to both academic discourse and societal well-being.
                        </p>
                        <p class="mobile-para1 pt-2" style="color: #264273; text-align: justify;">
                            <span class="fw-bold">Interdisciplinary and Policy Relevance</span><br />
                            Recognizing the complex and interconnected nature of contemporary challenges, the doctoral
                            programme emphasizes interdisciplinary research that integrates perspectives from environmental
                            science, social sciences, geospatial technology, and development studies. Scholars are
                            encouraged to pursue research that informs public policy, sustainable planning, and
                            evidence-based decision-making. By bridging academic inquiry with real-world applications, the
                            programme contributes to policy discourse and sustainable development initiatives at regional,
    ...
    <div class="website">
        <div id="page" class="site site_wrapper">
            ...
            <div data-elementor-type="wp-page" data-elementor-id="704" class="elementor elementor-704">
                                        ...
                                        <div class="prthalign">
                                            <h2 class="headd1 fw-bold mt-3" style="color: #264273; font-weight: 500;">
                                                Ph.D. Programme <span style="color: #FF9A1E; font-weight: 500;">in
                                                    <br/>Geoinformatics</span>
                                            </h2>
                                            <div class="para1 text-dark kd-para-1 disc" data-splitting
                                                style="text-align: justify;">
                                                <p class="mobile-para1 pt-2" style="color: #264273; text-align: justify;">
                                                    The Department of Geography and Geoinformatics at The Assam Royal Global
                                                    University is dedicated to advancing research and scholarship in
                                                    geographical sciences with a strong emphasis on interdisciplinary
                                                    inquiry and contemporary relevance. The department’s doctoral programme
                                                    provides a rigorous academic platform for scholars to investigate
                                                    complex spatial, environmental, and socio-economic processes shaping
                                                    regional and global landscapes. Through a combination of theoretical
                                                    engagement, methodological training, and field-based research, the
                                                    programme seeks to cultivate critical scholarship and innovative
                                                    research addressing emerging environmental and developmental challenges.
                                                </p>
                ...
                <p class="mobile-para1 pt-5" style="color: #264273; text-align: justify; padding-top: 10px; padding-left: 50px; padding-right: 50px;">
                    <span class="fw-bold">Research Areas / Specializations</span><br />
                    The doctoral programme supports advanced research across diverse domains within geography and
                    allied disciplines, including:<br />
                <ul style="color: #264273; padding-top: 10px; padding-left: 50px; padding-right: 50px;">
                    <li>> Human Geography and Social Geography</li>
                    <li>> Environmental Geography and Climate Change Studies</li>
                    <li>> Disaster Risk Reduction and Resilience Studies</li>
                    <li>> Urban and Regional Development</li>
                ...
                <p class="mobile-para1" style="color: #264273; text-align: justify; padding-top: 10px; padding-left: 50px; padding-right: 50px;">
                    <span class="fw-bold">Research Facilities and Academic Environment</span><br />
                    The department offers a dynamic and intellectually stimulating research environment supported by
                    experienced faculty members and institutional academic resources. Doctoral scholars benefit from
                    opportunities for field-based investigation, geospatial analysis, and interdisciplinary
                ...
                <p class="mobile-para1 pt-2" style="color: #264273; text-align: justify; padding-top: 10px; padding-left: 50px; padding-right: 50px;">
                    <span class="fw-bold">Contribution to Knowledge and Society</span><br />
                    Research undertaken within the department seeks to generate critical insights into environmental
                    processes, spatial inequalities, and developmental transformations. Doctoral scholars are
                    encouraged to produce research that contributes to the advancement of geographical knowledge
