    ...
    <div id="page" class="site site_wrapper">
                                ...
                                <div class="elementor-widget-container">
                                    <div class="prthalign">
                                        ...
                                        <div class="para1 text-dark kd-para-1 disc" data-splitting style="text-align: justify;">
                                            <p>
                                                The doctoral program in Sociology aims to build researchers who are
                                                intellectually independent and can generate original research that is
                                                theoretically, analytically and empirically robust. The program is shaped and
                                                structured in a way so that the researchers can connect their studies to the
                                                world and social environment around them. Apart from this active participation
                                                is encouraged in departmental activities and that outside the university so as
                                                to help them move beyond rigid boundaries and broaden their perspectives and
                                                horizon on their research topics. All these help in encouraging them to have a
                                                more inclusive outlook and if possible incorporate the same in their research as
        ...
        <div style="padding: 40px 60px; text-align: justify;">
            ...
            <div class="card mt-4 shadow-sm">
                <div class="row p-3">
                    <div class="col-lg-2">
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-sociology/1.jpeg" alt="">
                    </div>
                    <div class="col-lg-9">
            ...
            <div class="card mt-4 shadow-sm">
                <div class="row p-3">
                    <div class="col-lg-2">
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-sociology/2.jpeg" alt="">
                    </div>
                    <div class="col-lg-9">
            ...
            <div class="card mt-4 shadow-sm">
                <div class="row p-3">
                    <div class="col-lg-2">
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-sociology/3.jpeg" alt="">
                    </div>
                    <div class="col-lg-9">
            ...
            <div class="card mt-4 shadow-sm">
                <div class="row p-3">
                    <div class="col-lg-2">
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-sociology/4.jpeg" alt="">
                    </div>
                    <div class="col-lg-9">
                        ...
                        <h2 class="para1 fw-bold text-dark ">Research Interest</h2>
                        <p class="para1 text-dark">
                            Political Sociology, Sociology of Law, Sociology of Development, Sociology of Northeast India,
                            Sociology of Gender, Ethnographic Methods.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="card mt-4 shadow-sm">
                <div class="row p-3">
                    <div class="col-lg-2">
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-sociology/5.jpeg" alt="">
                    </div>
                    <div class="col-lg-9">
                        ...
                        <h2 class="para1 fw-bold text-dark ">Research Interest</h2>
                        <p class="para1 text-dark">
                            Ethnicity, Identity Politics, Sociology of Northeast India, Sociological Theories, Political
                            Sociology.
                        </p>
                    </div>
                </div>
            ...
            <div class="card mt-4 shadow-sm">
                <div class="row p-3">
                    <div class="col-lg-2">
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-sociology/6.jpeg" alt="">
                    </div>
                    <div class="col-lg-9">
