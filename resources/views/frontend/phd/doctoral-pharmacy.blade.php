...
@section('content')
    <div class="mobile">
        ...
        <section
            style="padding: 110px 10px; background-image: url(mobile-assets/placement-all/mobile-bg.svg); position: relative;">
            <div class="container">
                                        ...
                                        <div class="prthalign">
                                            ...
                                            <div class="para1 text-dark kd-para-1 disc" data-splitting
                                                ...
                                                <p>
                                                    ...
                                                    students with the skills and knowledge necessary to become leaders in
                                                    the field of pharmacy research. Some areas of research that students in
                                                    a Ph.D. in Pharmacy program may focus on include drug discovery and
                                                    development, pharmacokinetics, pharmacodynamics, toxicology, and drug
                                                    delivery systems. A Ph.D. in Pharmacy is an advanced degree program that
                                                    prepares students to conduct original research and make contributions to
                                                    the field of pharmacy. It develops deep and broad understanding of
                                                    fundamentals and state of the art of knowledge in the chosen field
                                                    through courses and self-study, develop ability and skills to carry out
                                                    independent research and development to face the challenges posed to
                                                    mankind on specific problems.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
