    ...
    <div id="page" class="site site_wrapper">
                                ...
                                <div class="elementor-widget-container">
                                    <div class="prthalign">
                                        ...
                                        <div class="para1 text-dark kd-para-1 disc" data-splitting style="text-align: justify;">
                                            <p>
                                                A Ph.D. in Zoology is an advanced degree program that provides students with
                                                in-depth knowledge and research experience in the study of animal life. Zoology
                                                is a branch of biology that focuses on the structure, function, behavior,
                                                evolution, and ecology of animals, from the smallest invertebrates to the
                                                largest mammals.
                                            </p>
                                            <p>
                                                During a Ph.D. program in Zoology, students typically undertake advanced
                                                coursework in areas such as ecology, evolution, genetics, animal behavior,
                                                physiology, and anatomy, as well as statistics and research methods. They also
                                                engage in independent research under the guidance of a faculty advisor, and
                                                typically write and defend a thesis based on their research findings.The program
                                                aims to provide students with a deep understanding of animal life and prepare
                                                them for careers in academia, research, science communication, or conservation
                                                work.
                                            </p>
                                        </div>
                                    </div>
        ...
        <div style="padding: 40px 60px; text-align: justify;">
            ...
            <div class="card mt-4 shadow-sm">
                <div class="row p-3">
                    <div class="col-lg-2">
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-zoology/1.png" alt="">
                    </div>
                    <div class="col-lg-9">
            ...
            <div class="card mt-4 shadow-sm">
                <div class="row p-3">
                    <div class="col-lg-2">
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-zoology/2.jpeg" alt="">
                    </div>
                    <div class="col-lg-9">
                        ...
                        <h2 class="para1 fw-bold text-dark ">Research Interest</h2>
                        <p class="para1 text-dark">
                            Molecular Cell Biology, Genetic Toxicology, Environmental Toxicology, Medicinal Plant Research,
                            Cancer Biology.
                        </p>
                    </div>
                </div>
            ...
            <div class="card mt-4 shadow-sm">
                <div class="row p-3">
                    <div class="col-lg-2">
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-zoology/3.jpeg" alt="">
                    </div>
                    <div class="col-lg-9">
            ...
            <div class="card mt-4 shadow-sm">
                <div class="row p-3">
                    <div class="col-lg-2">
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-zoology/4.jpeg" alt="">
                    </div>
                    <div class="col-lg-9">
            ...
            <div class="card mt-4 shadow-sm">
                <div class="row p-3">
                    <div class="col-lg-2">
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-zoology/5.jpeg" alt="">
                    </div>
                    <div class="col-lg-9">
            ...
            <div class="card mt-4 shadow-sm">
                <div class="row p-3">
                    <div class="col-lg-2">
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-zoology/6.jpeg" alt="">
                    </div>
                    <div class="col-lg-9">
