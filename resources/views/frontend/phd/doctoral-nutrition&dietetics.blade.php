...
@section('content')
    ...
    <div class="container pt-4" style="text-align: justify; color: #27467A;">
        ...
        <p>
            Ph.D. in Nutrition and Dietetics is an advanced scientific inquiry in human nutrition. This program offers
            advanced training in clinical nutrition, public health, and cutting-edge research methodologies. It explores
            areas such as nutrient metabolism, functional foods, and disease prevention while working alongside experienced
            faculty and state-of-the-art research facilities.
        </p>

        <p>
            The programme enables scholars to contribute meaningful research addressing global challenges such as
            malnutrition, obesity, and lifestyle disorders. It is also designed to develop high-level competence in
            nutritional biochemistry, clinical nutrition, nutrigenomics, and public health nutrition.
        </p>

        <p class="fw-bold">Program Highlights:</p>
        <ul style="padding-left: 18px;">
            <li>Specialized research in metabolic pathways and functional foods</li>
            <li>Training in advanced laboratory and statistical methodologies</li>
            <li>Interdisciplinary collaboration across clinical and public health domains</li>
            <li>Opportunities for peer-reviewed publications and scientific dissemination</li>
        </ul>
