                                ...
                                <div class="elementor-widget-container">
                                    <div class="prthalign">
                                        ...
                                        <div class="para1 text-dark kd-para-1 disc" data-splitting style="text-align: justify;">
                                            <p>
                                                The Travel and Tourism sector is a significant, diverse and ever-expanding
                                                industry that encompasses a wide range of activities, services and businesses
                                                related to travel, leisure and hospitality. Pursuing a Ph.D. Program in this
                                                field can be rewarding and intellectually stimulating journey, allowing you to
                                                conduct research, contribute to the knowledge based on the industry and
                                                potentially pursue a career in academia or advanced research within the travel,
            ...
            <div class="row d-flex"> <!-- Add d-flex here -->
                ...
                <div class="col-lg-3 d-flex"> <!-- Add d-flex to columns -->
                    <div class="card mt-4 shadow-sm p-3 flex-fill"> <!-- Add flex-fill to cards -->
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-travel-tourism-management/1.jpeg"
                            alt="">
