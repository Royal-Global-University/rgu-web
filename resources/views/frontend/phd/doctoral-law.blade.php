...
@section('content')
        ...
        <img style="padding-top: 90px; position: relative;" src="mobile-assets/phd-mobile/mob-law.png" alt="">
                                    ...
                                    <div class="elementor-widget-container">
                                        <div class="prthalign">
                                            ...
                                            <div class="para1 text-dark kd-para-1 disc" data-splitting style="text-align: justify;">
                                                <p>
                                                    The Ph.D. (Law) programme offered at RSLA provides an opportunity to the candidate of engage in in-depth legal studies and to contribute innovative and new ideas in legal discourse. A PhD in Law includes intense coursework followed by detailed research in the chosen area in order to attain in-depth knowledge and advanced studies in the domain. The candidates are also encouraged to study interdisciplinary areas and bring out useful and effective thoughts for the society. In addition, the candidates are encouraged to take part in various academic activities of the department, university and other avenues to sharpen their skills in critical thinking and to gain further knowledge.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
