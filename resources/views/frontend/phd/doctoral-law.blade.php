                                    ...
                                    <div class="prthalign">
                                        ...
                                        <div class="para1 text-dark kd-para-1 disc" data-splitting style="text-align: justify;">
                                            <p>
                                                ...
                                                candidate of engage in in-depth legal studies and to contribute innovative and
                                                new ideas in legal discourse. A PhD in Law includes intense coursework followed
                                                by detailed research in the chosen area in order to attain in-depth knowledge
                                                and advanced studies in the domain. The candidates are also encouraged to study
                                                interdisciplinary areas and bring out useful and effective thoughts for the
                                                society. In addition, the candidates are encouraged to take part in various
                                                academic activities of the department, university and other avenues to sharpen
            ...
            <div class="row d-flex"> <!-- Add d-flex here -->
                <div class="col-lg-3 d-flex"> <!-- Add d-flex to columns -->
                    <div class="card mt-4 shadow-sm p-3 flex-fill"> <!-- Add flex-fill to cards -->
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-law/1.jpeg" alt="">
                ...
                <div class="col-lg-3 d-flex"> <!-- Add d-flex to columns -->
                    <div class="card mt-4 shadow-sm p-3 flex-fill"> <!-- Add flex-fill to cards -->
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-law/2.jpeg" alt="">
                ...
                <div class="col-lg-3 d-flex"> <!-- Add d-flex to columns -->
                    <div class="card mt-4 shadow-sm p-3 flex-fill"> <!-- Add flex-fill to cards -->
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-law/3.jpeg" alt="">
