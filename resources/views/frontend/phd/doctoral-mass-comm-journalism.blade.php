    ...
    <div id="page" class="site site_wrapper">
                                ...
                                <div class="elementor-widget-container">
                                    <div class="prthalign">
                                        <h1 class="headd2 text-dark fw-bold kd-title-ani kd-split-text">
                                            Journalism and Mass Communication</h1>
                                        <div class="para1 text-dark kd-para-1 disc" data-splitting style="text-align: justify;">
                                            <p>
                                                A Ph.D. in Journalism & Mass Communication is a scholarly pursuit that offers
                                                individuals the opportunity to explore the dynamic and ever-evolving field of
                                                media and communication. Ph.D. candidates embark on a journey of in-depth
                                                research and critical analysis of media phenomena, communication theories, and
                                                emerging trends. They often conduct extensive fieldwork, surveys, and case
                                                studies to contribute original insights to the discipline. The culmination of
                                                their efforts is a comprehensive dissertation that adds to the body of knowledge
        ...
        <div style="padding: 40px 60px;">
            ...
            <p class="para1 text-dark" style="text-align: justify;">
                This program not only equips individuals with advanced research and analytical skills but also prepares them for
                careers in academia, media research, policy analysis, and communication consulting. A Ph.D. in Journalism & Mass
                Communication is a pathway to becoming a thought leader and shaping the future of media and communication
            ...
            <div class="row d-flex"> <!-- Add d-flex here -->
                <div class="col-lg-3 d-flex"> <!-- Add d-flex to columns -->
                    <div class="card mt-4 shadow-sm p-3 flex-fill"> <!-- Add flex-fill to cards -->
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-journalism-mass-comm/1.jpg"
                            alt="">
                        <h2 class="pt-2 headd3 fw-bold text-dark">Dr. Esha Chakraborty</h2>
                        <p class="para1 text-dark">Ph.D.</p>
                        <h2 class="para1 fw-bold text-dark ">Research Interest</h2>
                        <p class="para1 text-dark">
                            New Media, Journalism, Gender Communication and Film studies
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-3 d-flex"> <!-- Add d-flex to columns -->
                    <div class="card mt-4 shadow-sm p-3 flex-fill"> <!-- Add flex-fill to cards -->
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-journalism-mass-comm/2.jpeg"
                            alt="">
                        <h2 class="pt-2 headd3 fw-bold text-dark">Dr. Haoinlen Chongloi</h2>
                        <p class="para1 text-dark">Ph.D.</p>
                        <h2 class="para1 fw-bold text-dark ">Research Interest</h2>
                        <p class="para1 text-dark">
                            Media Laws and ethics, Development Communication, Advertising and Media Theories
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-3 d-flex"> <!-- Add d-flex to columns -->
                    <div class="card mt-4 shadow-sm p-3 flex-fill"> <!-- Add flex-fill to cards -->
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-journalism-mass-comm/3.jpeg"
                            alt="">
                ...
                <div class="col-lg-3 d-flex"> <!-- Add d-flex to columns -->
                    <div class="card mt-4 shadow-sm p-3 flex-fill"> <!-- Add flex-fill to cards -->
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-journalism-mass-comm/4.jpeg"
                            alt="">
                        <h2 class="pt-2 headd3 fw-bold text-dark">Dr. Sailendra Das</h2>
                        <p class="para1 text-dark">Ph.D.</p>
