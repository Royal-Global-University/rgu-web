...
@section('content')
        ...
        <img style="padding-top: 90px; position: relative;" src="mobile-assets/phd-mobile/mob-mass.png" alt="">
     ...
     <div class="website">
        ...
        <div style="padding: 40px 60px;">
               ...
               <p class="para1 text-dark" style="text-align: justify;">
                This program not only equips individuals with advanced research and analytical skills but also prepares them for careers in academia, media research, policy analysis, and communication consulting. A Ph.D. in Journalism & Mass Communication is a pathway to becoming a thought leader and shaping the future of media and communication practices in the country.
            </p>
            ...
            <div class="row d-flex"> <!-- Add d-flex here -->
                <div class="col-lg-3 d-flex"> <!-- Add d-flex to columns -->
                    <div class="card mt-4 shadow-sm p-3 flex-fill"> <!-- Add flex-fill to cards -->
                        <img class="rounded shadow-sm border" src="mobile-assets/phd-mobile/doctoral-journalism-mass-comm/1.jpg" alt="">
                ...
                <div class="col-lg-3 d-flex"> <!-- Add d-flex to columns -->
                    <div class="card mt-4 shadow-sm p-3 flex-fill"> <!-- Add flex-fill to cards -->
                        <img class="rounded shadow-sm border" src="mobile-assets/phd-mobile/doctoral-journalism-mass-comm/2.jpeg" alt="">
                ...
                <div class="col-lg-3 d-flex"> <!-- Add d-flex to columns -->
                    <div class="card mt-4 shadow-sm p-3 flex-fill"> <!-- Add flex-fill to cards -->
                        <img class="rounded shadow-sm border" src="mobile-assets/phd-mobile/doctoral-journalism-mass-comm/4.jpeg" alt="">
