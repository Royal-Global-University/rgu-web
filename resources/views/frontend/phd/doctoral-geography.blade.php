...
@section('content')
    <div id="page" class="site site_wrapper">
                                ...
                                <div class="elementor-widget-container">
                                    <div class="prthalign">
                                        ...
                                        <div class="para1 text-dark kd-para-1 disc" data-splitting style="text-align: justify;">
                                            <p>
                                                Ph.D. Geography is an exploration-based doctoral course in geography that is
                                                committed to the investigation of the Earth and the planetary bases, elements,
                                                habitats, and wonders. A student focuses on geography to understand how the
                                                Earth is evolving. They think experimentally and logically as to why it is
                                                developing. In this course, students will explore each and every component of
                                                the Earth and its field circulation, research regions and places, types of
                                                plains, geology, and much more. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div style="padding: 40px 60px;">
            ...
            <p class="text-dark para1" style="text-align: justify;">Geology gives knowledge about important contemporary issues,
                such as globalization and ecological change, with a specific enthusiasm for neighborhood contrasts; Changes in
                disciplinary interests and practices reflect those issues. In this course, students will explore each and every
                component of the Earth and its field circulation, research regions and places, types of plains, geology,
                etc.There are many positions available for Ph.D. Geography researcher. Candidates after this degree can work as
                researchers, academicians, meteorologist, naturalist, map maker, metropolitan organizer, climatologist,
                ecological specialist, topographical data framework officers etc.
            </p>
            ...
            <div class="card mt-4 shadow-sm">
                <div class="row p-3">
                    <div class="col-lg-2">
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-geography/1.webp" alt="">
                    </div>
                    <div class="col-lg-9">
            ...
            <div class="card mt-4 shadow-sm">
                <div class="row p-3">
                    <div class="col-lg-2">
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-geography/2.webp" alt="">
                    </div>
                    <div class="col-lg-9">
