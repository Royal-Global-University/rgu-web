                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-12">
                        <p class="mobile-para1 pt-5" style="color: #264273; text-align: justify;">
                            The Doctoral Program in Forestry at The Assam Royal Global University offers a vibrant and
                            research-intensive academic environment dedicated to addressing contemporary challenges in
                            forestry and environmental sustainability. Established in July 2024, the Department of Forestry
                            brings together interdisciplinary expertise spanning agroforestry, plant genetics, soil science,
                            forest ecology, climate change, remote sensing & GIS, etc., enabling scholars to engage in both
                            fundamental inquiry and applied research.
                        </p>
                        <p class="mobile-para1 pt-2" style="color: #264273; text-align: justify;">
                            Positioned within the ecologically significant Eastern Himalayan region, the program provides a
                            unique opportunity to undertake context-specific yet globally relevant research. Scholars are
                            encouraged to explore critical themes such as biodiversity conservation, ecosystem services,
                            climate resilience, etc., with a strong emphasis on developing context-specific solutions to
                            real-world environmental challenges. Through the integration of modern geospatial tools and
                            data-driven approaches, the program equips scholars with the competencies required for
                            high-quality research and evidence-based decision-making.
                        </p>
                        <p class="mobile-para1 pt-2" style="color: #264273; text-align: justify;">
                            Supported by experienced faculty, structured mentorship, and a research-enabling ecosystem, the
                            program promotes academic excellence through high-quality publications, interdisciplinary
                            collaboration, and active knowledge dissemination. Aligned with national priorities and global
                            sustainability frameworks, the program aims to nurture skilled researchers and professionals who
                            can contribute meaningfully to sustainable forest management, policy development, and
        ...
        <div id="page" class="site site_wrapper">
            ...
            <div data-elementor-type="wp-page" data-elementor-id="704" class="elementor elementor-704">
                                    ...
                                    <div class="elementor-widget-container">
                                        <div class="prthalign">
                                            ...
                                            <div class="para1 text-dark kd-para-1 disc" data-splitting
                                                ...
                                                <p class="mobile-para1 pt-2" style="color: #264273; text-align: justify;">
                                                    The Doctoral Program in Forestry at The Assam Royal Global University offers a vibrant and research-intensive academic environment dedicated to addressing contemporary challenges in forestry and environmental sustainability. Established in July 2024, the Department of Forestry brings together interdisciplinary expertise spanning agroforestry, plant genetics, soil science, forest ecology, climate change, remote sensing & GIS, etc., enabling scholars to engage in both fundamental inquiry and applied research.
                                                </p>
                ...
                <p class="mobile-para1"
                    ...
                    Positioned within the ecologically significant Eastern Himalayan region, the program provides a unique opportunity to undertake context-specific yet globally relevant research. Scholars are encouraged to explore critical themes such as biodiversity conservation, ecosystem services, climate resilience, etc., with a strong emphasis on developing context-specific solutions to real-world environmental challenges. Through the integration of modern geospatial tools and data-driven approaches, the program equips scholars with the competencies required for high-quality research and evidence-based decision-making.
                </p>
                <p class="mobile-para1"
                    style="color: #264273; text-align: justify; padding-top: 10px; padding-left: 50px; padding-right: 50px;">
                    Supported by experienced faculty, structured mentorship, and a research-enabling ecosystem, the program promotes academic excellence through high-quality publications, interdisciplinary collaboration, and active knowledge dissemination. Aligned with national priorities and global sustainability frameworks, the program aims to nurture skilled researchers and professionals who can contribute meaningfully to sustainable forest management, policy development, and environmental governance.
                </p>
            </div>
            <!--End About-->
