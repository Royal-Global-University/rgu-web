    ...
    <div id="page" class="site site_wrapper">
        ...
        <div style="padding: 40px 60px;">
            ...
            <div class="card mt-4 shadow-sm">
                <div class="row p-3">
                    <div class="col-lg-2">
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-library-sc/1.jpg" alt="">
                    </div>
                    <div class="col-lg-9">
            ...
            <div class="card mt-4 shadow-sm">
                <div class="row p-3">
                    <div class="col-lg-2">
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-library-sc/2.jpg" alt="">
                    </div>
                    <div class="col-lg-9">
