...
@section('content')
        ...
        <img style="padding-top: 90px; position: relative;" src="mobile-assets/phd-mobile/mob-lib.png" alt="">
     ...
     <div class="website">
        ...
        <div style="padding: 40px 60px;">
            ...
            <div class="card mt-4 shadow-sm">
                <div class="row p-3">
                    <div class="col-lg-2">
                        <img class="rounded shadow-sm border" src="mobile-assets/phd-mobile/doctoral-library-sc/1.jpg" alt="">
                    </div>
                    <div class="col-lg-9">
                        <h2 class="headd3 fw-bold text-dark">Dr. Hirak Jyoti Hazarika</h2>
                        <p class="para1 text-dark">Assistant Professor, RSLISC</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <ol class="para1 text-dark">
                                    <li>Library Automation System</li>
                                    <li>Content Management System</li>
                                    <li>Learning Management System</li>
                                    <li>Information Behaviour</li>
                            ...
                            <div class="col-lg-5">
                                <ol class="para1 text-dark">
                                    ...
                                    <li>Web 2.0</li>
                                    <li>Library 2.0</li>
                                    <li>Scientometrics/ Bibliometric/ Altmetrics</li>
                                    <li>Ontology</li>
                                </ol>
                            </div>
                            ...
                            <div class="col-lg-3">
                                <ol class="para1 text-dark">
                                    <li>Information Retrieval and Organization</li>
                                    <li>Emerging Technologies</li>
                                    <li>Health Information</li>
                                    <li>Cloud Computing in Libraries</li>
                                </ol>
                            </div>
                        </div>
                    </div>
              ...
              <div class="card mt-4 shadow-sm">
                <div class="row p-3">
                    <div class="col-lg-2">
                        <img class="rounded shadow-sm border" src="mobile-assets/phd-mobile/doctoral-library-sc/2.jpg" alt="">
                    </div>
                    <div class="col-lg-9">
                        <h2 class="headd3 fw-bold text-dark">Dr. Md. Mukutor Rahman</h2>
                        <p class="para1 text-dark">Librarian (I/C) & Assistant Professor, RSLISC</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <ol class="para1 text-dark">
                                    <li>Libraries and Information Centres</li>
                            ...
                            <div class="col-lg-3">
                                <ol class="para1 text-dark">
                                    <li>Computer Network in Libraries</li>
