...
@section('content')
        ...
        <img style="padding-top: 90px; position: relative;" src="mobile-assets/phd-mobile/mob-Psychology.png" alt="">
                                    ...
                                    <div class="elementor-widget-container">
                                        <div class="prthalign">
                                            ...
                                            <div class="para1 text-dark kd-para-1 disc" data-splitting style="text-align: justify;">
                                                <p>
                                                    Psychology is the study of behaviour, mental processor and emotions. Over the past decades, the discipline of psychology has grown significantly. Currently psychologists play a significant role in various sectors such as education, medicine, public health, counselling and industry. Psychologists examine both individual and group behaviours working towards to understand human activity, mental health issues, and the importance of psychotherapy and counselling for the enhancement of well-being and quality of life. The doctoral program in Psychology at The Assam Royal Global University aims to encourage the research enthusiasts to carry out research to make significant contribution to the field of psychology by developing theories and models.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="row d-flex"> <!-- Add d-flex here -->
                ...
                <div class="col-lg-3 d-flex"> <!-- Add d-flex to columns -->
                    <div class="card mt-4 shadow-sm p-3 flex-fill"> <!-- Add flex-fill to cards -->
                        ...
                        <h2 class="pt-2 headd3 fw-bold text-dark">Dr. Jwmwishree Boro</h2>
                ...
                <div class="col-lg-3 d-flex"> <!-- Add d-flex to columns -->
                    <div class="card mt-4 shadow-sm p-3 flex-fill"> <!-- Add flex-fill to cards -->
                        <img class="rounded shadow-sm border" src="mobile-assets/phd-mobile/doctoral-psychology/3.jpeg" alt="">
                        <h2 class="pt-2 headd3 fw-bold text-dark">Dr. Queen Deka</h2>
                        <p class="para1 text-dark">Ph.D.</p>
                        <h2 class="para1 fw-bold text-dark ">Research Interest</h2>
                        <p class="para1 text-dark">
