    ...
    <div id="page" class="site site_wrapper">
                                ...
                                <div class="elementor-widget-container">
                                    <div class="prthalign">
                                        ...
                                        <div class="para1 text-dark kd-para-1 disc" data-splitting style="text-align: justify;">
                                            <p>
                                                The Department of History provides a stimulating and vibrant environment for
                                                scholars to pursue their doctoral research in a wide range of research areas.
                                                The passionate, experienced and welcoming faculties of the department are
                                                distinguished by their expertise in their respective fields and provide the most
                                                wholesome guidance to our research scholars in their academic journey. Every
                                                scholar, post admission, becomes a member of a community of departmental
                                                researchers who meet every month to discuss issues of core research.
                                            </p>
                                        </div>
                                    </div>
                                </div>
        ...
        <div style="padding: 40px 60px;">
            ...
            <p class="para1 text-dark" style="text-align: justify;">
                The Department of History specializes in a myriad of areas of historical research from every period of Indian
                History with a special focus on the history of Assam and the other Northeastern states. Areas of interest
                include: history of ancient Assam, ethnographic history of North Eastern cultures, history of medieval Assam,
                history of colonialism in the North East, literary and oral history, history of protest and conflict, colonial
                resource-use regime and infrastructure, labour history etc.
            </p>
            ...
            <div class="row d-flex"> <!-- Add d-flex here -->
                <div class="col-lg-3 d-flex"> <!-- Add d-flex to columns -->
                    <div class="card mt-4 shadow-sm p-3 flex-fill"> <!-- Add flex-fill to cards -->
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-history/1.jpeg" alt="">
                ...
                <div class="col-lg-3 d-flex"> <!-- Add d-flex to columns -->
                    <div class="card mt-4 shadow-sm p-3 flex-fill"> <!-- Add flex-fill to cards -->
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-history/2.jpeg" alt="">
                ...
                <div class="col-lg-3 d-flex"> <!-- Add d-flex to columns -->
                    <div class="card mt-4 shadow-sm p-3 flex-fill"> <!-- Add flex-fill to cards -->
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-history/3.jpeg" alt="">
