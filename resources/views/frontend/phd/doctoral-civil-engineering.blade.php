...
@section('content')
    <div class="mobile">
        ...
        <section style="padding-top: 110px; background-image: url(mobile-assets/placement-all/mobile-bg.svg);">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-12">
                        ...
                        <p class="mobile-para1" style="color: #264273; text-align: justify; font-size: 18px;">
                            A Ph.D. in Civil Engineering is the pinnacle of academic achievement in the field, offering
                            individuals the opportunity to delve deep into the complexities of infrastructure, construction,
                            and sustainable development. This advanced degree represents a commitment to expanding the
                            frontiers of knowledge and solving some of the world's most pressing challenges. Civil
                            engineering encompasses a wide range of disciplines, including structural engineering,
                            geotechnical engineering, transportation engineering, environmental engineering, and more. A
                            Ph.D. program in Civil Engineering allows students to specialize in their area of interest and
                            contribute to the advancement of that specific field and can work in Academia, Research and
                            Development, Consulting, Government and Regulatory Bodies.
                        </p>
                                    ...
                                    <div class="elementor-widget-container">
                                        <div class="prthalign">
                                            <h2 class="headd1 fw-bold mt-3" style="color: #264273; font-weight: 700;">
                                                Ph.D. Programme <span style="color: #FF9A1E; font-weight: 500;"><br>in Civil
                                                    Engineering</span>
                                            </h2>
                                            <div class="para1 text-dark kd-para-1 disc" data-splitting
                                                style="text-align: justify;">
                                                <p>
                                                    A Ph.D. in Civil Engineering is the pinnacle of academic achievement in
                                                    the field, offering individuals the opportunity to delve deep into the
                                                    complexities of infrastructure, construction, and sustainable
                                                    development. This advanced degree represents a commitment to expanding
                                                    the frontiers of knowledge and solving some of the world's most pressing
                                                    challenges. Civil engineering encompasses a wide range of disciplines,
                                                    including structural engineering, geotechnical engineering,
                                                    transportation engineering, environmental engineering, and more. A Ph.D.
                                                    program in Civil Engineering allows students to specialize in their area
                                                    of interest and contribute to the advancement of that specific field and
                                                    can work in Academia, Research and Development, Consulting, Government
