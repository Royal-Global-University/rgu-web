                                ...
                                <div class="elementor-widget-container">
                                    <div class="prthalign">
                                        ...
                                        <div class="para1 text-dark kd-para-1 disc" data-splitting style="text-align: justify;">
                                            <p>
                                                Welcome to The Assam Royal Global University’s Ph.D. programme in Political
                                                Science. We offer both full time and part time Ph.D. in the field of Political
                                                Science. Specially, research scholars are encouraged to work on areas such as
                                                international relations, Indian politics, North East politics, human rights,
                                                etc. Researchers get a chance to work under the supervision of experienced and
                                                highly qualified supervisors. As a part of the programme, scholars need to do a
                                                course work for a period of 6 months. Periodical presentations, progress report
                                                submissions, doing good quality literature review, etc. are a part of the
                                                programme. After completing Ph.D. from here, research scholars get opportunities
                                                to pursue their career in academia, research institutes, NGOs, think tanks, etc.
                                            </p>
            ...
            <div class="row d-flex"> <!-- Add d-flex here -->
                <div class="col-lg-3 d-flex"> <!-- Add d-flex to columns -->
                    <div class="card mt-4 shadow-sm p-3 flex-fill"> <!-- Add flex-fill to cards -->
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-pol-sc/1.jpeg" alt="">
                ...
                <div class="col-lg-3 d-flex"> <!-- Add d-flex to columns -->
                    <div class="card mt-4 shadow-sm p-3 flex-fill"> <!-- Add flex-fill to cards -->
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-pol-sc/2.jpeg" alt="">
                ...
                <div class="col-lg-3 d-flex"> <!-- Add d-flex to columns -->
                    <div class="card mt-4 shadow-sm p-3 flex-fill"> <!-- Add flex-fill to cards -->
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-pol-sc/3.jpeg" alt="">
