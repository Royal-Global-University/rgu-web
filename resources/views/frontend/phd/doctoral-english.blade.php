...
@section('content')
        ...
        <img style="padding-top: 90px; position: relative;" src="mobile-assets/phd-mobile/mob-English.png" alt="">
                                    ...
                                    <div class="elementor-widget-container">
                                        <div class="prthalign">
                                            ...
                                            <div class="para1 text-dark kd-para-1 disc" data-splitting style="text-align: justify;">
                                                <p>
                                                    The Ph.D. in English at The Assam Royal Global University aims to admit students who are passionate about literature and the world. As part of the Ph.D. programme, students study diverse modes of analysing texts, enabling them to formulate questions that are both rigorous and adventurous. The programme trains students in pedagogic practice, emphasising at every stage the dialogic nature of all learning and writing. The Ph.D. in English thus aims to produce colleagues who will inject both academic rigour and intellectual adventurousness into both their theory and practice.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="row d-flex"> <!-- Add d-flex here -->
                <div class="col-lg-3 d-flex"> <!-- Add d-flex to columns -->
                    <div class="card mt-4 shadow-sm p-3 flex-fill"> <!-- Add flex-fill to cards -->
                        <img class="rounded shadow-sm border" src="mobile-assets/phd-mobile/doctoral-english/1.jpeg" alt="">
                        <h2 class="pt-2 headd3 fw-bold text-dark">Prof. (Dr.) P J Mahanta</h2>
                        <p class="para1 text-dark">Ph.D.</p>
                        </div>
                </div>
                <div class="col-lg-3 d-flex"> <!-- Add d-flex to columns -->
                    <div class="card mt-4 shadow-sm p-3 flex-fill"> <!-- Add flex-fill to cards -->
                        <img class="rounded shadow-sm border" src="mobile-assets/phd-mobile/doctoral-english/2.jpeg" alt="">
                        <h2 class="pt-2 headd3 fw-bold text-dark">Prof. (Dr.) Krishna Barua</h2>
                        <p class="para1 text-dark">Ph.D.</p>
                    </div>
                </div>
                <div class="col-lg-3 d-flex"> <!-- Add d-flex to columns -->
                    <div class="card mt-4 shadow-sm p-3 flex-fill"> <!-- Add flex-fill to cards -->
                        <img class="rounded shadow-sm border" src="mobile-assets/phd-mobile/doctoral-english/3.jpeg" alt="">
                        <h2 class="pt-2 headd3 fw-bold text-dark">Dr. Baishalee Rajkhowa</h2>
                        <p class="para1 text-dark">Ph.D.</p>
                        </div>
                </div>
                <div class="col-lg-3 d-flex"> <!-- Add d-flex to columns -->
                    <div class="card mt-4 shadow-sm p-3 flex-fill"> <!-- Add flex-fill to cards -->
                        <img class="rounded shadow-sm border" src="mobile-assets/phd-mobile/doctoral-english/4.jpeg" alt="">
                        <h2 class="pt-2 headd3 fw-bold text-dark">Dr. Jasmine A Choudhury</h2>
                        <p class="para1 text-dark">Ph.D.</p>
                    </div>
                </div>
                <div class="col-lg-3 d-flex"> <!-- Add d-flex to columns -->
                    <div class="card mt-4 shadow-sm p-3 flex-fill"> <!-- Add flex-fill to cards -->
                        <img class="rounded shadow-sm border" src="mobile-assets/phd-mobile/doctoral-english/5.jpeg" alt="">
                        <h2 class="pt-2 headd3 fw-bold text-dark">Dr. Pronami Bhattacharyya</h2>
                        <p class="para1 text-dark">Ph.D.</p>
                    </div>
                </div>
                <div class="col-lg-3 d-flex"> <!-- Add d-flex to columns -->
                    <div class="card mt-4 shadow-sm p-3 flex-fill"> <!-- Add flex-fill to cards -->
                        <img class="rounded shadow-sm border" src="mobile-assets/phd-mobile/doctoral-english/6.jpeg" alt="">
                        <h2 class="pt-2 headd3 fw-bold text-dark">Dr. Stuti Goswami</h2>
                        <p class="para1 text-dark">Ph.D.</p>
                    </div>
                </div>
