                ...
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <h2 class="mobile-headd2 kd-title-ani kd-split mb-4 text-center"
                            ...
                            Ph.D. Programme <br><span style="color: #FF9A1E; font-weight: 500;">
                                in Fashion Design and Technology</span> </h2>
                    ...
                    <div class="col-lg-12">
                        <p class="mobile-para1 pt-5" style="color: #264273; text-align: justify;">
                            The Ph.D. program at the Royal School of Fashion Design and Technology, under The Assam Royal
                            Global University, Betkuchi, Guwahati, is designed to nurture advanced research and innovation
                            in the field of fashion and design. The program emphasizes a research-intensive,
                            industry-oriented, and interdisciplinary & Multidisciplinary approach, encouraging scholars to
                            explore contemporary issues such as sustainability, ethical practices, material innovation,
                            traditional textiles and cultural studies within fashion.
                        </p>
                        <p class="mobile-para1 pt-5" style="color: #264273; text-align: justify;">
                            With access to dedicated facilities, experienced faculty, and a vibrant academic environment,
                            doctoral scholars are encouraged to develop critical thinking, analytical abilities, and
                            original work contributions to the discipline. The program also integrates community engagement
                            and sustainable design practices, aligning academic inquiry with real-world challenges and
                            global fashion trends.
                        </p>
                        <p class="mobile-para1 pt-5" style="color: #264273; text-align: justify;">
                            Overall, the Ph.D. program aims to prepare researchers, academicians, and industry leaders who
                            can contribute meaningfully to the developing field of fashion design and technology.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="website">
        <div id="page" class="site site_wrapper">
            ...
            <div data-elementor-type="wp-page" data-elementor-id="704" class="elementor elementor-704">
                                        ...
                                        <div class="prthalign">
                                            <h2 class="headd1 fw-bold mt-3" style="color: #264273; font-weight: 500;">
                                                Ph.D. Programme <span style="color: #FF9A1E; font-weight: 500;">in
                                                    Fashion Design and Technology</span>
                                            </h2>
                                            <div class="para1 text-dark kd-para-1 disc" data-splitting
                                                ...
                                                <p class="mobile-para1 pt-2" style="color: #264273; text-align: justify;">
                                                    The Ph.D. program at the Royal School of Fashion Design and Technology,
                                                    under The Assam Royal
                                                    Global University, Betkuchi, Guwahati, is designed to nurture advanced
                                                    research and innovation
                                                    in the field of fashion and design. The program emphasizes a
                                                    research-intensive,
                                                    industry-oriented, and interdisciplinary & Multidisciplinary approach,
                                                    encouraging scholars to
                                                    explore contemporary issues such as sustainability, ethical practices,
                                                    material innovation,
                                                    traditional textiles and cultural studies within fashion.
                                                </p>
                ...
                <p class="mobile-para1" style="color: #264273; text-align: justify; padding-top: 20px; padding-left: 50px; padding-right: 50px;">
                    With access to dedicated facilities, experienced faculty, and a vibrant
                    academic environment, doctoral scholars are encouraged to develop
                    critical thinking, analytical abilities, and original work contributions
                    to the discipline. The program also integrates community engagement and
                    sustainable design practices, aligning academic inquiry with real-world
                    challenges and global fashion trends.
                </p>
                <p class="mobile-para1" style="color: #264273; text-align: justify; padding-top: 10px; padding-left: 50px; padding-right: 50px;">
                    Overall, the Ph.D. program aims to prepare researchers, academicians,
                    and industry leaders who can contribute meaningfully to the developing
                    field of fashion design and technology.
                </p>
            </div>
            <!--End About-->
