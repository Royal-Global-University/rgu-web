...
@section('content')
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-12">
                        ...
                        <p class="mobile-para1" style="color: #264273; text-align: justify; font-size: 18px;">
                            ...
                            Microbiology often pursue careers in academia, research institutions, pharmaceutical companies,
                            healthcare, and public health agencies, making significant contributions to science and human
                            welfare.
                        </p>
    ...
    <div class="container pt-3">
        <h3 class="fw-bold pb-2 text-dark text-capitalize headd3">A. Registration & Admission Fees</h3>
