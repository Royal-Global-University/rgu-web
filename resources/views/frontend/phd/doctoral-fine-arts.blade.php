                                ...
                                <div class="elementor-widget-container">
                                    <div class="prthalign">
                                        ...
                                        <div class="para1 text-dark kd-para-1 disc" data-splitting style="text-align: justify;">
                                            <p>
                                                A Ph.D. in Fine Arts is a terminal research-oriented degree that focuses on a
                                                wide range of artistic expressions of visual arts. The program equips with
                                                advanced skills in creating, evaluating, and analyzing contemporary art forms
                                                while cultivating their research and writing abilities. Scholar may choose to
                                                specialize in areas such as painting, sculpture, art history, art philosophy.
                                            </p>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row d-flex"> <!-- Add d-flex here -->
                <div class="col-lg-3 d-flex"> <!-- Add d-flex to columns -->
                    <div class="card mt-4 shadow-sm p-3 flex-fill"> <!-- Add flex-fill to cards -->
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-fine-arts/1.jpeg" alt="">
                ...
                <div class="col-lg-3 d-flex"> <!-- Add d-flex to columns -->
                    <div class="card mt-4 shadow-sm p-3 flex-fill"> <!-- Add flex-fill to cards -->
                        <img class="rounded shadow-sm border" src="assets/img/all-phd/doctoral-fine-arts/2.jpeg" alt="">
