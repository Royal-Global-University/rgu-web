...
@section('content')
    <div class="mobile">
        ...
        <section style="padding-top: 110px; background-image: url(https://bucket-0534zd.s3.ap-south-1.amazonaws.com/mobile-assets/placement-all/mobile-bg.svg); position: relative;">
            <div class="container">
    ...
    <div class="website">
        ...
        <div class="container">
        <h3 class="fw-bold pt-2 pb-2 text-dark text-capitalize headd3">A. Registration & Admission Fees</h3>
