                ...
                <div>
                    <div class="container">
                        ...
                        <div class="table-responsive">
                            <table class="overflow-hidden table text-wrap table-bordered border-top mb-3">
                                ...
                                <tbody class="para1 text-dark align-middle text-center">
                                    ...
                                    <tr>
                                        <td>6</td>
                                        <td><img src="mobile-assets/research/Research_Assets/preview-not-avl.png"></td>
                                        <td>Microwave Oven</td>
                                    </tr>
                                    <tr>
                                        <td>7</td>
                                        <td><img src="mobile-assets/research/Research_Assets/preview-not-avl.png"><br>Biosafety
                                            Level-II cabinet </td>
                                        <td>Klenzaids, India Ltd. </td>
                                    </tr>
                                    <tr>
                                        <td>8</td>
                                        <td><img src="mobile-assets/research/Research_Assets/preview-not-avl.png"><br>Digital pH
                                            meter </td>
                        ...
                        <div class="para1 text-dark" style="text-align: justify;">
                            <p>Dr. Debajit Borah, Associate Professor, Dept. of Biotechnology, RGU and Mr. Abhijit Sonowal, a
                                student of MSc Biotechnology 4th semester was jointly conferred with “Idea Exposition Award” on
                                “Innovations in Agriculture and Sustainability” with an exposure grant of Rs. 50,000/- (fifty
                                thousand only) by DBT-BIRAC Regional Innovation Centre (BRIC) in collaboration with Idea
                                Knowledge Park, Hyderabad and Guwahati Biotech Park, Guwahati during July 16-17, 2020.</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <table class="overflow-hidden table text-wrap table-bordered border-top mb-3">
                                ...
                                <tbody class="para1 text-dark align-middle text-center">
                                    ...
                                    <tr>
                                        <td>6</td>
                                        <td><img style="height: 200px;"
                                                src="mobile-assets/research/Research_Assets/preview-not-avl.png"></td>
                                        <td>Microwave Oven</td>
                                    </tr>
                                    <tr>
                                        <td>7</td>
                                        <td><img style="height: 200px;"
                                                src="mobile-assets/research/Research_Assets/preview-not-avl.png"><br>Biosafety
                                            Level-II cabinet </td>
                                        <td>Klenzaids, India Ltd. </td>
                                    </tr>
                                    <tr>
                                        <td>8</td>
                                        <td><img style="height: 200px;"
                                                src="mobile-assets/research/Research_Assets/preview-not-avl.png"><br>Digital pH
                                            meter </td>
                                        <td>BioEra, India Ltd. </td>
                                    </tr>
                                    <tr>
