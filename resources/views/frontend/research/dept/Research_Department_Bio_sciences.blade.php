                ...
                <div style="padding: 20px 30px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 mb-4">
                            ...
                            <a href="department-biotechnology.html">
                        ...
                        <div class="col-lg-4 mb-4">
                            ...
                            <a href="department-microbiology.html">
                                <div class="card rounded d-flex flex-column"
                                    style="background-color: #fff; border: none; box-shadow: -1px 3px 5px 0px rgba(0,0,0,0.25); height: 100%;">
                                    <div class="p-3 text-center">
                        ...
                        <div class="col-lg-4 mb-4">
                            ...
                            <a href="department-food-technology.html">
                                <div class="card rounded d-flex flex-column"
                                    style="background-color: #fff; border: none; box-shadow: -1px 3px 5px 0px rgba(0,0,0,0.25); height: 100%;">
                                    <div class="p-3 text-center">
                                ...
                                <div class="p-4 card rounded d-flex flex-column"
                                    ...
                                    <div class="card-body">
                                        <h5 style="font-weight: 700; color: #27467A;"
                                            class="text-center card-title headd2 pb-2">Department of Bio-Chemistry</h5>
