                ...
                <div style="padding: 20px 30px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 mb-4">
                            ...
                            <a href="Research_Department_Biotechnology.html">
                        ...
                        <div class="col-lg-4 mb-4">
                            ...
                            <a href="Research_Department_Microbiology.html">
                                <div class="card rounded d-flex flex-column"
                                    style="background-color: #fff; border: none; box-shadow: -1px 3px 5px 0px rgba(0,0,0,0.25); height: 100%;">
                                    <div class="p-3 text-center">
                        ...
                        <div class="col-lg-4 mb-4">
                            ...
                            <a href="Research_Department_Food_Technology.html">
                                <div class="card rounded d-flex flex-column"
                                    style="background-color: #fff; border: none; box-shadow: -1px 3px 5px 0px rgba(0,0,0,0.25); height: 100%;">
                                    <div class="p-3 text-center">
                        ...
                        <div class="col-lg-4 mb-4">
                            ...
                            <a href="Research_Department_Biochemistry.html">
                                <div class="card rounded d-flex flex-column"
                                    style="background-color: #fff; border: none; box-shadow: -1px 3px 5px 0px rgba(0,0,0,0.25); height: 100%;">
                                    <div class="p-3 text-center">
                                        <i style="color: #27467A;" class="fas fa-vial-circle-check fa-3x"></i>

                                    </div>
                                    <div class="card-body ">
                                        <h5 style="font-weight: 800; color: #27467A;"
                                            class="text-center card-title mobile-headd2 pb-2">Department of Bio-Chemistry</h5>
                                    </div>
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="col-lg-3 mb-4">
                        ...
                        <a href="Research_Department_Biochemistry.html">
                            <div class="p-4 card rounded d-flex flex-column"
                                ...
                                <div class="p-3 text-center">
                                    <i style="color: #27467A;" class="fas fa-vial-circle-check fa-4x"></i>

                                </div>
                                <div class="card-body">
                                    <h5 style="font-weight: 700; color: #27467A;" class="text-center card-title headd2 pb-2">
                                        Department of Bio-Chemistry</h5>
                    ...
                    <div class="col-lg-3 mb-4">
                        ...
                        <a href="Research_Department_Biotechnology.html">
                            <div class="p-4 card rounded d-flex flex-column"
                                ...
                                <div class="card-body">
                                    <h5 style="font-weight: 700; color: #27467A;" class="text-center card-title headd2 pb-2">
                                        Department of Bio-Technology</h5>
                    ...
                    <div class="col-lg-3 mb-4">
                        ...
                        <a href="Research_Department_Food_Technology.html">
                            <div class="p-4 card rounded d-flex flex-column"
                                ...
                                <div class="card-body">
                                    <h5 style="font-weight: 700; color: #27467A;" class="text-center card-title headd2 pb-2">
                                        Department of Food Technology</h5>
