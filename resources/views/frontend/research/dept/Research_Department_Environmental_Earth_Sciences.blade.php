    ...
    <div class="mobile">
        ...
        <section style="background-image: url('mobile-assets/royal-schools-assets/bg.svg');">
            <h2 class="mobile-headd2 fw-bold text-center kd-title-ani kd-split-text pt-4"
                ...
                Royal School of Environmental <span style="color: #FF9A1E; font-weight: 500;">and Earth Sciences (RSEES)</span>
            </h2>
                            ...
                            <div class="card rounded d-flex flex-column"
                                ...
                                <div class="card-body ">
                                    <h5 style="font-weight: 800; color: #27467A;"
                                        class="text-center card-title mobile-headd2 pb-2">Department of Geography</h5>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-lg-4 mb-4">
                        ...
                        <a href="Research_Department_Environmental_Sciences">
                            <div class="card rounded d-flex flex-column"
                                ...
                                <div class="card-body ">
                                    <h5 style="font-weight: 800; color: #27467A;"
                                        class="text-center card-title mobile-headd2 pb-2">Department of Environmental Sciences
                                    </h5>
                                </div>
                            </div>
                        </a>
                            ...
                            <div class="p-3 card rounded d-flex flex-column"
                                ...
                                <div class="card-body">
                                    <h5 style="font-weight: 700; color: #27467A;" class="text-center card-title headd3 pb-2">
                                        Department of Environmental Sciences</h5>
