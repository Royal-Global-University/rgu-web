...
<div id="page" class="site site_wrapper">
    ...
    <!--About Section-->
    <div>
        <img src="assets/img/international-faq/faq.svg" alt="">
    </div>


    <div>
        <img src="assets/img/international-faq/contact.svg" alt="">
    </div>
            ...
            <div class="accordion" id="accordionExample">
                ...
                <div class="accordion-item mt-2">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                        ...
                        <div class="accordion-body">
                            <p class="para1">No. In order to explore various options to study in India, he/she can apply for
                                provisional Student Visa of 6 months duration from Indian Mission abroad and if he/she gets
                                confirmed admission while in India, then he/she can apply for a Student Visa by visiting the
                                local FRRO/FRO along with all the necessary documents.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item mt-2">
                    ...
                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                        data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <p class="para1">The maximum duration of a student visa is 5 years or the duration of the course
                                whichever is earlier. Students may apply for extension by visiting the FRROs or the office
                ...
                <div class="accordion-item mt-2">
                    <h2 class="accordion-header" id="headingsix">
                        <button class="accordion-button collapsed headd3 " type="button" data-bs-toggle="collapse"
                            ...
                            Q. Does foreign students require the approval/ NOC from any Ministry or Department for technical
                            courses?
                        </button>
                    </h2>
                    <div id="collapsesix" class="accordion-collapse collapse" aria-labelledby="headingsix"
                        ...
                        <div class="accordion-body">
                            <p class="para1">Students do not require approval/NOC from MHRD for admission to
                                ...
                                However, NOC from the Ministry of Health is required for admission to courses in medical or
                                para-military courses.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item mt-2">
                    ...
                    <div id="collapseseven" class="accordion-collapse collapse" aria-labelledby="headingseven"
                        data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <p class="para1">Yes, he/ she must provide the concerned university/ institute permits as proof
                                to the local FRRO/ FRO.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="accordion-item mt-2">
                    ...
                    <div id="collapse8" class="accordion-collapse collapse" aria-labelledby="heading8"
                        data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <p class="para1">Students may apply for extension by visiting the local FRRO or the office of
                                Superintendent of Police with Bonafede certificate, proof of adequate financial standing
                                etc.
                            </p>
                        </div>
                    </div>
