...
@section('content')
    <div class="mobile bg-light">
        ...
        <section
            style="padding-top: 90px; position: relative; background-image: url(https://bucket-0534zd.s3.ap-south-1.amazonaws.com/mobile-assets/preface/bg3.png); background-size: cover;">
    ...
    <div class="website bg-light">
        ...
        <div class="pb-4">
            <h2 class="headd1 fw-bold text-center  pb-4 pt-2" style="color: #27467A; font-weight: 900;">
                Royal <span style="color: #FF9A1E; font-weight: 500;">Information Centers</span></h2>
