...
@section('content')
    ...
    >
      <div class="mobile">
        ...
        <div class="container">
          <h2
            class="headd1 fw-bold text-center"
            style="color: #27467a; font-weight: 900; font-size: 25px"
          >
            Courses
          ...
          >
            ...
            >
              <span style="font-size: 18px"
                >Master of Travel & Tourism Management (MTTM)</span
              >
              <span
                style="
                  position: absolute;
            ...
            <a
              target="_blank"
              href="programs-Master-Travel&Tourism"
          ...
          >
            ...
            >
              <span style="font-size: 18px; padding-right: 20px"
                >Bachelor of Travel & Tourism Management (BTTM)</span
              >
              |
              <span
                style="
                ...
                "
                >Honours / Honours with Research</span
              >
          ...
          >
            ...
            >
              <span style="font-size: 18px; padding-right: 20px"
                >B.Sc./ BA Travel & Tourism Management</span
              >
              |
              <span
                style="
        ...
        <div class="container">
          <div>
            <h2
              class="headd1 fw-bold text-center pt-4 pb-3"
              style="
                color: #27467a;
                font-weight: 900;
                font-size: 25px;
            ...
            <div>
              <div class="row">
                <div class="col-lg-12">
                  <div
                    class="accordion para1"
                    id="mobileAccordionCourses"
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <a
                              href="mobile-assets/department-all/rsttm/updated-syllabus/Course-structure-TTM.pdf Arts.pdf"
                              target="_blank"
                              style="color: #27467a"
                            >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <a
                              href="mobile-assets/department-all/rsttm/updated-syllabus/MTTM-Detailed-Syllabus.pdf"
                              target="_blank"
                              style="color: #27467a"
                            >
                              <i class="fa fa-file-text px-2"></i> Detailed
        ...
        <div class="container pb-4">
          <div class="row" style="display: flex; justify-content: center">
            <div class="col-lg-12">
              <h2
                class="headd1 fw-bold pt-4 pb-3"
              ...
              <div style="max-width: 100%; position: relative">
                    ...
                    >
                      ...
                      >
                        <tr style="border-bottom: 1px solid #ddd">
                          ...
                          >
                            <img
                              src="mobile-assets/department-all/imgg.jpg"
                              alt="Event Image"
                              style="
                                width: 120px;
                                height: 80px;
                ...
                <div style="text-align: center; margin-top: 15px">
                  <a
                    href="department-new-rshss-sociology-events"
                    style="
        ...
        <div id="bos-mobile" class="container pb-5">
          ...
          <div style="margin-bottom: 20px">
            ...
            >
              ...
              <span style="float: right; font-weight: 700; font-size: 20px"
                >＋</span
              >
            </button>
        ...
        <section>
          ...
          <section id="about">
            <section style="background-color: #fff8f0">
              <img
                src="mobile-assets/department-all/rsttm/web-top.png"
                alt=""
              />

              <img
                src="mobile-assets/department-all/rsttm/web-btm.png"
                alt=""
              />
            </section>
          </section>
          ...
          <section id="syllabus">
            <div class="container">
              <div>
                ...
                >
                  Courses Structure
                  <span style="color: #ff9a1e; font-weight: 600"
                    >and Syllabus</span
                  >
                </h2>
                          ...
                          >
                            <tr style="border-bottom: 1px solid #ddd">
                              ...
                              >
                                ...
                                <div>
                                  <div
                                    style="font-weight: bold; color: #27467a"
                                  >
                                    On 20th February, 2020, Prof. Shiela Bora,
                ...
                <div style="flex: 1 1 calc(50% - 8px); box-sizing: border-box">
                  ...
                  >
                    ...
                    >
                      <i class="fa fa-users me-2"></i> The Board of Studies
                      <span
                        style="float: right; font-weight: 700; font-size: 20px"
                        >＋</span
                      >
                    </button>
                    <div
