...
@section('content')
            ...
            <div class="dept-finearts-accordion-wrapper">
                ...
                <div class="dept-finearts-accordion-item active">
                    ...
                    <div class="dept-finearts-accordion-content">
                        <div class="dept-finearts-syllabus-list">
                            <a target="_blank"
                                href="/mobile-assets/department-all/rsfa/updated-syllabus/Course_structure_UG_RSFA.pdf"
                            ...
                            <a target="_blank" href="/mobile-assets/syllabus/RSFA/BFA%20-%20Detailed%20Syllabus.pdf"
                                class="dept-finearts-syllabus-link" download>
                                <div class="dept-finearts-syllabus-link-left">
                                    <i class="fa-solid fa-file-lines"></i>
                ...
                <div class="dept-finearts-accordion-item">
                    ...
                    <div class="dept-finearts-accordion-content">
                        <div class="dept-finearts-syllabus-list">
                            <a target="_blank"
                                href="/mobile-assets/department-all/rsfa/updated-syllabus/Course_structure_PG_RSFA.pdf"
                                class="dept-finearts-syllabus-link" download>
                                <div class="dept-finearts-syllabus-link-left">
                                    <i class="fa-solid fa-file-lines"></i>
                            ...
                            <a target="_blank" href="/mobile-assets/syllabus/RSFA/MFA%20-%20Detailed%20Syllabus.pdf"
                                class="dept-finearts-syllabus-link" download>
                                <div class="dept-finearts-syllabus-link-left">
                                    <i class="fa-solid fa-file-lines"></i>
                ...
                <div class="dept-finearts-accordion-item">
                    ...
                    <div class="dept-finearts-accordion-content">
                        <div class="dept-finearts-syllabus-list">
                            <a href="/phd" class="dept-finearts-syllabus-link" download>
                                <div class="dept-finearts-syllabus-link-left">
                                    <i class="fa-solid fa-file-lines"></i>
                                    Click to View
                                </div>
    ...
    <script>
        ...
        const coursesData = [{
                ...
                duration: "2 years",
                link: "/programs-Master-of-Fine-Arts-MFA"
            },
            {
                title: "Bachelor of Fine Arts (BFA)",
                duration: "4 Years",
                link: "/programs-Bachelor-of-Fine-Arts-BFA"
            }
        ];
