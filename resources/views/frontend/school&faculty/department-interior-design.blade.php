                ...
                <table class="table bg-white table-responsive table-striped table-bordered border-top  vertical-scroll">
                    ...
                    <tbody class="para1 bg-light">
                        <tr>
                            ...
                            <td>
                                <a target="_blank" href="programs-BachelorInterior-DesignBID"><button type="button"
                        ...
                        <tr>
                            ...
                            <td>
                                <a target="_blank" href="programs-Bachelor-of-Interior-Design-BID-Lateral-Entry"><button
