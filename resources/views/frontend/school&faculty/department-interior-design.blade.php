    ...
    <div style="background-image: url(mobile-assets/department-all/bg.svg); background-size: cover;">
        ...
        <div class="mobile">
            ...
            <section style="padding-top: 130px; position: relative;">
                <img src="mobile-assets/department-all/rsd/interior-design/mob-interiordesign.png" alt="">
            </section>
            <!-- till about dept  -->
            ...
            <div class="container">
                ...
                <div style="background-color:#FDF9F4; padding:10px; width:100%; margin: 0px auto;">
                    ...
                    <div
                        ...
                        <span style="font-size:18px; padding-right: 20px;">Bachelor of Interior Design (BID)</span> | <span
                    ...
                    <!-- Statute Items -->
                    <a target="_blank" href="programs-BachelorInterior-DesignBID" style="text-decoration:none;">
                        <div
                            ...
                            <span>
                                <a class="para1 fw-bold"
                                    ...
                                    href="programs-BachelorInterior-DesignBID">View Details</a>
                            </span>
                        </div>
                    </a>
                </div>
                ...
                <div style="background-color:#FDF9F4; padding:10px; width:100%; margin: 0px auto;">
                    ...
                    <div
                        ...
                        <span style="font-size:18px; padding-right: 20px;">Bachelor of Interior Design (BID) Lateral
                            Entry</span> | <span
                            style="font-size:16px; padding-left: 16px; font-weight: 300px !important;">Honours / Honours
                            with
                            Research</span>
                    ...
                    <!-- Statute Items -->
                    <a target="_blank" href="programs-Bachelor-of-Interior-Design-BID-Lateral-Entry"
                        ...
                        <div
                            ...
                            <span>
                                <a class="para1 fw-bold"
                                    style="padding: 5px 20px; border-radius: 5px; color: #fff; background: linear-gradient(135deg, hsla(33, 100%, 56%, 1) 0%, hsla(8, 52%, 50%, 1) 100%); font-size: 13px;"
                                    href="programs-Bachelor-of-Interior-Design-BID-Lateral-Entry">View Details</a>
                            </span>
                        </div>
                    </a>
                </div>
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body"
                                                ...
                                                <div class="row" style="display: flex; flex-direction: column; gap: 12px;">
                                                    ...
                                                    <a href="mobile-assets/department-all/rsd/interior-design/syllabus/Course-structure_Interior-Design.pdf"
                                                    ...
                                                    <a href="mobile-assets/department-all/rsd/interior-design/syllabus/B.I.D.-Interior-Design-Detailed-Syllabus.pdf"
                                                        target="_blank" style="color: #27467A;">
                                                        <i class="fa fa-file-text px-2"></i> Detailed Syllabus -- Interior
                                                        Design
                                                        <i class="fa fa-download ms-2" style="color: #FF9A1E;"></i>
                                                    </a>
            ...
            <section>
                ...
                <section id="about">
                    <section style="background-color: #FFF8F0;">
                        ...
                        <img src="mobile-assets/department-all/rsd/interior-design/web-interiordesign.png" alt="">
                    ...
                    <div class="container">
                        ...
                        <div style="background-color:#FDF9F4; padding:10px; width:100%; margin: 0px auto;">
                            ...
                            <div
                                ...
                                <span style="font-size:22px; padding-right: 20px;">Bachelor of Interior Design (BID)</span>
                        ...
                        <div style="background-color:#FDF9F4; padding:10px; width:100%; margin: 0px auto;">
                            ...
                            <div
                                ...
                                <span style="font-size:22px; padding-right: 20px;">Bachelor of Interior Design (BID) Lateral
                                    Entry</span> | <span
