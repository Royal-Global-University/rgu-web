...
@section('content')
    <div style="background-image: url(mobile-assets/dept-interior-design/s2-bg-img-1.webp);">
          <div class="mobile">
            @include('frontend/components/mobileheader')
            <img style="padding-top: 80px; position: relative;" class="pb-3" src="mobile-assets/dept-interior-design/mob-interiordesign.png" alt="">
      ...
      <div class="p-2">
        ...
        <div class="row">
          ...
          <div class="website">
            ...
            <img src="mobile-assets/dept-interior-design/web-interiordesign.png" alt="">
