...
@section('content')
    <div style="background-image: url(https://bucket-0534zd.s3.ap-south-1.amazonaws.com/mobile-assets/department-all/bg.svg); background-size: cover;">
        <div class="mobile" >
            ...
            <img style="padding-top: 80px; position: relative;" class="pb-3" src="https://bucket-0534zd.s3.ap-south-1.amazonaws.com/mobile-assets/department-all/dept-geology/mob-top.png" alt="">
            ...
            <img class="pb-3" src="https://bucket-0534zd.s3.ap-south-1.amazonaws.com/mobile-assets/department-all/dept-geology/mob-btm.png" alt="">
                                ...
                                <div class="accordion para1" id="accordionExample">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseThree" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <a href="doctoral-geology" class="para1" target="_blank">
                                                    <strong>
                                                        Click to View...
                                                    </strong>
                                                </a>
        ...
        <div class="website">
            ...
            <img class="pb-3" src="https://bucket-0534zd.s3.ap-south-1.amazonaws.com/mobile-assets/department-all/dept-geology/web-top.png" alt="">
            ...
            <img class="pb-3" src="https://bucket-0534zd.s3.ap-south-1.amazonaws.com/mobile-assets/department-all/dept-geology/web-btm.png" alt="">
            ...
            <div class="container pb-5">
                ...
                <div class="quick-links-container">
                    ...
                    <div class="quick-links-panel">
                        <a href="Research_Department_Geology" style="background-color: #FF9A1E;"
