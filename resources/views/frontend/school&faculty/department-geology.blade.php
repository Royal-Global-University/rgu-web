...
@section('content')
    <div style="background-image: url(mobile-assets/department-all/bg.svg); background-size: cover;">
        <div class="mobile" >
            ...
            <img style="padding-top: 80px; position: relative;" class="pb-3" src="mobile-assets/department-all/dept-geology/mob-top.png" alt="">
            ...
            <img class="pb-3" src="mobile-assets/department-all/dept-geology/mob-btm.png" alt="">
        ...
        <div class="website">
            ...
            <img class="pb-3" src="mobile-assets/department-all/dept-geology/web-top.png" alt="">
            ...
            <img class="pb-3" src="mobile-assets/department-all/dept-geology/web-btm.png" alt="">
