  ...
  <div class="dept-mls-wrapper">
    ...
    <div class="dept-mls-hero" id="dept-about">
      ...
      <div class="dept-mls-content">
        ...
        <p>
          The Department of Dialysis Therapy Technology is committed to developing highly skilled dialysis professionals
          equipped to provide safe, ethical, and patient-centred renal care. The department offers state-of-the-art
          education and hands-on clinical training in hemodialysis, peritoneal dialysis, continuous renal replacement
    ...
    <div class="dept-mls-prospects-section" id="dept-prospects">
      ...
      <div class="dept-mls-prospects-content">
        ...
        <p class="dept-mls-intro-text" style="text-align: justify;">
          With a curriculum aligned to the National Commission for Allied and Healthcare Professions (NCAHP) standards,
          students gain expertise in renal physiology, infection control, vascular access management, emergency care,
          ...
          multidisciplinary nephrology teams and improving the quality of life of patients with acute and chronic kidney
          disease.
          <br><br>
  ...
  const coursesData = [
    {
      ...
      duration: "2 Years",
      link: "https://www.rgu.ac/programme-m-dialysis-therapy"
    },

    {
      title: "Bachelor – Dialysis Therapy Technology",
      duration: "4 years",
      link: "https://www.rgu.ac/programme-b-dialysis-therapy"
    },
  ...
  const tableData = [
    {
      ...
      rows: [
        ["1", "Dr. Imliwati Longkumer", "Biochemist/Researcher, Northeast Cancer Hospital and Research Institute, Guwahati", "Invited talk", "08-11-2023"],

        ["2", "Dr. Areendam Barua", "Cancer Surgeon, Swagat SSI & NH", "Awareness talk", "05-02-2024"],

        ["3", "Dr. Sweta Bansali", "Obstetrician & Gynaecologist, Swagat SSI & NH", "Awareness talk", "05-02-2024"],

        ["4", "Prof. (Dr.) Ramesh C Deka", "Distinguished Professor & Adviser, RSMAS, RGU", "Invited talk", "08-05-2024"],

        ["5", "Dr. Surjana Chaliha Hazarika", "Associate Professor, Dept. of Microbiology, Gauhati Medical College & Hospital", "Invited talk", "10-05-2024"],

        ["6", "Dr. Monsoomi Mahanta", "Consultant Microbiologist, Ultracare Diagnostic, Guwahati", "Invited talk", "09-08-2024"],

        ["7", "Prof. (Dr.) Rajjyoti Das", "Department of Head and Neck Surgical Oncology, Dr. B. Borooah Cancer Institute, Guwahati", "Awareness talk", "04-02-2025"],

        ["8", "Dr. Sunita Shrotna", "MS, FRCS, Consultant Surgeon, Ashford and St. Peters Hospital, UK", "Awareness talk", "09-04-2025"],

        ["9", "Dr. D. Jayarajan", "Associate Professor, Dept. of MLT, The Assam Royal Global University", "Awareness talk", "23-04-2025"]
      ]
    },
    {
