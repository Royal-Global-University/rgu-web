                ...
                <div class="row" style="display: flex; align-items: center; justify-content: center;">
                  ...
                  <div class="col-lg-3 mb-4">
                    <div class="card rounded d-flex flex-column"
                      ...
                      <div class="card-body d-flex flex-column flex-grow-1">
                        <h5 style="font-weight: 600; color: #27467A;" class="card-title headd2 pb-2">Prof. Samip Baruah</h5>
                  ...
                  <div class="col-lg-3 mb-4">
                    <div class="card rounded d-flex flex-column"
                      ...
                      <div class="card-body d-flex flex-column flex-grow-1">
                        <h5 style="font-weight: 600; color: #27467A;" class="card-title headd2 pb-2">Dr. Priyanka Mahanta</h5>
                        <p class="para1" style="color: #27467A; line-height: 1.3;">Assistant Professor</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-3 mb-4">
                    <div class="card rounded d-flex flex-column"
                      ...
                      <div class="card-body d-flex flex-column flex-grow-1">
                        ...
                        <p class="para1" style="color: #27467A; line-height: 1.3;">Assistant Professor and Deputy Controller of
                          Examination</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-3 mb-4">
                    <div class="card rounded d-flex flex-column"
                      ...
                      <div class="card-body d-flex flex-column flex-grow-1">
                        <h5 style="font-weight: 600; color: #27467A;" class="card-title headd2 pb-2">Dr. Upasana Sharma</h5>
                        <p class="para1" style="color: #27467A; line-height: 1.3;">Assistant Professor</p>
                      </div>
                    </div>
                  </div>
