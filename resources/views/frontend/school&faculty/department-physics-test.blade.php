    ...
    <div style="background-image: url(mobile-assets/department-all/bg.svg); background-size: cover;">
        <div class="mobile">
            ...
            <img style="padding-top: 80px; position: relative;"
                src="https://media.rgu.ac/department-all/dept-physics/mob-top.png" alt="">
            ...
            <img src="https://media.rgu.ac/department-all/dept-physics/mob-btm.png" alt="">
                            ...
                            <div>
                                <table class="overflow-hidden table text-wrap table-bordered border-top mb-2">
                                    ...
                                    <tr>
                                        ...
                                        <td>Field visit to Center of Plasma Physics – Institute for Plasma Research
                                            (CPP-IPR) Guwahati
                                        </td>
                                    </tr>
                                    <tr>
        ...
        <div class="website">
            ...
            <!-- floating button  -->
            <img src="https://media.rgu.ac/department-all/dept-physics/web-top.png" alt="">
                        ...
                        <div class="col-lg-12">
                            <div class="accordion para1" id="accordionExample">
                                <div class="accordion-item pb-1">
                                    <h2 class="accordion-header" id="headingOne">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#collapse2018" aria-expanded="false" aria-controls="collapse2018"><strong>
                                                YEAR: 2018
                                            </strong>
                                        </button>
                                    </h2>
                                    <div id="collapse2018" class="accordion-collapse collapse" aria-labelledby="heading2018"
                                ...
                                <div class="accordion-item pb-1">
                                    <h2 class="accordion-header" id="headingTwo">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#collapse2019" aria-expanded="false" aria-controls="collapse2019">
                                            <strong>
                                                YEAR: 2019
                                            </strong>
                                        </button>
                                ...
                                <div class="accordion-item pb-1">
                                    <h2 class="accordion-header" id="headingThree">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#collapse2020" aria-expanded="false" aria-controls="collapse2020"><strong>
                                                YEAR: 2020
                                            </strong>
                                        </button>
                                    </h2>
                                ...
                                <div class="accordion-item pb-1">
                                    <h2 class="accordion-header" id="headingThree">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#collapse2021" aria-expanded="false" aria-controls="collapse2021"><strong>
                                                YEAR: 2021
                                            </strong>
                                        </button>
                                    </h2>
                                ...
                                <div class="accordion-item pb-1">
                                    <h2 class="accordion-header" id="headingThree">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#collapse2022" aria-expanded="false" aria-controls="collapse2022"><strong>
                                                YEAR: 2022
                                            </strong>
                                        </button>
                                    </h2>
                                ...
                                <div class="accordion-item pb-1">
                                    <h2 class="accordion-header" id="headingThree">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#collapse2023" aria-expanded="false" aria-controls="collapse2023"><strong>
                                                YEAR: 2023
                                            </strong>
                                        </button>
                                    </h2>
                                ...
                                <div class="accordion-item pb-1">
                                    <h2 class="accordion-header" id="headingThree">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#collapse2024" aria-expanded="false" aria-controls="collapse2024"><strong>
                                                YEAR: 2024
                                            </strong>
                                        </button>
                                    </h2>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingThree">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#collapse2025" aria-expanded="false" aria-controls="collapse2025"><strong>
                                                YEAR: 2025
                                            </strong>
                                        </button>
                                    </h2>
