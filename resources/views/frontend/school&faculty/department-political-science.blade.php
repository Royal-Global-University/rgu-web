    ...
    <div style="background-image: url(mobile-assets/department-all/bg.svg); background-size: cover;">
        ...
        <div class="mobile">
            ...
            <section style="background-color: #fff8f0; padding: 130px 10px 0px 10px;">
                ...
                <img src="mobile-assets/department-all/rshss/pol-sc/mob-politicalscience.png" alt="">
            ...
            <div class="container">
                ...
                <div style="background-color: transparent; padding:10px; width:100%; margin: 0px auto;">
                    ...
                    <div
                        ...
                        <span style="font-size: 16px; padding-right: 0px; line-height: 1.3;">BA Political Science</span> |
                                            ...
                                            <tr style="border-bottom: 1px solid #ddd;">
                                                <td style="display: flex; align-items: flex-start; padding: 12px;">
                                                    ...
                                                    <div style="color: #27467A; font-weight: bold;">
                                                        On 10th December 2018, <b>Dr. Shubhrajeet Konwar</b>, Associate
                                            ...
                                            <tr style="border-bottom: 1px solid #ddd;">
                                                <td style="display: flex; align-items: flex-start; padding: 12px;">
                                                    <img src="mobile-assets/department-all/imgg.jpg" alt="Guest Image"
                                                        style="width: 120px; height: 80px; object-fit: cover; border-radius: 12px; border: 1px solid #ccc; margin-right: 15px;">
                                                    <div style="color: #27467A; font-weight: bold;">
                                                        On 6th March 2019, <b>Dr. Nilima Bhagabati</b>, Former Professor and
                                                        Head, Department of
                                            ...
                                            <tr style="border-bottom: 1px solid #ddd;">
                                                <td style="display: flex; align-items: flex-start; padding: 12px;">
                                                    <img src="mobile-assets/department-all/imgg.jpg" alt="Guest Image"
                                                        style="width: 120px; height: 80px; object-fit: cover; border-radius: 12px; border: 1px solid #ccc; margin-right: 15px;">
                                                    <div style="color: #27467A; font-weight: bold;">
                                                        On 25th April 2019, <b>Mr. Sumanta Basu</b>, Senior Programme
                                                        Officer/Manager, United
                                                        States-India Educational Foundation (USIEF), American Centre,
                                                        delivered a session.
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr style="border-bottom: 1px solid #ddd;">
                                                <td style="display: flex; align-items: flex-start; padding: 12px;">
                                                    <img src="mobile-assets/department-all/imgg.jpg" alt="Guest Image"
                                                        style="width: 120px; height: 80px; object-fit: cover; border-radius: 12px; border: 1px solid #ccc; margin-right: 15px;">
                                                    <div style="color: #27467A; font-weight: bold;">
                                                        On 27th September 2019, <b>Dr. Kiran Keshavamurthy</b>, Assistant
                                                        Professor, Department of
                                            ...
                                            <tr style="border-bottom: 1px solid #ddd;">
                                                <td style="display: flex; align-items: flex-start; padding: 12px;">
                                                    <img src="mobile-assets/department-all/imgg.jpg" alt="Guest Image"
                                                        style="width: 120px; height: 80px; object-fit: cover; border-radius: 12px; border: 1px solid #ccc; margin-right: 15px;">
                                                    <div style="color: #27467A; font-weight: bold;">
                                                        On 2nd December 2019, <b>Prof. (Dr.) Nani Gopal Mahanta</b>,
                                                        Professor, Department of
                                                        Political Science and Director, Centre for South East Asian Studies,
                                            ...
                                            <tr style="border-bottom: 1px solid #ddd;">
                                                <td style="display: flex; align-items: flex-start; padding: 12px;">
                                                    <img src="mobile-assets/department-all/imgg.jpg" alt="Guest Image"
                                                        style="width: 120px; height: 80px; object-fit: cover; border-radius: 12px; border: 1px solid #ccc; margin-right: 15px;">
                                                    <div style="color: #27467A; font-weight: bold;">
                                                        On 5th March 2020, <b>Prof. (Dr.) Joydeep Baruah</b>, Professor,
                                                        Department of Economics,
                                                        Omeo Kumar Das Institute of Social Change and Development, visited
                                                        for an invited lecture.
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr style="border-bottom: 1px solid #ddd;">
                                                <td style="display: flex; align-items: flex-start; padding: 12px;">
                                                    <img src="mobile-assets/department-all/imgg.jpg" alt="Guest Image"
                                                        style="width: 120px; height: 80px; object-fit: cover; border-radius: 12px; border: 1px solid #ccc; margin-right: 15px;">
                                                    <div style="color: #27467A; font-weight: bold;">
                                                        On 6th March 2020, <b>Patricia Mukhim</b> (social activist, writer,
                                                        journalist, editor of
                                                        Shillong Times), <b>Mitra Phukan</b> (author, translator,
                                                        columnist), and <b>Teresa
                                                            Rehman</b> (journalist) shared their insights in a special
                                                        session.
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr style="border-bottom: 1px solid #ddd;">
                                                <td style="display: flex; align-items: flex-start; padding: 12px;">
                                                    <img src="mobile-assets/department-all/imgg.jpg" alt="Speaker Image"
                                                        style="width: 120px; height: 80px; object-fit: cover; border-radius: 12px; border: 1px solid #ccc; margin-right: 15px;">
                                                    <div style="color: #27467A; font-weight: bold;">
                                                        On 16th October 2023, Dr. Daisy Gogoi delivered a guest lecture on
                                            ...
                                            <tr style="border-bottom: 1px solid #ddd;">
                                                <td style="display: flex; align-items: flex-start; padding: 12px;">
                                                    <img src="mobile-assets/department-all/imgg.jpg" alt="Speaker Image"
                                                        style="width: 120px; height: 80px; object-fit: cover; border-radius: 12px; border: 1px solid #ccc; margin-right: 15px;">
                                                    <div style="color: #27467A; font-weight: bold;">
                                                        On 1st April 2024, Mr. Rickystar Syiemlieh conducted a webinar on
                                                        "Laparoscopic
                                                        Instrumentation".
                                                    </div>
                                                </td>
                                            ...
                                            <tr style="border-bottom: 1px solid #ddd;">
                                                <td style="display: flex; align-items: flex-start; padding: 12px;">
                                                    <img src="mobile-assets/department-all/imgg.jpg" alt="Speaker Image"
                                                        style="width: 120px; height: 80px; object-fit: cover; border-radius: 12px; border: 1px solid #ccc; margin-right: 15px;">
                                                    <div style="color: #27467A; font-weight: bold;">
                                                        On 9th August 2024, Mr. Chinmoy Thakuria delivered a guest lecture
                                                        during the "Student
                                                        Induction Programme".
                                                    </div>
                                                </td>
                                            ...
                                            <tr style="border-bottom: 1px solid #ddd;">
                                                <td style="display: flex; align-items: flex-start; padding: 12px;">
                                                    <img src="mobile-assets/department-all/imgg.jpg" alt="Speaker Image"
                                                        style="width: 120px; height: 80px; object-fit: cover; border-radius: 12px; border: 1px solid #ccc; margin-right: 15px;">
                                                    <div style="color: #27467A; font-weight: bold;">
                                                        On 18th September 2024, Ms. Sarita Chettri delivered a guest lecture
                                                        for students.
                                                    </div>
                                                </td>
                                            </tr>
          ...
          color:white; font-weight:600; font-size:16px; cursor:pointer; border-radius:12px;">
                        <i class="fa fa-flask me-2"></i> Board of Studies
          ...
          color:white; font-weight:600; font-size:15px; cursor:pointer; border-radius:12px;">
                        <i class="fa fa-magnifying-glass me-2"></i> Departmental Research Committee (DRC)
                        <span style="float:right; font-weight:700; font-size:20px;">＋</span>
                    </button>
            ...
            <section>
                ...
                <section id="about">
                    <section style="background-color: #FFF8F0;">
                        <img src="mobile-assets/department-all/rshss/pol-sc/web-politicalscience.png" alt="">
                    </section>
                </section>
                    ...
                    <div class="container">
                        ...
                        <div style="background-color: transparent; padding:10px; width:100%; margin: 0px auto;">
                            ...
                            <a target="_blank" href="programs-MA-Political-Science" style="text-decoration:none;">
                                <div
                                    ...
                                    <span style="flex-grow:1; color:#27467A; font-weight:bold; font-size: 18px;">2
                                        years</span>
                                    <span>
                                        <a class="para1 fw-bold"
                                            style="padding: 5px 15px; border-radius: 5px; color: #fff; background: linear-gradient(135deg, hsla(33, 100%, 56%, 1) 0%, hsla(8, 52%, 50%, 1) 100%); font-size: 13px;"
                        ...
                        <div style="background-color: transparent; padding:10px; width:100%; margin: 0px auto;">
                            ...
                            <div
                                ...
                                <span style="font-size: 16px; padding-right: 0px; line-height: 1.3;">BA Political
                                    Science</span> |
                                <span
                                    style="font-size: 13px; padding-left: 16px; font-weight: 300px !important; line-height: 1.3;">
                                    Honours/ Honours with Research
                                </span>
                            ...
                            <a target="_blank" href="programs-BA-Political-Science" style="text-decoration:none;">
                                <div
                                    ...
                                    <span style="flex-grow:1; color:#27467A; font-weight:bold; font-size: 18px;">4
                                        years</span>
                                    <span>
                                        <a class="para1 fw-bold"
                                            style="padding: 5px 15px; border-radius: 5px; color: #fff; background: linear-gradient(135deg, hsla(33, 100%, 56%, 1) 0%, hsla(8, 52%, 50%, 1) 100%); font-size: 13px;"
                                                    ...
                                                    <tr style="border-bottom: 1px solid #ddd;">
                                                        <td style="display: flex; align-items: flex-start; padding: 12px;">
                                                            <img src="mobile-assets/department-all/imgg.jpg"
                                                                ...
                                                                style="width: 120px; height: 80px; object-fit: cover; border-radius: 12px; border: 1px solid #ccc; margin-right: 15px;">
                                                            <div style="color: #27467A; font-weight: bold;">
                                                                On 10th December 2018, <b>Dr. Shubhrajeet Konwar</b>,
                                                                Associate Professor, Department of
                                                                Political Science, Gauhati University, visited the
                                                                institution.
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr style="border-bottom: 1px solid #ddd;">
                                                        <td style="display: flex; align-items: flex-start; padding: 12px;">
                                                            <img src="mobile-assets/department-all/imgg.jpg"
                                                                ...
                                                                style="width: 120px; height: 80px; object-fit: cover; border-radius: 12px; border: 1px solid #ccc; margin-right: 15px;">
                                                            <div style="color: #27467A; font-weight: bold;">
                                                                On 6th March 2019, <b>Dr. Nilima Bhagabati</b>, Former
                                                    ...
                                                    <tr style="border-bottom: 1px solid #ddd;">
                                                        <td style="display: flex; align-items: flex-start; padding: 12px;">
                                                            <img src="mobile-assets/department-all/imgg.jpg"
                                                                ...
                                                                style="width: 120px; height: 80px; object-fit: cover; border-radius: 12px; border: 1px solid #ccc; margin-right: 15px;">
                                                            <div style="color: #27467A; font-weight: bold;">
                                                                On 25th April 2019, <b>Mr. Sumanta Basu</b>, Senior
                                                                Programme Officer/Manager, United
                                                                States-India Educational Foundation (USIEF), American
                                                                Centre, delivered a session.
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr style="border-bottom: 1px solid #ddd;">
                                                        <td style="display: flex; align-items: flex-start; padding: 12px;">
                                                            <img src="mobile-assets/department-all/imgg.jpg"
                                                                ...
                                                                style="width: 120px; height: 80px; object-fit: cover; border-radius: 12px; border: 1px solid #ccc; margin-right: 15px;">
                                                            <div style="color: #27467A; font-weight: bold;">
                                                                On 27th September 2019, <b>Dr. Kiran Keshavamurthy</b>,
                                                                Assistant Professor, Department of
                                                                Humanities and Social Sciences, IIT Guwahati, visited the
                                                                campus.
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr style="border-bottom: 1px solid #ddd;">
                                                        <td style="display: flex; align-items: flex-start; padding: 12px;">
                                                            ...
                                                            <div style="color: #27467A; font-weight: bold;">
                                                                On 2nd December 2019, <b>Prof. (Dr.) Nani Gopal Mahanta</b>,
                                                                Professor, Department of
                                                                Political Science and Director, Centre for South East Asian
                                                                Studies, Gauhati University, was
                                                                the guest of honor.
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr style="border-bottom: 1px solid #ddd;">
                                                        <td style="display: flex; align-items: flex-start; padding: 12px;">
                                                            <img src="mobile-assets/department-all/imgg.jpg"
                                                                ...
                                                                style="width: 120px; height: 80px; object-fit: cover; border-radius: 12px; border: 1px solid #ccc; margin-right: 15px;">
                                                            <div style="color: #27467A; font-weight: bold;">
                                                                On 5th March 2020, <b>Prof. (Dr.) Joydeep Baruah</b>,
                                                                Professor, Department of Economics,
                                                                Omeo Kumar Das Institute of Social Change and Development,
                                                                visited for an invited lecture.
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr style="border-bottom: 1px solid #ddd;">
                                                        <td style="display: flex; align-items: flex-start; padding: 12px;">
                                                            <img src="mobile-assets/department-all/imgg.jpg"
                                                                ...
                                                                style="width: 120px; height: 80px; object-fit: cover; border-radius: 12px; border: 1px solid #ccc; margin-right: 15px;">
                                                            <div style="color: #27467A; font-weight: bold;">
                                                                On 6th March 2020, <b>Patricia Mukhim</b> (social activist,
                                                                writer, journalist, editor of
                                                                Shillong Times), <b>Mitra Phukan</b> (author, translator,
                                                                columnist), and <b>Teresa
                                                                    Rehman</b> (journalist) shared their insights in a
                                                                special session.
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr style="border-bottom: 1px solid #ddd;">
                                                        <td style="display: flex; align-items: flex-start; padding: 12px;">
                                                            <img src="mobile-assets/department-all/imgg.jpg"
                                                                ...
                                                                style="width: 120px; height: 80px; object-fit: cover; border-radius: 12px; border: 1px solid #ccc; margin-right: 15px;">
                                                            <div style="color: #27467A; font-weight: bold;">
                                                                On 16th October 2023, Dr. Daisy Gogoi delivered a guest
                                                                lecture on "World Anaesthesia Day".
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr style="border-bottom: 1px solid #ddd;">
                                                        <td style="display: flex; align-items: flex-start; padding: 12px;">
                                                            <img src="mobile-assets/department-all/imgg.jpg"
                                                                ...
                                                                style="width: 120px; height: 80px; object-fit: cover; border-radius: 12px; border: 1px solid #ccc; margin-right: 15px;">
                                                            <div style="color: #27467A; font-weight: bold;">
                                                                On 1st April 2024, Mr. Rickystar Syiemlieh conducted a
                                                                webinar on "Laparoscopic
                                                                Instrumentation".
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr style="border-bottom: 1px solid #ddd;">
                                                        <td style="display: flex; align-items: flex-start; padding: 12px;">
                                                            <img src="mobile-assets/department-all/imgg.jpg"
                                                                ...
                                                                style="width: 120px; height: 80px; object-fit: cover; border-radius: 12px; border: 1px solid #ccc; margin-right: 15px;">
                                                            <div style="color: #27467A; font-weight: bold;">
                                                                On 9th August 2024, Mr. Chinmoy Thakuria delivered a guest
                                                                lecture during the "Student
                                                                Induction Programme".
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr style="border-bottom: 1px solid #ddd;">
                                                        <td style="display: flex; align-items: flex-start; padding: 12px;">
                                                            <img src="mobile-assets/department-all/imgg.jpg"
                                                                ...
                                                                style="width: 120px; height: 80px; object-fit: cover; border-radius: 12px; border: 1px solid #ccc; margin-right: 15px;">
                                                            <div style="color: #27467A; font-weight: bold;">
                                                                On 18th September 2024, Ms. Sarita Chettri delivered a guest
