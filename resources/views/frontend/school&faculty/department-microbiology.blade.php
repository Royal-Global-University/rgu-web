                                ...
                                <div class="accordion-body">
                                    <div class="row">
                                        <a href="mobile-assets/department-all/dept-microbio/updated-syllabus/course-structure-bsc-microbiology.pdf"
                                            target="_blank">
                                            <i class="fa fa-file-text px-2"></i> Structure of Syllabus - B.Sc. Microbology
                                            <i class="fa fa-download"></i>
                                        </a>

                                        <a href="mobile-assets/department-all/dept-microbio/updated-syllabus/detailed-syllabus-bsc-microbiology.pdf"
                                            target="_blank">
                                            <i class="fa fa-file-text px-2"></i> Detailed Syllabus - B.Sc. Microbology
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                ...
                                <div class="accordion-body">
                                    <a href="mobile-assets/department-all/dept-microbio/updated-syllabus/detailed-syllabus-msc-microbiology.pdf"
                                        target="_blank">
                                        <i class="fa fa-file-text px-2"></i> Detailed Syllabus - M.Sc. Microbology
                                        <i class="fa fa-download"></i>
                                    </a>
