...
@section('content')
       <div style="background-image: url(mobile-assets/dept-microbio/s2-bg-img-1.webp);">
          <div class="mobile" >
            @include('frontend/components/mobileheader')
            <img style="padding-top: 80px; position: relative;" src="mobile-assets/dept-microbio/mobile-microbio.png" alt="">
                      ...
                      <div class="accordion para1" id="accordionExample">
                        <div class="accordion-item">
                          ...
                          >
                            <div class="accordion-body">
                              <div class="row">
                                <a
                                  href="assets/Departmentalpdf/AY 2023-24 Bsc Microbiology.pdf"
                                  target="_blank"
                                >
                                  <i class="fa fa-file-text px-2"></i>AY 2023-24 Bsc
                                  Microbiology.pdf
                                  <i class="fa fa-download"></i>
                                </a>

                                <a
                                  href="assets/Departmentalpdf/AY 2022-23 Bsc Microbiology.pdf"
                                  target="_blank"
                                >
                        ...
                        <div class="accordion-item">
                          ...
                          >
                            <div class="accordion-body">
                              <a
                                href="assets/Departmentalpdf/AY 2022-23 MSC Microbiology.pdf"
                                target="_blank"
                              >
                                <i class="fa fa-file-text px-2"></i>AY 2022-23 MSC
                                Microbiology.pdf <i class="fa fa-download"></i>
                              </a>
                            </div>
                          </div>
                        </div>
        ...
        <img src="mobile-assets/dept-microbio/web-microbiology.png" alt="">
    <!--About Section-->
