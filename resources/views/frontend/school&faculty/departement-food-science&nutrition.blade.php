...
@section('content')
    ...
    <div class="dept-food-sc-floating">
        ...
        <a href="#dept-achievement" class="dept-food-sc-float-item">
            ...
            <span class="dept-food-sc-float-text">Achievement</span>
        </a>
    ...
    <div class="dept-food-sc-wrapper">
        ...
        <div class="dept-food-sc-events-section" id="dept-events">

            <h2 class="dept-food-sc-section-title">Expert Lecture Details</h2>

            <div class="dept-food-sc-events-box">
                <div class="dept-food-sc-events-track" id="events-track"></div>
            </div>
        ...
        <!-- ================= ACHIEVEMENT SECTION ================= -->
        <div class="dept-food-sc-achievement-section" id="dept-achievement">

            <h2 class="dept-food-sc-section-title">
                Achievements
            </h2>

            <!-- Tabs -->
            <div class="dept-food-sc-achievement-tabs">
            ...
            <!-- Content -->
            <div class="dept-food-sc-achievement-content">
                        ...
                        <table class="dept-food-sc-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>1</td>
                                    <td>Placement</td>
                                    <td>Swapnanil Bhattacharjee</td>
                                    <td>2020-23</td>
                                    <td>Food Technologist</td>
                                    <td>Bionest, IASST, Guwahati</td>
                                    <td>-</td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td>Placement</td>
                                    <td>Lanchangba Panmei</td>
                                    <td>2021-24</td>
                                    <td>Quality Assurance Officer</td>
                                    <td>Anmol Industries Ltd., Guwahati</td>
                                    <td>-</td>
                                </tr>
                                <tr>
                                    <td>3</td>
                                    <td>Placement</td>
                                    <td>Violeena Sharma</td>
                                    <td>2021-24</td>
                                    <td>Quality and Production Executive</td>
                                    <td>Repose Foods Private Ltd.</td>
                                    <td>-</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>Swapnanil Bhattacharjee</td>
                                    <td>UG 2020-23</td>
                                    <td>CUET (National Level)</td>
                                    <td>Allahabad University Selection</td>
                                    <td>-</td>
                                </tr>
                                <tr>
                                    <td>5</td>
                                    <td>Competitive Exam</td>
                                    <td>Balname Sangma</td>
                                    <td>PG 2023-2025</td>
                                    <td>ICAR PG Exam (National Level)</td>
                                    <td>-</td>
                                    <td>-</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>UG 2022-25</td>
                                    <td>CUET (National Level)</td>
                                    <td>Pondicherry University Selection</td>
                                    <td>-</td>
                                </tr>
                                <tr>
                                    <td>8</td>
                                ...
                                <tr>
                                    ...
                                    <td>Joey Jedon R. Moroh</td>
                                    <td>UG 2021-24</td>
                                    <td>Musical Competition ‘ROCK-O-PHONIX’ (Alcheringa 2024)</td>
                                    <td>IIT Guwahati</td>
                                    <td>2nd Runner Up (Vocalist)</td>
                                </tr>
                                <tr>
                                    <td>10</td>
                                    <td>Sports & Cultural</td>
                                    <td>Nathaniel S.H. Tariang</td>
                                    <td>UG 2021-24</td>
                                    <td>All India Inter University Baseball Tournament 2024</td>
                                    <td>Royal Global University</td>
                                    <td>Selection (Player)</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="dept-food-sc-table-responsive">
                        <table class="dept-food-sc-table">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td>Food Science and Nutrition (Food Technology) / RSMAS</td>
                                    <td>Dr. Jon Jyoti Kalita</td>
                                    <td>Young Scientist Award</td>
                                    <td>Research</td>
                                    <td>Koshambi Foundation, India</td>
                                    <td>29 Dec 2024</td>
                                    <td>2nd International Conference on Multidisciplinary Research and Practices
                                        (ICMRP-2024)</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>Research</td>
                                    <td>The Assam Kaziranga University</td>
                                    <td>10–11 Feb 2026</td>
                                    <td>International Conference on ICBSSS – Celebrating Women and Girls in Science</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>Food Science and Nutrition (Food Technology) / RSMAS</td>
                                    <td>Dr. Pankaj Jha</td>
                                    <td>Best Paper Award (Invited Faculty/Scientist)</td>
                                    <td>Research</td>
                                    <td>JVMGRR College, Haryana, India</td>
                                    <td>6–8 Apr 2026</td>
                                    <td>4th International Conference on Recent Trends in Materials Science and Devices</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
        ...
        <div class="dept-food-sc-table-section" id="dept-committee">

            <h2 class="dept-food-sc-section-title">Committee</h2>

            <div class="dept-food-sc-table-grid" id="table-accordion-container"></div>
    ...
    <script>
        // ================= EVENTS DATA =================
        const eventsData = [
            "The Department of Food Technology organized a special expert lecture by Dr. G. Bhanuprakash Reddy, Scientist G & Head, Biochemistry Division, ICMR – National Institute of Nutrition, Hyderabad. The lecture was delivered on the topic “Nutraceuticals/Functional Foods in Health and Diseases” on 22nd May 2025 at 10:30 AM",
            "Dr. Deepjyoti Bhuyan, Senior Research Fellow and International Engagement Coordinator at the National Institute of Complementary Medicine – Health Research Institute (NICM-HRI), Western Sydney University, Australia, delivered a lecture on the topic “How Gut Microbiome Research Can Shape the Future of Food and Health Science” on 28th January 2025 at 3:00 PM.",
        ];
    ...
    <script>
        const tableData = [{
                ...
                rows: [
                    ["1", "Convener (Ex-Officio)", "Prof. (Dr.) Abhijit Dutta, Dean, RSMAS"],

                    ["2", "Member (Ex-Officio) - All Faculty Members", "Prof. (Dr.) Pranati Das, Professor"],
                    ["", "", "Dr. Pankaj Jha, Coordinator & Assistant Professor"],
                    ["", "", "Dr. Shagufta Rizwana, Assistant Professor"],
                    ["", "", "Dr. Jon Jyoti Kalita, Assistant Professor"],
                    ["", "", "Dr. Robbarts Nongmaithem, Assistant Professor"],
                    ["", "", "Mrs. Dipanjali Das, Assistant Professor, ARGU"],

                    ["3", "External Expert (Academic)",
                        "Prof. (Dr.) Ananta Saikia, Professor and Coordinator of Food Science and Technology, AAU, Jorhat"
                    ],
                    ["4", "External Expert (Industry)",
                        "Mr. Trailukya Dutta, Founder and CEO, Tholua Pratisthan Private Limited"
                    ]
                ]
            },
            {
                ...
                rows: [
                    ["1", "Chairperson", "Prof. (Dr.) Abhijit Dutta, Dean & Professor, RSMAS"],

                    ["2", "Member", "Prof. (Dr.) Pranati Das, Professor"],

                    ["3", "Member Secretary", "Dr. Priyanka Bhattacharya, Assistant Professor"],

                    ["4", "Member", "Dr. Pankaj Jha, Coordinator & Assistant Professor"],

                    ["5", "Member", "Dr. Robbarrts Nongmaithem, Assistant Professor"],

                    ["6", "External Member",
                        "Prof. (Dr.) Mamoni Das, Dean & Faculty of Community Science, Food and Nutrition, AAU, Jorhat"
                    ]
                ]
            }
