                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-12">
                            ...
                            <p class="mobile-para1 pt-2" style="color: #264273; text-align: justify; line-height: 1.5;">
                                The Royal School of Business (RSB) since its inception in 2009 has been a trend setter in
                                management
                                education in the North-East and stands tall for its complete bouquet of programmes at the
                                Graduate,
                                Post-graduate and Doctoral levels. The school follows an interdisciplinary approach and draw
                                resources
                                from multiple disciplines. To meet the emerging demand for new generation courses, Royal
                                School of
                                Business will be offering specialization in Business Analytics and Entrepreneurship and
                                Small Business
                                Management. Royal School of Business has a distinguished tradition of preparing business
                                leaders,
                ...
                <div style="background-color: #fff;">
                    <div class="container p-4">
                        <p class="mobile-para1 pt-2" style="color: #264273; text-align: justify; line-height: 1.5;">
                            ...
                            excellent
                            faculty who have studied and taught at some of the best universities and institutes in India and
                            abroad.
                            They bring their vast industry, academic and research experience into the classroom and create a
                            unique
                            and stimulating learning environment for the learners. The management programme of RSB was
                            ranked 37th in
                            India (Business India survey 2017) and the school was adjudged as the 2nd most promising
                            business school
                            (GHRDC B School Survey 2019) and one among the best in overall ranking (Business Today, 2019).
                            Royal
                            School of Business through its placement and training cell provides the necessary resources,
                            knowledge and
                            support to create effective employment and entrepreneurship opportunities for students. A few of
                            the top
                            recruiters of our students are ---Amul, IDBI, Infosys, Asian Paints, Berger Paints, Flipkart,
                            Wipro,
                            Cognizant, TCS, Capgemini, Aditya Birla, Marico etc. The students are recruited by Indian Oil
                            Corporation
                            Limited, SBI, IIBM, Topcem, Adani Group, Hilton Group of Hotels, Star cement, Airport Authority
                            of India
                            etc for internship.
            ...
            <div class="container">
                ...
                <div style="background-color:#FDF9F4; padding:10px; width:100%; margin: 0px auto;">
                    ...
                    <div
                        ...
                        <span style="font-size:18px; padding-right: 20px;">
                            MBA (Finance, Marketing, HRM, Operations Management, Entrepreneurship & Small Business
                            Management,
                            Business
                            Analytics)
                        </span>
                ...
                <div style="background-color:#FDF9F4; padding:10px; width:100%; margin: 0px auto;">
                    ...
                    <div
                        ...
                        <span style="font-size:18px; padding-right: 20px;">Executive MBA</span>
                    ...
                    <a style="text-decoration:none;">
                        <div
                            ...
                            <span style="flex-grow:1; color:#27467A; font-weight:bold; font-size: 16px;"> 2 years as per
                                NEP</span>
                            <span>
                                                ...
                                                <td style="display: flex; align-items: center; padding: 12px;">
                                                    ...
                                                    <div>
                                                        <div style="font-weight: bold; color: #27467A;">
                                                            ...
                                                            Training Session on Resume Making by JC Kushal Bharat Bagadia,
                                                ...
                                                <td style="display: flex; align-items: center; padding: 12px;">
                                                    ...
                                                    <div>
                                                        <div style="font-weight: bold; color: #27467A;">
                                                            ...
                                                            Workshop on Basics to Excel by CA Ankit Jallan, Founder &
                                                            Trainer "Excel with Excel"
                                                        </div>
                                                        <a href="#"
                                                            style="color: #FF9A1E; font-weight: bold; font-size: 14px;">Read
                                                            More
                                                ...
                                                <td style="display: flex; align-items: center; padding: 12px;">
                                                    ...
                                                    <div>
                                                        <div style="font-weight: bold; color: #27467A;">
                                                            ...
                                                            Aptitude Skills Training by Mr. Soumen Das, Director T.I.M.E
                                                            Guwahati & Shillong
                                                        </div>
                                                        <a href="#"
                                                            style="color: #FF9A1E; font-weight: bold; font-size: 14px;">Read
                                                ...
                                                <td style="display: flex; align-items: center; padding: 12px;">
                                                    ...
                                                    <div>
                                                        <div style="font-weight: bold; color: #27467A;">
                                                            ...
                                                            Professional Communication Skills by JC Kushal Bharat Bagadia,
                                                            Zone Trainer JCI India
                                                        </div>
                                                        <a href="#"
                                                            style="color: #FF9A1E; font-weight: bold; font-size: 14px;">Read
                                                ...
                                                <td style="display: flex; align-items: center; padding: 12px;">
                                                    ...
                                                    <div>
                                                        <div style="font-weight: bold; color: #27467A;">
                                                            ...
                                                            Mock Interview by Mr. Polash Pratim Baruah, Senior HR, Bandhan
                                                            Bank
                                                        </div>
                                                        <a href="#"
                                                            style="color: #FF9A1E; font-weight: bold; font-size: 14px;">Read
                    ...
                    <section style="background-color: #FFF8F0;">
                            ...
                            <div class="row align-items-center gx-5">
                                    ...
                                    <div class="kd-about-3-img-wrap txaa-slide-down-1">
                                        <div>
                                            <img class="rounded w-60" decoding="async"
                                                src="mobile-assets/department-all/dept-business/head-img.png"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <p class="mobile-para1 pt-3"
                                        ...
                                        The Royal School of Business (RSB) since its inception in 2009 has been a trend
                                        setter in management
                                        education in the North-East and stands tall for its complete bouquet of programmes
                                        at the Graduate,
                                        Post-graduate and Doctoral levels. The school follows an interdisciplinary approach
                                        and draw
                                        resources from multiple disciplines. To meet the emerging demand for new generation
                                        courses, Royal
                                        School of Business will be offering specialization in Business Analytics and
                                        Entrepreneurship and
                                        Small Business Management. Royal School of Business has a distinguished tradition of
                                        preparing
                        ...
                        <div style="background-color: #fff;">
                            <div class="p-5">
                                ...
                                <img class="w-100"
                                    src="mobile-assets/department-all/dept-business/vision-mission-web.png"
                                    alt="">
                            </div>
                        </div>

                        <div class="p-4">
                            <img class="w-100" src="mobile-assets/department-all/dept-business/web-btm.png"
                                alt="">
                        </div>
                    ...
                    <div class="container">
                        ...
                        <div style="background-color:#FDF9F4; padding:10px; width:100%; margin: 0px auto;">
                            ...
                            <div
                                ...
                                <span style="font-size:22px; padding-right: 20px;">Executive MBA</span>
                                                    ...
                                                    <tr style="border-bottom: 1px solid #ddd;">
                                                        <td style="display: flex; align-items: center; padding: 12px;">
                                                            ...
                                                            <div>
                                                                <div style="font-weight: bold; color: #27467A;">
                                                                    04-12-2023 | BBA Batch 2021-2024 (5th Semester)
                                                                    Training Session on Resume Making by JC Kushal Bharat
                                                                    Bagadia, Zone Trainer JCI India
                                                                </div>
                                                                <a href="#"
                                                                    style="color: #FF9A1E; font-weight: bold; font-size: 14px;">Read
                                                                    More
                                                    ...
                                                    <tr style="border-bottom: 1px solid #ddd;">
                                                        <td style="display: flex; align-items: center; padding: 12px;">
                                                            ...
                                                            <div>
                                                                <div style="font-weight: bold; color: #27467A;">
                                                                    23-09-2023 | MBA Batch 2022-2024 (3rd Semester)
                                                                    Aptitude Skills Training by Mr. Soumen Das, Director
                                                                    T.I.M.E Guwahati & Shillong
                                                                </div>
                                                                <a href="#"
                                                                    style="color: #FF9A1E; font-weight: bold; font-size: 14px;">Read
                                                                    More
                                                    ...
                                                    <tr style="border-bottom: 1px solid #ddd;">
                                                        <td style="display: flex; align-items: center; padding: 12px;">
                                                            ...
                                                            <div>
                                                                <div style="font-weight: bold; color: #27467A;">
                                                                    19-10-2023 | MBA Batch 2022-2024 (3rd Semester)
                                                                    Professional Communication Skills by JC Kushal Bharat
                                                                    Bagadia, Zone Trainer JCI India
                                                                </div>
                                                                <a href="#"
                                                                    style="color: #FF9A1E; font-weight: bold; font-size: 14px;">Read
                                                    ...
                                                    <tr style="border-bottom: 1px solid #ddd;">
                                                        <td style="display: flex; align-items: center; padding: 12px;">
                                                            ...
                                                            <div>
                                                                <div style="font-weight: bold; color: #27467A;">
                                                                    01-12-2023 | BBA Batch 2021-2024 & MBA Batch 2022-2024
                                                                    Mock Interview by Mr. Polash Pratim Baruah, Senior HR,
                                                                    Bandhan Bank
                                                                </div>
                                                                <a href="#"
                                                                    style="color: #FF9A1E; font-weight: bold; font-size: 14px;">Read
                                            ...
                                            <table class="overflow-hidden table text-wrap table-bordered border-top mb-5">
                                                ...
                                                <tbody class="para1 align-middle"
                                                    ...
                                                    <tr>
                                                        <td>6</td>
                                                        <td>Registrar, Member Secretary (Ex-officio)</td>
                                                        <td>Prof. (Dr.) Diganta Munshi, Registrar (Administration)</td>
                                                    </tr>
                                                    <tr>
                                                        <td>7</td>
                                        ...
                                        <div class="table-responsive">
                                            <table class="overflow-hidden table text-wrap table-bordered border-top mb-5">
                                                ...
                                                <tbody class="para1 align-middle"
                                                    ...
                                                    <tr>
                                                        <td rowspan="2">2</td>
                                                        <td rowspan="2" class="align-middle">Two Professors, including
                                                            the Dean of the School</td>
                                                        <td>Prof (Dr.) George A.P.</td>
                                                    ...
                                                    <tr>
                                                        <td rowspan="3">5</td>
                                                        <td rowspan="3" class="align-middle">
                                                            External members not below the rank of Professors, including
                                                            members from an allied department, who will be nominated by
                                                            the URC (Outside RGU)
                                                        </td>
                                                        <td>Prof. (Dr.) Mrinmoy Kumar Sharma</td>
                                                        <td>Professor, Department of Business Administration, Tezpur
                                                            University</td>
                                                        <td>External Member</td>
                                                    </tr>
                                                    <tr>
