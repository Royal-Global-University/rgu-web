...
@section('content')
    <div style="background-image: url(mobile-assets/dept-business/s2-bg-img-1.webp);">
          <div class="mobile" >
            @include('frontend/components/mobileheader')
            <img style="padding-top: 80px; position: relative;" src="all-dept/mobile-business.png" alt="">
                    ...
                    <div>
                      ...
                      <div class="text-dark">
                        <h3 class="headd3 text-dark fw-bold kd-split-text pt-2">
                          <a href="https://www.rgu.ac/research-and-development-rsb.php"
                            >Click More</a
                          >
                        </h3>
                      </div>
                            ...
                            <div class="accordion-item">
                              ...
                              >
                                <div class="accordion-body">
                                  <div class="row">
                                    <a
                                      href="assets/Departmentalpdf/AY 2023-24 BBA.pdf"
                                      target="_blank"
                                    >
                                      <i class="fa fa-file-text px-2"></i>AY 2023-24 BBA.pdf
                                      <i class="fa fa-download"></i>
                                    </a>

                                    <a
                                      href="assets/Departmentalpdf/AY 2022-23 BBA.pdf"
                                      target="_blank"
                                    >
                                      <i class="fa fa-file-text px-2"></i>AY 2022-23 BBA.pdf
                                      <i class="fa fa-download"></i>
                                    </a>

                                    <a
                                      href="assets/Departmentalpdf/AY2022-23BBA+MBA.pdf"
                                      target="_blank"
                                    >
                            ...
                            <div class="accordion-item">
                              ...
                              >
                                <div class="accordion-body">
                                  <div class="row">
                                    <a
                                      href="assets/Departmentalpdf/AY 2022-23 MBA.pdf"
                                      target="_blank"
                                    >
                                      <i class="fa fa-file-text px-2"></i>AY 2022-23 MBA.pdf
                                      <i class="fa fa-download"></i>
                                    </a>

                                    <a
                                      href="assets/Departmentalpdf/AY 2021-22 MBA.pdf"
                                      target="_blank"
                                    >
