                ...
                <table class="table bg-white table-responsive table-striped table-bordered border-top  vertical-scroll">
                    ...
                    <tbody class="para1 bg-light">
                        ...
                        <tr>
                            ...
                            <td>
                                <p>
                                    <strong style="color: #023e8a;" class="#">MBA Entrepreneurship & Small Business
                                        Management</strong>
                                </p>
                            </td>
                            <td class="para1">
                            ...
                            <table class="overflow-hidden table text-wrap table-bordered border-top mb-5">
                                ...
                                <tbody class="para1 align-middle" style="background-color: #f9f9f9; text-align: start;">
                                    ...
                                    <tr>
                                        ...
                                        <td>Ms. Varsha S Chakravarty, HR Manager</td>
                                    </tr>
                                    <tr>
                                        <td>5</td>
                                        <td>
                                ...
                                <div class="accordion para1" id="accordionExample">
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="row">
                                                    <a href="mobile-assets/department-all/syllabus-new/5RSB/BBA 4 YEAR SYLLABUS STRUCTURE FOR 25.2.25(Final).pdf"
                                                        target="_blank">
                                                    ...
                                                    <a href="mobile-assets/department-all/syllabus-new/5RSB/MBA_Syllabus2025-26_(10.5.25).pdf"
                                                        target="_blank">
                                                        <i class="fa fa-file-text px-2"></i>COURSE STRUCTURE & SYLLABUS
                                                        (BASED ON NATIONAL EDUCATION POLICY 2020) FOR MBA
                                                        <i class="fa fa-download"></i>
                                                    </a>

                                                    <a href="mobile-assets/department-all/syllabus-new/5RSB/Structure of syllabus - UG-29.4.25F - updated.pdf"
                                                        target="_blank">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseTwo" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="row">
                                                    <a href="mobile-assets/department-all/syllabus-new/5RSB/Structure of syllabus - PG 29.4.25 -F (1) (1)- 2 Semester.pdf"
                                                        target="_blank">
                                                    ...
                                                    <!-- <a
                             href="mobile-assets/department-all/Departmentalpdf/AY 2021-22 MBA.pdf"
                             target="_blank"
                           >
                             <i class="fa fa-file-text px-2"></i>AY 2021-22 MBA.pdf
                             <i class="fa fa-download"></i>
                           </a>

                           <a
                             href="mobile-assets/department-all/Departmentalpdf/AY2022-23BBA+MBA.pdf"
                             target="_blank"
                           >
                             <i class="fa fa-file-text px-2"></i>AY 2022-23 BBA + MBA.pdf
                             <i class="fa fa-download"></i>
                           </a> -->
                                                </div>
                                            </div>
