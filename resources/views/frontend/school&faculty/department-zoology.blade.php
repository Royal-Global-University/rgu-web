...
@section('content')
            <div style="background-image: url(mobile-assets/dept-zoology/s2-bg-img-1.webp);">
          <div class="mobile" >
            @include('frontend/components/mobileheader')
        <img style="padding-top: 80px; position: relative;" src="mobile-assets/dept-zoology/mobile-zoology.png" alt="">
        ...
        <div>
          <div>
            ...
            <div class="table-responsive">
              <table
                class="overflow-hidden table text-wrap table-bordered border-top mb-5 para1"
              >
                  ...
                  <div class="accordion-item">
                    ...
                    >
                      <div class="accordion-body">
                        <div class="row">
                          <a
                            href="assets/Departmentalpdf/AY 2022-23 BSc Zoology.pdf"
                            target="_blank"
                          >
                            <i class="fa fa-file-text px-2"></i>AY 2022-23 BSc
                            Zoology.pdf <i class="fa fa-download"></i>
                          </a>
                          <a
                            href="assets/Departmentalpdf/AY 2023-24 B.Sc. Zoology .pdf"
                            target="_blank"
                          >
                            <i class="fa fa-file-text px-2"></i> AY 2023-24 B.Sc. Zoology
                  ...
                  <div class="accordion-item">
                    ...
                    >
                      <div class="accordion-body">
                        <div class="row">
                          <a
                            href="assets/Departmentalpdf/Old Syllabus MSc Zoology.pdf"
                            target="_blank"
                          >
                            <i class="fa fa-file-text px-2"></i>Old Syllabus MSc
                            Zoology.pdf<i class="fa fa-download"></i>
                          </a>
                        </div>
                      </div>
        ...
        <img src="mobile-assets/dept-zoology/web-zoology.png" alt="">
