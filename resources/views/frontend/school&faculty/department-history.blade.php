                            ...
                            <div class="accordion para1" id="accordionExample">
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                        ...
                                        <div class="accordion-body">
                                            <div class="row">
                                                <a href="mobile-assets/department-all/syllabus-new/17RSHSS/History/RSHSS_UG_History_Syllabus_Post_BoS_March_3.pdf"
                                                    target="_blank">
                                                    <i class="fa fa-file-text px-2"></i> COURSE STRUCTURE & SYLLABUS (BASED
                                                    ON NATIONAL EDUCATION POLICY 2020) FOR B.A. (Hons) History (4 YEARS
                                                    SINGLE MAJOR)
                                                    <i class="fa fa-download"></i>
                                                </a>
                                                <a href="mobile-assets/department-all/syllabus-new/17RSHSS/History/Structure of syllabus - UG.pdf"
                                                    target="_blank">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                        ...
                                        <div class="accordion-body">
                                            <div class="row">
                                                <a href="mobile-assets/department-all/syllabus-new/17RSHSS/History/RSHSS_P.G History_NEP_Syllabus_Post_BoS_March_25 .pdf"
                                                    target="_blank">
                                                    <i class="fa fa-file-text px-2"></i> Curriculum Framework for
                                                    Post-Graduate programme based on NEP 2020 MA in History
                                                    <i class="fa fa-download"></i>
                                                </a>

                                                <a href="mobile-assets/department-all/syllabus-new/17RSHSS/History/Structure of syllabus - PG.pdf"
                                                    target="_blank">
