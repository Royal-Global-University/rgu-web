...
@section('content')
    ...
    <div class="dept-physiotherapy-wrapper">
        ...
        <div class="dept-physiotherapy-hero" id="dept-about">
            ...
            <div class="dept-physiotherapy-content">
                ...
                <p>
                    The Department of Physiotherapy is dedicated to developing competent, compassionate, and evidence-based
                    physiotherapy professionals committed to promoting health, restoring function, preventing disability,
                    and enhancing quality of life. The department offers comprehensive education with extensive clinical
                    training across musculoskeletal, neurological, cardiopulmonary, sports, pediatric, geriatric, and
                    community-based rehabilitation.<br /><br />

                    Aligned with the National Commission for Allied and Healthcare Professions (NCAHP) standards, the
                    curriculum integrates foundational medical sciences, advanced physiotherapy practices, clinical
                    reasoning, research, digital health, and interdisciplinary patient care. Through hands-on training in
                    teaching hospitals, rehabilitation centres, sports medicine facilities, and community health settings,
                    students acquire the knowledge and skills required for independent professional practice.<br /><br />

                    The department fosters excellence in clinical care, research, innovation, ethical practice, and lifelong
                    learning, preparing graduates to become competent Physiotherapists, educators, researchers, and
                    rehabilitation specialists capable of addressing the evolving healthcare needs of India and the global
                    community.
                </p>
        ...
        <div class="dept-physiotherapy-prospects-section" id="dept-vision">
            ...
            <div class="dept-physiotherapy-prospects-content">
                ...
                <ul class="dept-physiotherapy-bullet-list">
                    <li>
                        To inculcate professional competence among students through education by adhering to standardized
                        methods of
                        assessment and patient care creating physiotherapists who deliver the best services focusing the
                        various age
                ...
                <ul class="dept-physiotherapy-bullet-list">
                    ...
                    <li>
                        To achieve the objective that enhances competencies in clinical reasoning to deliver the best
                        healthcare
                        service to the community with core values of ethical conduct.
                    </li>
                    <li>
                        To produce healthcare professionals with exceptional clinical skills, leadership qualities to serve
                        humanity
            ...
            <div class="dept-physiotherapy-accordion-wrapper">
                ...
                <div class="dept-physiotherapy-accordion-item active">
                    ...
                    <div class="dept-physiotherapy-accordion-content">
                        <div class="dept-physiotherapy-syllabus-list">
                            <a target="_blank"
                                href="/mobile-assets/department-all/rsmas/physiotherapy/updated-syllabus/MPT%20SYLLABUS-2025.pdf"
                ...
                <div class="dept-physiotherapy-accordion-item">
                    ...
                    <div class="dept-physiotherapy-accordion-content">
                        <div class="dept-physiotherapy-syllabus-list">
                            <a target="_blank"
                                href="/mobile-assets/department-all/rsmas/physiotherapy/updated-syllabus/BPT_Syllabus_2025-26.pdf"
                                class="dept-physiotherapy-syllabus-link" download>
                                <div class="dept-physiotherapy-syllabus-link-left">
                                    <i class="fa-solid fa-file-lines"></i>
                ...
                <div class="dept-physiotherapy-accordion-item">
                    ...
                    <div class="dept-physiotherapy-accordion-content">
                        <div class="dept-physiotherapy-syllabus-list">
                            <a href="/phd" class="dept-physiotherapy-syllabus-link" target="_blank">
                                <div class="dept-physiotherapy-syllabus-link-left">
                                    <i class="fa-solid fa-file-lines"></i>
                                    Click to View
                                </div>
        ...
        <section class="dept-physiotherapy-recognition-section">
            ...
            <div class="dept-physiotherapy-recognition-container">
                ...
                <div class="dept-physiotherapy-recognition-img">
                    <img src="/mobile-assets/ads/aip-logo.png" alt="IAP Logo">
                </div>
                ...
                <div class="dept-physiotherapy-recognition-content">
                    ...
                    <p>
                        The Assam Royal Global University has been awarded provisional institutional membership by the
                        Indian
                        Association of Physiotherapists (IAP) for the period 2025–2027. This recognition affirms that the
                        University
                        meets the prescribed academic and training standards, enabling its Bachelor of Physiotherapy
                        graduates to be
                        eligible for IAP membership as per prevailing norms. The certification reflects the institution’s
                        commitment
                        to quality education and professional excellence in physiotherapy.
                    </p>

                    <a href="/mobile-assets/ads/AIP.jpeg" class="dept-physiotherapy-recognition-btn" download>
                    ...
                    <div class="dept-physiotherapy-table-responsive">
                        <table class="dept-physiotherapy-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>3</td>
                                    <td>Best Scientific Paper Presenter at the Osteomanual Summit, 2023 (Dr. Sonia Lakhotia
                                        PT)</td>
                                </tr>

                                <tr>
                                    <td>4</td>
                                    <td>Awarded first prize in scientific paper presentation at 17th IAP State Conference
                                        held on December
                                ...
                                <tr>
                                    <td>6</td>
                                    <td>Awarded 3rd Prize in scientific paper presentation at 2nd National Conference of IAP
                                        Women cell
                                ...
                                <tr>
                                    <td>7</td>
                                    <td>Expert Speaker in Physiofest 2025-15th Physiotherapy Summit, An INTERNATIONAL
                                        Conference held at
                                ...
                                <tr>
                                    <td>8</td>
                                    <td>Chikitsa Ratan Award at All India Institute of Medical Sciences (AIIMS) New Delhi at
                                        the National
                                        Conference on Advance Healthcare & Rehabilitation Sciences (NCAHRS-AIIMS) organised
                                        by the Dept of
            ...
            <div class="dept-physiotherapy-lab-container">
                ...
                <ol class="dept-physiotherapy-lab-list">
                    <li>
                        ...
                        pain, reduce
                        inflammation, and accelerate tissue healing. The Infrared (IRR) radiation in physical therapy acts
                        as a
                    ...
                    <li>
                        Ultrasound therapy: It delivers deep heat and micro-vibrations to soft tissues. Common uses include
                        reducing
                ...
                <div class="dept-physiotherapy-lab-gallery">
                    ...
                    <img src="mobile-assets/rsmas-new-dept/physiotherapy/f.jpg" alt="Lab f"
                        class="dept-physiotherapy-lab-img">
                    ...
                    <img src="mobile-assets/rsmas-new-dept/physiotherapy/1.jpg" alt="Lab 1"
                        class="dept-physiotherapy-lab-img">
                    <img src="mobile-assets/rsmas-new-dept/physiotherapy/2.JPG" alt="Lab 2"
                        class="dept-physiotherapy-lab-img">
                    <img src="mobile-assets/rsmas-new-dept/physiotherapy/3.JPG" alt="Lab 3"
                        class="dept-physiotherapy-lab-img">
                    <img src="mobile-assets/rsmas-new-dept/physiotherapy/4.JPG" alt="Lab 4"
                        class="dept-physiotherapy-lab-img">
                    <img src="mobile-assets/rsmas-new-dept/physiotherapy/5.JPG" alt="Lab 5"
                        class="dept-physiotherapy-lab-img">
                    <img src="mobile-assets/rsmas-new-dept/physiotherapy/6.JPG" alt="Lab 6"
                        class="dept-physiotherapy-lab-img">
                    <img src="mobile-assets/rsmas-new-dept/physiotherapy/7.JPG" alt="Lab 7"
                        class="dept-physiotherapy-lab-img">
                    <img src="mobile-assets/rsmas-new-dept/physiotherapy/8.JPG" alt="Lab 8"
                        class="dept-physiotherapy-lab-img">
    ...
    <script>
        ...
        const coursesData = [{
                ...
                duration: "2 years",
                link: "/programs-MasterofPhysiotherapyMPT"
            },
            {
        ...
        const tableData = [{
            ...
            rows: [
                ["1", "Convener (Ex-officio) - Head of the Department",
                    "Dr. Madhusmita Koch, Associate Professor & HOD, Department of Physiotherapy, RSMAS"
                ],
                ...
                ["3", "External Expert (Industry)",
                    "Dr. Ankur Jyoti Bora, Physiotherapist, Jorhat Medical College & Hospital"
                ],
                ["4", "External Expert (Academics)",
                    "Dr. Ujjwal Bhattacharya, Dean, Pratiksha Institute of Allied Health"
                ]
            ]
        }];
