...
@section('content')
         <div style="background-image: url(mobile-assets/dept-law/s2-bg-img-1.webp);">
          <div class="mobile" >
            @include('frontend/components/mobileheader')
        <img style="padding-top: 80px; position: relative;" src="mobile-assets/dept-law/mobile-law.png" alt="">
          ...
          <div>
            ...
            <div class="text-dark">
              <h3 class="headd3 text-dark fw-bold kd-split-text pt-2">
                <a href="research-and-development-rsla.php" class="" target="_blank"
                  >Click to view...</a
                >
              </h3>
            </div>
        ...
        <div>
                  ...
                  <div class="accordion-item">
                    ...
                    >
                      <div class="accordion-body">
                        <div class="row">
                          <a
                            href="assets/Departmentalpdf/Old Syllabus B.A. LL.B..pdf"
                            target="_blank"
                          >
                            <i class="fa fa-file-text px-2"></i> Old Syllabus B.A.
                            LL.B..pdf <i class="fa fa-download"></i>
                          </a>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="accordion-item">
                    ...
                    >
                      <div class="accordion-body">
                        <div class="row">
                          <a
                            href="assets/Departmentalpdf/Old Syllabus LLM.pdf"
                            target="_blank"
                          >
                            <i class="fa fa-file-text px-2"></i> Old Syllabus LLM.pdf
          ...
          <div class="website">
            ...
            <img src="mobile-assets/dept-law/web-law.png" alt="">
