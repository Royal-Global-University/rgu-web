                                            ...
                                            <div class="accordion-body"
                                                ...
                                                <div class="row" style="display: flex; flex-direction: column; gap: 12px;">
                                                    ...
                                                    <a href="/mobile-assets/syllabus/RSLA/BA LL.B Syllabus.pdf"
                                                        target="_blank" style="color: #27467A;">
                                                        <i class="fa fa-file-text px-2"></i> Details Syllabus -- BA LLB
                                                        <i class="fa fa-download ms-2" style="color: #FF9A1E;"></i>
                                                    </a>
                                                ...
                                                <div id="collapseOne" class="accordion-collapse collapse"
                                                    ...
                                                    <div class="accordion-body"
                                                        ...
                                                        <div class="row"
                                                            ...
                                                            <a href="/mobile-assets/syllabus/RSLA/BA LL.B Syllabus.pdf"
                                                                target="_blank" style="color: #27467A;">
                                                                <i class="fa fa-file-text px-2"></i> Details Syllabus
                                                                -- BA LLB
                                                                <i class="fa fa-download ms-2" style="color: #FF9A1E;"></i>
                                                            </a>
                                                            ...
                                                            <a href="/mobile-assets/syllabus/RSLA/BBA LL.B Syllabus.pdf"
                                                                target="_blank" style="color: #27467A;">
                                                                <i class="fa fa-file-text px-2"></i> Detailed Syllabus --
                                                                BBA LLB
                                                                <i class="fa fa-download ms-2" style="color: #FF9A1E;"></i>
                                                ...
                                                <div id="collapseTwo" class="accordion-collapse collapse"
                                                    ...
                                                    <div class="accordion-body"
                                                        ...
                                                        <div class="row"
                                                            ...
                                                            <a href="/mobile-assets/syllabus/RSLA/LLM syllabus.pdf"
                                                                target="_blank" style="color: #27467A;">
                                                                <i class="fa fa-file-text px-2"></i> Detailed Syllabus --
                                                                LLM
                                                                <i class="fa fa-download ms-2" style="color: #FF9A1E;"></i>
