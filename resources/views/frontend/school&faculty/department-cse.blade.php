                            ...
                            <table class="overflow-hidden table text-wrap table-bordered border-top mb-5">
                                ...
                                <tbody class="para1 align-middle" style="background-color: #f9f9f9; text-align: start;">
                                    ...
                                    <tr>
                                        ...
                                        <td>Prof. (Dr.) Hiren Kumar Deva Sarma, Professor, Department of Information
                                            Technology,
                                            ...
                                            <table class="overflow-hidden table text-wrap table-bordered border-top mb-5">
                                                ...
                                                <tbody class="para1 align-middle"
                                                    ...
                                                    <tr>
                                                        <td>1</td>
                                                        <td>Convener (Ex-Officio) - Head of the Department</td>
                                                        <td>Dr. Deepjyoti Choudhury, Associate Professor, HoD, Dept. of CSE
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>2</td>
                                                        <td>All Faculty members of the Department Members (Ex-Officio)</td>
                                                        <td>
                                                            Prof. (Dr.) Diganta Munshi, Registrar (Administration), Dean
                                                            (RSET)
                                                            <hr>
                                                            Prof. (Dr.) Rashel Sarkar, Professor
                                                            <hr>
                                                            ...
                                                            Dr. Dipankar Dutta, Associate Professor
                                                            <hr>
                                                            Ms. Vanita Agrawal, Assistant Professor &amp; Head, Laboratory
                                                            Services
                                                            <hr>
                                                            Ms. Ankita Goyal Agarwala, Assistant Professor
                                                            <hr>
                                                    ...
                                                    <tr>
                                                        <td>3</td>
                                                        <td>External Experts (Academic)</td>
                                                        <td>Prof. (Dr.) Hiren Kumar Deva Sarma, Professor, Department of
