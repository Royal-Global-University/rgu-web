                ...
                <div class="col-lg-12">
                  ...
                  <div class="txaa-slide-down-1">
                    <div style=" height: 550px; width: 100%;" class="kd-about-3-img img-cover fix kd-img-ani-1">
                      <img class="rounded " decoding="async" src="mobile-assets/department-all/rset/cse/headimg.png" alt="">
                    </div>
                  </div>
                </div>
                <div class="col-lg-12">
            ...
            <div style="background-color: #fff;">
              <div class="container p-4">
                ...
                <p style="color: #243B95; text-align: justify;" class="para1">
                  ...
                  and international conferences. Graduates and postgraduates from the department enjoy promising career
                  prospects in various sectors, securing roles in tech giants, finance, healthcare, manufacturing, and
                  government, often continuing education in AI, ML, Data Science, or Cybersecurity, and achieving
                  professional certifications. Emerging trends in AI, ML, cybersecurity, data science, cloud computing,
                  blockchain, IoT, and quantum computing offer substantial opportunities. Technical expertise combined
                  with soft skills like problem-solving, communication, teamwork, and adaptability ensures graduates
                          ...
                          <div class="accordion-body"
                            ...
                            <div class="row" style="display: flex; flex-direction: column; gap: 12px;">
                              ...
                              <a href="mobile-assets/department-all/rset/cse/updated-syllabus/BTech_Syllabus_CSE.pdf"
                                target="_blank" style="color: #27467A;">
                                <i class="fa fa-file-text px-2"></i> Detailed Syllabus -- B.Tech CSE
                                <i class="fa fa-download ms-2" style="color: #FF9A1E;"></i>
                              </a>
                          ...
                          <tr style="border-bottom: 1px solid #ddd;">
                                <td style="display: flex; align-items: center; padding: 12px;">
                                  ...
                                  <div>
                                    <div style="font-weight: bold; color: #27467A;">
                                      26-09-2024 | Dr. John Jose (Associate Professor, Department of CSE, IIT Guwahati;
                                      Vice-chair IEEE India Council) | Speaker at IEEE-IC: Standard Workshop and Hackathon
                                      2024.
                                    </div>
                              ...
                              <tr style="border-bottom: 1px solid #ddd;">
                                <td style="display: flex; align-items: center; padding: 12px;">
                                  ...
                                  <div>
                                    <div style="font-weight: bold; color: #27467A;">
                                      26-09-2024 | Mr. Anupam Agarwal (Chair of the India Internet Foundation) | Speaker at
                              ...
                              <tr style="border-bottom: 1px solid #ddd;">
                                <td style="display: flex; align-items: center; padding: 12px;">
                                  ...
                                  <div>
                                    <div style="font-weight: bold; color: #27467A;">
                                      26-09-2024 | Mr. Anand Raje (Co-founder & Director, BASIS Technologies Pvt. Ltd.; CTO,
                                      India Internet Foundation) | Speaker at IEEE-IC: Standard Workshop and Hackathon 2024.
                                    </div>
                                    <a href="#" style="color: #FF9A1E; font-weight: bold; font-size: 14px;">Read More
                                      ...</a>
                                  </div>
                              ...
                              <tr style="border-bottom: 1px solid #ddd;">
                                <td style="display: flex; align-items: center; padding: 12px;">
                                  ...
                                  <div>
                                    <div style="font-weight: bold; color: #27467A;">
                                      24-09-2024 | Prof. Ujjwal K. Saha (Professor, Mechanical Engineering, IIT Guwahati) |
                              ...
                              <tr style="border-bottom: 1px solid #ddd;">
                                <td style="display: flex; align-items: center; padding: 12px;">
                                  ...
                                  <div>
                                    <div style="font-weight: bold; color: #27467A;">
                                      11-09-2024 | Ms. Megha Roy Chatterjee (Education USA advisor, USIEF Kolkata) | Invited
                              ...
                              <tr style="border-bottom: 1px solid #ddd;">
                                <td style="display: flex; align-items: center; padding: 12px;">
                                  ...
                                  <div>
                                    <div style="font-weight: bold; color: #27467A;">
                                      09-09-2024 | Ms. Promita Mazumdar (Founder, All About You) | Workshop on personality
                              ...
                              <tr style="border-bottom: 1px solid #ddd;">
                                <td style="display: flex; align-items: center; padding: 12px;">
                                  ...
                                  <div>
                                    <div style="font-weight: bold; color: #27467A;">
                                      07-08-2024 | Dr. Pradip Kumar Das (Professor, Computer Science & Engineering, IIT
                              ...
                              <tr style="border-bottom: 1px solid #ddd;">
                                <td style="display: flex; align-items: center; padding: 12px;">
                                  ...
                                  <div>
                                    <div style="font-weight: bold; color: #27467A;">
                                      06-08-2024 | Mr. Rintu Das (Scientist D, NIELIT Guwahati) | Invited talk: NIELIT and
                          ...
                          <table class="overflow-hidden table text-wrap table-bordered border-top mb-5">
                            ...
                            <tbody class="para1 align-middle" style="background-color: #f9f9f9; text-align: start;">
                              <tr>
                                ...
                                <td>Dr. Deepjyoti Choudhury, Associate Professor, HoD, Dept. of CSE</td>
                              </tr>
                              <tr>
                                <td>2</td>
                                ...
                                <td>
                                  ...
                                  <hr>
                                  Prof. (Dr.) Rashel Sarkar, Professor
                                  <hr>
                                  ...
                                  <hr>
                                  Ms. Akangkhi Borah, Assistant Professor
                                </td>
                              </tr>
                              <tr>
                                <td>3</td>
                                <td>External Experts (Academic)</td>
                                <td>Prof. (Dr.) Hiren Kumar Deva Sarma, Professor, Department of Information Technology,
                ...
                <div class="table-responsive">
                          <table class="overflow-hidden table text-wrap table-bordered border-top mb-5">
                            ...
                            <tbody class="para1 align-middle" style="background-color: #f9f9f9; text-align: start;">
                              ...
                              <tr>
                                <td>4</td>
                                <td>Associate Professors – one of them will be the member secretary</td>
                              ...
                              <tr>
                                ...
                                <td>Professor</td>
                                <td>External Member from Gauhati University</td>
                              </tr>
                              <tr>
                                <td>6</td>
                                <td></td>
                                <td>Prof. Shwetambara Verma</td>
                                <td>Professor</td>
              ...
              <section style="background-color: #FFF8F0;">
                <div class="p-5">
                  <h1 class="headd1 text-center" style="color: #27467A; font-weight: 700;">Department of
                    <span class="headd1" style="color: #FF9A1E; font-weight: 500;">Computer Science & Engineering</span>
                  </h1>
                  ...
                  <div class="row align-items-center gx-5">
                    ...
                    <div class="col-lg-6 text-center">
                      <div class="kd-about-3-img-wrap txaa-slide-down-1">
                        <div>
                          <img class="rounded w-60" decoding="async" src="mobile-assets/department-all/rset/cse/headimg.png"
                            alt="">
                        </div>
                      </div>
                    </div>
                ...
                <div style="background-color: #fff;">
                  <div class="p-5">
                    ...
                    <img class="w-100" src="mobile-assets/department-all/rset/cse/vision-mission-web.png" alt="">
