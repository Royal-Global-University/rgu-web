                        ...
                        <table
                            ...
                            <tbody class="para1 bg-light">
                                ...
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        <p class="para1">
                                            <strong style="color: #023e8a;" class="#">B.Tech. (CSE)</strong>
                                        </p>
                                    </td>
                                    <td class="para1">
                                        4 Years
                                    ...
                                    <td>
                                        <a target="_blank" href="programs-b-tech-cse"><button type="button"
                                ...
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        <p class="para1">
                                            <strong style="color: #023e8a;" class="#">B.Tech. - CSE (Lateral Entry)</strong>
                                        </p>
                                    </td>
                                    <td class="para1">
                                        3 Years
                                ...
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        <p class="para1">
                                            <strong style="color: #023e8a;" class="#">M.Tech. CSE in Internet of
                                                Things</strong>
                                        </p>
                                    </td>
                                    <td class="para1">
                                    ...
                                    <td>
                                        <a target="_blank" href="programs-MTech-CSE-in-Internet-of-Things"><button
                                ...
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        <p class="para1">
                                            <strong style="color: #023e8a;" class="#">M.Tech. CSE in Artificial
                                                Intelligence</strong>
                                        </p>
                                    </td>
                                    <td class="para1">
                                    ...
                                    <td>
                                        <a target="_blank" href="programs-MTech-CSE-in-Artifical-Intelligence"><button
                                                type="button" style="background-color: #FF9A1E; color: #fff;"
                                                class="btn btn-md custom-details-btn fw-bold">Details</button></a>
                                    </td>
                                </tr>
                                ...
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        <p class="para1">
                                            <strong style="color: #023e8a;" class="#">M.Tech. CSE in Structural
                                                Engineering</strong>
                                        </p>
                                    </td>
                                    <td class="para1">
                    ...
                    <table class="table bg-white table-responsive table-striped table-bordered border-top  vertical-scroll">
                        ...
                        <tbody class="para1 bg-light">
                            ...
                            <tr class="align-middle">
                                ...
                                <td>
                                    <p class="para1">
                                        <strong style="color: #023e8a;" class="#">M.Tech. CSE in Internet of Things</strong>
                                    </p>
                                </td>
                                <td class="para1">
                                    2 Years
                                ...
                                <td>
                                    <a target="_blank" href="programs-MTech-CSE-in-Internet-of-Things"><button type="button"
                                            style="background-color: #FF9A1E; color: #fff;"
                                            class="btn btn-md custom-details-btn fw-bold">Details</button></a>
                                </td>
                            </tr>
