...
@section('content')
    <div style="background-image: url(mobile-assets/department-all/bg.svg); background-size: cover;">
        ...
        <div class="mobile">
            ...
            <!-- courses offered  -->
            <div class="container">
                <h2 class="headd1 pt-3 fw-bold text-center" style="color: #27467A; font-weight: 900; font-size: 25px;">
                        ...
                        <div
                            ...
                            <span>
                                <a class="para1 fw-bold"
                                    ...
                                    href="https://www.rgu.ac/programs-BSc-Nursing">View Details</a>
                            </span>
                        </div>
                    </a>
                </div>
                ...
                <div style="background-color:#FDF9F4; padding:10px; width:100%; margin: 0px auto;">
                    ...
                    <a style="text-decoration:none;">
                        <div
                            ...
                            <span style="flex-grow:1; color:#27467A; font-weight:bold; font-size: 20px;">3.5 years</span>
                            <a class="para1 fw-bold"
                                style="padding: 5px 20px; border-radius: 5px; color: #fff; background: linear-gradient(135deg, hsla(33, 100%, 56%, 1) 0%, hsla(8, 52%, 50%, 1) 100%); font-size: 13px;"
                                href="https://www.rgu.ac/programs-General-Nursing-Midwifery">View Details</a>
                        </div>
                    </a>
                </div>
