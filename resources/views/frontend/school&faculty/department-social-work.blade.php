...
@section('content')
    <div style="background-image: url(mobile-assets/department-all/bg.svg); background-size: cover;">
        ...
        <div class="mobile">
            ...
            <img style="padding-top: 80px; position: relative;" src="https://media.rgu.ac/department-all/dept-social-work/mobile-social-work.png" alt="">
        ...
        <div class="website">
            ...
            <img src="https://media.rgu.ac/department-all/dept-social-work/web-social-work.png" alt="">
