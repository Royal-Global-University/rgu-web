                ...
                <div class="row justify-content-center">
                        ...
                        <div class="card">
                            <div class="card-image">
                                <img src="https://www.rgu.ac/mobile-assets/updated-faculty-img/Prabahan-Puzari.png"
                                    alt="Profile image of Prabahan Puzari">
                            </div>
                        ...
                        <div class="card">
                            <div class="card-image">
                                <img src="mobile-assets/updated-faculty-img/no-pic.png"
                                    alt="Profile image of Jemima Yasmin">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            ...
                            <p class="card-designation">Associate Professor, Associate Dean, Academic Affairs & HOD, RSTTM
                            </p>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-image">
                                <img src="mobile-assets/updated-faculty-img/no-pic.png"
                                    alt="Profile image of Roshni Saikia">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-image"><img
                                    src=" https://www.rgu.ac/mobile-assets/all-faculty/rshss/jugal.jpeg"
                                    alt="Profile image "></div>
                            <h3 class="card-name">Mr. Jugal Kishore Bhattacharyya</h3>
                            <p class="card-title">Assistant Professor & Coordinator GE/AEEC</p><a
                                href="https://www.rgu.ac/faculty-jugal-kishore-bhattacharyya" class="profile-link">View
                                Profile</a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-image"><img
                                    src=" https://www.rgu.ac/mobile-assets/updated-faculty-img/Ms-Nikita-Biswakarma-RSHSS.png"
                                    alt="Profile image "></div>
                            <h3 class="card-name">Ms. Nikita Biswakarma</h3>
                            <p class="card-title">Teaching Assistant & Departmental Representative, Academic Affairs</p><a
                                href="https://www.rgu.ac/faculty-nikita-biswakarma" class="profile-link">View Profile</a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-image"><img
                                    src=" https://www.rgu.ac/mobile-assets/all-faculty/rsl/Pankaj.jpeg"
                                    alt="Profile image "></div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-image"><img
                                    src=" https://www.rgu.ac/mobile-assets/updated-faculty-img/Prajna-Borah-RSHSS.png"
                                    alt="Profile image "></div>
                            <h3 class="card-name">Ms. Prajna Borah</h3>
                            <p class="card-title">Assistant Professor</p><a href="https://www.rgu.ac/faculty-prajna-borah"
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-image"><img
                                    src="https://www.rgu.ac/mobile-assets/updated-faculty-img/Mr-Rajdeep-Deb-RSEES.png "
                                    alt="Profile image "></div>
                            <h3 class="card-name">Rajdeep Deb</h3>
                            <p class="card-title">Assistant Professor</p><a href="https://www.rgu.ac/faculty-rajdeep-deb"
                                class="profile-link">View Profile</a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-image"><img
                                    src=" https://www.rgu.ac/mobile-assets/updated-faculty-img/Dr-Rohit-Sarma.png"
                                    alt="Profile image "></div>
                            <h3 class="card-name">Mr. Rohit Sarma</h3>
                            <p class="card-title">Assistant Professor</p><a href="https://www.rgu.ac/faculty-rohit-sarma"
                                class="profile-link">View Profile</a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-image"><img
                                    src=" https://www.rgu.ac/mobile-assets/updated-faculty-img/Ms-Lalzikpuii-Rajkhowa.png"
                                    alt="Profile image "></div>
                            <h3 class="card-name">Ms. Lalzikpuii Rajkhowa</h3>
                            <p class="card-title">Assistant Professor</p><a
                                href="https://www.rgu.ac/faculty-lalzikpuii-rajkhowa" class="profile-link">View
                                Profile</a>
                        </div>
                    </div>
