...
@section('content')
        <div style="background-image: url(mobile-assets/dept-economics/s2-bg-img-1.webp);">
      <div class="mobile">
        @include('frontend/components/mobileheader')
        <img style="padding-top: 80px; position: relative;" class="pb-3" src="mobile-assets/dept-economics/mob-economics.png" alt="">
        ...
        <div>
          <div>
            ...
            <div class="text-dark">
              <h3 class="headd3 text-dark fw-bold kd-split-text pt-2"></h3>
            </div>
          </div>
        </div>
                  ...
                  <div class="accordion-item">
                    ...
                    >
                      <div class="accordion-body">
                        <div class="row">
                          <a
                            href="assets/Departmentalpdf/AY 2022-23 BA Economics.pdf"
                            target="_blank"
                          >
                            <i class="fa fa-file-text px-2"></i> AY 2022-23 BA
                            Economics.pdf <i class="fa fa-download"></i>
                          </a>
                          <a
                            href="assets/Departmentalpdf/AY 2023-24 B.A. Economics1.pdf"
                            target="_blank"
                          >
                  ...
                  <div class="accordion-item">
                    ...
                    >
                      <div class="accordion-body">
                        <div class="row">
                          <a
                            href="assets/Departmentalpdf/Old Syllabus MA Economics.pdf"
                            target="_blank"
                          >
      ...
      <div class="website">
        ...
        <img src="mobile-assets/dept-economics/web-economics.png" alt="">
