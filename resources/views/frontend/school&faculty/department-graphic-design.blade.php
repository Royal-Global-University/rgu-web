  ...
  <div>
    ...
    <div class="p-2">
      ...
      <ol class="para1 text-dark">
        <li>
          To achieve academic excellence through a curriculum that blends
          innovative, research-driven, and industry-focused education. Our goal
          is to nurture creativity, critical thinking, and technical expertise
          in our students, preparing them for successful careers in the
          ever-evolving field of graphic design.
        </li>
        <li>
          To make a lasting, positive impact on society and the global design
          community through our commitment to academic rigor, community
          engagement, and sustainable design practices.
        </li>
        <li>
          To produce visionary, ethically responsible graduates who are poised
          to lead and transform the future of graphic design.
        </li>
      </ol>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          <img
            ...
            src="assets/img/Departments/Department_Graphic_Design/AnimationandVFX2.jpg"
          />
        </div>
        <div class="col-lg-6">
          <img
            style="border-radius: 10px"
            src="assets/img/Departments/Department_Graphic_Design/AnimationandVFX.jpg"
          />
        </div>
      </div>
    </div>
            ...
            <div class="accordion-item">
              ...
              >
                <div class="accordion-body">
                  <div class="row para1">
                    <a
                      href="assets/Departmentalpdf/AY 2022-23 B.Des. Graphic Design.pdf"
                      target="_blank"
                    >
                    ...
                    <a
                      href="assets/Departmentalpdf/AY 2023-24 B.Des. Graphic Design.pdf"
                      target="_blank"
                    >
