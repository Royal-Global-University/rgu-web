...
@section('content')
    ...
    <div class="mobile" >
      ...
      <section style="padding-top: 130px; position: relative;">
        <img src="mobile-assets/department-all/rsd/graphic-design/mob-graphicdesign.png" alt="">
      </section>
      <!-- till about dept  -->
      ...
      <div class="container">
        ...
        <div style="background-color:#FDF9F4; padding:10px; width:100%; margin: 0px auto;">
          ...
          <div
            ...
            <span style="font-size:18px; padding-right: 20px;">Bachelor of Design (Graphic Design)</span> | <span
          ...
          <!-- Statute Items -->
          <a target="_blank" href="programs-Bachelor-of-Design-Graphic-Design" style="text-decoration:none;">
            <div
              ...
              <span>
                <a class="para1 fw-bold"
                  ...
                  href="programs-Bachelor-of-Design-Graphic-Design">View Details</a>
              </span>
            </div>
          </a>
        </div>
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                          ...
                          <div class="accordion-body"
                            ...
                            <div class="row" style="display: flex; flex-direction: column; gap: 12px;">
                              ...
                              <a href="mobile-assets/department-all/rsd/graphic-design/syllabus/Course-structure-Graphic-Design.pdf"
                                target="_blank" style="color: #27467A;">
                                <i class="fa fa-file-text px-2"></i> Structure of Syllabus -- Graphic Design
                              ...
                              <a href="mobile-assets/department-all/rsd/graphic-design/syllabus/B.Des.-Graphic-Design-Deatiled-syllabus.pdf"
                                target="_blank" style="color: #27467A;">
                                <i class="fa fa-file-text px-2"></i> Detailed Syllabus -- Graphic Design
                                <i class="fa fa-download ms-2" style="color: #FF9A1E;"></i>
                              </a>
      ...
      <section>
        ...
        <section id="about">
          <section style="background-color: #FFF8F0;">
            ...
            <img src="mobile-assets/department-all/rsd/graphic-design/web-graphicdesign.png" alt="">
          ...
          <div class="container">
            ...
            <div style="background-color:#FDF9F4; padding:10px; width:100%; margin: 0px auto;">
              ...
              <div
                ...
                <span style="font-size:22px; padding-right: 20px;">Bachelor of Design (Graphic Design)</span> | <span
