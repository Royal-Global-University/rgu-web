...
@section('content')
        <div style="background-image: url(mobile-assets/dept-graphic-design/s2-bg-img-1.webp);">
      <div class="mobile">
        @include('frontend/components/mobileheader')
        <img style="padding-top: 80px; position: relative;" class="pb-3" src="mobile-assets/dept-graphic-design/mob-graphicdesign.png" alt="">
      ...
      <div class="website">
        ...
        <img src="mobile-assets/dept-graphic-design/web-graphicdesign.png" alt="">
