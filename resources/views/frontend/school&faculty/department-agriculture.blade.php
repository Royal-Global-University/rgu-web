        ...
        <div class="mobile">
            ...
            <section style="background-color: #fff8f0; padding: 130px 10px 0px 10px;">
                ...
                <h1 class="headd3 text-center" style="color: #27467A; font-weight: 700;">Department of
                    <span class="headd3" style="color: #FF9A1E; font-weight: 500;">Agriculture</span>
                </h1>
                            ...
                            <div class="txaa-slide-down-1">
                                <div style=" height: 400px; width: 100%;" class="kd-about-3-img img-cover fix kd-img-ani-1">
                                    <img class="rounded" decoding="async"
                                        src="mobile-assets/department-all/rsag/headimg.png" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            ...
                            <p class="mobile-para1 pt-2 fw-bold"
                                style="color: #264273; text-align: justify; line-height: 1.5;">
                                Bachelor of Science in Agriculture (B.Sc. in Agriculture) is a comprehensive undergraduate
                                programme
                                that combines scientific understanding and practical skills in the field of Agriculture.
                            </p>

                            <p class="mobile-para1 pt-2" style="color: #264273; text-align: justify; line-height: 1.5;">
                                Agriculture is an undergraduate degree program that focuses on the science and practice of
                                agriculture.
                                The program typically covers a wide range of topics, including:
                            </p>

                            <ol class="para1" style="color: #27467A; font-size: 16px; line-height: 1.6;">
                                <li>Crop production and management</li>
                                <li>Soil science and fertility management</li>
                                <li>Plant breeding and genetics</li>
                                <li>Agricultural entomology and pathology</li>
                                <li>Agricultural economics and farm management</li>
            ...
            <div style="background-color: #fff; padding: 20px 0px;">
                <div class="container">
                    ...
                    <p class="para1 pt-3" style="color: #264273; text-align: justify; line-height: 1.5; font-size: 16px;">
                        The prospects after a B.Sc. in Agriculture are diverse and promising, in regard to the growing
                        importance of sustainable farming, food security, agribusiness, and research. The programme aims to
                        equip students with a strong foundation in agricultural sciences, preparing them for following
                        careers
                        opportunities:
                    </p>

                    <p class="headd3 fw-bold" style="color: #243B95;">
                        Higher Education Opportunities
                    </p>

                    <ol class="para1" style="color: #27467A; font-size: 16px; line-height: 1.6;">
                        <li>M.Sc. in Agriculture (in specializations like Agronomy, Horticulture, Plant Breeding, Soil
                            Science, etc.)</li>
                        ...
                        <li>International degrees: Many students opt for MS/M.Sc. abroad in Agri Sciences, Environmental
                            Science, or related disciplines</li>
                    </ol>
                    ...
                    <ol class="para1" style="color: #27467A; font-size: 16px; line-height: 1.6;">
                        <li>Agricultural Officer / Agriculture Development Officer (ADO)</li>
                        <li>IBPS AFO (Agricultural Field Officer)</li>
                        <li>UPSC/State PSC exams – for roles in Indian Forest Services, Rural Development, etc.</li>
                        <li>Research roles – through ICAR institutes, CSIR, or state agricultural departments</li>
                        <li>Krishi Vigyan Kendras (KVK) – for extension and research-based roles</li>
                    </ol>
                    ...
                    <ol class="para1" style="color: #27467A; font-size: 16px; line-height: 1.6;">
                        <li>Agri-Input Companies – seeds, fertilizers, pesticides (roles in sales, R&D, quality control)
                        </li>
                        <li>Food Processing Industries</li>
                        <li>Agri-Tech Startups – technology-based agricultural solutions</li>
                        <li>Banking & Insurance – as agriculture officers in banks or crop insurance companies</li>
                        <li>Export & Supply Chain Management – in agri-exports, logistics</li>
                    </ol>
                    ...
                    <ol class="para1" style="color: #27467A; font-size: 16px; line-height: 1.6;">
                        <li>Agricultural research, farm management, food security projects</li>
                    ...
                    <ol class="para1" style="color: #27467A; font-size: 16px; line-height: 1.6;">
                        ...
                        <li>Computer literacy – GIS, remote sensing, data analytics in agriculture</li>
                        ...
                        <section style="background-color: #FFF8F0;">
                            <div class="p-5">
                                <h1 class="headd1 text-center" style="color: #27467A; font-weight: 700;">Department of
                                    <span class="headd1" style="color: #FF9A1E; font-weight: 500;">Agriculture</span>
                                </h1>
                            ...
                            <div class="container p-4">
                                <div class="row align-items-center gx-5">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <p class="para1 pt-3 fw-bold"
                                            style="color: #264273; text-align: justify; line-height: 1.5;">
                                            Bachelor of Science in Agriculture (B.Sc. in Agriculture) is a comprehensive
                                            undergraduate programme
                                            that combines scientific understanding and practical skills in the field of
                                            Agriculture.
                                        </p>

                                        <p class="para1 pt-1"
                                            style="color: #264273; text-align: justify; line-height: 1.5;">
                                            Agriculture is an undergraduate degree program that focuses on the science and
                                            practice of
                                            agriculture. The program typically covers a wide range of topics, including:
                                        </p>
                            ...
                            <div style="background-color: #fff; padding: 20px 0px;">
                                <div class="container">
                                    ...
                                    <p class="para1 pt-3" style="color: #264273; text-align: justify; line-height: 1.5;">
                                        The prospects after a B.Sc. in Agriculture are diverse and promising, in regard to
                                        the growing
                                        importance of sustainable farming, food security, agribusiness, and research. The
                                        programme aims to
                                        equip students with a strong foundation in agricultural sciences, preparing them for
                                        following careers
                                        opportunities:
                                    </p>
                                    ...
                                    <ol class="para1" style="color: #27467A; font-size: 16px; line-height: 1.6;">
                                        <li>M.Sc. in Agriculture (in specializations like Agronomy, Horticulture, Plant
                                            Breeding, Soil
                                            Science, etc.)</li>
                                        <li>MBA in Agribusiness Management</li>
                                        <li>Postgraduate diplomas in fields like Agri-Extension, Food Technology, or Rural
                                            Development</li>
                                        <li>International degrees: Many students opt for MS/M.Sc. abroad in Agri Sciences,
                                            Environmental
                                            Science, or related disciplines</li>
                                    </ol>
                                    ...
                                    <ol class="para1" style="color: #27467A; font-size: 16px; line-height: 1.6;">
                                        <li>Agricultural Officer / Agriculture Development Officer (ADO)</li>
                                        <li>IBPS AFO (Agricultural Field Officer)</li>
                                        <li>UPSC/State PSC exams – for roles in Indian Forest Services, Rural Development,
                                            etc.</li>
                                        <li>Research roles – through ICAR institutes, CSIR, or state agricultural
                                            departments</li>
                                        <li>Krishi Vigyan Kendras (KVK) – for extension and research-based roles</li>
                                    </ol>
                                    ...
                                    <ol class="para1" style="color: #27467A; font-size: 16px; line-height: 1.6;">
                                        <li>Agri-Input Companies – seeds, fertilizers, pesticides (roles in sales, R&D,
                                            quality control)</li>
                                        <li>Food Processing Industries</li>
                                        <li>Agri-Tech Startups – technology-based agricultural solutions</li>
                                        <li>Banking & Insurance – as agriculture officers in banks or crop insurance
                                            companies</li>
                                        <li>Export & Supply Chain Management – in agri-exports, logistics</li>
                                    </ol>
                                    ...
                                    <ol class="para1" style="color: #27467A; font-size: 16px; line-height: 1.6;">
                                        <li>Research Assistant / Scientist – in public and private research institutions
                                        </li>
                                        <li>Lecturer / Professor – after completing postgraduation + NET/Ph.D.</li>
                                        <li>ICAR / CSIR / DST fellowships – for research positions and Ph.D. programs</li>
                                    </ol>
                                    ...
                                    <ol class="para1" style="color: #27467A; font-size: 16px; line-height: 1.6;">
                                        <li>Agricultural research, farm management, food security projects</li>
                                        <li>Opportunities in countries like Canada, Australia, the USA, and Gulf countries
                                        </li>
                                        <li>Roles in international organizations (FAO, CGIAR, World Bank, etc.)</li>
                                    </ol>
                                    ...
                                    <ol class="para1" style="color: #27467A; font-size: 16px; line-height: 1.6;">
                                        <li>Practical knowledge of farming tools and technologies</li>
                                        <li>Communication and management skills (especially in extension or agribusiness)
                                        </li>
                                        <li>Computer literacy – GIS, remote sensing, data analytics in agriculture</li>
                                        <li>Language skills and report writing</li>
                                    </ol>
