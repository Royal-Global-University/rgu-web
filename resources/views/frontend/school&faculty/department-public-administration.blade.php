            ...
            <div class="container py-5">
              ...
              <div id="tab2024" class="tab-content">
                  ...
                  <div style="max-width: 1000px; margin: 30px auto; overflow: hidden; position: relative;">
                    <div id="carousel1" style="display: flex; transition: transform 0.5s ease; justify-content: center;">
              ...
              <div id="tab2025" class="tab-content d-none">
                  ...
                  <div>
                    ...
                    <div style="max-width: 1000px; margin: 30px auto; overflow: hidden; position: relative;">
                      <div id="carousel2" style="display: flex; transition: transform 0.5s ease; justify-content: center;">
