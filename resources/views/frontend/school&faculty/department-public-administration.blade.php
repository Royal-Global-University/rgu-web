...
@section('content')
    <div class="mobile">
        ...
        <img style="padding-top: 80px; position: relative;" class="pb-3"
            src="mobile-assets/dept-public-admin/mob-publicadministration.png" alt="">
                            ...
                            <div class="accordion para1" id="accordionExample">
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                        ...
                                        <div class="accordion-body">
                                            <div class="row">
                                                <a href="assets/Departmentalpdf/AY 2022-23 BA Public Administration.pdf"
                                                    target="_blank">
                                                    <i class="fa fa-file-text px-2"></i> AY 2022-23 BA Public
                                                    Administration.pdf <i class="fa fa-download"></i>
                                                </a>
                                                <a href="assets/Departmentalpdf/AY 2023-24 BA Public Administration.pdf"
                                                    target="_blank">
                                                    <i class="fa fa-file-text px-2"></i> AY 2023-24 BA Public
                                                    Administration.pdf <i class="fa fa-download"></i>
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                        ...
                                        <div class="accordion-body">
                                            <div class="row">
                                                <a href="assets/Departmentalpdf/Old Syllabus MA Public Administration.pdf"
                                                    target="_blank">
                                                    <i class="fa fa-file-text px-2"></i> Old Syllabus MA Public
                                                    Administration.pdf <i class="fa fa-download"></i>
                                                </a>
                                            </div>
                                        </div>
