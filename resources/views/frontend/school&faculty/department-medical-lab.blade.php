    ...
    <div style="background-image: url(mobile-assets/department-all/bg.svg); background-size: cover;">
        ...
        <div class="mobile">
            ...
            <img style="padding-top: 80px; position: relative;"
                src="https://bucket-0534zd.s3.ap-south-1.amazonaws.com/mobile-assets/department-all/update/dept-medical-lab/mob-top.png" alt="">
                    ...
                    <table class="table bg-white table-responsive table-striped table-bordered border-top  vertical-scroll">
                        ...
                        <tbody class="para1 bg-light">
                            ...
                            <tr class="align-middle">
                                ...
                                <td>
                                    <p class="para1">
                                        <strong style="color: #023e8a;" class="#">M.Sc. - Medical Laboratory Technology
                                            (MMLT)</strong>
                                    </p>
                                </td>
                                <td class="para1">
                                ...
                                <td>
                                    <a target="_blank" href="programs-MSc-Medical-Laboratory-MMLT"><button type="button"
                            ...
                            <tr class="align-middle">
                                ...
                                <td>
                                    <a target="_blank" href="programs-bsc-Medical-technology-bmlt"><button type="button"
                                            style="background-color: #FF9A1E; color: #fff;"
                                            class="btn btn-md custom-details-btn fw-bold">Details</button></a>
                                </td>
                            </tr>
            ...
            <img src="https://bucket-0534zd.s3.ap-south-1.amazonaws.com/mobile-assets/department-all/update/dept-medical-lab/mob-btm.png" alt="">
        </div>

        <div class="website">
            @include('frontend/components/aheader')
            <img src="https://bucket-0534zd.s3.ap-south-1.amazonaws.com/mobile-assets/department-all/update/dept-medical-lab/web-top.png" alt="">
            ...
            <img src="https://bucket-0534zd.s3.ap-south-1.amazonaws.com/mobile-assets/department-all/update/dept-medical-lab/web-btm.png" alt="">
                        ...
                        <table class="overflow-hidden table text-wrap table-bordered border-top mb-5">
                            ...
                            <tbody class="para1 align-middle" style="background-color: #f9f9f9; text-align: start;">
                                <tr>
                                    ...
                                    <td>---</td>
                                    <td>---</td>
                                    <td>Health camp organized by Dept. of Social Work in collaboration with MLT at MV
                                        School, Pamohi with NSS and Unnat Bharat Abhiyan</td>
                                    <td>30/08/2024</td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    ...
                                    <td>---</td>
                                    <td>Invited talk on Immunology</td>
                                    <td>09/08/2024</td>
                                </tr>
                                <tr>
                                    <td>3</td>
                                ...
                                <tr>
                                    ...
                                    <td>Associate Professor, Dept of Microbiology, Gauhati Medical College &amp; Hospital
                                    </td>
                                    <td>Invited talk</td>
                                    <td>10/05/2024</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>---</td>
                                    <td>---</td>
                                    <td>Celebration of International Labor Day, Free health camp.</td>
                                    <td>01/05/2024</td>
                                </tr>
                                <tr>
                                    <td>12</td>
                                    <td>---</td>
                                    <td>---</td>
                                    <td>Health screening camp in association with NSS and in collaboration with Swagat Super
                                        Specialty Surgical Institute (SSSSI) ANH</td>
                                    <td>10/04/2024</td>
                                </tr>
                                <tr>
                                    <td>13</td>
                                    <td>---</td>
                                    <td>---</td>
                                    <td>Community outreach program organized by Department of MLT and Physiotherapy.</td>
                                    <td>09/04/2024</td>
                                </tr>
                                <tr>
                                    <td>14</td>
                                ...
                                <tr>
                                    <td>15</td>
                                    <td>Dr. Imliwati Longkumer</td>
                                    <td>Biochemist/Researcher, Northeast Cancer Hospital and Research Institute, Guwahati
                                    </td>
                                    <td>Invited talk</td>
                                    <td>11/08/2023</td>
                                </tr>
                                <tr>
                                    ...
                                    <td>---</td>
                                    <td>---</td>
                                    <td>Health Screening Camp in association with NSS and in collaboration with Dr. B.
                                        Barooah Cancer Institute Guwahati.</td>
                                    <td>30/08/2023</td>
                                </tr>
                                <tr>
                                    <td>17</td>
                                    <td>---</td>
                                    <td>---</td>
                                    <td>Celebration of World Labor Day, Free Health Checkup camp in association with NSS
                                        (RGU)</td>
                                    <td>01/05/2023</td>
                                </tr>
                                <tr>
                                    ...
                                    <td>---</td>
                                    <td>---</td>
                                    <td>World Health Day, Poster Design Contest</td>
                                    <td>06/04/2023</td>
                                </tr>
                            </tbody>
