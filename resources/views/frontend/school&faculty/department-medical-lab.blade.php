...
@section('content')
    ...
    <div class="dept-mls-floating">
        ...
        <a href="#dept-vision" class="dept-mls-float-item">
            <i class="fa fa-bullseye"></i>
            <span class="dept-mls-float-text">Vision & Mission</span>
        </a>
        ...
        <a href="#dept-syllabus" class="dept-mls-float-item">
            <i class="fa fa-file-text"></i>
            <span class="dept-mls-float-text">Syllabus</span>
        </a>

        <a href="#dept-events" class="dept-mls-float-item">
            <i class="fa fa-calendar"></i>
            <span class="dept-mls-float-text">Events</span>
        </a>

        <a href="#dept-committee" class="dept-mls-float-item">
            <i class="fa fa-users"></i>
            <span class="dept-mls-float-text">Committee</span>
        </a>

        <a href="#dept-lab" class="dept-mls-float-item">
            <i class="fa fa-flask"></i>
            <span class="dept-mls-float-text">Lab</span>
        </a>
    ...
    <div class="dept-mls-wrapper">
        ...
        <div class="dept-mls-heading" id="dept-home">
            <h1>Department of <span>Medical Laboratory Science</span></h1>
        ...
        <div class="dept-mls-prospects-section" id="dept-vision">
            ...
            <div class="dept-mls-prospects-content">
                ...
                <ul class="dept-mls-bullet-list">
                    <li>
                        The vision for students in Medical Lab Technology is to train the new generation with pioneering
                        knowledge
                ...
                <ul class="dept-mls-bullet-list">
                    <li>
                        To provide severe academic training in medical lab technology and offer hands-on laboratory
                        experience to
                        develop practical skills.
                    </li>

                    <li>
                        To provide mentorship and guidance to students by cultivating a dedication to advancing healthcare
                        through
                        accurate diagnosis and research.
                    </li>

                    <li>
                        To introduce a commitment to patient care and safety by conducting community health camps
                        prioritizing
            ...
            <div class="dept-mls-accordion-wrapper">
                ...
                <div class="dept-mls-accordion-item active">
                    ...
                    <div class="dept-mls-accordion-content">
                        <div class="dept-mls-syllabus-list">
                            ...
                            <a target="_blank"
                                href="mobile-assets/rsmas-new-dept/mls/syllabus/BMLT-SYLLABUS-2024-batch.pdf"
                                class="dept-mls-syllabus-link" download>
                                <div class="dept-mls-syllabus-link-left">
                                    <i class="fa-solid fa-file-lines"></i>
                            ...
                            <a target="_blank"
                                href="mobile-assets/rsmas-new-dept/mls/syllabus/BMLT-SYLLABUS-2023-batch.pdf"
                                class="dept-mls-syllabus-link" download>
                                <div class="dept-mls-syllabus-link-left">
                                    <i class="fa-solid fa-file-lines"></i>
                ...
                <div class="dept-mls-accordion-item">
                    ...
                    <div class="dept-mls-accordion-content">
                        <div class="dept-mls-syllabus-list">
                            <a target="_blank"
                                href="mobile-assets/rsmas-new-dept/mls/syllabus/MMLT-NEP-SYLLABUS-2025-26.pdf"
                                class="dept-mls-syllabus-link" download>
                                <div class="dept-mls-syllabus-link-left">
                                    <i class="fa-solid fa-file-lines"></i>
        ...
        <div class="dept-mls-lab-section" id="dept-lab">
            ...
            <div class="dept-mls-lab-container">
                ...
                <p class="dept-mls-intro-lab" style="padding-bottom: 30px;">
                    A state-of-art diagnostic laboratory under the aegis of the Royal School of Medical and Allied Sciences.
                    The
                    ...
                    community at large through the Royal Swasthya Seva which offers free medical services. The reports
                    generated
