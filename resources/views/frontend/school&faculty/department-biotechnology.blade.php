...
@section('content')
    <div style="background-image: url(mobile-assets/dept-biotech/s2-bg-img-1.webp);">
        <div class="mobile" >
            @include('frontend/components/mobileheader')
            <img style="padding-top: 80px; position: relative;" src="mobile-assets/dept-biotech/mobile-biotech.png" alt="">
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="row">
                                                    ...
                                                    <a href="assets/Departmentalpdf/AY 2022-23 BIOTECHNOLOGY.pdf"
                                                        target="_blank">
                                                        <i class="fa fa-file-text px-2"></i>AY 2022-23 BIOTECHNOLOGY.pdf <i
                                                            class="fa fa-download"></i>
                                                    </a>

                                                    <a href="assets/Departmentalpdf/AY 2023-24 BIOTECHNOLOGY.pdf"
                                                        target="_blank">
                                                        <i class="fa fa-file-text px-2"></i>AY 2023-24 BIOTECHNOLOGY.pdf <i
                                                            class="fa fa-download"></i>
                                                    </a>
                                        ...
                                        <div id="collapseTwo" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <div class="row">
                                                    ...
                                                    <a href="assets/Departmentalpdf/AY 2023-24 M.Sc. Biotechnology.pdf"
                                                        target="_blank">
                                                        <i class="fa fa-file-text px-2"></i>AY 2023-24 M.Sc.
                                                        Biotechnology.pdf <i class="fa fa-download"></i>
                                                    </a>
        ...
        <div class="website">
            ...
            <img src="mobile-assets/dept-biotech/web-biotech.png" alt="">
