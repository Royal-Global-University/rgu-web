...
@section('content')
    ...
    <div class="dept-sociology-wrapper">
        ...
        <div class="dept-sociology-hero" id="dept-about">
            ...
            <div class="dept-sociology-img">
                <img src="/mobile-assets/department-all/dept-sociology/head-img.png"
            ...
            <div class="dept-sociology-content">
                ...
                <p>
                    ...
                    and
                    these diversities in terms of the institution they belong to is the major strength of the Department.
                    The
                    interests and expertise of the faculty cover a broad sociological canvas. The courses therefore offered
                    are
                    ...
                    department is to promote experiential learning. Sociology touches upon every aspect of human social life
                    and
                    activity. Therefore, to make learning in the department experiential students are encouraged to write
                    projects
        ...
        <div class="dept-sociology-prospects-section" id="dept-vision">
            <div class="dept-sociology-prospects-content">
                <h3>The courses offered in the department are interdisciplinary in nature however, some of the important
                    trust
                ...
                <ul class="dept-sociology-bullet-list">
                    <li>
                        The graduate from the department get the opportunity to engage in teaching at primary and secondary
                        schools.
                    </li>
                    <li>
        ...
        <div class="dept-sociology-accordion-section" id="dept-syllabus">
            ...
            <div class="dept-sociology-accordion-wrapper">
                ...
                <div class="dept-sociology-accordion-item active">
                    ...
                    <div class="dept-sociology-accordion-content">
                        <div class="dept-sociology-syllabus-list">
                            ...
                            <a target="_blank"
                                href="/mobile-assets/department-all/dept-sociology/syllabus-pdf/structure-course-sociology-ug.pdf"
                            ...
                            <a target="_blank" href="/mobile-assets/syllabus/RSHSS/UG%20Sociology%20Syllabus.pdf"
                                class="dept-sociology-syllabus-link">
                                <div class="dept-sociology-syllabus-link-left">
                                    <i class="fa-solid fa-file-lines"></i>
                ...
                <div class="dept-sociology-accordion-item">
                    ...
                    <div class="dept-sociology-accordion-content">
                        <div class="dept-sociology-syllabus-list">
                            ...
                            <a target="_blank" href="/mobile-assets/syllabus/RSHSS/PG%20Sociology%20Syllabus.pdf"
                                class="dept-sociology-syllabus-link">
                                <div class="dept-sociology-syllabus-link-left">
                                    <i class="fa-solid fa-file-lines"></i>
                ...
                <div class="dept-sociology-accordion-item">
                    ...
                    <div class="dept-sociology-accordion-content">
                        <div class="dept-sociology-syllabus-list">
                            <a href="/phd" class="dept-sociology-syllabus-link">
                                <div class="dept-sociology-syllabus-link-left">
                                    <i class="fa-solid fa-file-lines"></i>
                                    Click to View
                                </div>
                        ...
                        <table class="dept-sociology-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>2</td>
                                    <td>Dr. Tripti Das</td>
                                    <td>Negotiating Power and Gendered Citizenship: A Sociological Analysis of Political
                                        Participation and
                                        Grassroots Leadership among SHG Women in Panchayati Raj Institutions in Selected
                                        Districts of Lower
                                        Assam</td>
    ...
    <script>
        const tableData = [{
                ...
                rows: [
                    ["1", "External Member ",
                        "Dr. Shabeena Yasmin Saikia, Associate Professor, Sociology ( Gauhati University)  "
                    ],
                    ...
                    ["4", "Internal Member  Faculty Expert- Sociology) ",
                        "Dr. Tripti Das, Assistant Professor in the Department of Sociology"
                    ],
                    ["5", "Internal Member (Faculty expert- Sociology) ",
                        "Dr. Denim Deka,Assistant Professor in the Department of Sociology"
                    ],
                    ["6", "Internal Member (Faculty expert- Sociology) ",
                        "Adishree Borgohain, Assistant Professor of Sociology "
                    ],
                    ["7", "Internal Member (Faculty expert- Sociology) ",
                        "Kadiguang Panmei , Assistant Professor of Sociology"
                    ],
                    ["8", "Internal Member (Faculty expert- Sociology) ",
                        "Ms. Prajna Borah , Assistant Professor of Sociology"
                    ],
                    ["9", "Internal Member (Faculty expert- Sociology) ",
                        "Dr. Trishna Mani Thakuria, Assistant Professor of Sociology"
                    ],
                    ["10", "Internal member (Assistant Professor)  ",
                        "Ms. Lalzikpuii Rajkhowa, Assistant Professor of Sociology"
                    ]
                ]
            },
            {
                ...
                rows: [
                    ["1", "Head of the Department", "Dr. Tripti Das", "Assistant Professor & Coordinator",
                        "Chairperson"
                    ],
                    ["2", "Two Professors, including the Dean of the School", "Prof. Surajit Chandra Mukhopadhyay",
                        "Professor & Dean, RSHSS", "Member"
                    ],
                    ["", "", "", "", ""],
                    ["3", "Two Associate Professors one of them will be the member secretary", "", "", ""],
                    ["", "", "", "", ""],
                    ["4", "Two Assistant Professors holding Ph.D. degree", "Dr. Trishna Mani Thakuria",
                        "Assistant Professor", "Member"
                    ],
                    ["", "", "Dr. Denim Deka", "Assistant Professor", "Member"],
                    ["5", "External member nominated by the URC", "Prof. Saswati Choudhury",
                        "Professor & Acting Director, Omeo Kumar Das Institute of Social Change and Development",
                        "Member"
                    ],
                    ["", "", "", "", ""],
                    ["", "", "", "", ""]
