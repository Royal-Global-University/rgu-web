                        ...
                        <div class="card rounded d-flex flex-column"
                            ...
                            <div class="card-body d-flex flex-column flex-grow-1">
                                <h5 style="font-weight: 600; color: #27467A;" class="card-title headd2 pb-2">Ms.
                                    Bachaspatimayum Deeparani
                                    Devi
                                </h5>
                                <p class="para1" style="color: #27467A; line-height: 1.3;">Assistant Professor and Clinical
                                    Psychologist
                                    (Associate)</p>
        ...
        <div class="website">
            ...
            <div style="padding: 20px 90px;">
                ...
                <div class="row" style="display: flex; align-items: center; justify-content: center;">
                    ...
                    <div class="col-lg-3 mb-4">
                        <div class="card rounded d-flex flex-column"
                            style="background-color: #fff; border: none; box-shadow: -1px 3px 5px 0px rgba(0,0,0,0.25); height: 670px;">
                            <div class="p-3">
                                <img style="height: 310px; width: 100%;" src="mobile-assets/all-faculty/rsbas/surajit.jpeg"
                                    class="img-fluid rounded border" />
                            </div>
