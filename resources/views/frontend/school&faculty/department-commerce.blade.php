                        ...
                        <div class="table-responsive">
                            <table class="overflow-hidden table text-wrap table-bordered border-top mb-5">
                                ...
                                <tbody class="para1 align-middle" style="background-color: #f9f9f9; text-align: start;">
                                    ...
                                    <tr>
                                        <td>2</td>
                                        <td>Two Professors, including the Dean of the School</td>
                                        <td>Prof. (Dr) A.P. Singh</td>
                                        <td>Professor, RSC</td>
                                    ...
                                    <tr>
                                        <td>4</td>
                                        <td>Two Associate Professors - one of them will be member secretary
                                        </td>
                                    ...
                                    <tr>
                                        <td>7</td>
                                        <td>Three external members not below the rank of Professors,
                                            including members from an allied department, nominated by the
                                            URC</td>
                                        <td>Prof. (Dr) Aparajeeta Borkakoty</td>
