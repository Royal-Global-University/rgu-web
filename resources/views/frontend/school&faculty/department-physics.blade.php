...
@section('content')
    <div style="background-image: url(mobile-assets/dept-physics/s2-bg-img-1.webp);">
        <div class="mobile" >
            @include('frontend/components/mobileheader')
            <img style="padding-top: 80px; position: relative;" src="mobile-assets/dept-physics/mobile-physics.png" alt="">
                    ...
                    <div>
                        ...
                        <div class="text-dark">
                            <h3 class="headd3 text-dark fw-bold kd-split-text pt-2">
                                <a href="https://www.rgu.ac/research-and-development-rsaps-physics.php">
                                    Click More</a>
                            </h3>
                        </div>
                    </div>
                                ...
                                <div class="accordion para1" id="accordionExample">
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <a href="assets/Departmentalpdf/AY 2022-23 BSc Physics.pdf" target="_blank">
                                                    <i class="fa fa-file-text px-2"></i> AY 2022-23 BSc Physics.pdf
                                                    <i class="fa fa-download"></i>
                                                </a>
                                                <br />

                                                <a href="assets/Departmentalpdf/AY 2023-24 BSc Physics.pdf" target="_blank">
                                                    <i class="fa fa-file-text px-2"></i> AY 2023-24 BSc Physics.pdf
                                                    <i class="fa fa-download"></i> </a><br />

                                                <a href="assets/Departmentalpdf/Old Syllabus B.Sc. Physics.pdf"
                                                    target="_blank">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseTwo" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <a href="assets/Departmentalpdf/AY 2021-22 M.Sc. Physics.pdf">AY 2021-22
                                                    M.Sc. Physics.pdf<i class="fa fa-download"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
        ...
        <div class="website">
            ...
            <img src="mobile-assets/dept-physics/physics-web.png" alt="">
