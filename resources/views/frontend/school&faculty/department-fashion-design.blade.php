...
@section('content')
    <div style="background-image: url(mobile-assets/dept-fashion/s2-bg-img-1.webp);">
        <div class="mobile">
            @include('frontend/components/mobileheader')
            <img style="padding-top: 80px; position: relative;" src="mobile-assets/dept-fashion/mobile-fashion.png" alt="">
        ...
        <div class="website">
            ...
            <img src="mobile-assets/dept-fashion/web-fashion-design.png" alt="">
