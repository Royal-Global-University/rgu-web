            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-image">
                                <img src="/mobile-assets/all-faculty/rsd/1.jpeg" alt="Profile image ">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-image">
                                <img src="/mobile-assets/updated-faculty-img/Tikendra.png" alt="Profile image">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-image">
                                <img src="/mobile-assets/updated-faculty-img/Asif-Iqbal-Mazid-RSFT.png" alt="Profile image">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            ...
                            <h3 class="card-name">Sattyakee D'Com Bhuyan</h3>
                            <p class="card-designation">Associate Dean</p>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-image">
                                <img src="/mobile-assets/updated-faculty-img/suresh.jpg" alt="Profile image">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-image">
                                <img src="/mobile-assets/all-faculty/rsd/2.png" alt="Profile image">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-image">
                                <img src="/demo-assets/Dipankar.png" alt="Profile image">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-image">
                                <img src="/mobile-assets/updated-faculty-img/Manas.png" alt="Profile image">
                            </div>
                            <h3 class="card-name">Mr. Manash Pratim Borah</h3>
                            <p class="card-designation">Assistant Professor</p>
                            <a href="/faculty-manash-pratim-borah" class="profile-link">View Profile</a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-image">
                                <img src="/mobile-assets/all-faculty/rsd/3.png" alt="Profile image">
                            </div>
                            <h3 class="card-name">Ms. Varsha Jain</h3>
                            <p class="card-designation">Assistant Professor</p>
                            <a href="/faculty-varsha-jain" class="profile-link">View Profile</a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-image">
                                <img src="/mobile-assets/all-faculty/rsd/4.png" alt="Profile image">
                            </div>
                            <h3 class="card-name">Mr. Zubin Islam</h3>
                            <p class="card-designation">Assistant Professor</p>
                            <a href="/faculty-zubin-islam" class="profile-link">View Profile</a>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            ...
                            <a href="/faculty-kasturi-borah" class="profile-link">View Profile</a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-image">
                                <img src="/mobile-assets/updated-faculty-img/Barsha-Kunda-RSA.png" alt="Profile image ">
                            </div>
                            <h3 class="card-name">Ar. Barsha Kunda</h3>
                            <p class="card-designation">Assistant Professor</p>
                            <a href="/faculty-barsha-kunda" class="profile-link">View Profile</a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            ...
                            <p class="card-designation">Assistant Professor</p>
                            <a href="/faculty-jagriti-pathak" class="profile-link">View Profile</a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-image">
                                <img src="/mobile-assets/all-faculty/rsa/11.jpeg" alt="Profile image ">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-image">
                                <img src="/mobile-assets/all-faculty/rsa/13.jpeg" alt="Profile image ">
                            </div>
                            <h3 class="card-name">Ar. Pratyasha Das</h3>
                            <p class="card-designation">Assistant Professor</p>
                            <a href="/faculty-pratyasha-das" class="profile-link">View Profile</a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-image">
                                <img src="/mobile-assets/all-faculty/rsa/15.jpeg" alt="Profile image ">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            ...
                            <a href="/faculty-mousumi-deka" class="profile-link">View Profile</a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-image">
                                <img src="/mobile-assets/updated-faculty-img/Ar%20Madhu.jpg" alt="Profile image ">
                            </div>
                            <h3 class="card-name">Ar. Madhu Vottery</h3>
                            <p class="card-designation">Visiting Faculty</p>
                            <a href="/faculty-madhu-vottery" class="profile-link">View Profile</a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-image">
                                <img src="/mobile-assets/updated-faculty-img/shweta.png" alt="Profile image ">
                            </div>
                            <h3 class="card-name">Ar. Shweta Das</h3>
                            <p class="card-designation">Visiting Faculty</p>
                            <a href="/faculty-shweta-das" class="profile-link">View Profile</a>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-image">
                                <img src="/mobile-assets/updated-faculty-img/Akriti-Mazumdar.png" alt="Profile image">
                            </div>
