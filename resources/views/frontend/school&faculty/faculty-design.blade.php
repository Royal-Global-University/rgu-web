...
@section('content')
    <div class="mobile">
        ...
        <section style="background-image: url(mobile-assets/boardofmanagement/bg.svg); background-size: cover; padding-top: 100px;">
                ...
                <div class="row" style="display: flex; align-items: center; justify-content: center;">
                    ...
                    <div class="col-lg-3 mb-4">
                        <div class="card rounded d-flex flex-column"
                            ...
                            <div class="card-body d-flex flex-column flex-grow-1">
                                <h5 style="font-weight: 600; color: #27467A;" class="card-title headd2 pb-2">Prof. Tikendra Kumar
                                    Sahu</h5>
                                <p class="para1" style="color: #27467A; line-height: 1.3;">
                                    Professor
                                </p>
                ...
                <div class="row" style="display: flex; align-items: center; justify-content: center;">
                    ...
                    <div class="col-lg-3 mb-4">
                        <div class="card rounded d-flex flex-column"
                            ...
                            <div class="p-3">
                                <img style="height: 300px; width: 100%;"
                                    src="mobile-assets/updated-faculty-img/Barsha-Kunda-RSA.png" class="img-fluid rounded border" />
                            </div>
                            <div class="card-body d-flex flex-column flex-grow-1">
                ...
                <div class="row" style="display: flex; align-items: center; justify-content: center;">
                    ...
                    <div class="col-lg-3 mb-4">
                        <div class="card rounded d-flex flex-column"
                            ...
                            <div class="p-3">
                                <img style="height: 310px; width: 100%;"
                                    src="mobile-assets/updated-faculty-img/Aruniva-Bhagwati.png" class="img-fluid rounded border" />
                            </div>
                            <div class="card-body d-flex flex-column flex-grow-1">
                ...
                <div class="row" style="display: flex; align-items: center; justify-content: center;">
                    ...
                    <div class="col-lg-3 mb-4">
                        <div class="card rounded d-flex flex-column"
                            ...
                            <div class="p-3">
                                <img style="height: 310px; width: 100%;"
                                    src="mobile-assets/updated-faculty-img/Ms-Jahnabi-Mahanta-RSBAS.png" class="img-fluid rounded border" />
                            </div>
                            <div class="card-body d-flex flex-column flex-grow-1">
                                <h5 style="font-weight: 600; color: #27467A;" class="card-title headd2 pb-2">Ms. Jahnabi
                                    Mahanta</h5>
