    ...
    <div style="background-image: url(https://media.rgu.ac/department-all/bg.svg); background-size: cover;">
        ...
        <div class="mobile">
            @include('frontend/components/mobileheader')
                    ...
                    <!-- floating button  -->
          <img style="padding-top: 80px; position: relative;" class="pb-4" src="https://media.rgu.ac/department-all/dept-mathematics/mobile-mathematics.png" alt="">
                  ...
                  <table class="overflow-hidden table text-wrap table-bordered border-top mb-5">
                    ...
                    <tbody class="para1 align-middle" style="background-color: #f9f9f9; text-align: start;">
                      ...
                      <tr>
                        ...
                        <td>Felicitated as the Eminent Mathematician of the State for the year 2024 on the occasion of
                    ...
                    <div class="accordion para1" id="accordionExample">
                      <div class="accordion-item">
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                          ...
                          <div class="accordion-body">
                            <div class="row">
                              <a href="https://media.rgu.ac/department-all/syllabus-new/1RSAPS/Maths/B.Sc. Maths Syllabus AY 2023-24 29.04.2025.pdf"
                                target="_blank">
                                <i class="fa fa-file-text px-2"></i>
                                COURSE STRUCTURE & SYLLABUS (BASED ON NATIONAL EDUCATION POLICY 2020) FOR B.Sc. IN
                                MATHEMATICS
                                <i class="fa fa-download"></i>
                              </a>
                              <a href="https://media.rgu.ac/department-all/syllabus-new/1RSAPS/Maths/Structure of syllabus - UG_MATHS.pdf"
                                target="_blank">
                                <i class="fa fa-file-text px-2"></i>
                      ...
                      <div class="accordion-item">
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                          ...
                          <div class="accordion-body">
                            <div class="row">
                              <a href="https://media.rgu.ac/department-all/syllabus-new/1RSAPS/Maths/MSc_Maths_NEP_Syllabus AY 2025-26_29.04.2025.pdf"
                                target="_blank">
                                <i class="fa fa-file-text px-2"></i>
                                COURSE STRUCTURE & SYLLABUS (BASED ON NATIONAL EDUCATION POLICY 2020) W.E.F AY- 2025 – 26
                                <i class="fa fa-download"></i>
                              </a>

                              <a href="https://media.rgu.ac/department-all/syllabus-new/1RSAPS/Maths/Structure of syllabus - PG_MATHS.pdf"
                                target="_blank">
                                <i class="fa fa-file-text px-2"></i>
