    ...
    <div style="background-image: url(mobile-assets/department-all/bg.svg); background-size: cover;">
        ...
        <div class="mobile">
            ...
            <section style="padding-top: 130px;">
                <img src="mobile-assets/department-all/dept-food-tech/mobile-top.png" alt="">
                <img src="mobile-assets/department-all/dept-food-tech/mobile-down.png" alt="">
            </section>
            ...
            <div class="container pt-3">
                ...
                <div style="background-color: transparent; padding:10px; width:100%; margin: 0px auto;">
                    ...
                    <div
                        ...
                        <span style="font-size: 18px;">M.Sc. Food Science and Technology</span>
                        <span
                ...
                <div style="background-color: transparent; padding:10px; width:100%; margin: 0px auto;">
                    ...
                    <div
                        ...
                        <span style="font-size: 18px;">B.Sc. (H) Food Science and Technology</span>
                        <span
                            style="position:absolute; right:0; bottom:0; width:15px; height:15px; background-color:#FF9A1E; clip-path:polygon(100% 0, 0 100%, 100% 100%);"></span>
                    </div>
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body"
                                                ...
                                                <div class="row"
                                                    ...
                                                    <a href="mobile-assets/department-all/dept-food-tech/updated-syllabus/course-structure-ug.pdf"
                                                        target="_blank" style="color: #27467A;">
                                                        <i class="fa fa-file-text px-2"></i> Structure of Syllabus -- Food
                                                        Technology

                                                        <i class="fa fa-download ms-2" style="color: #FF9A1E;"></i>
                                                    </a>

                                                    <a href="mobile-assets/department-all/dept-food-tech/updated-syllabus/detailed-syllabus-food-tech-ug.pdf"
                                                        target="_blank" style="color: #27467A;">
                                                        <i class="fa fa-file-text px-2"></i> Detailed Syllabus -- B.Sc. Food
                                                        Technology
                                                        <i class="fa fa-download ms-2" style="color: #FF9A1E;"></i>
                                                    </a>
                                        ...
                                        <div id="collapseTwo" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body"
                                                ...
                                                <div class="row"
                                                    ...
                                                    <a href="mobile-assets/department-all/dept-food-tech/updated-syllabus/detailed-syllabus-food-tech-pg.pdf"
                                                        target="_blank" style="color: #27467A;">
                                        ...
                                        <tbody class="para1" id="mobileEventScrollContent"
                                                ...
                                                <td style="display: flex; align-items: center; padding: 12px;">
                                                    ...
                                                    <div>
                                                        <div style="font-weight: bold; color: #27467A;">
                                                            ...
                                                            communication & health education, niche, Guwahati) | Invited
                                                            talk.
                                                        </div>
                                                        <a href="#"
                                            ...
                                            <tr style="border-bottom: 1px solid #ddd;">
                                                <td style="display: flex; align-items: center; padding: 12px;">
                                                    ...
                                                    <div>
                                                        <div style="font-weight: bold; color: #27467A;">
                                                            01-04-2024 | Er. Raju Prajapati (Ceo agrivision4u, Indore) |
                                                            Career counselling.
                                                        </div>
                                                        <a href="#"
                                                            style="color: #FF9A1E; font-weight: bold; font-size: 14px;">Read
                                            ...
                                            <tr style="border-bottom: 1px solid #ddd;">
                                                <td style="display: flex; align-items: center; padding: 12px;">
                                                    ...
                                                    <div>
                                                        <div style="font-weight: bold; color: #27467A;">
                                                            09-08-2024 | Mr. Anupam Baruah (Ceo miha trading solutions) |
                                                            Invited talk.
                                                        </div>
                                                        <a href="#"
                                                            style="color: #FF9A1E; font-weight: bold; font-size: 14px;">Read
                                            ...
                                            <tr style="border-bottom: 1px solid #ddd;">
                                                <td style="display: flex; align-items: center; padding: 12px;">
                                                    ...
                                                    <div>
                                                        <div style="font-weight: bold; color: #27467A;">
                                                            16-09-2024 | Prof. (Dr.) Iddya Karunasagar (Research advisor at
                                                            Nitte University,
                                                            Mangalore and international consultant in food safety, FAO) |
                                                            Invited talk.
                                                        </div>
                                                        <a href="#"
                                                            style="color: #FF9A1E; font-weight: bold; font-size: 14px;">Read
                                            ...
                                            <tr style="border-bottom: 1px solid #ddd;">
                                                <td style="display: flex; align-items: center; padding: 12px;">
                                                    ...
                                                    <div>
                                                        <div style="font-weight: bold; color: #27467A;">
                                                            16-09-2024 | Dr. Sabu Thomas (Director centre of excellence in
                                                            microbiome, government
                                                            of Kerala, Thiruvananthapuram, Kerala) | Invited talk.
                                                        </div>
                                                        <a href="#"
                                                            style="color: #FF9A1E; font-weight: bold; font-size: 14px;">Read
                                                            more
                                            ...
                                            <tr style="border-bottom: 1px solid #ddd;">
                                                <td style="display: flex; align-items: center; padding: 12px;">
                                                    ...
                                                    <div>
                                                        <div style="font-weight: bold; color: #27467A;">
                                                            15-10-2024 | Prof. (Dr.) Bipul Deka (Assam Agriculture
                                                            University, Jorhat) | Invited
                                                            talk.
                                                        </div>
                                                        <a href="#"
                                                            style="color: #FF9A1E; font-weight: bold; font-size: 14px;">Read
        ...
        <div class="website">
            ...
            <section>
                ...
                <section id="about">
                    ...
                    <img src="mobile-assets/department-all/dept-food-tech/web-top.png" alt="">
                    <img src="mobile-assets/department-all/dept-food-tech/web-down.png" alt="">
                    ...
                    <div class="container">
                        ...
                        <div style="background-color:#FDF9F4; padding:10px; width:100%; margin: 0px auto;">
                            ...
                            <div
                                ...
                                <span style="font-size:22px;">M.Sc. Food Science and Technology</span>
                                <span
                                    style="position:absolute; right:0; bottom:0; width:15px; height:15px; background-color:#FF9A1E; clip-path:polygon(100% 0, 0 100%, 100% 100%);"></span>
                            </div>
                        ...
                        <div style="background-color:#FDF9F4; padding:10px; width:100%; margin: 0px auto;">
                            ...
                            <div
                                ...
                                <span style="font-size:22px; padding-right: 20px;">B.Sc. Food Science and Technology
                                                ...
                                                <tbody class="para1" id="scrollContent"
                                                        ...
                                                        <td style="display: flex; align-items: center; padding: 12px;">
                                                            ...
                                                            <div>
                                                                <div style="font-weight: bold; color: #27467A;">
                                                                    ...
                                                                    & head nutrition information
                                                                    communication & health education, niche, Guwahati) |
                                                                    Invited talk.
                                                                </div>
                                                                <a href="#"
                                                                    style="color: #FF9A1E; font-weight: bold; font-size: 14px;">Read
                                                    ...
                                                    <tr style="border-bottom: 1px solid #ddd;">
                                                        <td style="display: flex; align-items: center; padding: 12px;">
                                                            ...
                                                            <div>
                                                                <div style="font-weight: bold; color: #27467A;">
                                                                    01-04-2024 | Er. Raju Prajapati (Ceo agrivision4u,
                                                                    Indore) | Career counselling.
                                                                </div>
                                                                <a href="#"
                                                                    style="color: #FF9A1E; font-weight: bold; font-size: 14px;">Read
                                                                    more
                                                    ...
                                                    <tr style="border-bottom: 1px solid #ddd;">
                                                        <td style="display: flex; align-items: center; padding: 12px;">
                                                            ...
                                                            <div>
                                                                <div style="font-weight: bold; color: #27467A;">
                                                                    09-08-2024 | Mr. Anupam Baruah (Ceo miha trading
                                                                    solutions) | Invited talk.
                                                                </div>
                                                                <a href="#"
                                                                    style="color: #FF9A1E; font-weight: bold; font-size: 14px;">Read
                                                                    more
                                                    ...
                                                    <tr style="border-bottom: 1px solid #ddd;">
                                                        <td style="display: flex; align-items: center; padding: 12px;">
                                                            ...
                                                            <div>
                                                                <div style="font-weight: bold; color: #27467A;">
                                                                    16-09-2024 | Prof. (Dr.) Iddya Karunasagar (Research
                                                                    advisor at Nitte University,
                                                                    Mangalore and international consultant in food safety,
                                                                    FAO) | Invited talk.
                                                                </div>
                                                                <a href="#"
                                                                    style="color: #FF9A1E; font-weight: bold; font-size: 14px;">Read
                                                    ...
                                                    <tr style="border-bottom: 1px solid #ddd;">
                                                        <td style="display: flex; align-items: center; padding: 12px;">
                                                            ...
                                                            <div>
                                                                <div style="font-weight: bold; color: #27467A;">
                                                                    16-09-2024 | Dr. Sabu Thomas (Director centre of
                                                                    excellence in microbiome, government
                                                                    of Kerala, Thiruvananthapuram, Kerala) | Invited talk.
                                                                </div>
                                                                <a href="#"
                                                                    style="color: #FF9A1E; font-weight: bold; font-size: 14px;">Read
