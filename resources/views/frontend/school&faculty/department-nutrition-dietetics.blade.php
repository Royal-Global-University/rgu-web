        ...
        <div class="mobile">
            ...
            <section style="background-color: #fff8f0; padding: 130px 10px 0px 10px;">
                ...
                <h2 class="headd3 text-center" style="color: #27467A; font-weight: 700;">
                    ...
                    Medical & Allied Health Sciences (RSMAS)
                </h2>
                            ...
                            <div class="txaa-slide-down-1">
                                <div style=" height: 550px; width: 100%;" class="kd-about-3-img img-cover fix kd-img-ani-1">
                                    <img class="rounded " decoding="async"
                                        src="mobile-assets/department-all/rsmas/nutrition/headimg.png" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            ...
                            <p class="mobile-para1 pt-3" style="color: #264273; text-align: justify; line-height: 1.5;">
                                The Department of Nutrition & Dietetics is committed to excellence in education, research,
                                and
                                community service, aiming to shape future professionals in the field of nutrition, health,
                                and
                                wellness. Our curriculum is designed to provide students with a strong foundation in the
                                science of
                                nutrition, clinical dietetics, food service management, and public health nutrition.

                            </p>

                            <p class="mobile-para1 pt-1" style="color: #264273; text-align: justify; line-height: 1.5;">
                                Department of Food Technology at The Assam Royal Global University, Guwahati, offers B.Sc,
                                M.Sc and
                                Ph.D programmes to produce future food technologists of global fame with strong knowledge
                                and
                                understanding of the subject. The courses gives in depth background of physical, chemical
                                and
                                biological compositions of foods, different processing technologies for quality food
                                production and
                                development of innovative, healthy and safe foods. The department is self sufficient carry
                                out the
                                programme with proper infrastructure interms of class rooms and laboratories with state of
                                art
                                facilities. The graduate and post graduates develop competencies to serve in academia, food
                                industries, research institutes, food regulatory agencies or to become a food entrepreneur.
                            </p>
                ...
                <div class="pt-3">
                    ...
                    <img src="mobile-assets/department-all/rsmas/nutrition/vision-mission-mob.png" alt="">
                </div>
            ...
            <div class="container">
                ...
                <div style="background-color:#FDF9F4; padding:10px; width:100%; margin: 0px auto;">
                    ...
                    <div
                        ...
                        <span style="font-size:18px;">M.Sc. - Nutrition and Dietetics</span>
                        <span
                    ...
                    <!-- Statute Items -->
                    <a target="_blank" href="programs-MSc-Nutrition" style="text-decoration:none;">
                        <div
                            ...
                            <span>
                                <a class="para1 fw-bold"
                                    ...
                                    href="programs-MSc-Nutrition">View Details</a>
                            </span>
                        </div>
                    </a>
                </div>
                ...
                <div style="background-color:#FDF9F4; padding:10px; width:100%; margin: 0px auto;">
                    ...
                    <div
                        ...
                        <span style="font-size:18px;">B.Sc. - Nutrition and Dietetics</span>
                        <span
                            style="position:absolute; right:0; bottom:0; width:15px; height:15px; background-color:#FF9A1E; clip-path:polygon(100% 0, 0 100%, 100% 100%);"></span>
                    </div>
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body"
                                                ...
                                                <div class="row" style="display: flex; flex-direction: column; gap: 12px;">
                                                    ...
                                                    <a href="mobile-assets/department-all/rsmas/nutrition/updated-syllabus/structure-of-syllabus-bsc.pdf"
                                                    ...
                                                    <a href="mobile-assets/department-all/rsmas/nutrition/updated-syllabus/NUTRITION-UG-2025-SYLLABUS.pdf"
                                                        target="_blank" style="color: #27467A;">
                                        ...
                                        <tbody class="para1" id="mobileEventScrollContent"
                                                ...
                                                <td style="display: flex; align-items: center; padding: 12px;">
                                                    ...
                                                    <div>
                                                        <div style="font-weight: bold; color: #27467A;">
                                                            28-09-2023 | Dr. SubbaRao M Gavaravarapu (Scientist F & head,
                                                            nutrition, communication
                                                            & health education, ICMR-NIN, Tarnaka, Hyderabad) | Invited
                                                            talk.
                                                        </div>
                                                        <a href="#"
                                            ...
                                            <tr style="border-bottom: 1px solid #ddd;">
                                                <td style="display: flex; align-items: center; padding: 12px;">
                                                    ...
                                                    <div>
                                                        <div style="font-weight: bold; color: #27467A;">
                                                            14-03-2024 | Dr. Dhruvajyoti Choudhury (Consultant nephrologist
                                                            & renal transplant
                                            ...
                                            <tr style="border-bottom: 1px solid #ddd;">
                                                <td style="display: flex; align-items: center; padding: 12px;">
                                                    ...
                                                    <div>
                                                        <div style="font-weight: bold; color: #27467A;">
                                                            08-04-2024 | Dr. Jesto George (Deputy director & central
                                            ...
                                            <tr style="border-bottom: 1px solid #ddd;">
                                                <td style="display: flex; align-items: center; padding: 12px;">
                                                    ...
                                                    <div>
                                                        <div style="font-weight: bold; color: #27467A;">
                                                            10-09-2024 | Ms. Dimi Ingtipi (Senior dietician, Department of
                                                            Digestive Disease and
                                                            Clinical Nutrition, Dr. B Barooah Cancer Institute, Guwahati) |
                                                            Invited talk.
                                                        </div>
                                                        <a href="#"
                                                            style="color: #FF9A1E; font-weight: bold; font-size: 14px;">Read
                        ...
                        <div class="table-responsive">
                            <table class="overflow-hidden table text-wrap table-bordered border-top mb-5">
                                ...
                                <tbody class="para1 align-middle" style="background-color: #f9f9f9; text-align: start;">
                                    ...
                                    <tr>
                                        <td>2</td>
                                        <td>Dr. Moloya Gogoi</td>
                                        <td>HOD &amp; Associate Professor, Dept. of Food Science &amp; Nutrition, AAU,
                                            Jorhat</td>
                                        <td>External Member</td>
                                    </tr>
                                    <tr>
                                        <td>3</td>
                                        <td>Ms. Mitali Dowerah</td>
                                        <td>Consultant &amp; HOD, Dept. of Nutrition &amp; Dietetics, Ayursundra Hospital,
                                            Guwahati
                                        </td>
                                        <td>External Member</td>
                                    </tr>
                            ...
                            <table class="overflow-hidden table text-wrap table-bordered border-top mb-5">
                                <thead class="text-white" style="background-color: #27467a">
                                    <tr>
                                        ...
                                        <th class="text-white">Designation</th>
                                        <th class="text-white">Nomination</th>
                                    </tr>
                                </thead>
                                <tbody class="para1 align-middle" style="background-color: #f9f9f9; text-align: start;">
                                    <tr>
                                        ...
                                        <td>Dean &amp; Professor, RSMAS</td>
                                        <td>Chairperson</td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        <td>Prof. Pranati Das</td>
                                        <td>Professor, Dept. of Food Technology</td>
                                        <td>Member</td>
                                    </tr>
                                    <tr>
                                        <td>3</td>
                                        <td>Dr. D Jayarajan</td>
                                        <td>Associate Professor, Dept. of Physiotherapy</td>
                                        <td>Member Secretary</td>
                                    </tr>
                                    <tr>
                                        <td>4</td>
                                        <td>Dr. Madhusmita Koch</td>
                                        <td>Associate Professor, Dept. of Medical Laboratory Technology</td>
                                        <td>Member</td>
                                    </tr>
                                    <tr>
                                        <td>5</td>
                                        <td>Dr. Rupesh Kumar</td>
                                        <td>Assistant Professor, Dept. of Medical Laboratory Technology</td>
                                        <td>Member</td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <section style="background-color: #FFF8F0;">
                            ...
                            <div class="row align-items-center gx-5">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <p class="mobile-para1 pt-3"
                                        ...
                                        The Department of Nutrition & Dietetics is committed to excellence in education,
                                        research, and
                                        community service, aiming to shape future professionals in the field of nutrition,
                                        health, and
                                        wellness. Our curriculum is designed to provide students with a strong foundation in
                                        the science of
                                        nutrition, clinical dietetics, food service management, and public health nutrition.
                        ...
                        <div style="background-color: #fff;">
                            <div class="p-5">
                                ...
                                <img class="w-100" src="mobile-assets/department-all/rsmas/nutrition/vision-mission-web.png"
                                    alt="">
                    ...
                    <div class="container">
                        ...
                        <div style="background-color:#FDF9F4; padding:10px; width:100%; margin: 0px auto;">
                            ...
                            <div
                                ...
                                <span style="font-size:22px;">M.Sc. - Nutrition and Dietetics</span>
                                <span
                                    style="position:absolute; right:0; bottom:0; width:15px; height:15px; background-color:#FF9A1E; clip-path:polygon(100% 0, 0 100%, 100% 100%);"></span>
                            </div>
                        ...
                        <div style="background-color:#FDF9F4; padding:10px; width:100%; margin: 0px auto;">
                            ...
                            <div
                                ...
                                <span style="font-size:22px; padding-right: 20px;">B.Sc. - Nutrition and Dietetics</span> |
                                                ...
                                                <tbody class="para1" id="scrollContent" style="background-color: #f9f9f9;">
                                                    ...
                                                    <tr style="border-bottom: 1px solid #ddd;">
                                                        <td style="display: flex; align-items: center; padding: 12px;">
                                                            ...
                                                            <div>
                                                                <div style="font-weight: bold; color: #27467A;">
                                                                    28-09-2023 | Dr. SubbaRao M Gavaravarapu (Scientist F &
                                                                    head, nutrition, communication
                                                                    & health education, ICMR-NIN, Tarnaka, Hyderabad) |
                                                                    Invited talk.
                                                                </div>
                                                                <a href="#"
                                                                    style="color: #FF9A1E; font-weight: bold; font-size: 14px;">Read
                                                    ...
                                                    <tr style="border-bottom: 1px solid #ddd;">
                                                        <td style="display: flex; align-items: center; padding: 12px;">
                                                            ...
                                                            <div>
                                                                <div style="font-weight: bold; color: #27467A;">
                                                                    14-03-2024 | Dr. Dhruvajyoti Choudhury (Consultant
                                                                    nephrologist & renal transplant
                                                                    physician, Apollo Hospitals, Guwahati) | Invited talk.
                                                                </div>
                                                                <a href="#"
                                                                    style="color: #FF9A1E; font-weight: bold; font-size: 14px;">Read
                                                    ...
                                                    <tr style="border-bottom: 1px solid #ddd;">
                                                        <td style="display: flex; align-items: center; padding: 12px;">
                                                            ...
                                                            <div>
                                                                <div style="font-weight: bold; color: #27467A;">
                                                                    10-09-2024 | Ms. Dimi Ingtipi (Senior dietician,
                                                                    Department of Digestive Disease and
                                                                    Clinical Nutrition, Dr. B Barooah Cancer Institute,
                                                                    Guwahati) | Invited talk.
                                                                </div>
                                                                <a href="#"
                                                                    style="color: #FF9A1E; font-weight: bold; font-size: 14px;">Read
                                            ...
                                            <table class="overflow-hidden table text-wrap table-bordered border-top mb-5">
                                                ...
                                                <tbody class="para1 align-middle"
                                                    ...
                                                    <tr>
                                                        <td>2</td>
                                                        <td>Dr. Moloya Gogoi</td>
                                                        <td>HOD &amp; Associate Professor, Dept. of Food Science &amp;
                                                            Nutrition, AAU, Jorhat</td>
                                                        <td>External Member</td>
                                                    </tr>
                                                    <tr>
                                                        <td>3</td>
                                                        <td>Ms. Mitali Dowerah</td>
                                                        <td>Consultant &amp; HOD, Dept. of Nutrition &amp; Dietetics,
