                    ...
                    <table class="table bg-white table-responsive table-striped table-bordered border-top  vertical-scroll">
                        ...
                        <tbody class="para1 bg-light">
                            <tr class="align-middle">
                                ...
                                <td>
                                    <p class="para1">
                                        <strong style="color: #023e8a;" class="#">B.A. - English</strong><br>
                                ...
                                <td>
                                    <a target="_blank" href="programs-BA-English"><button type="button"
                            ...
                            <tr class="align-middle">
                                ...
                                <td>
                                    <p class="para1">
                                        <strong style="color: #023e8a;" class="#">M.A. - English</strong>
                                ...
                                <td>
                                    <a target="_blank" href="programs-MA-English"><button type="button"
                                            style="background-color: #FF9A1E; color: #fff;"
                                            class="btn btn-md custom-details-btn fw-bold">Details</button></a>
                                </td>
                            </tr>
                            ...
                            <div class="accordion para1" id="accordionExample">
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                        ...
                                        <div class="accordion-body">
                                            <div class="row">
                                                <a href="mobile-assets/department-all/syllabus-new/18_RSL/ba-eng-final-compiled syllabus.pdf"
                                                    target="_blank">
                                                    <i class="fa fa-file-text px-2"></i> Syllabus - BA English
                                                    <i class="fa fa-download"></i>
                                                </a>
                                                <a href="mobile-assets/department-all/syllabus-new/18_RSL/Structure of syllabus - UG.pdf"
                                                    target="_blank">
                                                    <i class="fa fa-file-text px-2"></i> Course Structure - Language
                                                    <i class="fa fa-download"></i>
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                        ...
                                        <div class="accordion-body">
                                            <div class="row">
                                                <a href="mobile-assets/department-all/syllabus-new/18_RSL/maeng-compiled-final.pdf"
                                                    target="_blank">
                                                    <i class="fa fa-file-text px-2"></i> Syllabus - M.A. English
                                                    <i class="fa fa-download"></i>
                                                </a>

                                                <a href="mobile-assets/department-all/syllabus-new/18_RSL/Structure of syllabus - PG.pdf"
                                                    target="_blank">
                                                    <i class="fa fa-file-text px-2"></i> Structure - M.A. English
                                                    <i class="fa fa-download"></i>
                                                </a>
                                            </div>
                                        </div>
