                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                    ...
                                    <div class="accordion-body">
                                        <div class="row">
                                            <a href="mobile-assets/department-all/rslisc/course-structure_m_library-sci.pdf"
                                                target="_blank">
                                                <i class="fa fa-file-text px-2"></i> Structure of Syllabus -- MLISC
                                                <i class="fa fa-download"></i>
                                            </a>

                                            <a href="mobile-assets/department-all/rslisc/m-lisc-Syllabus.pdf" target="_blank">
                                                <i class="fa fa-file-text px-2"></i> Detailed Syllabus -- LISC
                                                <i class="fa fa-download"></i>
                                            </a>
                                        </div>
                                    </div>
