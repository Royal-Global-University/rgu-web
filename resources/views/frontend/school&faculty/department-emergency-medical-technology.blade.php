...
@section('content')
    ...
    <div class="dept-mls-wrapper">
        ...
        <div class="dept-mls-heading" id="dept-home">
            <h1>Department of <span>Emergency Medical Technology</span></h1>
        ...
        <div class="dept-mls-hero" id="dept-about">
            ...
            <div class="dept-mls-content">
                ...
                <p>
                    The Department of Emergency Medical Technology, Burn Care Technology, and Advanced Care Paramedic is
                    dedicated
                    to preparing highly competent emergency healthcare professionals capable of delivering rapid,
                    evidence-based,
                    and life-saving care across pre-hospital, hospital, trauma, disaster, and critical care settings. The
                    department integrates rigorous academic instruction with simulation-based learning and extensive
                    clinical
                    training to develop excellence in emergency response and patient management.
        ...
        <div class="dept-mls-prospects-section" id="dept-prospects">
            ...
            <div class="dept-mls-prospects-content">
                ...
                <p class="dept-mls-intro-text" style="text-align: justify;">
                    ...
                    standards,
                    equips students with expertise in emergency assessment, trauma management, advanced life support,
                    critical
                    care transport, disaster preparedness, burn management, and multidisciplinary patient care. Graduates
                    are
                    trained to function effectively in ambulances, emergency departments, intensive care units, trauma
                    centres,
                    burn units, air medical services, and disaster response teams, while upholding the highest standards of
                    professionalism, ethics, and patient safety.
                    <br><br>
                    With a strong emphasis on innovation, clinical excellence, research, and community service, the
                    department
                    prepares future Emergency Medical Technologists, Burn Care Technologists, and Advanced Care Paramedics
                    to meet
                    the growing demands of modern emergency and critical care healthcare systems at national and
                    international
                    levels.
                </p>
