              ...
              <div class="row align-items-center">
                <div class="col-lg-12">
                  ...
                  <div class="txaa-slide-down-1">
                    <div style=" height: 500px; width: 100%;" class="kd-about-3-img img-cover fix kd-img-ani-1">
                      <img class="rounded " decoding="async" src="mobile-assets/department-all/rsmas/headimg.png"
                        alt="">
                    </div>
                  </div>
                </div>
                <div class="col-lg-12">
                  ...
                  <p class="mobile-para1 pt-2" style="color: #264273; text-align: justify; line-height: 1.5;">
                    The Optometry programme at Royal Global University is a comprehensive course of study aimed at
                        preparing students for a rewarding career in eye care. Optometry focuses on the health of the eyes
                        and the visual system for enhancing quality of life through the preservation and improvement of
                        vision.
                  </p>
            ...
            <div style="background-color: #fff;">
                  <div class="container p-4">
                    ...
                    <p style="color: #243B95; text-align: justify;" class="para1">
                      ...
                      necessary to diagnose, treat, and manage various eye and vision conditions. The curriculum spans 4
                    ...
                    <p style="color: #243B95; text-align: justify;" class="para1">
                      ...
                      experience in clinical settings under the supervision of experienced optometrists. This real-world
                      exposure ensures that students are well-prepared to enter the professional world with confidence and
                    ...
                    <p style="color: #243B95; text-align: justify;" class="para1">
                      ...
                      of settings, including private practices, hospitals, research institutions, and the optical industry.
                      With a degree in Optometry, career paths include clinical practice as an optometrist, research in
                      vision sciences, and roles in the public health sector aimed at improving visual health services.
                    </p>
                    ...
                    <ol style="color: #27467A; font-size: 16px; line-height: 1.6;" class="para1">
                      <li>At Royal Global University, our Optometry programme is supported by dedicated faculties who are
                        committed to research as well. Our students are not only clinically proficient but also equipped
                        with the research and professional skills needed to advance the field of optometry.</li>

                      <li>Our infrastructure includes advanced clinical labs, research centres, and comprehensive libraries,
                        providing an enriching environment for both study and discovery. Beyond academics, we offer a
                        vibrant extracurricular scene with clubs, societies, and sports teams, fostering a well-rounded
                        university experience.</li>

                      <li>Join us at Royal Global University to embark on a fulfilling career dedicated to enhancing vision
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                              ...
                              <div class="accordion-body"
                                ...
                                <div class="row" style="display: flex; flex-direction: column; gap: 12px;">
                                  ...
                                  <a href="mobile-assets/department-all/rsmas/syllabus/UG-Optometry-structure.pdf"
                                    target="_blank" style="color: #27467A;">
                                    <i class="fa fa-file-text px-2"></i> Structure of Syllabus -- Optometry
                                    <i class="fa fa-download ms-2" style="color: #FF9A1E;"></i>
                                  </a>

                                  <a href="mobile-assets/department-all/rsmas/syllabus/OPTOMETRY-UG-2025-SYLLABUS.pdf"
                                    target="_blank" style="color: #27467A;">
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                              ...
                              <div class="accordion-body"
                                ...
                                <div class="row" style="display: flex; flex-direction: column; gap: 12px;">
                                   ...
                                   <a href="mobile-assets/department-all/rsmas/syllabus/PG-Optometry-structure.pdf"
                                    target="_blank" style="color: #27467A;">
                                    <i class="fa fa-file-text px-2"></i> Structure of Syllabus -- Optometry
                                    <i class="fa fa-download ms-2" style="color: #FF9A1E;"></i>
                                  </a>

                                  <a href="mobile-assets/department-all/rsmas/syllabus/OPTOMETRY-PG-2025-SYLLABUS.pdf"
                                    target="_blank" style="color: #27467A;">
                                    <i class="fa fa-file-text px-2"></i> Detailed Syllabus -- Optometry
                                    <i class="fa fa-download ms-2" style="color: #FF9A1E;"></i>
                                  </a>
                          ...
                          <tr style="border-bottom: 1px solid #ddd;">
                                <td style="display: flex; align-items: center; padding: 12px;">
                                  ...
                                  <div>
                                    <div style="font-weight: bold; color: #27467A;">
                                      03-05-2023 | Dr. Manjil Hazarika (Assistant Professor, Cotton University) | FDP
                                      resource person.
                                    </div>
                              ...
                              <tr style="border-bottom: 1px solid #ddd;">
                                <td style="display: flex; align-items: center; padding: 12px;">
                                  ...
                                  <div>
                                    <div style="font-weight: bold; color: #27467A;">
                                      04-06-2022 | As part of the MoU with ICT Mumbai, a lecture series was organized by the
                              ...
                              <tr style="border-bottom: 1px solid #ddd;">
                                <td style="display: flex; align-items: center; padding: 12px;">
                                  ...
                                  <div>
                                    <div style="font-weight: bold; color: #27467A;">
                                      27-09-2019 | Invited talk by Dr. Ankur Bharali, Assistant Professor, Guwahati
                                      University.
                                    </div>
                                    <a href="#" style="color: #FF9A1E; font-weight: bold; font-size: 14px;">Read More
                                      ...</a>
              ...
              <section style="background-color: #FFF8F0;">
                  ...
                  <div class="row align-items-center gx-5">
                    ...
                    <div class="col-lg-6 text-center">
                      <div class="kd-about-3-img-wrap txaa-slide-down-1">
                        <div>
                          <img class="rounded w-60" decoding="async" src="mobile-assets/department-all/rsmas/headimg.png"
                            alt="">
                        </div>
                      </div>
                    </div>
                ...
                <div style="background-color: #fff;">
                  <div class="p-5">
                    ...
                    <img class="w-100" src="mobile-assets/department-all/rsmas/vision-mission-web.png" alt="">

                  </div>
                  <img class="w-100" src="mobile-assets/department-all/rsmas/web-btm.png" alt="">
                </div>
              ...
              <div class="container">
                ...
                <div style="background-color:#FDF9F4; padding:10px; width:100%; margin: 0px auto;">
                  ...
                  <div
                    ...
                    <span style="font-size:22px; padding-right: 20px;">B. Optometry - Lateral Entry</span> | <span
