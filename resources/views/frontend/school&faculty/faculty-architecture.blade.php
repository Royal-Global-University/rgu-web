            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-image">
                                <img src="/mobile-assets/updated-faculty-img/ayesha.jpg" alt="Profile image">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-image">
                                <img src="/mobile-assets/updated-faculty-img/Ar-Diksha-Dutta-RSA.png" alt="Profile image">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-image">
                                <img src="/mobile-assets/updated-faculty-img/Ar-Jagriti-Pathak-RSA.jpg" alt="Profile image">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-image">
                                <img src="/mobile-assets/updated-faculty-img/Ar. Rajpankaja Talukdar.jpeg"
                                    alt="Profile image">
                            </div>
                            <h3 class="card-name">Ar. Rajpankaja Talukdar</h3>
                            <p class="card-designation">Assistant Professor</p>
                    ...
                    <div class="col-lg-3 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-image">
                                <img src="/mobile-assets/updated-faculty-img/Ar. Rishangi Bharadwaj.jpeg"
                                    alt="Profile image">
                            </div>
