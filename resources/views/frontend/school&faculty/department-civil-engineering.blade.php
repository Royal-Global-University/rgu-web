...
@section('content')
        ...
        <div class="mobile" >
          ...
          <section style="padding-top: 130px; position: relative;">
            ...
            <img src="mobile-assets/department-all/rset/ce/mob-top.png" alt="">

            <img src="mobile-assets/department-all/rset/ce/mob-btm.png" alt="">
                              ...
                              <div class="accordion-body"
                                ...
                                <div class="row" style="display: flex; flex-direction: column; gap: 12px;">
                                  ...
                                  <a href="mobile-assets/department-all/rset/ce/updated-syllabus/Course-structure_CE.pdf"
                                    ...
                                    <i class="fa fa-file-text px-2"></i> Structure of Syllabus -- B.Tech. CE
                                  ...
                                  <a href="mobile-assets/department-all/rset/ce/updated-syllabus/BTech_Syllabus_CE.pdf"
                                    target="_blank" style="color: #27467A;">
                                    <i class="fa fa-file-text px-2"></i> Detailed Syllabus -- B.Tech. CE
                                    <i class="fa fa-download ms-2" style="color: #FF9A1E;"></i>
                                  </a>
                              ...
                              <div class="accordion-body"
                                ...
                                <div class="row" style="display: flex; flex-direction: column; gap: 12px;">
                                  ...
                                  <a href="mobile-assets/department-all/rset/ce/updated-syllabus/M.TECH._Syllabus_CE- SE.pdf"
                                    target="_blank" style="color: #27467A;">
                                    <i class="fa fa-file-text px-2"></i> Structure of Syllabus -- M.Tech. CE
                                    <i class="fa fa-download ms-2" style="color: #FF9A1E;"></i>
                                  </a>
                           ...
                           <tr style="border-bottom: 1px solid #ddd;">
                                <td style="display: flex; align-items: center; padding: 12px;">
                                  ...
                                  <div>
                                    <div style="font-weight: bold; color: #27467A;">
                                      07-10-2024 | RSET, civil engineering | A talk on vegetation: a key player in climate
                                      change mitigation by Dr. Jyotirmoy Barman, Killam post doctoral fellow, University of
                              ...
                              <tr style="border-bottom: 1px solid #ddd;">
                                <td style="display: flex; align-items: center; padding: 12px;">
                                  ...
                                  <div>
                                    <div style="font-weight: bold; color: #27467A;">
                                      07-03-2024 | RSET, civil engineering | A talk on water resource planning and
                                      management in NER by Mr. Gopal Chetri, deputy secretary, irrigation department, Govt.
                              ...
                              <tr style="border-bottom: 1px solid #ddd;">
                                <td style="display: flex; align-items: center; padding: 12px;">
                                  ...
                                  <div>
                                    <div style="font-weight: bold; color: #27467A;">
                                      07-12-2023 | RSET, civil engineering | Inauguration of the student chapter of the
                                      Institute of Engineers (India), Assam State Centre by Chairman Dr. N. N. Patwari and
                              ...
                              <tr style="border-bottom: 1px solid #ddd;">
                                <td style="display: flex; align-items: center; padding: 12px;">
                                  ...
                                  <div>
                                    <div style="font-weight: bold; color: #27467A;">
                                      06-06-2023 | RSET, civil engineering | Inauguration of the student chapter of the
                                      Institute of Engineers (India), Assam State Centre by Chairman Dr. N. N. Patwari and
                                      Honorary Secretary Pulak Sarmah. | Inauguration and talk | Offline.
                                    </div>
                                    <a href="#" style="color: #FF9A1E; font-weight: bold; font-size: 14px;">Read More
                                      ...</a>
                                  </div>
                              ...
                              <tr style="border-bottom: 1px solid #ddd;">
                                <td style="display: flex; align-items: center; padding: 12px;">
                                  ...
                                  <div>
                                    <div style="font-weight: bold; color: #27467A;">
                                      18-09-2023 | RSET, civil engineering | A talk on reclaimed asphalt as a suitable
                                      material for the forest roads reinforcement by Dr. Jaroslav Blahuta, research fellow
                              ...
                              <tr style="border-bottom: 1px solid #ddd;">
                                <td style="display: flex; align-items: center; padding: 12px;">
                                  ...
                                  <div>
                                    <div style="font-weight: bold; color: #27467A;">
                                      10-04-2023 | RSET, civil engineering | A talk on from theory to practice: implementing
                                      earthquake engineering principles in building design by Dr. Snehal Kaushik, GIMT,
                              ...
                              <tr style="border-bottom: 1px solid #ddd;">
                                <td style="display: flex; align-items: center; padding: 12px;">
                                  ...
                                  <div>
                                    <div style="font-weight: bold; color: #27467A;">
                                      23-11-2023 | Dr. Bhaskar Chakravorty (Associate Professor, Department of Geography,
                              ...
                              <tr style="border-bottom: 1px solid #ddd;">
                                <td style="display: flex; align-items: center; padding: 12px;">
                                  ...
                                  <div>
                                    <div style="font-weight: bold; color: #27467A;">
                                      29-01-2024 | Prof. M. Taher (Former Professor, Department of Geography, Gauhati
                              ...
                              <tr style="border-bottom: 1px solid #ddd;">
                                <td style="display: flex; align-items: center; padding: 12px;">
                                  ...
                                  <div>
                                    <div style="font-weight: bold; color: #27467A;">
                                      06-02-2024 | Prof. Hitesh Deka (Vice Chancellor, KKH State Open University, Guwahati)
                                      | Guest lecture.
                                    </div>
                                    <a href="#" style="color: #FF9A1E; font-weight: bold; font-size: 14px;">Read More
                                      ...</a>
                              ...
                              <tr style="border-bottom: 1px solid #ddd;">
                                <td style="display: flex; align-items: center; padding: 12px;">
                                  ...
                                  <div>
                                    <div style="font-weight: bold; color: #27467A;">
                                      16-02-2024 | Dr. Juri Sarma (Principal, B. Baruah College, Guwahati) | Guest lecture.
                                    </div>
                                    <a href="#" style="color: #FF9A1E; font-weight: bold; font-size: 14px;">Read More
                                      ...</a>
                                  </div>
                              ...
                              <tr style="border-bottom: 1px solid #ddd;">
                                <td style="display: flex; align-items: center; padding: 12px;">
                                  ...
                                  <div>
                                    <div style="font-weight: bold; color: #27467A;">
                                      20-08-2024 | Sri Atul Chandrakant Kulkarni (Chairman, National Board of Accreditation,
                              ...
                              <tr style="border-bottom: 1px solid #ddd;">
                                <td style="display: flex; align-items: center; padding: 12px;">
                                  ...
                                  <div>
                                    <div style="font-weight: bold; color: #27467A;">
                                      08-11-2024 | Prof. Jatin Kumar Das (Head, department of geography, Rajiv Gandhi
                              ...
                              <tr style="border-bottom: 1px solid #ddd;">
                                <td style="display: flex; align-items: center; padding: 12px;">
                                  ...
                                  <div>
                                    <div style="font-weight: bold; color: #27467A;">
                                      09-12-2024 | Prof. Sudip Kumar Rakhshit (Ex professor, Indian Institute of
                              ...
                              <tr style="border-bottom: 1px solid #ddd;">
                                <td style="display: flex; align-items: center; padding: 12px;">
                                  ...
                                  <div>
                                    <div style="font-weight: bold; color: #27467A;">
                                      02-01-2025 | Prof. Chandan Mahanta (Retd. professor, IIT Guwahati) | Invited talk.
                                    </div>
                                    <a href="#" style="color: #FF9A1E; font-weight: bold; font-size: 14px;">Read More
                                      ...</a>
                                  </div>
        ...
        <div class="website">
          ...
          <section>
            ...
            <section id="about">
              <section style="background-color: #FFF8F0;">
                ...
                <img src="mobile-assets/department-all/rset/ce/web-top.png" alt="">

                <img src="mobile-assets/department-all/rset/ce/web-btm.png" alt="">
                ...
                <div style="background-color:#FDF9F4; padding:10px; width:100%; margin: 0px auto;">
                  ...
                  <a target="_blank" href="programs-b-tech-lateral-entry" style="text-decoration:none;">
                    <div
                      ...
                      <span style="flex-grow:1; color:#27467A; font-weight:bold; font-size: 20px;">Duration: 3 years</span>
                      <span>
                        <a class="para1 fw-bold"
                          style="padding: 5px 20px; border-radius: 5px; color: #fff; background: linear-gradient(135deg, hsla(33, 100%, 56%, 1) 0%, hsla(8, 52%, 50%, 1) 100%);"
                          href="programs-b-tech-lateral-entry">View Details</a>
          ...
          <div class="container mt-2">
            ...
            <h2 class="mobile-headd1 fw-bold text-left mt-3" style="color: #243B95;">
              The Department of Civil Engineering organized an industrial site visit to the RMC plant, providing
              students with valuable exposure to real-time concrete production and modern construction practices.
            </h2>
                ...
                <div class="scroll-track-wrapper" style="padding-top: 0px;">
                  ...
                  <div class="scroll-content-images unique-set-alpha">
                    ...
                    <div class="slider-image-frame">
                      <img src="mobile-assets/department-all/rset/ce/events/1.jpeg" alt="Image 1" class="scroller-image"
                        onclick="openLightbox(this.src)">
                    </div>

                    <div class="slider-image-frame">
                      <img src="mobile-assets/department-all/rset/ce/events/2.jpeg" alt="Image 2" class="scroller-image"
                        onclick="openLightbox(this.src)">
                    </div>

                    <div class="slider-image-frame">
                      <img src="mobile-assets/department-all/rset/ce/events/3.jpeg" alt="Image 2" class="scroller-image"
                        onclick="openLightbox(this.src)">
                    </div>

                    <div class="slider-image-frame">
                      <img src="mobile-assets/department-all/rset/ce/events/4.jpeg" alt="Image 2" class="scroller-image"
                        onclick="openLightbox(this.src)">
                    </div>

                    <div class="slider-image-frame">
                      <img src="mobile-assets/department-all/rset/ce/events/5.jpeg" alt="Image 2" class="scroller-image"
                        onclick="openLightbox(this.src)">
                    </div>
