...
@section('content')
    ...
    <tr>
        ...
        <td>
          <a target="_blank" href="programs-barch"><button type="button" style="background-color: #FF9A1E; color: #fff;" class="btn btn-md custom-details-btn fw-bold">Details</button></a>
        </td>
    </tr>
        ...
        <img class="pb-3" src="https://bucket-0534zd.s3.ap-south-1.amazonaws.com/mobile-assets/dept-arch/mobile-down.png" alt="">
    ...
    <!-- courses section web  -->
          <div>
            <div>
              <h2 class="headd2 fw-bold text-center pt-4 pb-3" style="color: #27467A; font-weight: 900;">
                Events and <span style="color: #FF9A1E; font-weight: 500;">Achievements</span></h2>
              <div class="table-responsive">
                <table
                  class="overflow-hidden table text-wrap table-bordered border-top mb-5" style="font-size: 16px;"
                >
                    ...
                    <div class="accordion-item">
                      ...
                      >
                        <div class="accordion-body">
                          <div class="row">
                            <a
                              href="mobile-assets/department-all/syllabus-new/2_RSA/B.ARCH. _Course Structure &  Detailed Syllabus _2025 Batch.pdf"
                              target="_blank"
                            >
                            ...
                            <a
                              href="mobile-assets/department-all/syllabus-new/2_RSA/Structure of syllabus - UG B.Arch 2025.pdf"
                              target="_blank"
                            >
