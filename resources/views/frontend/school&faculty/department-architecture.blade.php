    ...
    <div style="background-image: url(https://media.rgu.ac/department-all/bg.svg); background-size: cover;">
        ...
        <div class="mobile">
            ...
            <img class="pb-3" style="padding-top: 80px; position: relative;"
                src="https://media.rgu.ac/department-all/dept-arch/mobile-top.png" alt="">
            ...
            <img class="pb-3"
                src="https://bucket-0534zd.s3.ap-south-1.amazonaws.com/mobile-assets/dept-arch/mobile-down.png" alt="">
                                ...
                                <div class="accordion mobile-para1" id="accordionExample">
                                            ...
                                            <div class="accordion-body">
                                                <div class="row">
                                                    <a href="mobile-assets/department-all/syllabus-new/2_RSA/B.ARCH. _Course Structure &  Detailed Syllabus _2025 Batch.pdf"
                                                        target="_blank">
                                                        <i class="fa fa-file-text px-2"></i> SYLLABUS & COURSE STRUCTURE
                                                        2025
                                                        <i class="fa fa-download"></i>
                                                    </a>
                                                    <a href="mobile-assets/department-all/syllabus-new/2_RSA/Structure of syllabus - UG B.Arch 2025.pdf"
                                                        target="_blank">
                                                        <i class="fa fa-file-text px-2"></i> STRUCTURE OF THE SYLLABUS FOR 5
                                                        YEAR UG PROGRAMME
                                                        <i class="fa fa-download"></i>
                                                    </a>
                                                    <!-- <a
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseThree" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <a href="phd" class="mobile-para1" target="_blank"><strong>Click to
                                                        View...</strong></a>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="website">
            ...
            <!-- floating button  -->
            <img class="pb-3" src="https://media.rgu.ac/department-all/dept-arch/web-architecture.png" alt="">
