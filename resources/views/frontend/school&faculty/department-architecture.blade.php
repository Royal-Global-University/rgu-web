...
@section('content')
    <div style="background-image: url(mobile-assets/dept-arch/s2-bg-img-1.webp);">
        <div class="mobile">
            @include('frontend/components/mobileheader')
            <img style="padding-top: 80px; position: relative;" class="pb-3" src="mobile-assets/dept-arch/mobile-arch.png" alt="">

            <div class="container">
                <div>
                    <div>
                        <h3 class="mobile-headd3 text-dark fw-bold p-3" style="background-color: #c7daf9; color: #ffffff">
                ...
                <div>
                    <div>
                        ...
                        <div class="text-dark">
                            <h3 class="mobile-headd3 text-dark fw-bold kd-split-text pt-2">Click More</h3>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="accordion mobile-para1" id="accordionExample">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseThree" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <a href="doctoral-programme.html" class="mobile-para1"
        ...
        <div class="website">
            ...
            <img class="pb-3" src="mobile-assets/dept-arch/web-architecture.png" alt="">
