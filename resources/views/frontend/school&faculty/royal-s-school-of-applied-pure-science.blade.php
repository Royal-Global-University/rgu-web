    ...
    <div class="mobile">
        ...
        <section style="padding-top: 90px; position: relative; background-image: url('mobile-assets/royal-schools-assets/bg.svg');">
            <h2 class="mobile-headd2 fw-bold text-center kd-title-ani kd-split-text pt-4"
                ...
                Royal School of Applied <span style="color: #FF9A1E; font-weight: 500;">and Pure Sciences (RSAPS)</span>
            </h2>
            ...
            <div style="padding: 20px 30px;">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-4">
                        ...
                        <a href="department-physics">
                            <div class="card rounded d-flex flex-column"
                                style="background-color: #fff; border: none; box-shadow: -1px 3px 5px 0px rgba(0,0,0,0.25); height: 100%;">
                                <div class="p-3 text-center">
                                    <i style="color: #27467A;" class="fas fa-atom fa-3x"></i>

                                </div>
                                <div class="card-body ">
                                    <h5 style="font-weight: 800; color: #27467A;"
                                        class="text-center card-title mobile-headd2 pb-2">Department of Physics</h5>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-lg-4 mb-4">
                        ...
                        <a href="department-chemistry">
                            <div class="card rounded d-flex flex-column"
                                ...
                                <div class="card-body ">
                                    <h5 style="font-weight: 800; color: #27467A;"
                                        class="text-center card-title mobile-headd2 pb-2">Department of Chemistry</h5>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-lg-4 mb-4">
                        ...
                        <a href="department-mathematics">
                            <div class="card rounded d-flex flex-column"
                                style="background-color: #fff; border: none; box-shadow: -1px 3px 5px 0px rgba(0,0,0,0.25); height: 100%;">
                                <div class="p-3 text-center">
                                    <i style="color: #27467A;" class="fas fa-square-root-alt fa-3x"></i>

                                </div>
                                <div class="card-body ">
                                    <h5 style="font-weight: 800; color: #27467A;"
                                        class="text-center card-title mobile-headd2 pb-2">Department of Mathematics</h5>
                                </div>
                            </div>
                        </a>
                    </div>
                            ...
                            <div class="p-4 card rounded d-flex flex-column"
                                ...
                                <div class="card-body">
                                    <h5 style="font-weight: 700; color: #27467A;"
                                        class="text-center card-title headd2 pb-2">Department of Physics</h5>
                    ...
                    <div class="col-lg-4 mb-4">
                        ...
                        <a href="department-chemistry">
                            <div class="p-4 card rounded d-flex flex-column"
                                ...
                                <div class="card-body">
                                    <h5 style="font-weight: 700; color: #27467A;"
                                        class="text-center card-title headd2 pb-2">Department of Chemistry</h5>
                    ...
                    <div class="col-lg-4 mb-4">
                        ...
                        <a href="department-mathematics">
                            <div class="p-4 card rounded d-flex flex-column"
                                ...
                                <div class="card-body">
                                    <h5 style="font-weight: 700; color: #27467A;"
                                        class="text-center card-title headd2 pb-2">Department of Mathematics</h5>
