    ...
    <div style="background-image: url(mobile-assets/department-all/bg.svg); background-size: cover;">
        ...
        <div class="mobile">
            ...
            <section style="padding-top: 130px; position: relative;">
                <img src="mobile-assets/department-all/rsd/product-design/mob-productdesign.png" alt="">
            </section>
            <!-- till about dept  -->
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body"
                                                ...
                                                <div class="row" style="display: flex; flex-direction: column; gap: 12px;">
                                                    ...
                                                    <a href="mobile-assets/department-all/rsd/product-design/syllabus/Course-structure_Product-Design.pdf"
                                                    ...
                                                    <a href="mobile-assets/department-all/rsd/product-design/syllabus/B.Des.-Product-Design-Deatiled-syllabus.pdf"
                                                        target="_blank" style="color: #27467A;">
                                                        <i class="fa fa-file-text px-2"></i> Detailed Syllabus -- Product
                                                        Design
                                                        <i class="fa fa-download ms-2" style="color: #FF9A1E;"></i>
                                                    </a>
            ...
            <section>
                ...
                <section id="about">
                    <section style="background-color: #FFF8F0;">
                        ...
                        <img src="mobile-assets/department-all/rsd/product-design/web-productdesign.png" alt="">
                ...
                <section id="course">
                    ...
                    <div class="container">
                        ...
                        <div style="background-color:#FDF9F4; padding:10px; width:100%; margin: 0px auto;">
                            ...
                            <!-- Statute Items -->
                            <a target="_blank" href="programs-Bachelor-of-Design-Product-Design"
