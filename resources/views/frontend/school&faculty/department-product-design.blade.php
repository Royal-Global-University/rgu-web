...
@section('content')
    <div style="background-image: url(mobile-assets/dept-product-design/s2-bg-img-1.webp);">
        <div class="mobile">
            @include('frontend/components/mobileheader')
            <img style="padding-top: 80px; position: relative;" class="pb-3"
                src="mobile-assets/dept-product-design/mob-productdesign.png" alt="">

        </div>

        <div class="website">
            @include('frontend/components/aheader')
            <img src="mobile-assets/dept-product-design/web-productdesign.png" alt="">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                    ...
                                    <div class="accordion-body">
                                        <div class="row">
                                            <a href="assets/Departmentalpdf/AY 2023-24 B.Des. Product Design.pdf"
                                                target="_blank">
                                                <i class="fa fa-file-text px-2"></i>AY 2023-24 B.Des. Product
