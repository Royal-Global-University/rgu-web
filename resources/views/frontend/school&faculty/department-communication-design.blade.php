    ...
    <div style="background-image: url(mobile-assets/department-all/bg.svg); background-size: cover;">
        ...
        <div class="mobile">
            ...
            <section style="padding-top: 130px; position: relative;">
                <img src="mobile-assets/department-all/rsd/communication-design/mob-Communicationdesign.png" alt="">
            </section>
            <!-- till about dept  -->
            ...
            <div class="container">
                ...
                <div style="background-color:#FDF9F4; padding:10px; width:100%; margin: 0px auto;">
                    ...
                    <div
                        ...
                        <span style="font-size:18px; padding-right: 20px;">Bachelor of Design (Communication Design)</span>
                    ...
                    <!-- Statute Items -->
                    <a target="_blank" href="programs-Bachelor-of-Design-Communication-Design"
                        ...
                        <div
                            ...
                            <span>
                                <a class="para1 fw-bold"
                                    ...
                                    href="programs-Bachelor-of-Design-Communication-Design">View Details</a>
                            </span>
                        </div>
                    </a>
                </div>
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body"
                                                ...
                                                <div class="row" style="display: flex; flex-direction: column; gap: 12px;">
                                                    ...
                                                    <a href="mobile-assets/department-all/rsd/communication-design/syllabus/structure-b-des.pdf"
                                                        target="_blank" style="color: #27467A;">
                                                        <i class="fa fa-file-text px-2"></i> Structure of Syllabus -- B.Des
          ...
          color:white; font-weight:600; font-size:16px; cursor:pointer; border-radius:12px;">
                    ...
                    <div id="mobAccPanel2"
                        ...
                        <div class="table-responsive">
                            <table class="overflow-hidden table text-wrap table-bordered border-top mb-5 table-responsive">
                                <thead class="text-white" style="background-color: #27467a">
                                    <tr>
                                        <th class="text-white">#</th>
            ...
            <section>
                ...
                <section id="about">
                    <section style="background-color: #FFF8F0;">
                        ...
                        <img src="mobile-assets/department-all/rsd/communication-design/web-communicationdesign.png" alt="">
                    ...
                    <div class="container">
                        ...
                        <div style="background-color:#FDF9F4; padding:10px; width:100%; margin: 0px auto;">
                            ...
                            <div
                                ...
                                <span style="font-size:22px; padding-right: 20px;">Bachelor of Design (Communication
                                    Design)</span> | <span
                    ...
                    <div id="drc" style="margin:0 auto;">
                       ...
                       color:white; font-weight:600; font-size:18px; cursor:pointer; border-radius:12px;">
                                    ...
                                    <div id="accPanel2"
                                        ...
                                        <div class="table-responsive">
                                            <table
                                                class="overflow-hidden table text-wrap table-bordered border-top mb-5 table-responsive">
                                                <thead class="text-white" style="background-color: #27467a">
                                                    <tr>
                                                        <th class="text-white">#</th>
                                                        <th class="text-white">Name of the Member</th>
