    ...
    <div>
      ...
      <div class="p-2">
        ...
        <ol class="para1 text-dark">
          <li>
            To achieve academic excellence through a curriculum that seamlessly
            integrates innovative, research-intensive, and industry-oriented
            education tailored to the dynamic field of communication design.
          </li>
          <li>
            To incorporate community service and real-world projects into the
            educational experience, by engaging with local and global communities,
            with a strong sense of ethical conduct and compassion, encouraging our
            students to become conscientious designers who prioritize social
            responsibility.
          </li>
          <li>
            To develop responsible leaders who are equipped to enrich society and
            drive positive transformation through the power of design, enabling
            them to take on leadership roles in the industry, equipped with the
            skills to create impactful, user-centered designs that resonate on a
            global scale.
          </li>
        </ol>
      </div>
        ...
        <div class="row">
          <div class="col-lg-6">
            <img
              ...
              src="assets/img/Departments/Department_Communications_Media/Design2.jpg"
            />
          </div>
          <div class="col-lg-6">
            <img
              style="border-radius: 10px"
              src="assets/img/Departments/Department_Communications_Media/Design.jpg"
            />
          </div>
        </div>
      </div>
              ...
              <div class="accordion-item">
                ...
                >
                  <div class="accordion-body">
                    <div class="row">
                      <a
                        href="assets/Departmentalpdf/AY 2022-23 B.Des. Communication Design.pdf"
                        target="_blank"
                      >
                        <i class="fa fa-file-text px-2"></i>AY 2022-23 B.Des.
                        Communication Design.pdf <i class="fa fa-download"></i>
                      </a>

                      <a
                        href="assets/Departmentalpdf/AY 2023-24 B.Des. Communication Design.pdf"
                        target="_blank"
                      >
                        <i class="fa fa-file-text px-2"></i>AY 2023-24 B.Des.
                        Communication Design.pdf <i class="fa fa-download"></i>
                      </a>
                    </div>
                  </div>
                  ...
                  <div class="swiper-wrapper">
                      ...
                      <div class="kd-testimonial-1-item">
                        ...
                        <div class="item-content">
                          <h5 style="font-size: 18px; text-align: justify">
                            “ Studying at The Assam Royal Global University has
                            been an incredible experience. The Bachelor of Design
                            program helped me improve my communication skills and
                            build important connections. The teachers have been
                            very helpful, guiding me throughout my journey and
                            making a significant impact on my career as a
                            designer. ”
                          </h5>
                          ...
                          >
                            <div class="author-img fix img-cover">
                              <img
                                ...
                                src="assets/img/testimonial/Department_Product_Design/Manas.jpg"
                                alt=""
                              />
                            </div>
                            <div>
                    ...
                    <div class="swiper-slide">
                      <div class="kd-testimonial-1-item">
                        ...
                        <div class="item-content">
                          <h5 style="font-size: 18px; text-align: justify">
                            “ My four years in the Department of Communication
                            Design have been an incredible journey of growth and
                            creativity. The professors were not just educators but
                            mentors who guided and inspired me with their
                            expertise and support. Their dedication and the
                            department's hands-on approach to learning allowed me
                            to explore various facets of design and develop
                            practical skills that will undoubtedly shape my future
                            career. I am grateful for the opportunities,
                            collaborative projects, and the nurturing environment
                            that have made my learning experience truly
                            exceptional. Thank you to everyone at the department
                            for an awesome journey! ”
                          </h5>
                          ...
                          >
                            <div class="author-img fix img-cover">
                              <img
                                ...
                                src="assets/img/testimonial/Department_Product_Design/Chinmoy.jpg"
                                alt=""
                              />
                            </div>
                            <div>
                    ...
                    <div class="swiper-slide">
                      <div class="kd-testimonial-1-item">
                        ...
                        <div class="item-content">
                          <h5 style="font-size: 18px; text-align: justify">
                            “ My journey at the Department of Communication Design
                            at Royal Global University has been an enriching and
                            inspiring experience. The faculty's dedication and
                            expertise have profoundly impacted my growth, not just
                            as a designer but as an individual. Their approach to
                            teaching, blending theory with practical application,
                            provided me with a solid foundation and a creative
                            edge. The environment here has been collaborative and
                            supportive, allowing me to explore various dimensions
                            of design. I am deeply thankful for the guidance and
                            opportunities that have shaped my skills and
                            perspective. Thank you to everyone at the department
                            for making these four years truly transformative ”
                          </h5>
                          ...
                          >
                            <div class="author-img fix img-cover">
                              <img
                                ...
                                src="assets/img/testimonial/Department_Product_Design/Shriya.jpg"
                                alt=""
                              />
                            </div>
                            <div>
